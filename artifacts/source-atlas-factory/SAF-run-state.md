...
```yaml
program: SAF
current_issue: AMB-691 / PLOS-065 Source Authority validation gauntlet under AMB-614 / PLOS-M06
last_completed_issue: AMB-690 / PLOS-064 Source Settings drill-down model pushed and moved to Done in Linear
latest_pushed_commit: e0cd905a9348255160008f487d51e6085e8ac81c
branch: main
...
linear_update_status: AMB-691 was moved to In Progress in Linear before scoped artifact work
next_dependency: Validate, commit, push, and move AMB-691 to Done before AMB-614 / PLOS-M06 parent acceptance; do not allow M06 runtime eligibility claims, validator implementation claims, UI implementation claims, accessibility proof claims, or M10 runtime consumption claims from AMB-973 staging evidence or AMB-686 through AMB-691 documentation artifacts alone
