...
| 2 | M02 | AMB-610 | Local data, CloudKit, R2 boundary, and data lifecycle foundation | `scripts/codex/program-phase-gate.sh plos M02` | In Progress; AMB-654 active |
...
Continue AMB-654 / PLOS-021 only. Do not execute AMB-655 until AMB-654 is committed, pushed to `main`, and updated in Linear. Do not close AMB-610 / PLOS-M02 until all live-resolved M02 children AMB-653 through AMB-660 are complete and the parent acceptance gate passes.
