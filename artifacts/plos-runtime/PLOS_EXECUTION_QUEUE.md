...
| 8 | M08 | AMB-616 | Native Context Mesh and permission explainers | `scripts/codex/program-phase-gate.sh plos M08` | Active; AMB-702 / PLOS-080 through AMB-708 / PLOS-086 Done; AMB-771 / PLOS-087 Done; AMB-710 / PLOS-088 In Progress; AMB-764 through AMB-770 and AMB-772 Duplicate; AMB-709 archived/non-active |
...
Validate AMB-710 / PLOS-088, commit and push to `main`, update AMB-710 in Linear, then re-fetch AMB-616 and current M08 children before AMB-616 / PLOS-M08 parent acceptance if no new active M08 child was added.
