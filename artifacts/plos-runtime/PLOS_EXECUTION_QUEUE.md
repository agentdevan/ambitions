...
Scope of current run: AMB-680 / PLOS-054 claim extraction and duplicate detection under AMB-613 / PLOS-M05; no runtime implementation or live R2 writes
...
| 5 | M05 | AMB-613 | Source Atlas Pack / Seed Foundry | `scripts/codex/program-phase-gate.sh plos M05` | In progress; AMB-676 / PLOS-050 through AMB-679 / PLOS-053 Done; current child AMB-680 / PLOS-054; AMB-738 through AMB-747 Duplicate; AMB-973 Backlog future R2 staging child not active for AMB-680 |
...
Complete AMB-680 / PLOS-054 only. Do not perform live R2 writes; AMB-680 is claim extraction/duplicate-detection documentation/control-plane proof only and explicitly excludes extraction engine implementation, duplicate scanner implementation, merge tooling, schema migration, runtime pack consumption, Cloudflare/R2 provisioning, credential creation, network validation, pack publication, release claims, and accessibility/device/performance proof. AMB-681 / PLOS-055 becomes eligible only after AMB-680 is committed, pushed to `main`, moved to Done in Linear, and the M05 phase gate remains Green.
