...
Scope of current run: AMB-674 / PLOS-046 freshness cadence policy execution, one child issue at a time
...
| 4 | M04 | AMB-612 | R2 Source Atlas distribution mesh | `scripts/codex/program-phase-gate.sh plos M04` | In Progress; AMB-668 through AMB-673 Done; AMB-674 active |
...
Continue AMB-674 / PLOS-046 only. Do not perform live R2 writes; AMB-674 is freshness cadence policy documentation only and explicitly excludes background task and runtime freshness implementation. After AMB-674 is committed, pushed to `main`, and moved to Done in Linear, continue AMB-675 / PLOS-047 only.
