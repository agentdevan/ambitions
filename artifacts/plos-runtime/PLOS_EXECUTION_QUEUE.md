...
Scope of current run: AMB-670 / PLOS-042 signed manifest and compatibility manifest execution, one child issue at a time
...
| 4 | M04 | AMB-612 | R2 Source Atlas distribution mesh | `scripts/codex/program-phase-gate.sh plos M04` | In Progress; AMB-668 and AMB-669 Done; AMB-670 active |
...
Continue AMB-670 / PLOS-042 only. Do not perform live R2 writes; AMB-670 is signed manifest and compatibility manifest documentation only and explicitly excludes runtime parser implementation. After AMB-670 is committed, pushed to `main`, and moved to Done in Linear, continue AMB-671 / PLOS-043 only.
