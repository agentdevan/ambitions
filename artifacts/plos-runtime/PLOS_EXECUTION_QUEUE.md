...
| 1 | M01 | AMB-609 | Live runtime truth map | `scripts/codex/program-phase-gate.sh plos M01` | In progress; AMB-649 active |
...
Complete AMB-649 / PLOS-013, then continue M01 children one at a time only after push and Linear closeout. Do not execute `AMB-610` / `PLOS-M02` or later phases in this run.
