...
Scope of current run: AMB-710 / PLOS-088 Permission ledger and revocation controls
...
| 8 | M08 | AMB-616 | Native Context Mesh and permission explainers | `scripts/codex/program-phase-gate.sh plos M08` | Parent acceptance in progress; AMB-702 / PLOS-080 through AMB-708 / PLOS-086 Done; AMB-771 / PLOS-087 Done; AMB-710 / PLOS-088 Done; AMB-764 through AMB-770 and AMB-772 Duplicate; AMB-709 archived/non-active |
| 9 | M09 | AMB-627 | Step Quality Firewall | `scripts/codex/program-phase-gate.sh plos M09` | Blocked pending AMB-616 parent acceptance push and Linear closeout |
...
Validate AMB-616 / PLOS-M08 parent acceptance, commit and push to `main`, update AMB-616 in Linear, then re-fetch AMB-627 and current M09 children before starting M09 if no new active M08 child was added.
