...
current_child:
  label: "PLOS-033"
  linear_id: "AMB-664"
  title: "Define R2 write-token isolation"
  status: "In Progress in Linear; report pending commit/push"
next_allowed_action:
  action: "Complete AMB-664 / PLOS-033 only, then continue to AMB-665 / PLOS-034 after push and Linear closeout"
...
latest_local_scope:
  changed_path_policy: "reports, validation logs, and PLOS control-plane artifacts only for AMB-664"
