...
Updated: 2026-06-13
Scope of current packet: AMB-697 / PLOS-075 Coverage Demand Queue under AMB-615 / PLOS-M07; no PLOS runtime feature implementation
...
Current M07 status: In Progress under parent `AMB-615`. Live Linear verification on 2026-06-13 America/New_York found `AMB-692` / `PLOS-070`, `AMB-755` / `PLOS-071`, `AMB-694` / `PLOS-072`, `AMB-695` / `PLOS-073`, and `AMB-696` / `PLOS-074` Done, and active child `AMB-697` / `PLOS-075` In Progress for Coverage Demand Queue scope. Active later non-archived children include `AMB-698` through `AMB-701`; `AMB-754` and `AMB-756` through `AMB-763` are Duplicate/archived/canceled and must not be executed; `AMB-693` is archived/non-active and must not be executed unless owner reopens or otherwise marks it active.
