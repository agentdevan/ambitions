...
Updated: 2026-06-13
Scope of current packet: AMB-700 / PLOS-078 Unsupported And Unsafe Routing under AMB-615 / PLOS-M07; no PLOS runtime feature implementation
...
Current M07 status: In Progress under parent `AMB-615`. Live Linear verification on 2026-06-13 America/New_York found `AMB-692` / `PLOS-070`, `AMB-755` / `PLOS-071`, `AMB-694` / `PLOS-072`, `AMB-695` / `PLOS-073`, `AMB-696` / `PLOS-074`, `AMB-697` / `PLOS-075`, `AMB-698` / `PLOS-076`, and `AMB-699` / `PLOS-077` Done, and active child `AMB-700` / `PLOS-078` In Progress for unsupported/unsafe routing scope. Active later non-archived child is `AMB-701`; `AMB-754` and `AMB-756` through `AMB-763` are Duplicate/archived/canceled and must not be executed; `AMB-693` is archived/non-active and must not be executed unless owner reopens or otherwise marks it active.
