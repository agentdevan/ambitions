...
- Commit: source implementation commit `576cea9e6b7e5fb04b00d6be68d42353883b8817`; final metadata/push reconciliation pending before Linear closeout.
...
- Freshness: current on 2026-06-14 America/New_York for branch `main` after resolving `AMB-1052` through Linear and validating source commit `576cea9e6b7e5fb04b00d6be68d42353883b8817` locally.
- Rollback: revert source implementation commit `576cea9e6b7e5fb04b00d6be68d42353883b8817` and the follow-up AMB-1052 metadata reconciliation commit if unsafe.
