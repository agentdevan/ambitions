...
- Commit: pending AMB-681 closeout commit; final pushed hash will be recorded in Linear closeout.
...
- Freshness: current on 2026-06-12 America/New_York for branch `main` after resolving AMB-613, AMB-681, live M05 duplicate AMB-743, and future non-current Backlog R2 child AMB-973 through Linear using actual `AMB-*` identifiers.
...
- Freshness: current on 2026-06-12 America/New_York for branch `main` after resolving AMB-613, AMB-680, live M05 duplicate AMB-742, and future non-current Backlog R2 child AMB-973 through Linear using actual `AMB-*` identifiers.
