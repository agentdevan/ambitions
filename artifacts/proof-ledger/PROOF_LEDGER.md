...
- Commit: pending AMB-685 closeout commit; final pushed hash will be recorded in Linear closeout after push.
...
- Exit code: Linear reads succeeded before AMB-685 execution; local validation exits are recorded in the AMB-685 report after validation; Linear status update occurs only after push.
