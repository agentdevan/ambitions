...
| 10 | M01.T06B | AMB-1128 | Source Authority Mesh | `scripts/codex/program-phase-gate.sh amb-master M01` | Backlog / next |
...
Refresh live Linear and execute `AMB-1128` / `M01.T06B`.
