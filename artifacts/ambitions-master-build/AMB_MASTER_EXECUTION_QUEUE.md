...
| 18 | M02.T07 | AMB-1133 | Life Consequence Engine | `scripts/codex/program-phase-gate.sh amb-master M02` | Local Green / source commit pending |
...
Commit and push AMB-1133 source and closeout metadata, reconcile `AMB-1133` in Linear, then refresh live Linear and execute `AMB-1117` / `M02.T08`.
