...
| 24 | M04.T03 | AMB-1060 | Tokenized design system foundation: flagship semantic base | `scripts/codex/program-phase-gate.sh amb-master M04` | Done in Linear / source `f60258d6a0494223cc5e5899b21cbc37272bcb9d` / closeout metadata `5958d6d498bf5494f3da7526e3e4d4a11d53e6a2` / final proof-index `47eec76ebab5977c14937acb021a02bf455fb91e` |
| 25 | M04.T04 | AMB-1061 | Core reusable component set: native interaction primitives | `scripts/codex/program-phase-gate.sh amb-master M04` | Next eligible after AMB-1060 Done |
...
Refresh live Linear for `AMB-1061` / `M04.T04`, then start the core reusable component set train.
