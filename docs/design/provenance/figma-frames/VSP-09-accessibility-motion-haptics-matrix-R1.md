...
Scope:
- Candidate matrix for Dynamic Type, VoiceOver, Reduce Motion, Reduce Transparency, Increase Contrast, Differentiate Without Color, Switch Control/focus, hit targets, haptics, and static equivalents.
...
- Owner review of the VSP-09 matrix.
