...
Frame naming recommendation: EXPLORATION - VSP-08 - PART 01 - external boundary directions - R1
Shell relationship: requires VSP-01 shell = True; may mutate shell = False
...
Proof ceiling: Yellow
Missing proof: owner approval, VSP-08A policy readback owner approval, VSP-08B implementation proof packet, live SwiftUI boundary parity screenshot, R2/Source Atlas request-shape proof, offline no-account proof, owner direction selection
