...
```text
Annotation title: VSP-04 provenance - Time / LifeShape Week
Frame naming recommendation: CANDIDATE - VSP-04 - Time LifeShape Week hero - R1
Shell relationship: requires VSP-01 shell = True; may mutate shell = False
...
Allowed implementation area: Native/Ambitions/Surfaces/Time, Native/Ambitions/Core/Time, Native/Ambitions/Core/Runtime, Sources/Components
Forbidden implementation area: Native/Ambitions/Stage shell mutations, calendar-clone-only root pattern, top-level stale planning IA, unproven external calendar dependency for core value
Proof ceiling: Yellow
Missing proof: owner direction selection, owner approval, live SwiftUI Time parity screenshot, device screenshot, manual accessibility matrix, reflow/protection runtime proof
...
Frame naming recommendation: CANDIDATE - VSP-05 - Capture Open Field Composer hero - R1
Shell relationship: requires VSP-01 shell = True; may mutate shell = False
...
Proof ceiling: Yellow
Missing proof: owner approval, live SwiftUI composer parity screenshot, device keyboard/composer screenshots, manual accessibility matrix, offline save/proposal/receipt runtime proof
Linear mirror: AMB-1484 (Needs Repair)
Non-claim: this annotation is not Code Connect, not Visual Green, not source implementation, and not owner approval.
```
...
Frame naming recommendation: CANDIDATE - VSP-07 - Trust Inspection hero - R1
Shell relationship: requires VSP-01 shell = True; may mutate shell = False
...
Proof ceiling: Yellow
Missing proof: owner approval, live SwiftUI inspection parity screenshot, device screenshot, manual accessibility matrix, privacy/trust disclosure proof
