...
- direct repository/service mutation paths outside `Core/LocalRuntimeOS/Commands/`, `TransactionKernel/`, `EventJournal/`, `ProjectionEngine/`, `Receipt`, and `Replay` semantics
