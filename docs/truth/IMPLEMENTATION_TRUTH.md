...
- This CommandSpine proof is bounded to the wired executor/Today paths and does not prove app-wide command-only mutation or full LocalRuntimeOS completion.
