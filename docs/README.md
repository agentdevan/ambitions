...
- Truth: [`truth/README.md`](truth/README.md)
- Product/design truth: [`truth/PRODUCT_DESIGN_TRUTH.md`](truth/PRODUCT_DESIGN_TRUTH.md)
- Product moat truth: [`truth/PRODUCT_MOAT_TRUTH.md`](truth/PRODUCT_MOAT_TRUTH.md)
- Implementation/source truth: [`truth/IMPLEMENTATION_TRUTH.md`](truth/IMPLEMENTATION_TRUTH.md)
- Release/proof truth: [`truth/RELEASE_TRUTH.md`](truth/RELEASE_TRUTH.md)
- Private Life Runtime proof target: [`runtime/PRIVATE_LIFE_RUNTIME_PROOF_SPEC.md`](runtime/PRIVATE_LIFE_RUNTIME_PROOF_SPEC.md)
- Status ledgers: [`status/README.md`](status/README.md)
- Cleanup decisions: [`status/cleanup-decision-register.md`](status/cleanup-decision-register.md)
