...
Ambitions 3.0 batch trains are governed by [codex/AMBITIONS_3_0_BATCH_TRAIN_ORCHESTRATOR.md](codex/AMBITIONS_3_0_BATCH_TRAIN_ORCHESTRATOR.md). The active completion train is [codex/batch-trains/F17_F30_FAANG_HANDOFF_COMPLETION_TRAIN.md](codex/batch-trains/F17_F30_FAANG_HANDOFF_COMPLETION_TRAIN.md), starting with [codex/batches/F17_Shell_Meridian_Planning_And_Readiness_Audit_Prompt.md](codex/batches/F17_Shell_Meridian_Planning_And_Readiness_Audit_Prompt.md). F18 Shell/Meridian implementation remains blocked until F17 produces a Green architecture and ownership plan. FAANG handoff remains PARTIAL unless the F27 handoff gate is explicitly re-run and passes.
