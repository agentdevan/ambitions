...
**Lifecycle state:** Draft Research; not approved Scope or Design  
**Canonical destination if approved:** `docs/product-development/ambitions-private-semantic-intelligence/research.md`
