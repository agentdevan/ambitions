...
|---|---|---|---|---|
| FIND-003, FIND-007, FIND-009 | REQ-001 | AC-001 | DESIGN-002, DESIGN-003, DESIGN-008, DESIGN-011 | VERIFY-001 |
| FIND-003, FIND-007, FIND-009 | REQ-001 | AC-010 | DESIGN-008, DESIGN-029 | VERIFY-008 |
| FIND-004, FIND-008, FIND-009, PD-2026-08-LIFECYCLE-FIXTURE-SCOPE | REQ-002 | AC-002 | DESIGN-001, DESIGN-004 | VERIFY-002 |
| FIND-003, FIND-009 | REQ-003 | AC-003 | DESIGN-005, DESIGN-013 | VERIFY-011 |
| FIND-002, FIND-004, FIND-005, FIND-006 | REQ-004 | AC-004 | DESIGN-006, DESIGN-009 | VERIFY-003 |
| FIND-002, FIND-004, FIND-005, FIND-006 | REQ-004 | AC-005 | DESIGN-006 | VERIFY-003, VERIFY-004 |
| FIND-004, FIND-005, FIND-006 | REQ-005 | AC-006 | DESIGN-019, DESIGN-024, DESIGN-025 | VERIFY-004, VERIFY-005 |
| FIND-004, FIND-005, FIND-006 | REQ-005 | AC-007 | DESIGN-019, DESIGN-024 | VERIFY-005 |
| FIND-008, FIND-009 | REQ-006 | AC-008 | DESIGN-007, DESIGN-010 | VERIFY-006 |
| FIND-002, FIND-003, FIND-005, FIND-006 | REQ-007 | AC-009 | DESIGN-005, DESIGN-009 | VERIFY-007 |
| FIND-007 | REQ-008 | AC-010 | DESIGN-008, DESIGN-029 | VERIFY-008 |
| FIND-003, FIND-009 | REQ-009 | AC-011 | DESIGN-002, DESIGN-005, DESIGN-028 | VERIFY-009 |
| FIND-002 | REQ-010 | AC-012 | DESIGN-004 | VERIFY-002, VERIFY-010 |

All Scope requirements and acceptance criteria are covered. The `FIND-*` identifiers are upstream authority references carried through Scope; the exact passed Scope document is the sole lifecycle input to this Design.
