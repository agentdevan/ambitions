...
Status: AMB-1714 Implemented Yellow
...
`112` after this slice. The remaining files stay Yellow, not Green:

- `98` move-candidate files remain in legacy runtime owner scope.
- `8` adapter-shim files remain in legacy runtime owner scope.
- `5` test-only support files remain in legacy runtime owner scope.
...
three moved rows above. Follow-up ownership and deletion remain assigned to
AMB-1715 and AMB-1716 under AMB-1666. Unsafe write and persistence authority
findings remain outside this slice and stay under AMB-1667 follow-up work.
