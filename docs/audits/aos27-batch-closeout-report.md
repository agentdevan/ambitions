...
## Files Changed
- `Native/Ambitions/Domain/AmbitionsOSPrivacySafetyTailGate.swift` (added)
- `Native/AmbitionsTests/Domain/AmbitionsOSPrivacySafetyTailGateTests.swift` (added)
...
## EFC Applicability
Invoked. The Privacy Safety Tail Gate is deterministically implemented to verify that local processing limits, redaction rules, and telemetry restrictions are upheld before proceeding.
...
## Rollback Notes
If needed, can revert changes to `Native/Ambitions/Domain/AmbitionsOSPrivacySafetyTailGate.swift` and `Native/AmbitionsTests/Domain/AmbitionsOSPrivacySafetyTailGateTests.swift`.
