...
- an FE-11-specific proof manifest path at
  `docs/audits/visual-evidence/fe11/fe11-preview-visual-qa-proof.md`
- 21 SwiftUI ImageRenderer PNG evidence artifacts under
...
- The FE-11 proof manifest lives in
  `docs/audits/visual-evidence/fe11/fe11-preview-visual-qa-proof.md`.
...
|---|---|---|---|---|
| Today | `today.normal`, `today.disabled`, `today.waiting`, `today.recovery` | inventory complete | checklist scaffolded | not release or device proof |
| Goals | `goals.selected`, `goals.degraded`, `goals.staleSource`, `goals.needsReview` | inventory complete | checklist scaffolded | not release or device proof |
| Capture | `capture.focused`, `capture.noDataYet`, `capture.blocked`, `capture.dynamicType` | inventory complete | checklist scaffolded | not release or device proof |
| Time | `time.loading`, `time.partialSource`, `time.deniedSource`, `time.overwhelmingDay`, `time.reducedMotion` | inventory complete | checklist scaffolded | not release or device proof |
| You | `you.empty`, `you.privacySensitive`, `you.setupNeeded`, `you.offlineLocalOnly` | inventory complete | checklist scaffolded | not release or device proof |
...
- FE-11 proof manifest and JSON inventory under
  `docs/audits/visual-evidence/fe11/`
- SwiftUI ImageRenderer FE-11 fixture screenshot generator at
...
- `python3 scripts/ambitions-fe11-preview-visual-qa-report.py --write-proof`
- `python3 scripts/ambitions-fe11-preview-visual-qa-report.py --require-screenshots`
