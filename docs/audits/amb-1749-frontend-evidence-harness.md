...
| Time | `testLaunchURLCanLandOnCanonicalTimeSurface`, `testAMB964TimeReconstructionScreenshotMatrix`, `testAMB1174TimeVisualFlagshipLayerScreenshotProof`, `testAMB1176TimeEmptyAndAccessibilityProofPacket`. | Current Time screenshot evidence, Dynamic Type note, Reduce Motion note, and visual review. |
