...
## Files Changed
- `Native/Ambitions/Domain/AmbitionsOSExperienceTailGate.swift` (added)
- `Native/AmbitionsTests/Domain/AmbitionsOSExperienceTailGateTests.swift` (added)
...
## EFC Applicability
Invoked. The Experience Tail Gate evaluates experience-specific obligations, guaranteeing cognitive load bounds, signature language presence, and no-dashboard constraints are met before continuing.
...
## Rollback Notes
If needed, can revert changes to `Native/Ambitions/Domain/AmbitionsOSExperienceTailGate.swift` and `Native/AmbitionsTests/Domain/AmbitionsOSExperienceTailGateTests.swift`.
