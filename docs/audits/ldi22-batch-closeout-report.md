...
## Files Changed
- `Native/Ambitions/Domain/Planning/LivingPlanGovernanceConsole.swift` (added)
- `Native/AmbitionsTests/Domain/LivingPlanGovernanceConsoleTests.swift` (added)
...
## EFC Applicability
Invoked. The Governance Console enforces EFC by generating manual confirmation receipts for background maintenance tasks like pruning orphans, ensuring automated routines do not silently mutate plan structures.
...
## Rollback Notes
If needed, can revert changes to `Native/Ambitions/Domain/Planning/LivingPlanGovernanceConsole.swift` and `Native/AmbitionsTests/Domain/LivingPlanGovernanceConsoleTests.swift`.
