...
## Files Changed
- `Native/Ambitions/Domain/AmbitionsOSEvaluationTailGate.swift` (added)
- `Native/AmbitionsTests/Domain/AmbitionsOSEvaluationTailGateTests.swift` (added)
...
## EFC Applicability
Invoked. The Evaluation Tail Gate acts as an explicit receipt generator ensuring golden scenarios, fixture coverage, and privacy boundaries are explicitly proven before proceeding with unproven models.
...
## Rollback Notes
If needed, can revert changes to `Native/Ambitions/Domain/AmbitionsOSEvaluationTailGate.swift` and `Native/AmbitionsTests/Domain/AmbitionsOSEvaluationTailGateTests.swift`.
