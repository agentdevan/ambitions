...
| Widget payload action bridge | `Native/Ambitions/App/AppBootstrapper.swift`, `Native/Ambitions/Core/LocalRuntimeOS/CommandSpine/ExternalActionCommandService.swift`, `Native/Ambitions/Core/LocalRuntimeOS/RuntimeBoundary/AmbitionsRuntimeServices.swift` | `blockedUnknown` | Current widget UI does not emit mutating payloads, but app-level payload handling can execute commands if invoked. Typed receipt and canonical behavior proof remain AMB-1722. |
