...
| --- | --- | --- |
| Command bridge and external actions | `Native/Ambitions/Core/LocalRuntimeOS/SideEffectSystem/AppIntentBridge.swift`, `Native/Ambitions/Core/LocalRuntimeOS/SideEffectSystem/ExternalCreationImportService.swift`, `Native/Ambitions/Core/LocalRuntimeOS/Commands/ExternalActionCommandService.swift` | Existing command handoff and action-routing anchors for App Intents, Share Extension import, notification actions, and widget payload handling. |
