...
## Files Changed
- `tools/source-atlas/ambitions-pack-crypto.py` (added)
- `tools/source-atlas/tests/test_ambitions_pack_crypto.py` (added)

## Validation Commands and Exit Codes
- `git status --short`: `0`
- `git diff --check`: `0`
- `python3 tools/source-atlas/tests/test_ambitions_pack_crypto.py`: `0`
- `scripts/codex-forbidden-claim-scan.sh tools/source-atlas/ambitions-pack-crypto.py tools/source-atlas/tests/test_ambitions_pack_crypto.py`: `0`
- `python3 scripts/ambitions-source-atlas-title-check.py --strict`: `0`
- `make prompt-audit`: `0`
- `make batch-self-check`: `0`

## EFC Applicability
Invoked. Pack signing and revocation tracking ensures unverified or corrupted packs do not drive app features locally.
...
## Rollback Notes
If needed, can revert changes to `tools/source-atlas/ambitions-pack-crypto.py` and `tools/source-atlas/tests/test_ambitions_pack_crypto.py`.
