...
| `step` | `StepRecord` | `PlanningEngine`, `TimeEngine`, `Transactions` | Store goal-scoped step lookup, lifecycle columns, dependency/actionability payloads | No Step, reflow, or Time behavior Green from records alone. |
