...
## Files Changed
- `Native/Ambitions/Domain/Planning/LivingPlanMutationPermission.swift` (added)
- `Native/AmbitionsTests/Domain/LivingPlanMutationPermissionTests.swift` (added)
...
## EFC Applicability
Invoked. Implementation ensures plan changes define explicit mutation permissions and impact levels, completely preventing silent/destructive cloud intelligence from mutating user data without consent.
...
## Rollback Notes
If needed, can revert changes to `Native/Ambitions/Domain/Planning/LivingPlanMutationPermission.swift` and `Native/AmbitionsTests/Domain/LivingPlanMutationPermissionTests.swift`.
