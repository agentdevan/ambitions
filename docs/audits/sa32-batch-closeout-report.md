...
## Files Changed
- `Native/Ambitions/UI/SourceAtlasUIPrimitives.swift` (added)
- `Native/AmbitionsTests/UI/SourceAtlasUIPrimitivesTests.swift` (added)
...
## EFC Applicability
Invoked. Source Atlas UI primitives map explicitly to source and freshness states without collapsing confidence or claiming unsupported capabilities, closing the Source Atlas UI QA loop securely.
...
## Rollback Notes
If needed, can revert changes to `Native/Ambitions/UI/SourceAtlasUIPrimitives.swift` and `Native/AmbitionsTests/UI/SourceAtlasUIPrimitivesTests.swift`.
