...
- Legacy runtime: `python3 scripts/ambitions-legacy-runtime-production-use-guard.py --json` reported `currentLegacyRuntimeFiles=111` and `legacyRuntimeFileCeiling=111`. M02 administrative completion does not mean legacy runtime authority is gone.
...
| AMB-1666 | Needs Repair | `invalid_required_scope_incomplete` | Repair through AMB-1730; eliminate remaining legacy runtime production authority. |
...
- AMB-1730 Legacy runtime remaining authority elimination: owner AMB-1666; blocks AMB-1669 and AMB-1670 until remaining live `Core/Runtime` authority is moved, deleted, quarantined, or converted to approved adapter/test-only support.
