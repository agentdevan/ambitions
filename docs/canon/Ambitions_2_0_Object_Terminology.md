...
| Plan | Current agreement with time, capacity, constraints, rituals, recovery, and protected work. Calendar permission remains Plan-owned. | D15 aligns Plan believability, Weekly Plan Strip, Rich Timeline source labels, and Plan-owned calendar evidence; D16 aligns Ritual support-loop language while preserving compatibility routes internally. |
