...
Status: Active Ambitions 2.0 terminology source of truth.
Date: 2026-04-27.

This document locks shared object language for D02 and later Design Constitution delta batches. It clarifies product, docs, tests, previews, and user-facing copy without claiming that every object has a first-class model or surface today.
...
| Plan | Current agreement with time, capacity, constraints, rituals, recovery, and protected work. Calendar permission remains Plan-owned. | D15 aligns Plan believability, Weekly Plan Strip, Rich Timeline source labels, and Plan-owned calendar evidence. Ritual naming alignment continues in D16. |
...
| Archive | Saved history for learning and retrieval. Archive is not deletion or trash. | Partial goal/archive foundations exist; cross-object archive maturity remains future work. |
| Ritual | Recurring execution structure that supports Goals, Plan, Today, and You. Ritual replaces user-facing standalone Habits posture. | Compatibility code may still say Habit/Habits; user-facing copy should prefer Rituals. |
