# Ambitions 4.0 Accessibility And Cognitive Load Kernel
...
Accessibility And Cognitive Load makes Ambitions usable for people with different capabilities, attention patterns, stress levels, visual needs, motor needs, and cognitive states. This kernel makes the app humane.

## User Problem

A life OS can become overwhelming unless accessibility, density, language, motion, motor, visual, and cognitive-load needs are first-class.

## User-Visible Outcome

Every EB surface has Dynamic Type, VoiceOver, Reduce Motion, non-color meaning, tap target, motor alternative, plain-language, and overload-safe evidence.

## Owned Primitives

- CognitiveLoadMode
- InterfaceDensityLevel
- AnxietySafeCopyRule
- SimplifiedPlanningMode
- VoiceFirstAction
- PlainLanguageVariant
- LowVisionContrastMode
- DynamicTypeLayoutVariant
- VoiceOverOrderMap
- ReducedMotionEquivalent
- AccessibleActionAlternative
- ScreenExplanation
- OverloadAdaptiveSurface

## Owned UI Surfaces

- cognitive load setting
- simple mode
- executive mode
...
- voice-first capture
- accessible review flow
- overload-safe Today
- reduced-motion preview set

## Owned Data Concepts

- cognitive load mode
- simple / standard / expert density
- anxiety-safe language
- ADHD-friendly planning mode
...
Primary owner: All surfaces and shared accessibility/cognitive-load gates.
...
accessibility canon, settings, preview fixtures, UI evidence packs, focused accessibility tests, and cross-kernel gates named by EB25-EB30 and EB38.

## Forbidden Implementation Scope

color-only meaning, motion-only feedback, dense default flows, inaccessible voice capture, unsupported public accessibility claims, or closing EB batches without evidence.
