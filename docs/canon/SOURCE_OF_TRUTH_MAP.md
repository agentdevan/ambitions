...
4. `docs/canon/AMBITION_CANON_COMPLETION_REPORT.md` for completion status, open questions, no-drift rules, and next reconciliation prompt.
5. `MASTER_PRODUCT_SPEC.md` for current shipping product truth and product promise.
6. `docs/canon/design/Ambitions_Design_Constitution.md` for design, IA, UX writing, interaction, trust, accessibility posture, and external-surface behavior.
7. `docs/canon/Ambitions_2_0_Product_Architecture.md` for surface ownership, drilldown rules, object hierarchy, and operating loops.
8. `docs/canon/Ambitions_2_0_Systems_Architecture.md` for shared engines, local-first systems, and system ownership.
9. `docs/canon/Ambitions_2_0_Visual_System.md` plus `docs/canon/design/*` for visual, component, panel, density, grouped-list, accessibility, and UX-writing contracts.
10. Focused consolidation docs for implementation-readable detail.
11. `docs/canon/Ambitions_2_0_Roadmap.md`, `docs/canon/Ambitions_2_0_Batch_Plan.md`, and `docs/codex/batches/*` for execution sequencing after canon reconciliation.
12. QA, review, and release docs for acceptance evidence.
13. Archived docs only when explicitly marked as historical context and only where they do not conflict with active canon.
...
| Goals and Goal Detail | `GOALS_GOAL_DETAIL.md` | Lifecycle, Visual System | Goals direction, Goal Weather, Proof, next visible step. |
| Today and Now State | `TODAY_NOW_STATE.md` | Product Architecture, Plan canon | Best next action, daily schedule, recovery, Now State. |
| You / Profile / Reviews | `YOU_PROFILE_REVIEWS.md` | Trust/Memory, IA | You is canonical; Profile is legacy compatibility only during migration. |
| Capture / Smart Attachment | `CAPTURE_SMART_ATTACHMENT.md` | `design/smart-attachment-spec.md` | Quiet Command Sheet, Needs a Place, routing receipts. |
| Plan / Calendar / Believability | `PLAN_CALENDAR_BELIEVABILITY.md` | Systems Architecture, Today canon | Believable day/week, daily schedule, optional calendar awareness. |
| Intelligence / Automation | `INTELLIGENCE_AUTOMATION_SUGGESTIONS.md` | Intelligence Standards, Systems Architecture | Explain, suggest, prepare; no silent important changes. |
...
| Accessibility / Focus Support | `ACCESSIBILITY_FOCUS_SUPPORT.md` | Accessibility Nutrition docs, screen/component matrices | Accessibility is core quality; Focus Support protects next action clarity. |
| External surfaces | `EXTERNAL_SURFACES_NOTIFICATIONS_WIDGETS.md` | External Surfaces Contract | Notifications, widgets, Live Activities, App Intents, Shortcuts. |
...
| Empty/error/recovery states | `EMPTY_ERROR_RECOVERY_STATES.md` | UX writing matrix, Acceptance Gates | Screen-state coverage and recovery standards. |
...
Run the Codex reconciliation prompt inside `AMBITION_CANON_COMPLETION_REPORT.md` to align roadmap and batch execution with the completed canon system.
