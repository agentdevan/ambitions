...
| App Intents / Shortcuts | Open destination and Capture intents exist with D25 command descriptors, canon names, privacy language, safe routes, App Intent source routing, and in-app confirmation posture for mutation-capable commands. | Real Shortcuts/Siri/device verification remains for M04/R03. |
