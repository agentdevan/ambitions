# Ambitions 4.0 Universal Capture Kernel
...
Universal Capture makes Ambitions the safest place to put any loose thought, obligation, idea, worry, link, voice note, screenshot, plan fragment, goal seed, or life admin item. It turns scattered thought into structured direction without creating a shameful inbox.

## User Problem

Users need one trusted place to land life context before it becomes a goal, plan, Today step, reference item, or proof.

## User-Visible Outcome

Capture feels fast, private, correctable, and calming; unclear items receive one-question clarification instead of becoming a pile.

## Owned Primitives

- UniversalCaptureItem
- CaptureSource
...
- OpenLoopSignal
- ClarificationPrompt
- ThoughtParkingLotItem
- CaptureReviewBundle
- CaptureReceipt
- CaptureReclassificationAction

## Owned UI Surfaces

- universal composer
- voice dump review
- capture classification sheet
- capture cluster view
- inbox without shame
- capture route receipt
- thought parking lot
- review bundle
...
Primary owner: Capture, Today, Goals, Plan, You drill-downs.
...
domain models, Capture-owned composer/routing surfaces, receipts, fixtures, focused tests, and trust/accessibility docs named by EB02-EB06.

## Forbidden Implementation Scope

new top-level inbox tabs, silent routing, durable memory promotion without Trust controls, shame language, generic notes-app behavior, backend sync, or chatbot-first capture.
