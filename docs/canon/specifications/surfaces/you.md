...
destination_id = "DEST-YOU-DATA-BACKUP-READY-001"
...
success_focus_id = "FOCUS-YOU-DATA-BACKUP-READY-001-SUCCESS"
...
failure_focus_id = "FOCUS-YOU-DATA-BACKUP-READY-001-FAILURE"
...
recovery_id = "RECOVERY-YOU-DATA-BACKUP-READY-001"
...
activation_posture = "active"
gate_requirement_ids = []
transition_exit = "Open diagnostics => destination: the focused redacted diagnostics detail from You. The handoff starts from Data and Storage explicit state contract / Diagnostics Redacted; effect: No durable mutation occurs and no Receipt is created; local health and bounded recovery information are shown with no private titles or content and no authoritative product claim; Data and Storage explicit state contract / Diagnostics Redacted reports the outcome from this visible condition: Diagnostics are redacted before export; private life content and sensitive identifiers remain excluded; focus: the diagnostic summary within Data and Storage explicit state contract / Diagnostics Redacted."
...
destination_id = "DEST-YOU-DATA-DIAGNOSTICS-REDACTED-001"
destination_posture = "current"
effect = "No durable mutation occurs and no Receipt is created; local health and bounded recovery information are shown with no private titles or content and no authoritative product claim; Data and Storage explicit state contract / Diagnostics Redacted reports the outcome from this visible condition: Diagnostics are redacted before export; private life content and sensitive identifiers remain excluded"
success_focus = "the diagnostic summary within Data and Storage explicit state contract / Diagnostics Redacted"
success_focus_id = "FOCUS-YOU-DATA-DIAGNOSTICS-REDACTED-001-SUCCESS"
success_focus_posture = "current"
...
failure_focus_id = "FOCUS-YOU-DATA-DIAGNOSTICS-REDACTED-001-FAILURE"
failure_focus_posture = "current"
...
recovery_id = "RECOVERY-YOU-DATA-DIAGNOSTICS-REDACTED-001"
recovery_posture = "current"
recovery_owner = "surface.you.command-contract"
...
destination_id = "DEST-YOU-DATA-EXPORT-FAILED-001"
destination_posture = "current"
...
success_focus_id = "FOCUS-YOU-DATA-EXPORT-FAILED-001-SUCCESS"
success_focus_posture = "current"
...
failure_focus_id = "FOCUS-YOU-DATA-EXPORT-FAILED-001-FAILURE"
failure_focus_posture = "current"
...
recovery_id = "RECOVERY-YOU-DATA-EXPORT-FAILED-001"
recovery_posture = "current"
recovery_owner = "surface.you.command-contract"
...
destination_id = "DEST-YOU-DATA-EXPORT-PREVIEW-001"
destination_posture = "current"
...
success_focus_id = "FOCUS-YOU-DATA-EXPORT-PREVIEW-001-SUCCESS"
success_focus_posture = "current"
...
failure_focus_id = "FOCUS-YOU-DATA-EXPORT-PREVIEW-001-FAILURE"
failure_focus_posture = "current"
commit_boundary = "Mutation: the typed command commits only after current-revision validation, exact consequence review, and any required explicit confirmation."
...
recovery_id = "RECOVERY-YOU-DATA-EXPORT-PREVIEW-001"
recovery_posture = "current"
recovery_owner = "surface.you.command-contract"
...
failure_focus_id = "FOCUS-YOU-DATA-EXPORT-PROGRESS-001-FAILURE"
failure_focus_posture = "current"
commit_boundary = "Mutation: the typed command commits only after current-revision validation, exact consequence review, and any required explicit confirmation."
rollback_undo = "Cancellation before successful generation creates no success claim; after success, the export owner recovery route retains the artifact result and egress History without treating export as a backup."
recovery_id = "RECOVERY-YOU-DATA-EXPORT-PROGRESS-001"
recovery_posture = "current"
recovery_owner = "surface.you.command-contract"
privacy_egress = "Only explicitly selected and redacted fields go to the reviewed destination under SYSTEM-PRIVACY-EGRESS-001; export never authorizes ongoing sync."
verification_ids = ["SCENARIO-SURFACE-YOU-COMMAND-CONTRACT-001"]
...
activation_posture = "active"
gate_requirement_ids = []
transition_exit = "Done => destination: the surviving You data root. The handoff starts from Data and Storage explicit state contract / Permanent Delete Irreversible; effect: No durable mutation occurs and no Receipt is created; dismissal cannot reissue deletion, the existing irreversible deletion result keeps the destroyed scope unavailable, and the existing permanent-deletion Receipt and History remain unchanged; Data and Storage explicit state contract / Permanent Delete Irreversible reports the outcome from this visible condition: Permanent deletion completed and cannot be undone. The Receipt identifies the deleted scope without exposing deleted content; focus: the Data and Storage heading and irreversible result within Data and Storage explicit state contract / Permanent Delete Irreversible."
durable_effect = "Exact command consequences: Done: No durable mutation occurs and no Receipt is created; dismissal cannot reissue deletion, the existing irreversible deletion result keeps the destroyed scope unavailable, and the existing permanent-deletion Receipt and History remain unchanged. The durable boundary is specific to this visible evidence: Permanent deletion completed and cannot be undone. The Receipt identifies the deleted scope without exposing deleted content."
recovery_rollback = "Exact rollback and recovery: Done: No Undo is required; failed dismissal leaves the completed result visible, and retrying Done cannot reopen or repeat deletion. Recovery preserves the interface evidence that says: Permanent deletion completed and cannot be undone. The Receipt identifies the deleted scope without exposing deleted content."
...
accessibility_focus = "VoiceOver focus contract: Done announces that the completed result is closing, then success focuses the Data and Storage heading and irreversible result; failure focuses the Done control and completed result. The announcement includes this user-facing evidence before focus moves: Permanent deletion completed and cannot be undone. The Receipt identifies the deleted scope without exposing deleted content."

[[state_command_contracts.commands]]
command_id = "CMD-YOU-DATA-PERMANENT-DELETE-IRREVERSIBLE-DONE-001"
label = "Done"
canonical_owner = "surface.you.command-contract"
preconditions = ["The permanent-deletion result is complete", "The surviving You data route and focus target remain available"]
destination = "the surviving You data root. The handoff starts from Data and Storage explicit state contract / Permanent Delete Irreversible"
destination_id = "DEST-YOU-DATA-PERMANENT-DELETE-IRREVERSIBLE-DONE-001"
destination_posture = "current"
effect = "No durable mutation occurs and no Receipt is created; dismissal cannot reissue deletion, the existing irreversible deletion result keeps the destroyed scope unavailable, and the existing permanent-deletion Receipt and History remain unchanged; Data and Storage explicit state contract / Permanent Delete Irreversible reports the outcome from this visible condition: Permanent deletion completed and cannot be undone. The Receipt identifies the deleted scope without exposing deleted content"
success_focus = "the Data and Storage heading and irreversible result within Data and Storage explicit state contract / Permanent Delete Irreversible"
success_focus_id = "FOCUS-YOU-DATA-PERMANENT-DELETE-IRREVERSIBLE-DONE-001-SUCCESS"
success_focus_posture = "current"
failure_focus = "the Done control and completed irreversible result while Data and Storage explicit state contract / Permanent Delete Irreversible remains visible"
failure_focus_id = "FOCUS-YOU-DATA-PERMANENT-DELETE-IRREVERSIBLE-DONE-001-FAILURE"
failure_focus_posture = "current"
commit_boundary = "Non-mutating: dismissal returns from the completed result and makes no canonical commit."
...
recovery_id = "RECOVERY-YOU-DATA-PERMANENT-DELETE-IRREVERSIBLE-DONE-001"
recovery_posture = "current"
recovery_owner = "surface.you.command-contract"
...
destination_id = "DEST-YOU-DATA-PERMANENT-DELETE-REVIEW-001"
destination_posture = "current"
...
success_focus_id = "FOCUS-YOU-DATA-PERMANENT-DELETE-REVIEW-001-SUCCESS"
success_focus_posture = "current"
...
failure_focus_id = "FOCUS-YOU-DATA-PERMANENT-DELETE-REVIEW-001-FAILURE"
failure_focus_posture = "current"
commit_boundary = "Mutation: the typed command commits only after current-revision validation, exact consequence review, and any required explicit confirmation."
...
recovery_id = "RECOVERY-YOU-DATA-PERMANENT-DELETE-REVIEW-001"
recovery_posture = "current"
recovery_owner = "surface.you.command-contract"
privacy_egress = "The mutation remains local and sends no private content off device; any external side effect requires a separate minimum-field egress review under SYSTEM-PRIVACY-EGRESS-001."
verification_ids = ["SCENARIO-SURFACE-YOU-COMMAND-CONTRACT-001"]
rollback_posture = "confirmed_irreversible"
irreversible_confirmation_id = "CONFIRMATION-YOU-DATA-PERMANENT-DELETE-REVIEW-001"
irreversible_receipt_id = "RECEIPT-YOU-DATA-PERMANENT-DELETE-REVIEW-001"
...
destination_id = "DEST-YOU-DATA-RESET-REVIEW-001"
destination_posture = "current"
...
success_focus_id = "FOCUS-YOU-DATA-RESET-REVIEW-001-SUCCESS"
success_focus_posture = "current"
...
failure_focus_id = "FOCUS-YOU-DATA-RESET-REVIEW-001-FAILURE"
failure_focus_posture = "current"
commit_boundary = "Mutation: the typed command commits only after current-revision validation, exact consequence review, and any required explicit confirmation."
...
recovery_id = "RECOVERY-YOU-DATA-RESET-REVIEW-001"
recovery_posture = "current"
recovery_owner = "surface.you.command-contract"
privacy_egress = "The mutation remains local and sends no private content off device; any external side effect requires a separate minimum-field egress review under SYSTEM-PRIVACY-EGRESS-001."
verification_ids = ["SCENARIO-SURFACE-YOU-COMMAND-CONTRACT-001"]
...
destination_id = "DEST-YOU-DATA-RESET-ROLLBACK-001"
destination_posture = "current"
...
success_focus_id = "FOCUS-YOU-DATA-RESET-ROLLBACK-001-SUCCESS"
success_focus_posture = "current"
...
failure_focus_id = "FOCUS-YOU-DATA-RESET-ROLLBACK-001-FAILURE"
failure_focus_posture = "current"
commit_boundary = "Mutation: the typed command commits only after current-revision validation, exact consequence review, and any required explicit confirmation."
rollback_undo = "Cancellation before commit changes nothing; after commit, only the named typed Undo or recovery command may append a reversing Event while History remains intact."
recovery_id = "RECOVERY-YOU-DATA-RESET-ROLLBACK-001"
recovery_posture = "current"
recovery_owner = "surface.you.command-contract"
privacy_egress = "The mutation remains local and sends no private content off device; any external side effect requires a separate minimum-field egress review under SYSTEM-PRIVACY-EGRESS-001."
verification_ids = ["SCENARIO-SURFACE-YOU-COMMAND-CONTRACT-001"]
...
destination_id = "DEST-YOU-DATA-RESTORE-REVIEW-001"
destination_posture = "current"
...
success_focus_id = "FOCUS-YOU-DATA-RESTORE-REVIEW-001-SUCCESS"
success_focus_posture = "current"
...
failure_focus_id = "FOCUS-YOU-DATA-RESTORE-REVIEW-001-FAILURE"
failure_focus_posture = "current"
commit_boundary = "Mutation: the typed command commits only after current-revision validation, exact consequence review, and any required explicit confirmation."
...
recovery_id = "RECOVERY-YOU-DATA-RESTORE-REVIEW-001"
recovery_posture = "current"
recovery_owner = "surface.you.command-contract"
privacy_egress = "The mutation remains local and sends no private content off device; any external side effect requires a separate minimum-field egress review under SYSTEM-PRIVACY-EGRESS-001."
verification_ids = ["SCENARIO-SURFACE-YOU-COMMAND-CONTRACT-001"]
rollback_posture = "checkpoint_restore"
checkpoint_id = "CHECKPOINT-YOU-DATA-RESTORE-REVIEW-001"
...
activation_posture = "active"
gate_requirement_ids = []
transition_exit = "Done => destination: the You Data and Storage root. The handoff starts from Data and Storage explicit state contract / Trash Empty; effect: No durable mutation occurs and no Receipt is created; dismissal leaves Trash empty, invents no deleted identity, and performs no restoration; Data and Storage explicit state contract / Trash Empty reports the outcome from this visible condition: Trash is empty. No deleted Goal, Step, Capture, Proof, or Note is present; focus: the Trash entry control within Data and Storage explicit state contract / Trash Empty."
durable_effect = "Exact command consequences: Done: No durable mutation occurs and no Receipt is created; dismissal leaves Trash empty, invents no deleted identity, and performs no restoration. The durable boundary is specific to this visible evidence: Trash is empty. No deleted Goal, Step, Capture, Proof, or Note is present."
recovery_rollback = "Exact rollback and recovery: Done: No Undo is required; failed dismissal keeps the empty state visible, and retrying Done cannot invent an object or perform restoration. Recovery preserves the interface evidence that says: Trash is empty. No deleted Goal, Step, Capture, Proof, or Note is present."
...
accessibility_focus = "VoiceOver focus contract: Done announces that the empty Trash state is closing, then success focuses the Trash entry control; failure focuses the Done control and empty-state heading. The announcement includes this user-facing evidence before focus moves: Trash is empty. No deleted Goal, Step, Capture, Proof, or Note is present."

[[state_command_contracts.commands]]
command_id = "CMD-YOU-DATA-TRASH-EMPTY-DONE-001"
label = "Done"
canonical_owner = "surface.you.command-contract"
preconditions = ["The You Data and Storage return route and Trash focus target remain available", "Trash contains no deleted identity"]
destination = "the You Data and Storage root. The handoff starts from Data and Storage explicit state contract / Trash Empty"
destination_id = "DEST-YOU-DATA-TRASH-EMPTY-DONE-001"
destination_posture = "current"
effect = "No durable mutation occurs and no Receipt is created; dismissal leaves Trash empty, invents no deleted identity, and performs no restoration; Data and Storage explicit state contract / Trash Empty reports the outcome from this visible condition: Trash is empty. No deleted Goal, Step, Capture, Proof, or Note is present"
success_focus = "the Trash entry control within Data and Storage explicit state contract / Trash Empty"
success_focus_id = "FOCUS-YOU-DATA-TRASH-EMPTY-DONE-001-SUCCESS"
success_focus_posture = "current"
failure_focus = "the Done control and empty-state heading while Data and Storage explicit state contract / Trash Empty remains visible"
failure_focus_id = "FOCUS-YOU-DATA-TRASH-EMPTY-DONE-001-FAILURE"
failure_focus_posture = "current"
commit_boundary = "Non-mutating: dismissal returns from the empty state and makes no canonical commit."
...
recovery_id = "RECOVERY-YOU-DATA-TRASH-EMPTY-DONE-001"
recovery_posture = "current"
recovery_owner = "surface.you.command-contract"
...
activation_posture = "active"
gate_requirement_ids = []
transition_exit = "Restore => destination: the restored object under its authoritative owner and restore Receipt. The handoff starts from Data and Storage explicit state contract / Trash Populated; effect: The typed Trash object restore command appends an Event, updates the Projection, and creates a Receipt and History; the selected object leaves Trash and returns with identity, relationships, History, and projections preserved; Data and Storage explicit state contract / Trash Populated reports the outcome from this visible condition: Trash contains deleted Goals, Steps, Captures, Proof, or Notes with their deletion dates and retention deadlines; focus: the restored object status and Receipt within Data and Storage explicit state contract / Trash Populated."
...
destination_id = "DEST-YOU-DATA-TRASH-POPULATED-001"
destination_posture = "current"
effect = "The typed Trash object restore command appends an Event, updates the Projection, and creates a Receipt and History; the selected object leaves Trash and returns with identity, relationships, History, and projections preserved; Data and Storage explicit state contract / Trash Populated reports the outcome from this visible condition: Trash contains deleted Goals, Steps, Captures, Proof, or Notes with their deletion dates and retention deadlines"
success_focus = "the restored object status and Receipt within Data and Storage explicit state contract / Trash Populated"
success_focus_id = "FOCUS-YOU-DATA-TRASH-POPULATED-001-SUCCESS"
success_focus_posture = "current"
...
failure_focus_id = "FOCUS-YOU-DATA-TRASH-POPULATED-001-FAILURE"
failure_focus_posture = "current"
commit_boundary = "Mutation: the typed command commits only after current-revision validation, exact consequence review, and any required explicit confirmation."
rollback_undo = "Cancellation before commit changes nothing; after commit, only the named typed Undo or recovery command may append a reversing Event while History remains intact."
recovery_id = "RECOVERY-YOU-DATA-TRASH-POPULATED-001"
recovery_posture = "current"
recovery_owner = "surface.you.command-contract"
privacy_egress = "The mutation remains local and sends no private content off device; any external side effect requires a separate minimum-field egress review under SYSTEM-PRIVACY-EGRESS-001."
verification_ids = ["SCENARIO-SURFACE-YOU-COMMAND-CONTRACT-001"]
...
destination_id = "DEST-YOU-DATA-TRASH-RESTORE-001"
destination_posture = "current"
...
success_focus_id = "FOCUS-YOU-DATA-TRASH-RESTORE-001-SUCCESS"
success_focus_posture = "current"
...
failure_focus_id = "FOCUS-YOU-DATA-TRASH-RESTORE-001-FAILURE"
failure_focus_posture = "current"
commit_boundary = "Mutation: the typed command commits only after current-revision validation, exact consequence review, and any required explicit confirmation."
rollback_undo = "Failure returns to the last honest store; cancellation before activation changes nothing, and post-activation rollback uses the operation journal without rewriting History."
recovery_id = "RECOVERY-YOU-DATA-TRASH-RESTORE-001"
recovery_posture = "current"
recovery_owner = "surface.you.command-contract"
privacy_egress = "The mutation remains local and sends no private content off device; any external side effect requires a separate minimum-field egress review under SYSTEM-PRIVACY-EGRESS-001."
verification_ids = ["SCENARIO-SURFACE-YOU-COMMAND-CONTRACT-001"]
rollback_posture = "checkpoint_restore"
checkpoint_id = "CHECKPOINT-YOU-DATA-TRASH-RESTORE-001"
...
destination_id = "DEST-YOU-ENTITLEMENT-ACTIVE-001"
destination_posture = "current"
...
success_focus_id = "FOCUS-YOU-ENTITLEMENT-ACTIVE-001-SUCCESS"
success_focus_posture = "current"
...
failure_focus_id = "FOCUS-YOU-ENTITLEMENT-ACTIVE-001-FAILURE"
failure_focus_posture = "current"
...
recovery_id = "RECOVERY-YOU-ENTITLEMENT-ACTIVE-001"
recovery_posture = "current"
recovery_owner = "surface.you.entitlement-command-contract"
...
destination_id = "DEST-YOU-ENTITLEMENT-EXPIRED-001"
destination_posture = "current"
...
success_focus_id = "FOCUS-YOU-ENTITLEMENT-EXPIRED-001-SUCCESS"
success_focus_posture = "current"
...
failure_focus_id = "FOCUS-YOU-ENTITLEMENT-EXPIRED-001-FAILURE"
failure_focus_posture = "current"
...
recovery_id = "RECOVERY-YOU-ENTITLEMENT-EXPIRED-001"
recovery_posture = "current"
recovery_owner = "surface.you.entitlement-command-contract"
privacy_egress = "StoreKit receives only minimum transaction/account fields; Goals, Captures, Time, settings, Proof, History, Receipts, and the private graph never transfer or bind through entitlement controls."
verification_ids = ["SCENARIO-SURFACE-YOU-ENTITLEMENT-COMMAND-CONTRACT-001"]
...
success_focus_id = "FOCUS-YOU-ENTITLEMENT-EXPIRED-002-SUCCESS"
success_focus_posture = "current"
failure_focus = "the Purchase control and exact registry, StoreKit, or account reason"
failure_focus_id = "FOCUS-YOU-ENTITLEMENT-EXPIRED-002-FAILURE"
failure_focus_posture = "current"
...
recovery_id = "RECOVERY-YOU-ENTITLEMENT-EXPIRED-002"
recovery_posture = "current"
recovery_owner = "surface.you.entitlement-command-contract"
...
destination_id = "DEST-YOU-ENTITLEMENT-GRACE-001"
destination_posture = "current"
...
success_focus_id = "FOCUS-YOU-ENTITLEMENT-GRACE-001-SUCCESS"
success_focus_posture = "current"
...
failure_focus_id = "FOCUS-YOU-ENTITLEMENT-GRACE-001-FAILURE"
failure_focus_posture = "current"
commit_boundary = "External-result: Apple subscription management occurs outside Ambitions; only a later verified entitlement observation may separately persist non-sensitive status and a Receipt."
rollback_undo = "Cancellation or interruption returns to the prior verified status; a later downgrade changes only eligible service access and never local-core data availability."
recovery_id = "RECOVERY-YOU-ENTITLEMENT-GRACE-001"
recovery_posture = "current"
recovery_owner = "surface.you.entitlement-command-contract"
privacy_egress = "StoreKit receives only minimum transaction/account fields; Goals, Captures, Time, settings, Proof, History, Receipts, and the private graph never transfer or bind through entitlement controls."
verification_ids = ["SCENARIO-SURFACE-YOU-ENTITLEMENT-COMMAND-CONTRACT-001"]
...
destination_id = "DEST-YOU-ENTITLEMENT-MISMATCH-001"
destination_posture = "current"
...
success_focus_id = "FOCUS-YOU-ENTITLEMENT-MISMATCH-001-SUCCESS"
success_focus_posture = "current"
...
failure_focus_id = "FOCUS-YOU-ENTITLEMENT-MISMATCH-001-FAILURE"
failure_focus_posture = "current"
...
recovery_id = "RECOVERY-YOU-ENTITLEMENT-MISMATCH-001"
recovery_posture = "current"
recovery_owner = "surface.you.entitlement-command-contract"
privacy_egress = "StoreKit receives only minimum transaction/account fields; Goals, Captures, Time, settings, Proof, History, Receipts, and the private graph never transfer or bind through entitlement controls."
verification_ids = ["SCENARIO-SURFACE-YOU-ENTITLEMENT-COMMAND-CONTRACT-001"]
...
destination_id = "DEST-YOU-ENTITLEMENT-OFFLINE-CACHED-001"
destination_posture = "current"
...
success_focus_id = "FOCUS-YOU-ENTITLEMENT-OFFLINE-CACHED-001-SUCCESS"
success_focus_posture = "current"
...
failure_focus_id = "FOCUS-YOU-ENTITLEMENT-OFFLINE-CACHED-001-FAILURE"
failure_focus_posture = "current"
...
recovery_id = "RECOVERY-YOU-ENTITLEMENT-OFFLINE-CACHED-001"
recovery_posture = "current"
recovery_owner = "surface.you.entitlement-command-contract"
privacy_egress = "StoreKit receives only minimum transaction/account fields; Goals, Captures, Time, settings, Proof, History, Receipts, and the private graph never transfer or bind through entitlement controls."
verification_ids = ["SCENARIO-SURFACE-YOU-ENTITLEMENT-COMMAND-CONTRACT-001"]
...
destination_id = "DEST-YOU-ENTITLEMENT-RETRY-001"
destination_posture = "current"
...
success_focus_id = "FOCUS-YOU-ENTITLEMENT-RETRY-001-SUCCESS"
success_focus_posture = "current"
...
failure_focus_id = "FOCUS-YOU-ENTITLEMENT-RETRY-001-FAILURE"
failure_focus_posture = "current"
...
recovery_id = "RECOVERY-YOU-ENTITLEMENT-RETRY-001"
recovery_posture = "current"
recovery_owner = "surface.you.entitlement-command-contract"
privacy_egress = "StoreKit receives only minimum transaction/account fields; Goals, Captures, Time, settings, Proof, History, Receipts, and the private graph never transfer or bind through entitlement controls."
verification_ids = ["SCENARIO-SURFACE-YOU-ENTITLEMENT-COMMAND-CONTRACT-001"]
...
destination_id = "DEST-YOU-ENTITLEMENT-REVOKED-001"
destination_posture = "current"
...
success_focus_id = "FOCUS-YOU-ENTITLEMENT-REVOKED-001-SUCCESS"
success_focus_posture = "current"
...
failure_focus_id = "FOCUS-YOU-ENTITLEMENT-REVOKED-001-FAILURE"
failure_focus_posture = "current"
commit_boundary = "External-result: StoreKit restore completes outside canonical product mutation and must be revalidated before a separate entitlement-status commit."
rollback_undo = "Cancellation or failure preserves the prior verified status and all local data; retry cannot duplicate a transaction or entitlement observation."
recovery_id = "RECOVERY-YOU-ENTITLEMENT-REVOKED-001"
recovery_posture = "current"
recovery_owner = "surface.you.entitlement-command-contract"
privacy_egress = "StoreKit receives only minimum transaction/account fields; Goals, Captures, Time, settings, Proof, History, Receipts, and the private graph never transfer or bind through entitlement controls."
verification_ids = ["SCENARIO-SURFACE-YOU-ENTITLEMENT-COMMAND-CONTRACT-001"]
...
destination_id = "DEST-YOU-ENTITLEMENT-SUPPORTED-SHARING-001"
destination_posture = "current"
...
success_focus_id = "FOCUS-YOU-ENTITLEMENT-SUPPORTED-SHARING-001-SUCCESS"
success_focus_posture = "current"
...
failure_focus_id = "FOCUS-YOU-ENTITLEMENT-SUPPORTED-SHARING-001-FAILURE"
failure_focus_posture = "current"
commit_boundary = "Non-mutating: dismissal completes without entitlement, account, StoreKit, or local-data mutation."
rollback_undo = "No Undo is required; reopening Plan & Purchases restores the last verified status and freshness explanation."
recovery_id = "RECOVERY-YOU-ENTITLEMENT-SUPPORTED-SHARING-001"
recovery_posture = "current"
recovery_owner = "surface.you.entitlement-command-contract"
privacy_egress = "StoreKit receives only minimum transaction/account fields; Goals, Captures, Time, settings, Proof, History, Receipts, and the private graph never transfer or bind through entitlement controls."
verification_ids = ["SCENARIO-SURFACE-YOU-ENTITLEMENT-COMMAND-CONTRACT-001"]
...
failure_focus_id = "FOCUS-YOU-ENTITLEMENT-TRIAL-001-FAILURE"
failure_focus_posture = "current"
...
recovery_id = "RECOVERY-YOU-ENTITLEMENT-TRIAL-001"
recovery_posture = "current"
recovery_owner = "surface.you.entitlement-command-contract"
privacy_egress = "StoreKit receives only minimum transaction/account fields; Goals, Captures, Time, settings, Proof, History, Receipts, and the private graph never transfer or bind through entitlement controls."
verification_ids = ["SCENARIO-SURFACE-YOU-ENTITLEMENT-COMMAND-CONTRACT-001"]
...
destination_id = "DEST-YOU-ENTITLEMENT-UNKNOWN-001"
destination_posture = "current"
...
success_focus_id = "FOCUS-YOU-ENTITLEMENT-UNKNOWN-001-SUCCESS"
success_focus_posture = "current"
...
failure_focus_id = "FOCUS-YOU-ENTITLEMENT-UNKNOWN-001-FAILURE"
failure_focus_posture = "current"
commit_boundary = "External-result: entitlement observation completes outside canonical mutation and requires separate validation before persistence."
rollback_undo = "Cancellation, timeout, or invalid response preserves the prior verified status and focuses Check Again without changing local data or access."
recovery_id = "RECOVERY-YOU-ENTITLEMENT-UNKNOWN-001"
recovery_posture = "current"
recovery_owner = "surface.you.entitlement-command-contract"
privacy_egress = "StoreKit receives only minimum transaction/account fields; Goals, Captures, Time, settings, Proof, History, Receipts, and the private graph never transfer or bind through entitlement controls."
verification_ids = ["SCENARIO-SURFACE-YOU-ENTITLEMENT-COMMAND-CONTRACT-001"]
...
destination_id = "DEST-YOU-ROOT-ACCOUNT-SIGNED-IN-001"
destination_posture = "current"
...
success_focus_id = "FOCUS-YOU-ROOT-ACCOUNT-SIGNED-IN-001-SUCCESS"
success_focus_posture = "current"
...
failure_focus_id = "FOCUS-YOU-ROOT-ACCOUNT-SIGNED-IN-001-FAILURE"
failure_focus_posture = "current"
commit_boundary = "Non-mutating: the route, inspection, selection, preview, refresh, or cancellation completes without a canonical commit."
rollback_undo = "No Undo is required; dismissal returns to the initiating object or control with accepted data unchanged."
recovery_id = "RECOVERY-YOU-ROOT-ACCOUNT-SIGNED-IN-001"
recovery_posture = "current"
recovery_owner = "surface.you.command-contract"
...
destination_id = "DEST-YOU-ROOT-ACCOUNT-SIGNED-OUT-001"
destination_posture = "current"
...
success_focus_id = "FOCUS-YOU-ROOT-ACCOUNT-SIGNED-OUT-001-SUCCESS"
success_focus_posture = "current"
...
failure_focus_id = "FOCUS-YOU-ROOT-ACCOUNT-SIGNED-OUT-001-FAILURE"
failure_focus_posture = "current"
commit_boundary = "Non-mutating: the route, inspection, selection, preview, refresh, or cancellation completes without a canonical commit."
rollback_undo = "No Undo is required; dismissal returns to the initiating object or control with accepted data unchanged."
recovery_id = "RECOVERY-YOU-ROOT-ACCOUNT-SIGNED-OUT-001"
recovery_posture = "current"
recovery_owner = "surface.you.command-contract"
privacy_egress = "The operation reads only local canonical data and sends no private content off device."
verification_ids = ["SCENARIO-SURFACE-YOU-COMMAND-CONTRACT-001"]
...
activation_posture = "active"
gate_requirement_ids = []
transition_exit = "Open settings => destination: the focused native settings drilldown for Root Action Required. The handoff starts from You root explicit state contract / Action Required; effect: No durable mutation occurs and no Receipt is created; settings open with accepted values and pending edits distinct; viewing commits no preference or permission change; You root explicit state contract / Action Required reports the outcome from this visible condition: One settings value has an unresolved condition. Other settings remain available; focus: the selected setting value or group heading within You root explicit state contract / Action Required."
...
destination_id = "DEST-YOU-ROOT-ACTION-REQUIRED-001"
destination_posture = "current"
effect = "No durable mutation occurs and no Receipt is created; settings open with accepted values and pending edits distinct; viewing commits no preference or permission change; You root explicit state contract / Action Required reports the outcome from this visible condition: One settings value has an unresolved condition. Other settings remain available"
success_focus = "the selected setting value or group heading within You root explicit state contract / Action Required"
success_focus_id = "FOCUS-YOU-ROOT-ACTION-REQUIRED-001-SUCCESS"
success_focus_posture = "current"
failure_focus = "the Open settings control while You root explicit state contract / Action Required remains visible"
failure_focus_id = "FOCUS-YOU-ROOT-ACTION-REQUIRED-001-FAILURE"
failure_focus_posture = "current"
commit_boundary = "Non-mutating: the route, inspection, selection, preview, refresh, or cancellation completes without a canonical commit."
rollback_undo = "No Undo is required; dismissal returns to the initiating object or control with accepted data unchanged."
recovery_id = "RECOVERY-YOU-ROOT-ACTION-REQUIRED-001"
recovery_posture = "current"
recovery_owner = "surface.you.command-contract"
privacy_egress = "The operation reads only local canonical data and sends no private content off device."
verification_ids = ["SCENARIO-SURFACE-YOU-COMMAND-CONTRACT-001"]
...
destination_id = "DEST-YOU-ROOT-CONTINUITY-CONFLICTED-001"
destination_posture = "current"
...
success_focus_id = "FOCUS-YOU-ROOT-CONTINUITY-CONFLICTED-001-SUCCESS"
success_focus_posture = "current"
...
failure_focus_id = "FOCUS-YOU-ROOT-CONTINUITY-CONFLICTED-001-FAILURE"
failure_focus_posture = "current"
commit_boundary = "Non-mutating: the route, inspection, selection, preview, refresh, or cancellation completes without a canonical commit."
rollback_undo = "No Undo is required; dismissal returns to the initiating object or control with accepted data unchanged."
recovery_id = "RECOVERY-YOU-ROOT-CONTINUITY-CONFLICTED-001"
recovery_posture = "current"
recovery_owner = "surface.you.command-contract"
privacy_egress = "The operation reads only local canonical data and sends no private content off device."
verification_ids = ["SCENARIO-SURFACE-YOU-COMMAND-CONTRACT-001"]
...
destination_id = "DEST-YOU-ROOT-CONTINUITY-DISABLED-001"
destination_posture = "current"
...
success_focus_id = "FOCUS-YOU-ROOT-CONTINUITY-DISABLED-001-SUCCESS"
success_focus_posture = "current"
...
failure_focus_id = "FOCUS-YOU-ROOT-CONTINUITY-DISABLED-001-FAILURE"
failure_focus_posture = "current"
commit_boundary = "Non-mutating: the route, inspection, selection, preview, refresh, or cancellation completes without a canonical commit."
rollback_undo = "No Undo is required; dismissal returns to the initiating object or control with accepted data unchanged."
recovery_id = "RECOVERY-YOU-ROOT-CONTINUITY-DISABLED-001"
recovery_posture = "current"
recovery_owner = "surface.you.command-contract"
privacy_egress = "The operation reads only local canonical data and sends no private content off device."
verification_ids = ["SCENARIO-SURFACE-YOU-COMMAND-CONTRACT-001"]
...
destination_id = "DEST-YOU-ROOT-CONTINUITY-PENDING-001"
destination_posture = "current"
effect = "No durable mutation occurs and no Receipt is created; the future envelope/status may be inspected, but no enable, sync, keep-local, keep-remote, merge, or last-write-wins command is authorized and local use remains unaffected; You root explicit state contract / Continuity Pending reports the outcome from this visible condition: Continuity setup has not finished. This device still shows the latest saved information"
success_focus = "the Continuity disabled status within You root explicit state contract / Continuity Pending"
success_focus_id = "FOCUS-YOU-ROOT-CONTINUITY-PENDING-001-SUCCESS"
success_focus_posture = "current"
...
failure_focus_id = "FOCUS-YOU-ROOT-CONTINUITY-PENDING-001-FAILURE"
failure_focus_posture = "current"
commit_boundary = "Non-mutating: the route, inspection, selection, preview, refresh, or cancellation completes without a canonical commit."
rollback_undo = "No Undo is required; dismissal returns to the initiating object or control with accepted data unchanged."
recovery_id = "RECOVERY-YOU-ROOT-CONTINUITY-PENDING-001"
recovery_posture = "current"
recovery_owner = "surface.you.command-contract"
privacy_egress = "The operation reads only local canonical data and sends no private content off device."
verification_ids = ["SCENARIO-SURFACE-YOU-COMMAND-CONTRACT-001"]
...
activation_posture = "active"
gate_requirement_ids = []
transition_exit = "Open diagnostics => destination: the focused redacted diagnostics detail from You. The handoff starts from You root explicit state contract / Diagnostics Degraded; effect: No durable mutation occurs and no Receipt is created; local health and bounded recovery information are shown with no private titles or content and no authoritative product claim; You root explicit state contract / Diagnostics Degraded reports the outcome from this visible condition: Some diagnostics could not complete. The failed categories and known consequence are explicit; focus: the diagnostic summary within You root explicit state contract / Diagnostics Degraded."
...
destination_id = "DEST-YOU-ROOT-DIAGNOSTICS-DEGRADED-001"
destination_posture = "current"
effect = "No durable mutation occurs and no Receipt is created; local health and bounded recovery information are shown with no private titles or content and no authoritative product claim; You root explicit state contract / Diagnostics Degraded reports the outcome from this visible condition: Some diagnostics could not complete. The failed categories and known consequence are explicit"
success_focus = "the diagnostic summary within You root explicit state contract / Diagnostics Degraded"
success_focus_id = "FOCUS-YOU-ROOT-DIAGNOSTICS-DEGRADED-001-SUCCESS"
success_focus_posture = "current"
failure_focus = "the Open diagnostics control while You root explicit state contract / Diagnostics Degraded remains visible"
failure_focus_id = "FOCUS-YOU-ROOT-DIAGNOSTICS-DEGRADED-001-FAILURE"
failure_focus_posture = "current"
commit_boundary = "Non-mutating: the route, inspection, selection, preview, refresh, or cancellation completes without a canonical commit."
rollback_undo = "No Undo is required; dismissal returns to the initiating object or control with accepted data unchanged."
recovery_id = "RECOVERY-YOU-ROOT-DIAGNOSTICS-DEGRADED-001"
recovery_posture = "current"
recovery_owner = "surface.you.command-contract"
privacy_egress = "Diagnostics default to redacted local health metadata; no private titles or content leave the device."
verification_ids = ["SCENARIO-SURFACE-YOU-COMMAND-CONTRACT-001"]
...
activation_posture = "active"
gate_requirement_ids = []
transition_exit = "Open diagnostics => destination: the focused redacted diagnostics detail from You. The handoff starts from You root explicit state contract / Diagnostics Healthy; effect: No durable mutation occurs and no Receipt is created; local health and bounded recovery information are shown with no private titles or content and no authoritative product claim; You root explicit state contract / Diagnostics Healthy reports the outcome from this visible condition: The checked areas show no detected issue. This result covers only the health checks listed here; focus: the diagnostic summary within You root explicit state contract / Diagnostics Healthy."
...
destination_id = "DEST-YOU-ROOT-DIAGNOSTICS-HEALTHY-001"
destination_posture = "current"
effect = "No durable mutation occurs and no Receipt is created; local health and bounded recovery information are shown with no private titles or content and no authoritative product claim; You root explicit state contract / Diagnostics Healthy reports the outcome from this visible condition: The checked areas show no detected issue. This result covers only the health checks listed here"
success_focus = "the diagnostic summary within You root explicit state contract / Diagnostics Healthy"
success_focus_id = "FOCUS-YOU-ROOT-DIAGNOSTICS-HEALTHY-001-SUCCESS"
success_focus_posture = "current"
failure_focus = "the Open diagnostics control while You root explicit state contract / Diagnostics Healthy remains visible"
failure_focus_id = "FOCUS-YOU-ROOT-DIAGNOSTICS-HEALTHY-001-FAILURE"
failure_focus_posture = "current"
commit_boundary = "Non-mutating: the route, inspection, selection, preview, refresh, or cancellation completes without a canonical commit."
rollback_undo = "No Undo is required; dismissal returns to the initiating object or control with accepted data unchanged."
recovery_id = "RECOVERY-YOU-ROOT-DIAGNOSTICS-HEALTHY-001"
recovery_posture = "current"
recovery_owner = "surface.you.command-contract"
privacy_egress = "Diagnostics default to redacted local health metadata; no private titles or content leave the device."
verification_ids = ["SCENARIO-SURFACE-YOU-COMMAND-CONTRACT-001"]
...
activation_posture = "active"
gate_requirement_ids = []
transition_exit = "Life Capital => destination: the focused Life Capital native drilldown. The handoff starts from You root explicit state contract / Life Capital Empty; effect: No durable mutation occurs and no Receipt is created; Life Capital objects open for inspection; Add, Edit, Archive, Move to Trash, Restore, and Delete permanently remain separately scoped commands and never silently change a Goal or Proof; You root explicit state contract / Life Capital Empty reports the outcome from this visible condition: No Life Capital has been recorded in this scope. Ambitions does not infer or score missing life context; focus: the Life Capital heading and selected object within You root explicit state contract / Life Capital Empty."
...
destination_id = "DEST-YOU-ROOT-LIFE-CAPITAL-EMPTY-001"
destination_posture = "current"
effect = "No durable mutation occurs and no Receipt is created; Life Capital objects open for inspection; Add, Edit, Archive, Move to Trash, Restore, and Delete permanently remain separately scoped commands and never silently change a Goal or Proof; You root explicit state contract / Life Capital Empty reports the outcome from this visible condition: No Life Capital has been recorded in this scope. Ambitions does not infer or score missing life context"
success_focus = "the Life Capital heading and selected object within You root explicit state contract / Life Capital Empty"
success_focus_id = "FOCUS-YOU-ROOT-LIFE-CAPITAL-EMPTY-001-SUCCESS"
success_focus_posture = "current"
failure_focus = "the Life Capital row while You root explicit state contract / Life Capital Empty remains visible"
failure_focus_id = "FOCUS-YOU-ROOT-LIFE-CAPITAL-EMPTY-001-FAILURE"
failure_focus_posture = "current"
commit_boundary = "Non-mutating: the route, inspection, selection, preview, refresh, or cancellation completes without a canonical commit."
rollback_undo = "No Undo is required; dismissal returns to the initiating object or control with accepted data unchanged."
recovery_id = "RECOVERY-YOU-ROOT-LIFE-CAPITAL-EMPTY-001"
recovery_posture = "current"
recovery_owner = "surface.you.command-contract"
privacy_egress = "The operation reads only local canonical data and sends no private content off device."
verification_ids = ["SCENARIO-SURFACE-YOU-COMMAND-CONTRACT-001"]
...
activation_posture = "active"
gate_requirement_ids = []
transition_exit = "Life Capital => destination: the focused Life Capital native drilldown. The handoff starts from You root explicit state contract / Life Capital Populated; effect: No durable mutation occurs and no Receipt is created; Life Capital objects open for inspection; Add, Edit, Archive, Move to Trash, Restore, and Delete permanently remain separately scoped commands and never silently change a Goal or Proof; You root explicit state contract / Life Capital Populated reports the outcome from this visible condition: Life Capital shows user-owned context with source lineage, not a score or psychological label; focus: the Life Capital heading and selected object within You root explicit state contract / Life Capital Populated."
...
destination_id = "DEST-YOU-ROOT-LIFE-CAPITAL-POPULATED-001"
destination_posture = "current"
effect = "No durable mutation occurs and no Receipt is created; Life Capital objects open for inspection; Add, Edit, Archive, Move to Trash, Restore, and Delete permanently remain separately scoped commands and never silently change a Goal or Proof; You root explicit state contract / Life Capital Populated reports the outcome from this visible condition: Life Capital shows user-owned context with source lineage, not a score or psychological label"
...
success_focus_id = "FOCUS-YOU-ROOT-LIFE-CAPITAL-POPULATED-001-SUCCESS"
success_focus_posture = "current"
failure_focus = "the Life Capital row while You root explicit state contract / Life Capital Populated remains visible"
failure_focus_id = "FOCUS-YOU-ROOT-LIFE-CAPITAL-POPULATED-001-FAILURE"
failure_focus_posture = "current"
commit_boundary = "Non-mutating: the route, inspection, selection, preview, refresh, or cancellation completes without a canonical commit."
rollback_undo = "No Undo is required; dismissal returns to the initiating object or control with accepted data unchanged."
recovery_id = "RECOVERY-YOU-ROOT-LIFE-CAPITAL-POPULATED-001"
recovery_posture = "current"
recovery_owner = "surface.you.command-contract"
privacy_egress = "The operation reads only local canonical data and sends no private content off device."
verification_ids = ["SCENARIO-SURFACE-YOU-COMMAND-CONTRACT-001"]
...
destination_id = "DEST-YOU-ROOT-NO-ACCOUNT-HEALTHY-001"
destination_posture = "current"
...
success_focus_id = "FOCUS-YOU-ROOT-NO-ACCOUNT-HEALTHY-001-SUCCESS"
success_focus_posture = "current"
...
failure_focus_id = "FOCUS-YOU-ROOT-NO-ACCOUNT-HEALTHY-001-FAILURE"
failure_focus_posture = "current"
commit_boundary = "Non-mutating: the route, inspection, selection, preview, refresh, or cancellation completes without a canonical commit."
rollback_undo = "No Undo is required; dismissal returns to the initiating object or control with accepted data unchanged."
recovery_id = "RECOVERY-YOU-ROOT-NO-ACCOUNT-HEALTHY-001"
recovery_posture = "current"
recovery_owner = "surface.you.command-contract"
privacy_egress = "The operation reads only local canonical data and sends no private content off device."
verification_ids = ["SCENARIO-SURFACE-YOU-COMMAND-CONTRACT-001"]
...
activation_posture = "active"
gate_requirement_ids = []
transition_exit = "Open settings => destination: the focused native settings drilldown for Root Normal. The handoff starts from You root explicit state contract / Normal; effect: No durable mutation occurs and no Receipt is created; settings open with accepted values and pending edits distinct; viewing commits no preference or permission change; You root explicit state contract / Normal reports the outcome from this visible condition: You shows account, permissions, appearance, privacy, data, and support settings; focus: the selected setting value or group heading within You root explicit state contract / Normal."
...
destination_id = "DEST-YOU-ROOT-NORMAL-001"
destination_posture = "current"
effect = "No durable mutation occurs and no Receipt is created; settings open with accepted values and pending edits distinct; viewing commits no preference or permission change; You root explicit state contract / Normal reports the outcome from this visible condition: You shows account, permissions, appearance, privacy, data, and support settings"
success_focus = "the selected setting value or group heading within You root explicit state contract / Normal"
success_focus_id = "FOCUS-YOU-ROOT-NORMAL-001-SUCCESS"
success_focus_posture = "current"
failure_focus = "the Open settings control while You root explicit state contract / Normal remains visible"
failure_focus_id = "FOCUS-YOU-ROOT-NORMAL-001-FAILURE"
failure_focus_posture = "current"
commit_boundary = "Non-mutating: the route, inspection, selection, preview, refresh, or cancellation completes without a canonical commit."
rollback_undo = "No Undo is required; dismissal returns to the initiating object or control with accepted data unchanged."
recovery_id = "RECOVERY-YOU-ROOT-NORMAL-001"
recovery_posture = "current"
recovery_owner = "surface.you.command-contract"
privacy_egress = "The operation reads only local canonical data and sends no private content off device."
verification_ids = ["SCENARIO-SURFACE-YOU-COMMAND-CONTRACT-001"]
...
activation_posture = "active"
gate_requirement_ids = []
transition_exit = "Open settings => destination: the focused native settings drilldown for Root Permissions Available. The handoff starts from You root explicit state contract / Permissions Available; effect: No durable mutation occurs and no Receipt is created; settings open with accepted values and pending edits distinct; viewing commits no preference or permission change; You root explicit state contract / Permissions Available reports the outcome from this visible condition: Requested permissions are available. Existing Goals, Captures, and time are unchanged; focus: the selected setting value or group heading within You root explicit state contract / Permissions Available."
...
destination_id = "DEST-YOU-ROOT-PERMISSIONS-AVAILABLE-001"
destination_posture = "current"
effect = "No durable mutation occurs and no Receipt is created; settings open with accepted values and pending edits distinct; viewing commits no preference or permission change; You root explicit state contract / Permissions Available reports the outcome from this visible condition: Requested permissions are available. Existing Goals, Captures, and time are unchanged"
success_focus = "the selected setting value or group heading within You root explicit state contract / Permissions Available"
success_focus_id = "FOCUS-YOU-ROOT-PERMISSIONS-AVAILABLE-001-SUCCESS"
success_focus_posture = "current"
failure_focus = "the Open settings control while You root explicit state contract / Permissions Available remains visible"
failure_focus_id = "FOCUS-YOU-ROOT-PERMISSIONS-AVAILABLE-001-FAILURE"
failure_focus_posture = "current"
commit_boundary = "Non-mutating: the route, inspection, selection, preview, refresh, or cancellation completes without a canonical commit."
rollback_undo = "No Undo is required; dismissal returns to the initiating object or control with accepted data unchanged."
recovery_id = "RECOVERY-YOU-ROOT-PERMISSIONS-AVAILABLE-001"
recovery_posture = "current"
recovery_owner = "surface.you.command-contract"
privacy_egress = "The operation reads only local canonical data and sends no private content off device."
verification_ids = ["SCENARIO-SURFACE-YOU-COMMAND-CONTRACT-001"]
...
activation_posture = "active"
gate_requirement_ids = []
transition_exit = "Open settings => destination: the focused native settings drilldown for Root Permissions Denied. The handoff starts from You root explicit state contract / Permissions Denied; effect: No durable mutation occurs and no Receipt is created; settings open with accepted values and pending edits distinct; viewing commits no preference or permission change; You root explicit state contract / Permissions Denied reports the outcome from this visible condition: One or more permissions are denied. Unaffected Goals, Captures, time, and settings remain available; focus: the selected setting value or group heading within You root explicit state contract / Permissions Denied."
...
destination_id = "DEST-YOU-ROOT-PERMISSIONS-DENIED-001"
destination_posture = "current"
effect = "No durable mutation occurs and no Receipt is created; settings open with accepted values and pending edits distinct; viewing commits no preference or permission change; You root explicit state contract / Permissions Denied reports the outcome from this visible condition: One or more permissions are denied. Unaffected Goals, Captures, time, and settings remain available"
success_focus = "the selected setting value or group heading within You root explicit state contract / Permissions Denied"
success_focus_id = "FOCUS-YOU-ROOT-PERMISSIONS-DENIED-001-SUCCESS"
success_focus_posture = "current"
failure_focus = "the Open settings control while You root explicit state contract / Permissions Denied remains visible"
failure_focus_id = "FOCUS-YOU-ROOT-PERMISSIONS-DENIED-001-FAILURE"
failure_focus_posture = "current"
commit_boundary = "Non-mutating: the route, inspection, selection, preview, refresh, or cancellation completes without a canonical commit."
rollback_undo = "No Undo is required; dismissal returns to the initiating object or control with accepted data unchanged."
recovery_id = "RECOVERY-YOU-ROOT-PERMISSIONS-DENIED-001"
recovery_posture = "current"
recovery_owner = "surface.you.command-contract"
privacy_egress = "The operation reads only local canonical data and sends no private content off device."
verification_ids = ["SCENARIO-SURFACE-YOU-COMMAND-CONTRACT-001"]
...
destination_id = "DEST-YOU-ROOT-SETUP-COMPLETE-001"
destination_posture = "current"
effect = "No durable mutation occurs and no Receipt is created; settings open with accepted values and pending edits distinct; viewing commits no preference or permission change; You root explicit state contract / Setup Complete reports the outcome from this visible condition: Selected setup choices are complete. Optional account and service choices remain unchanged"
success_focus = "the selected setting value or group heading within You root explicit state contract / Setup Complete"
success_focus_id = "FOCUS-YOU-ROOT-SETUP-COMPLETE-001-SUCCESS"
success_focus_posture = "current"
failure_focus = "the Open settings control while You root explicit state contract / Setup Complete remains visible"
failure_focus_id = "FOCUS-YOU-ROOT-SETUP-COMPLETE-001-FAILURE"
failure_focus_posture = "current"
commit_boundary = "Non-mutating: the route, inspection, selection, preview, refresh, or cancellation completes without a canonical commit."
rollback_undo = "No Undo is required; dismissal returns to the initiating object or control with accepted data unchanged."
recovery_id = "RECOVERY-YOU-ROOT-SETUP-COMPLETE-001"
recovery_posture = "current"
recovery_owner = "surface.you.command-contract"
privacy_egress = "The operation reads only local canonical data and sends no private content off device."
verification_ids = ["SCENARIO-SURFACE-YOU-COMMAND-CONTRACT-001"]
...
activation_posture = "active"
gate_requirement_ids = []
transition_exit = "Open settings => destination: the focused native settings drilldown for Root Setup Partial. The handoff starts from You root explicit state contract / Setup Partial; effect: No durable mutation occurs and no Receipt is created; settings open with accepted values and pending edits distinct; viewing commits no preference or permission change; You root explicit state contract / Setup Partial reports the outcome from this visible condition: Some setup choices are incomplete. Saved information and completed choices remain available; focus: the selected setting value or group heading within You root explicit state contract / Setup Partial."
...
destination_id = "DEST-YOU-ROOT-SETUP-PARTIAL-001"
destination_posture = "current"
effect = "No durable mutation occurs and no Receipt is created; settings open with accepted values and pending edits distinct; viewing commits no preference or permission change; You root explicit state contract / Setup Partial reports the outcome from this visible condition: Some setup choices are incomplete. Saved information and completed choices remain available"
success_focus = "the selected setting value or group heading within You root explicit state contract / Setup Partial"
success_focus_id = "FOCUS-YOU-ROOT-SETUP-PARTIAL-001-SUCCESS"
success_focus_posture = "current"
failure_focus = "the Open settings control while You root explicit state contract / Setup Partial remains visible"
failure_focus_id = "FOCUS-YOU-ROOT-SETUP-PARTIAL-001-FAILURE"
failure_focus_posture = "current"
commit_boundary = "Non-mutating: the route, inspection, selection, preview, refresh, or cancellation completes without a canonical commit."
rollback_undo = "No Undo is required; dismissal returns to the initiating object or control with accepted data unchanged."
recovery_id = "RECOVERY-YOU-ROOT-SETUP-PARTIAL-001"
recovery_posture = "current"
recovery_owner = "surface.you.command-contract"
privacy_egress = "The operation reads only local canonical data and sends no private content off device."
verification_ids = ["SCENARIO-SURFACE-YOU-COMMAND-CONTRACT-001"]
...
destination_id = "DEST-YOU-SETTINGS-APP-LOCK-DISABLED-001"
destination_posture = "current"
...
success_focus_id = "FOCUS-YOU-SETTINGS-APP-LOCK-DISABLED-001-SUCCESS"
success_focus_posture = "current"
...
failure_focus_id = "FOCUS-YOU-SETTINGS-APP-LOCK-DISABLED-001-FAILURE"
failure_focus_posture = "current"
commit_boundary = "Mutation: the typed command commits only after current-revision validation, exact consequence review, and any required explicit confirmation."
rollback_undo = "Cancellation before commit changes nothing; after commit, only the named typed Undo or recovery command may append a reversing Event while History remains intact."
recovery_id = "RECOVERY-YOU-SETTINGS-APP-LOCK-DISABLED-001"
recovery_posture = "current"
recovery_owner = "surface.you.command-contract"
...
destination_id = "DEST-YOU-SETTINGS-APP-LOCK-ENABLED-001"
destination_posture = "current"
...
success_focus_id = "FOCUS-YOU-SETTINGS-APP-LOCK-ENABLED-001-SUCCESS"
success_focus_posture = "current"
...
failure_focus_id = "FOCUS-YOU-SETTINGS-APP-LOCK-ENABLED-001-FAILURE"
failure_focus_posture = "current"
commit_boundary = "Mutation: the typed command commits only after current-revision validation, exact consequence review, and any required explicit confirmation."
rollback_undo = "Cancellation before commit changes nothing; after commit, only the named typed Undo or recovery command may append a reversing Event while History remains intact."
recovery_id = "RECOVERY-YOU-SETTINGS-APP-LOCK-ENABLED-001"
recovery_posture = "current"
recovery_owner = "surface.you.command-contract"
privacy_egress = "Authentication and the App Lock setting remain local; no Ambitions Account or network is required."
verification_ids = ["SCENARIO-SURFACE-YOU-COMMAND-CONTRACT-001"]
...
activation_posture = "active"
gate_requirement_ids = []
transition_exit = "Open settings => destination: the focused native settings drilldown for Settings Appearance Dark. The handoff starts from You settings drilldown explicit state contract / Appearance Dark; effect: No durable mutation occurs and no Receipt is created; settings open with accepted values and pending edits distinct; viewing commits no preference or permission change; You settings drilldown explicit state contract / Appearance Dark reports the outcome from this visible condition: Dark appearance is active. Text, controls, and status labels keep their contrast and hierarchy; focus: the selected setting value or group heading within You settings drilldown explicit state contract / Appearance Dark."
...
destination_id = "DEST-YOU-SETTINGS-APPEARANCE-DARK-001"
destination_posture = "current"
effect = "No durable mutation occurs and no Receipt is created; settings open with accepted values and pending edits distinct; viewing commits no preference or permission change; You settings drilldown explicit state contract / Appearance Dark reports the outcome from this visible condition: Dark appearance is active. Text, controls, and status labels keep their contrast and hierarchy"
success_focus = "the selected setting value or group heading within You settings drilldown explicit state contract / Appearance Dark"
success_focus_id = "FOCUS-YOU-SETTINGS-APPEARANCE-DARK-001-SUCCESS"
success_focus_posture = "current"
...
failure_focus_id = "FOCUS-YOU-SETTINGS-APPEARANCE-DARK-001-FAILURE"
failure_focus_posture = "current"
commit_boundary = "Non-mutating: the route, inspection, selection, preview, refresh, or cancellation completes without a canonical commit."
rollback_undo = "No Undo is required; dismissal returns to the initiating object or control with accepted data unchanged."
recovery_id = "RECOVERY-YOU-SETTINGS-APPEARANCE-DARK-001"
recovery_posture = "current"
recovery_owner = "surface.you.command-contract"
privacy_egress = "The operation reads only local canonical data and sends no private content off device."
verification_ids = ["SCENARIO-SURFACE-YOU-COMMAND-CONTRACT-001"]
...
activation_posture = "active"
gate_requirement_ids = []
transition_exit = "Open settings => destination: the focused native settings drilldown for Settings Appearance Light. The handoff starts from You settings drilldown explicit state contract / Appearance Light; effect: No durable mutation occurs and no Receipt is created; settings open with accepted values and pending edits distinct; viewing commits no preference or permission change; You settings drilldown explicit state contract / Appearance Light reports the outcome from this visible condition: Light appearance is active. Text, controls, and status labels keep their contrast and hierarchy; focus: the selected setting value or group heading within You settings drilldown explicit state contract / Appearance Light."
...
destination_id = "DEST-YOU-SETTINGS-APPEARANCE-LIGHT-001"
destination_posture = "current"
effect = "No durable mutation occurs and no Receipt is created; settings open with accepted values and pending edits distinct; viewing commits no preference or permission change; You settings drilldown explicit state contract / Appearance Light reports the outcome from this visible condition: Light appearance is active. Text, controls, and status labels keep their contrast and hierarchy"
success_focus = "the selected setting value or group heading within You settings drilldown explicit state contract / Appearance Light"
success_focus_id = "FOCUS-YOU-SETTINGS-APPEARANCE-LIGHT-001-SUCCESS"
success_focus_posture = "current"
...
failure_focus_id = "FOCUS-YOU-SETTINGS-APPEARANCE-LIGHT-001-FAILURE"
failure_focus_posture = "current"
commit_boundary = "Non-mutating: the route, inspection, selection, preview, refresh, or cancellation completes without a canonical commit."
rollback_undo = "No Undo is required; dismissal returns to the initiating object or control with accepted data unchanged."
recovery_id = "RECOVERY-YOU-SETTINGS-APPEARANCE-LIGHT-001"
recovery_posture = "current"
recovery_owner = "surface.you.command-contract"
privacy_egress = "The operation reads only local canonical data and sends no private content off device."
verification_ids = ["SCENARIO-SURFACE-YOU-COMMAND-CONTRACT-001"]
...
activation_posture = "active"
gate_requirement_ids = []
transition_exit = "Open settings => destination: the focused native settings drilldown for Settings Appearance OLED Dark. The handoff starts from You settings drilldown explicit state contract / Appearance OLED Dark; effect: No durable mutation occurs and no Receipt is created; settings open with accepted values and pending edits distinct; viewing commits no preference or permission change; You settings drilldown explicit state contract / Appearance OLED Dark reports the outcome from this visible condition: OLED Dark appearance is active. True-black backgrounds keep text, controls, and status labels readable; focus: the selected setting value or group heading within You settings drilldown explicit state contract / Appearance OLED Dark."
...
destination_id = "DEST-YOU-SETTINGS-APPEARANCE-OLED-DARK-001"
destination_posture = "current"
effect = "No durable mutation occurs and no Receipt is created; settings open with accepted values and pending edits distinct; viewing commits no preference or permission change; You settings drilldown explicit state contract / Appearance OLED Dark reports the outcome from this visible condition: OLED Dark appearance is active. True-black backgrounds keep text, controls, and status labels readable"
success_focus = "the selected setting value or group heading within You settings drilldown explicit state contract / Appearance OLED Dark"
success_focus_id = "FOCUS-YOU-SETTINGS-APPEARANCE-OLED-DARK-001-SUCCESS"
success_focus_posture = "current"
...
failure_focus_id = "FOCUS-YOU-SETTINGS-APPEARANCE-OLED-DARK-001-FAILURE"
failure_focus_posture = "current"
commit_boundary = "Non-mutating: the route, inspection, selection, preview, refresh, or cancellation completes without a canonical commit."
rollback_undo = "No Undo is required; dismissal returns to the initiating object or control with accepted data unchanged."
recovery_id = "RECOVERY-YOU-SETTINGS-APPEARANCE-OLED-DARK-001"
recovery_posture = "current"
recovery_owner = "surface.you.command-contract"
privacy_egress = "The operation reads only local canonical data and sends no private content off device."
verification_ids = ["SCENARIO-SURFACE-YOU-COMMAND-CONTRACT-001"]
...
destination_id = "DEST-YOU-SETTINGS-APPEARANCE-SYSTEM-001"
destination_posture = "current"
effect = "No durable mutation occurs and no Receipt is created; settings open with accepted values and pending edits distinct; viewing commits no preference or permission change; You settings drilldown explicit state contract / Appearance System reports the outcome from this visible condition: Appearance follows the current iOS system setting"
success_focus = "the selected setting value or group heading within You settings drilldown explicit state contract / Appearance System"
success_focus_id = "FOCUS-YOU-SETTINGS-APPEARANCE-SYSTEM-001-SUCCESS"
success_focus_posture = "current"
...
failure_focus_id = "FOCUS-YOU-SETTINGS-APPEARANCE-SYSTEM-001-FAILURE"
failure_focus_posture = "current"
commit_boundary = "Non-mutating: the route, inspection, selection, preview, refresh, or cancellation completes without a canonical commit."
rollback_undo = "No Undo is required; dismissal returns to the initiating object or control with accepted data unchanged."
recovery_id = "RECOVERY-YOU-SETTINGS-APPEARANCE-SYSTEM-001"
recovery_posture = "current"
recovery_owner = "surface.you.command-contract"
privacy_egress = "The operation reads only local canonical data and sends no private content off device."
verification_ids = ["SCENARIO-SURFACE-YOU-COMMAND-CONTRACT-001"]
...
activation_posture = "active"
gate_requirement_ids = []
transition_exit = "Open settings => destination: the focused native settings drilldown for Settings Automation Policy. The handoff starts from You settings drilldown explicit state contract / Automation Policy; effect: No durable mutation occurs and no Receipt is created; settings open with accepted values and pending edits distinct; viewing commits no preference or permission change; You settings drilldown explicit state contract / Automation Policy reports the outcome from this visible condition: Automation uses the permission level shown here. Existing settings retain their saved values; focus: the selected setting value or group heading within You settings drilldown explicit state contract / Automation Policy."
...
destination_id = "DEST-YOU-SETTINGS-AUTOMATION-POLICY-001"
destination_posture = "current"
effect = "No durable mutation occurs and no Receipt is created; settings open with accepted values and pending edits distinct; viewing commits no preference or permission change; You settings drilldown explicit state contract / Automation Policy reports the outcome from this visible condition: Automation uses the permission level shown here. Existing settings retain their saved values"
success_focus = "the selected setting value or group heading within You settings drilldown explicit state contract / Automation Policy"
success_focus_id = "FOCUS-YOU-SETTINGS-AUTOMATION-POLICY-001-SUCCESS"
success_focus_posture = "current"
...
failure_focus_id = "FOCUS-YOU-SETTINGS-AUTOMATION-POLICY-001-FAILURE"
failure_focus_posture = "current"
commit_boundary = "Non-mutating: the route, inspection, selection, preview, refresh, or cancellation completes without a canonical commit."
rollback_undo = "No Undo is required; dismissal returns to the initiating object or control with accepted data unchanged."
recovery_id = "RECOVERY-YOU-SETTINGS-AUTOMATION-POLICY-001"
recovery_posture = "current"
recovery_owner = "surface.you.command-contract"
privacy_egress = "The operation reads only local canonical data and sends no private content off device."
verification_ids = ["SCENARIO-SURFACE-YOU-COMMAND-CONTRACT-001"]
...
activation_posture = "active"
gate_requirement_ids = []
transition_exit = "Open settings => destination: the focused native settings drilldown for Settings Biometric Unavailable. The handoff starts from You settings drilldown explicit state contract / Biometric Unavailable; effect: No durable mutation occurs and no Receipt is created; settings open with accepted values and pending edits distinct; viewing commits no preference or permission change; You settings drilldown explicit state contract / Biometric Unavailable reports the outcome from this visible condition: Biometric access is unavailable. Device passcode access remains unchanged, and the user is not locked out; focus: the selected setting value or group heading within You settings drilldown explicit state contract / Biometric Unavailable."
...
destination_id = "DEST-YOU-SETTINGS-BIOMETRIC-UNAVAILABLE-001"
destination_posture = "current"
effect = "No durable mutation occurs and no Receipt is created; settings open with accepted values and pending edits distinct; viewing commits no preference or permission change; You settings drilldown explicit state contract / Biometric Unavailable reports the outcome from this visible condition: Biometric access is unavailable. Device passcode access remains unchanged, and the user is not locked out"
success_focus = "the selected setting value or group heading within You settings drilldown explicit state contract / Biometric Unavailable"
success_focus_id = "FOCUS-YOU-SETTINGS-BIOMETRIC-UNAVAILABLE-001-SUCCESS"
success_focus_posture = "current"
...
failure_focus_id = "FOCUS-YOU-SETTINGS-BIOMETRIC-UNAVAILABLE-001-FAILURE"
failure_focus_posture = "current"
commit_boundary = "Non-mutating: the route, inspection, selection, preview, refresh, or cancellation completes without a canonical commit."
rollback_undo = "No Undo is required; dismissal returns to the initiating object or control with accepted data unchanged."
recovery_id = "RECOVERY-YOU-SETTINGS-BIOMETRIC-UNAVAILABLE-001"
recovery_posture = "current"
recovery_owner = "surface.you.command-contract"
privacy_egress = "The operation reads only local canonical data and sends no private content off device."
verification_ids = ["SCENARIO-SURFACE-YOU-COMMAND-CONTRACT-001"]
...
activation_posture = "active"
gate_requirement_ids = []
transition_exit = "Open settings => destination: the focused native settings drilldown for Settings Increase Contrast. The handoff starts from You settings drilldown explicit state contract / Increase Contrast; effect: No durable mutation occurs and no Receipt is created; settings open with accepted values and pending edits distinct; viewing commits no preference or permission change; You settings drilldown explicit state contract / Increase Contrast reports the outcome from this visible condition: Increase Contrast is on. Labels and outlines keep meaning clear without relying on color alone; focus: the selected setting value or group heading within You settings drilldown explicit state contract / Increase Contrast."
...
destination_id = "DEST-YOU-SETTINGS-INCREASE-CONTRAST-001"
destination_posture = "current"
effect = "No durable mutation occurs and no Receipt is created; settings open with accepted values and pending edits distinct; viewing commits no preference or permission change; You settings drilldown explicit state contract / Increase Contrast reports the outcome from this visible condition: Increase Contrast is on. Labels and outlines keep meaning clear without relying on color alone"
success_focus = "the selected setting value or group heading within You settings drilldown explicit state contract / Increase Contrast"
success_focus_id = "FOCUS-YOU-SETTINGS-INCREASE-CONTRAST-001-SUCCESS"
success_focus_posture = "current"
...
failure_focus_id = "FOCUS-YOU-SETTINGS-INCREASE-CONTRAST-001-FAILURE"
failure_focus_posture = "current"
commit_boundary = "Non-mutating: the route, inspection, selection, preview, refresh, or cancellation completes without a canonical commit."
rollback_undo = "No Undo is required; dismissal returns to the initiating object or control with accepted data unchanged."
recovery_id = "RECOVERY-YOU-SETTINGS-INCREASE-CONTRAST-001"
recovery_posture = "current"
recovery_owner = "surface.you.command-contract"
privacy_egress = "The operation reads only local canonical data and sends no private content off device."
verification_ids = ["SCENARIO-SURFACE-YOU-COMMAND-CONTRACT-001"]
...
destination_id = "DEST-YOU-SETTINGS-NOTIFICATION-CONTROLS-001"
destination_posture = "current"
effect = "No durable mutation occurs and no Receipt is created; the accepted value remains authoritative while a pending edit is reviewed; no setting is falsely saved or dismissed; You settings drilldown explicit state contract / Notification Controls reports the outcome from this visible condition: Notification controls separate category delivery from whether sensitive content may appear"
success_focus = "the notification setting value or first invalid pending edit within You settings drilldown explicit state contract / Notification Controls"
success_focus_id = "FOCUS-YOU-SETTINGS-NOTIFICATION-CONTROLS-001-SUCCESS"
success_focus_posture = "current"
...
failure_focus_id = "FOCUS-YOU-SETTINGS-NOTIFICATION-CONTROLS-001-FAILURE"
failure_focus_posture = "current"
commit_boundary = "Non-mutating: the route, inspection, selection, preview, refresh, or cancellation completes without a canonical commit."
rollback_undo = "No Undo is required; dismissal returns to the initiating object or control with accepted data unchanged."
recovery_id = "RECOVERY-YOU-SETTINGS-NOTIFICATION-CONTROLS-001"
recovery_posture = "current"
recovery_owner = "surface.you.command-contract"
privacy_egress = "The operation reads only local canonical data and sends no private content off device."
verification_ids = ["SCENARIO-SURFACE-YOU-COMMAND-CONTRACT-001"]
...
destination_id = "DEST-YOU-SETTINGS-PRIVACY-REVIEW-001"
destination_posture = "current"
...
success_focus_id = "FOCUS-YOU-SETTINGS-PRIVACY-REVIEW-001-SUCCESS"
success_focus_posture = "current"
...
failure_focus_id = "FOCUS-YOU-SETTINGS-PRIVACY-REVIEW-001-FAILURE"
failure_focus_posture = "current"
commit_boundary = "Non-mutating: the route, inspection, selection, preview, refresh, or cancellation completes without a canonical commit."
rollback_undo = "No Undo is required; dismissal returns to the initiating object or control with accepted data unchanged."
recovery_id = "RECOVERY-YOU-SETTINGS-PRIVACY-REVIEW-001"
recovery_posture = "current"
recovery_owner = "surface.you.command-contract"
privacy_egress = "The operation reads only local canonical data and sends no private content off device."
verification_ids = ["SCENARIO-SURFACE-YOU-COMMAND-CONTRACT-001"]
...
activation_posture = "active"
gate_requirement_ids = []
transition_exit = "Open settings => destination: the focused native settings drilldown for Settings Time Preferences. The handoff starts from You settings drilldown explicit state contract / Time Preferences; effect: No durable mutation occurs and no Receipt is created; settings open with accepted values and pending edits distinct; viewing commits no preference or permission change; You settings drilldown explicit state contract / Time Preferences reports the outcome from this visible condition: Time preferences state how Time is presented and which defaults affect future proposals; focus: the selected setting value or group heading within You settings drilldown explicit state contract / Time Preferences."
...
destination_id = "DEST-YOU-SETTINGS-TIME-PREFERENCES-001"
destination_posture = "current"
effect = "No durable mutation occurs and no Receipt is created; settings open with accepted values and pending edits distinct; viewing commits no preference or permission change; You settings drilldown explicit state contract / Time Preferences reports the outcome from this visible condition: Time preferences state how Time is presented and which defaults affect future proposals"
success_focus = "the selected setting value or group heading within You settings drilldown explicit state contract / Time Preferences"
success_focus_id = "FOCUS-YOU-SETTINGS-TIME-PREFERENCES-001-SUCCESS"
success_focus_posture = "current"
...
failure_focus_id = "FOCUS-YOU-SETTINGS-TIME-PREFERENCES-001-FAILURE"
failure_focus_posture = "current"
commit_boundary = "Non-mutating: the route, inspection, selection, preview, refresh, or cancellation completes without a canonical commit."
rollback_undo = "No Undo is required; dismissal returns to the initiating object or control with accepted data unchanged."
recovery_id = "RECOVERY-YOU-SETTINGS-TIME-PREFERENCES-001"
recovery_posture = "current"
recovery_owner = "surface.you.command-contract"
privacy_egress = "The operation reads only local canonical data and sends no private content off device."
verification_ids = ["SCENARIO-SURFACE-YOU-COMMAND-CONTRACT-001"]
