...
destination_id = "DEST-TODAY-DETAIL-ACTIVE-EXECUTION-001"
...
success_focus_id = "FOCUS-TODAY-DETAIL-ACTIVE-EXECUTION-001-SUCCESS"
...
failure_focus_id = "FOCUS-TODAY-DETAIL-ACTIVE-EXECUTION-001-FAILURE"
...
recovery_id = "RECOVERY-TODAY-DETAIL-ACTIVE-EXECUTION-001"
...
destination_id = "DEST-TODAY-DETAIL-CLOSURE-REVIEW-001"
destination_posture = "current"
...
success_focus_id = "FOCUS-TODAY-DETAIL-CLOSURE-REVIEW-001-SUCCESS"
success_focus_posture = "current"
...
failure_focus_id = "FOCUS-TODAY-DETAIL-CLOSURE-REVIEW-001-FAILURE"
failure_focus_posture = "current"
...
recovery_id = "RECOVERY-TODAY-DETAIL-CLOSURE-REVIEW-001"
recovery_posture = "current"
recovery_owner = "surface.today.command-contract"
...
destination_id = "DEST-TODAY-DETAIL-RECOVERY-001"
destination_posture = "current"
...
success_focus_id = "FOCUS-TODAY-DETAIL-RECOVERY-001-SUCCESS"
success_focus_posture = "current"
...
failure_focus_id = "FOCUS-TODAY-DETAIL-RECOVERY-001-FAILURE"
failure_focus_posture = "current"
commit_boundary = "Non-mutating: the route, inspection, selection, preview, refresh, or cancellation completes without a canonical commit."
rollback_undo = "No Undo is required; dismissal returns to the initiating object or control with accepted data unchanged."
recovery_id = "RECOVERY-TODAY-DETAIL-RECOVERY-001"
recovery_posture = "current"
recovery_owner = "surface.today.command-contract"
privacy_egress = "The operation reads only local canonical data and sends no private content off device."
verification_ids = ["SCENARIO-SURFACE-TODAY-COMMAND-CONTRACT-001"]
...
destination_id = "DEST-TODAY-DETAIL-STALE-EXTERNAL-CONTEXT-001"
destination_posture = "current"
...
success_focus_id = "FOCUS-TODAY-DETAIL-STALE-EXTERNAL-CONTEXT-001-SUCCESS"
success_focus_posture = "current"
...
failure_focus_id = "FOCUS-TODAY-DETAIL-STALE-EXTERNAL-CONTEXT-001-FAILURE"
failure_focus_posture = "current"
commit_boundary = "Non-mutating: the route, inspection, selection, preview, refresh, or cancellation completes without a canonical commit."
rollback_undo = "No Undo is required; dismissal returns to the initiating object or control with accepted data unchanged."
recovery_id = "RECOVERY-TODAY-DETAIL-STALE-EXTERNAL-CONTEXT-001"
recovery_posture = "current"
recovery_owner = "surface.today.command-contract"
privacy_egress = "The operation reads only local canonical data and sends no private content off device."
verification_ids = ["SCENARIO-SURFACE-TODAY-COMMAND-CONTRACT-001"]
...
destination_id = "DEST-TODAY-DETAIL-VIEWING-001"
destination_posture = "current"
...
success_focus_id = "FOCUS-TODAY-DETAIL-VIEWING-001-SUCCESS"
success_focus_posture = "current"
...
failure_focus_id = "FOCUS-TODAY-DETAIL-VIEWING-001-FAILURE"
failure_focus_posture = "current"
commit_boundary = "Non-mutating: the route, inspection, selection, preview, refresh, or cancellation completes without a canonical commit."
rollback_undo = "No Undo is required; dismissal returns to the initiating object or control with accepted data unchanged."
recovery_id = "RECOVERY-TODAY-DETAIL-VIEWING-001"
recovery_posture = "current"
recovery_owner = "surface.today.command-contract"
privacy_egress = "The operation reads only local canonical data and sends no private content off device."
verification_ids = ["SCENARIO-SURFACE-TODAY-COMMAND-CONTRACT-001"]
...
destination_id = "DEST-TODAY-ROOT-CONFLICT-001"
destination_posture = "current"
...
success_focus_id = "FOCUS-TODAY-ROOT-CONFLICT-001-SUCCESS"
success_focus_posture = "current"
...
activation_posture = "active"
gate_requirement_ids = []
transition_exit = "Open step => destination: the selected stable Step detail. The handoff starts from Today Reality Window explicit state contract / Dense; effect: No durable mutation occurs and no Receipt is created; the Step opens for inspection and Today, schedule, closure, and Proof data remain unchanged; Today Reality Window explicit state contract / Dense reports the outcome from this visible condition: Today is dense. Protected and fixed reality stays visible; Ambitions does not create urgency or silently move it; focus: the Step heading; if the Step vanished, the same Step status near Now, then Start here, then the Now heading within Today Reality Window explicit state contract / Dense."
...
destination_id = "DEST-TODAY-ROOT-DENSE-001"
destination_posture = "current"
effect = "No durable mutation occurs and no Receipt is created; the Step opens for inspection and Today, schedule, closure, and Proof data remain unchanged; Today Reality Window explicit state contract / Dense reports the outcome from this visible condition: Today is dense. Protected and fixed reality stays visible; Ambitions does not create urgency or silently move it"
...
success_focus_id = "FOCUS-TODAY-ROOT-DENSE-001-SUCCESS"
success_focus_posture = "current"
...
failure_focus_id = "FOCUS-TODAY-ROOT-DENSE-001-FAILURE"
failure_focus_posture = "current"
commit_boundary = "Non-mutating: the route, inspection, selection, preview, refresh, or cancellation completes without a canonical commit."
rollback_undo = "No Undo is required; dismissal returns to the initiating object or control with accepted data unchanged."
recovery_id = "RECOVERY-TODAY-ROOT-DENSE-001"
recovery_posture = "current"
recovery_owner = "surface.today.command-contract"
privacy_egress = "The operation reads only local canonical data and sends no private content off device."
verification_ids = ["SCENARIO-SURFACE-TODAY-COMMAND-CONTRACT-001"]
...
destination_id = "DEST-TODAY-ROOT-DESTRUCTIVE-CONFIRMATION-001"
destination_posture = "current"
...
success_focus_id = "FOCUS-TODAY-ROOT-DESTRUCTIVE-CONFIRMATION-001-SUCCESS"
success_focus_posture = "current"
...
failure_focus_id = "FOCUS-TODAY-ROOT-DESTRUCTIVE-CONFIRMATION-001-FAILURE"
failure_focus_posture = "current"
commit_boundary = "Mutation: the typed command commits only after current-revision validation, exact consequence review, and any required explicit confirmation."
rollback_undo = "Cancellation before commit changes nothing; after commit, only the named typed Undo or recovery command may append a reversing Event while History remains intact."
recovery_id = "RECOVERY-TODAY-ROOT-DESTRUCTIVE-CONFIRMATION-001"
recovery_posture = "current"
recovery_owner = "surface.today.command-contract"
privacy_egress = "The mutation remains local and sends no private content off device; any external side effect requires a separate minimum-field egress review under SYSTEM-PRIVACY-EGRESS-001."
verification_ids = ["SCENARIO-SURFACE-TODAY-COMMAND-CONTRACT-001"]
...
destination_id = "DEST-TODAY-ROOT-EMPTY-001"
destination_posture = "current"
...
success_focus_id = "FOCUS-TODAY-ROOT-EMPTY-001-SUCCESS"
success_focus_posture = "current"
...
failure_focus_id = "FOCUS-TODAY-ROOT-EMPTY-001-FAILURE"
failure_focus_posture = "current"
commit_boundary = "Non-mutating: the route, inspection, selection, preview, refresh, or cancellation completes without a canonical commit."
rollback_undo = "No Undo is required; dismissal returns to the initiating object or control with accepted data unchanged."
recovery_id = "RECOVERY-TODAY-ROOT-EMPTY-001"
recovery_posture = "current"
recovery_owner = "surface.today.command-contract"
privacy_egress = "The operation reads only local canonical data and sends no private content off device."
verification_ids = ["SCENARIO-SURFACE-TODAY-COMMAND-CONTRACT-001"]
...
destination_id = "DEST-TODAY-ROOT-LOADING-001"
destination_posture = "current"
...
success_focus_id = "FOCUS-TODAY-ROOT-LOADING-001-SUCCESS"
success_focus_posture = "current"
...
failure_focus_id = "FOCUS-TODAY-ROOT-LOADING-001-FAILURE"
failure_focus_posture = "current"
commit_boundary = "Non-mutating: the route, inspection, selection, preview, refresh, or cancellation completes without a canonical commit."
rollback_undo = "No Undo is required; dismissal returns to the initiating object or control with accepted data unchanged."
recovery_id = "RECOVERY-TODAY-ROOT-LOADING-001"
recovery_posture = "current"
recovery_owner = "surface.today.command-contract"
privacy_egress = "The operation reads only local canonical data and sends no private content off device."
verification_ids = ["SCENARIO-SURFACE-TODAY-COMMAND-CONTRACT-001"]
...
destination_id = "DEST-TODAY-ROOT-LOW-DENSITY-001"
destination_posture = "current"
...
success_focus_id = "FOCUS-TODAY-ROOT-LOW-DENSITY-001-SUCCESS"
success_focus_posture = "current"
...
failure_focus_id = "FOCUS-TODAY-ROOT-LOW-DENSITY-001-FAILURE"
failure_focus_posture = "current"
commit_boundary = "Non-mutating: the route, inspection, selection, preview, refresh, or cancellation completes without a canonical commit."
rollback_undo = "No Undo is required; dismissal returns to the initiating object or control with accepted data unchanged."
recovery_id = "RECOVERY-TODAY-ROOT-LOW-DENSITY-001"
recovery_posture = "current"
recovery_owner = "surface.today.command-contract"
privacy_egress = "The operation reads only local canonical data and sends no private content off device."
verification_ids = ["SCENARIO-SURFACE-TODAY-COMMAND-CONTRACT-001"]
...
destination_id = "DEST-TODAY-ROOT-OFFLINE-HEALTHY-001"
destination_posture = "current"
...
success_focus_id = "FOCUS-TODAY-ROOT-OFFLINE-HEALTHY-001-SUCCESS"
success_focus_posture = "current"
...
failure_focus_id = "FOCUS-TODAY-ROOT-OFFLINE-HEALTHY-001-FAILURE"
failure_focus_posture = "current"
commit_boundary = "Non-mutating: the route, inspection, selection, preview, refresh, or cancellation completes without a canonical commit."
rollback_undo = "No Undo is required; dismissal returns to the initiating object or control with accepted data unchanged."
recovery_id = "RECOVERY-TODAY-ROOT-OFFLINE-HEALTHY-001"
recovery_posture = "current"
recovery_owner = "surface.today.command-contract"
privacy_egress = "The operation reads only local canonical data and sends no private content off device."
verification_ids = ["SCENARIO-SURFACE-TODAY-COMMAND-CONTRACT-001"]
...
destination_id = "DEST-TODAY-ROOT-PARTIAL-FAILURE-001"
destination_posture = "current"
...
success_focus_id = "FOCUS-TODAY-ROOT-PARTIAL-FAILURE-001-SUCCESS"
success_focus_posture = "current"
...
failure_focus_id = "FOCUS-TODAY-ROOT-PARTIAL-FAILURE-001-FAILURE"
failure_focus_posture = "current"
commit_boundary = "Non-mutating: the route, inspection, selection, preview, refresh, or cancellation completes without a canonical commit."
rollback_undo = "No Undo is required; dismissal returns to the initiating object or control with accepted data unchanged."
recovery_id = "RECOVERY-TODAY-ROOT-PARTIAL-FAILURE-001"
recovery_posture = "current"
recovery_owner = "surface.today.command-contract"
privacy_egress = "The operation reads only local canonical data and sends no private content off device."
verification_ids = ["SCENARIO-SURFACE-TODAY-COMMAND-CONTRACT-001"]
...
destination_id = "DEST-TODAY-ROOT-PERMISSION-DENIED-001"
destination_posture = "current"
...
success_focus_id = "FOCUS-TODAY-ROOT-PERMISSION-DENIED-001-SUCCESS"
success_focus_posture = "current"
...
failure_focus_id = "FOCUS-TODAY-ROOT-PERMISSION-DENIED-001-FAILURE"
failure_focus_posture = "current"
commit_boundary = "Non-mutating: the route, inspection, selection, preview, refresh, or cancellation completes without a canonical commit."
rollback_undo = "No Undo is required; dismissal returns to the initiating object or control with accepted data unchanged."
recovery_id = "RECOVERY-TODAY-ROOT-PERMISSION-DENIED-001"
recovery_posture = "current"
recovery_owner = "surface.today.command-contract"
...
destination_id = "DEST-TODAY-ROOT-PERMISSION-DENIED-002"
destination_posture = "current"
...
success_focus_id = "FOCUS-TODAY-ROOT-PERMISSION-DENIED-002-SUCCESS"
success_focus_posture = "current"
...
failure_focus_id = "FOCUS-TODAY-ROOT-PERMISSION-DENIED-002-FAILURE"
failure_focus_posture = "current"
commit_boundary = "Non-mutating: the route, inspection, selection, preview, refresh, or cancellation completes without a canonical commit."
rollback_undo = "No Undo is required; dismissal returns to the initiating object or control with accepted data unchanged."
recovery_id = "RECOVERY-TODAY-ROOT-PERMISSION-DENIED-002"
recovery_posture = "current"
recovery_owner = "surface.today.command-contract"
privacy_egress = "The operation reads only local canonical data and sends no private content off device."
verification_ids = ["SCENARIO-SURFACE-TODAY-COMMAND-CONTRACT-001"]
...
destination_id = "DEST-TODAY-ROOT-POPULATED-001"
destination_posture = "current"
...
success_focus_id = "FOCUS-TODAY-ROOT-POPULATED-001-SUCCESS"
success_focus_posture = "current"
...
failure_focus_id = "FOCUS-TODAY-ROOT-POPULATED-001-FAILURE"
failure_focus_posture = "current"
commit_boundary = "Non-mutating: the route, inspection, selection, preview, refresh, or cancellation completes without a canonical commit."
rollback_undo = "No Undo is required; dismissal returns to the initiating object or control with accepted data unchanged."
recovery_id = "RECOVERY-TODAY-ROOT-POPULATED-001"
recovery_posture = "current"
recovery_owner = "surface.today.command-contract"
privacy_egress = "The operation reads only local canonical data and sends no private content off device."
verification_ids = ["SCENARIO-SURFACE-TODAY-COMMAND-CONTRACT-001"]
...
destination_id = "DEST-TODAY-ROOT-RECOVERY-001"
destination_posture = "current"
...
success_focus_id = "FOCUS-TODAY-ROOT-RECOVERY-001-SUCCESS"
success_focus_posture = "current"
...
failure_focus_id = "FOCUS-TODAY-ROOT-RECOVERY-001-FAILURE"
failure_focus_posture = "current"
commit_boundary = "Non-mutating: the route, inspection, selection, preview, refresh, or cancellation completes without a canonical commit."
rollback_undo = "No Undo is required; dismissal returns to the initiating object or control with accepted data unchanged."
recovery_id = "RECOVERY-TODAY-ROOT-RECOVERY-001"
recovery_posture = "current"
recovery_owner = "surface.today.command-contract"
privacy_egress = "The operation reads only local canonical data and sends no private content off device."
verification_ids = ["SCENARIO-SURFACE-TODAY-COMMAND-CONTRACT-001"]
...
destination_id = "DEST-TODAY-ROOT-RESTORED-001"
destination_posture = "current"
effect = "No durable mutation occurs and no Receipt is created; the Step opens for inspection and Today, schedule, closure, and Proof data remain unchanged; Today Reality Window explicit state contract / Restored reports the outcome from this visible condition: Today context restored after interruption and checked against current local reality"
...
success_focus_id = "FOCUS-TODAY-ROOT-RESTORED-001-SUCCESS"
success_focus_posture = "current"
...
failure_focus_id = "FOCUS-TODAY-ROOT-RESTORED-001-FAILURE"
failure_focus_posture = "current"
commit_boundary = "Non-mutating: the route, inspection, selection, preview, refresh, or cancellation completes without a canonical commit."
rollback_undo = "No Undo is required; dismissal returns to the initiating object or control with accepted data unchanged."
recovery_id = "RECOVERY-TODAY-ROOT-RESTORED-001"
recovery_posture = "current"
recovery_owner = "surface.today.command-contract"
privacy_egress = "The operation reads only local canonical data and sends no private content off device."
verification_ids = ["SCENARIO-SURFACE-TODAY-COMMAND-CONTRACT-001"]
...
destination_id = "DEST-TODAY-ROOT-STALE-EXTERNAL-CONTEXT-001"
destination_posture = "current"
effect = "No durable mutation occurs and no Receipt is created; the Step opens for inspection and Today, schedule, closure, and Proof data remain unchanged; Today Reality Window explicit state contract / Stale External Context reports the outcome from this visible condition: Outside calendar context may be out of date; local Steps and protected time remain visible"
...
success_focus_id = "FOCUS-TODAY-ROOT-STALE-EXTERNAL-CONTEXT-001-SUCCESS"
success_focus_posture = "current"
...
failure_focus_id = "FOCUS-TODAY-ROOT-STALE-EXTERNAL-CONTEXT-001-FAILURE"
failure_focus_posture = "current"
commit_boundary = "Non-mutating: the route, inspection, selection, preview, refresh, or cancellation completes without a canonical commit."
rollback_undo = "No Undo is required; dismissal returns to the initiating object or control with accepted data unchanged."
recovery_id = "RECOVERY-TODAY-ROOT-STALE-EXTERNAL-CONTEXT-001"
recovery_posture = "current"
recovery_owner = "surface.today.command-contract"
privacy_egress = "The operation reads only local canonical data and sends no private content off device."
verification_ids = ["SCENARIO-SURFACE-TODAY-COMMAND-CONTRACT-001"]
...
activation_posture = "active"
gate_requirement_ids = []
transition_exit = "Open step => destination: the selected stable Step detail. The handoff starts from Start here explicit state contract / Active Execution; effect: No durable mutation occurs and no Receipt is created; the Step opens for inspection and Today, schedule, closure, and Proof data remain unchanged; Start here explicit state contract / Active Execution reports the outcome from this visible condition: This Step is in progress. Still counts, Move it, Blocked, Waiting, and Not needed describe what happened without score or shame; focus: the Step heading; if the Step vanished, the same Step status near Now, then Start here, then the Now heading within Start here explicit state contract / Active Execution."
...
destination_id = "DEST-TODAY-START-HERE-ACTIVE-EXECUTION-001"
destination_posture = "current"
effect = "No durable mutation occurs and no Receipt is created; the Step opens for inspection and Today, schedule, closure, and Proof data remain unchanged; Start here explicit state contract / Active Execution reports the outcome from this visible condition: This Step is in progress. Still counts, Move it, Blocked, Waiting, and Not needed describe what happened without score or shame"
...
success_focus_id = "FOCUS-TODAY-START-HERE-ACTIVE-EXECUTION-001-SUCCESS"
success_focus_posture = "current"
...
failure_focus_id = "FOCUS-TODAY-START-HERE-ACTIVE-EXECUTION-001-FAILURE"
failure_focus_posture = "current"
commit_boundary = "Non-mutating: the route, inspection, selection, preview, refresh, or cancellation completes without a canonical commit."
rollback_undo = "No Undo is required; dismissal returns to the initiating object or control with accepted data unchanged."
recovery_id = "RECOVERY-TODAY-START-HERE-ACTIVE-EXECUTION-001"
recovery_posture = "current"
recovery_owner = "surface.today.command-contract"
privacy_egress = "The operation reads only local canonical data and sends no private content off device."
verification_ids = ["SCENARIO-SURFACE-TODAY-COMMAND-CONTRACT-001"]
...
destination_id = "DEST-TODAY-START-HERE-CLOSURE-READY-001"
destination_posture = "current"
...
success_focus_id = "FOCUS-TODAY-START-HERE-CLOSURE-READY-001-SUCCESS"
success_focus_posture = "current"
...
failure_focus_id = "FOCUS-TODAY-START-HERE-CLOSURE-READY-001-FAILURE"
failure_focus_posture = "current"
commit_boundary = "Mutation: the typed command commits only after current-revision validation, exact consequence review, and any required explicit confirmation."
rollback_undo = "Cancellation before commit changes nothing; after commit, only the named typed Undo or recovery command may append a reversing Event while History remains intact."
recovery_id = "RECOVERY-TODAY-START-HERE-CLOSURE-READY-001"
recovery_posture = "current"
recovery_owner = "surface.today.command-contract"
privacy_egress = "The mutation remains local and sends no private content off device; any external side effect requires a separate minimum-field egress review under SYSTEM-PRIVACY-EGRESS-001."
verification_ids = ["SCENARIO-SURFACE-TODAY-COMMAND-CONTRACT-001"]
...
destination_id = "DEST-TODAY-START-HERE-RECOVERY-NEEDED-001"
destination_posture = "current"
...
success_focus_id = "FOCUS-TODAY-START-HERE-RECOVERY-NEEDED-001-SUCCESS"
success_focus_posture = "current"
...
failure_focus_id = "FOCUS-TODAY-START-HERE-RECOVERY-NEEDED-001-FAILURE"
failure_focus_posture = "current"
commit_boundary = "Non-mutating: the route, inspection, selection, preview, refresh, or cancellation completes without a canonical commit."
rollback_undo = "No Undo is required; dismissal returns to the initiating object or control with accepted data unchanged."
recovery_id = "RECOVERY-TODAY-START-HERE-RECOVERY-NEEDED-001"
recovery_posture = "current"
recovery_owner = "surface.today.command-contract"
privacy_egress = "The operation reads only local canonical data and sends no private content off device."
verification_ids = ["SCENARIO-SURFACE-TODAY-COMMAND-CONTRACT-001"]
