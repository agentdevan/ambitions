...
destination_id = "DEST-APP-DEEP-LINK-INTAKE-CONSUMED-001"
...
success_focus_id = "FOCUS-APP-DEEP-LINK-INTAKE-CONSUMED-001-SUCCESS"
...
failure_focus_id = "FOCUS-APP-DEEP-LINK-INTAKE-CONSUMED-001-FAILURE"
...
recovery_id = "RECOVERY-APP-DEEP-LINK-INTAKE-CONSUMED-001"
recovery_posture = "current"
recovery_owner = "app.deep-linking.command-contract"
...
destination_id = "DEST-APP-DEEP-LINK-INTAKE-PRESENTED-001"
destination_posture = "current"
...
success_focus_id = "FOCUS-APP-DEEP-LINK-INTAKE-PRESENTED-001-SUCCESS"
success_focus_posture = "current"
failure_focus = "the Dismiss control and opaque recovery reason in Deep-link intake and resolution — Presented"
failure_focus_id = "FOCUS-APP-DEEP-LINK-INTAKE-PRESENTED-001-FAILURE"
failure_focus_posture = "current"
commit_boundary = "Non-mutating: route resolution, retry, fallback, or dismissal completes without a canonical commit."
rollback_undo = "No Undo is required; cancellation preserves the last stable route, local canonical state, and any recoverable Capture input."
recovery_id = "RECOVERY-APP-DEEP-LINK-INTAKE-PRESENTED-001"
recovery_posture = "current"
recovery_owner = "app.deep-linking.command-contract"
privacy_egress = "Resolution uses only allowlisted source metadata and opaque identifiers; rejected or locked targets disclose no protected identity or content."
verification_ids = ["SCENARIO-APP-DEEP-LINK-COMMAND-CONTRACT-001"]
...
destination_id = "DEST-APP-DEEP-LINK-INTAKE-QUEUED-001"
destination_posture = "current"
...
success_focus_id = "FOCUS-APP-DEEP-LINK-INTAKE-QUEUED-001-SUCCESS"
success_focus_posture = "current"
failure_focus = "the Dismiss control and opaque recovery reason in Deep-link intake and resolution — Queued"
failure_focus_id = "FOCUS-APP-DEEP-LINK-INTAKE-QUEUED-001-FAILURE"
failure_focus_posture = "current"
commit_boundary = "Non-mutating: route resolution, retry, fallback, or dismissal completes without a canonical commit."
rollback_undo = "No Undo is required; cancellation preserves the last stable route, local canonical state, and any recoverable Capture input."
recovery_id = "RECOVERY-APP-DEEP-LINK-INTAKE-QUEUED-001"
recovery_posture = "current"
recovery_owner = "app.deep-linking.command-contract"
privacy_egress = "Resolution uses only allowlisted source metadata and opaque identifiers; rejected or locked targets disclose no protected identity or content."
verification_ids = ["SCENARIO-APP-DEEP-LINK-COMMAND-CONTRACT-001"]
...
destination_id = "DEST-APP-DEEP-LINK-INTAKE-RECOVERABLE-001"
destination_posture = "current"
...
success_focus_id = "FOCUS-APP-DEEP-LINK-INTAKE-RECOVERABLE-001-SUCCESS"
success_focus_posture = "current"
failure_focus = "the Dismiss control and opaque recovery reason in Deep-link intake and resolution — Recoverable"
failure_focus_id = "FOCUS-APP-DEEP-LINK-INTAKE-RECOVERABLE-001-FAILURE"
failure_focus_posture = "current"
commit_boundary = "Non-mutating: route resolution, retry, fallback, or dismissal completes without a canonical commit."
rollback_undo = "No Undo is required; cancellation preserves the last stable route, local canonical state, and any recoverable Capture input."
recovery_id = "RECOVERY-APP-DEEP-LINK-INTAKE-RECOVERABLE-001"
recovery_posture = "current"
recovery_owner = "app.deep-linking.command-contract"
privacy_egress = "Resolution uses only allowlisted source metadata and opaque identifiers; rejected or locked targets disclose no protected identity or content."
verification_ids = ["SCENARIO-APP-DEEP-LINK-COMMAND-CONTRACT-001"]
...
destination = "the allowlisted deep-link resolver for the interrupted request from Deep-link intake and resolution — Recoverable"
destination_id = "DEST-APP-DEEP-LINK-INTAKE-RECOVERABLE-002"
destination_posture = "current"
...
success_focus = "the safe destination heading after Recoverable"
success_focus_id = "FOCUS-APP-DEEP-LINK-INTAKE-RECOVERABLE-002-SUCCESS"
success_focus_posture = "current"
failure_focus = "the Try Again control and opaque recovery reason in Deep-link intake and resolution — Recoverable"
failure_focus_id = "FOCUS-APP-DEEP-LINK-INTAKE-RECOVERABLE-002-FAILURE"
failure_focus_posture = "current"
commit_boundary = "Non-mutating: route resolution, retry, fallback, or dismissal completes without a canonical commit."
rollback_undo = "No Undo is required; cancellation preserves the last stable route, local canonical state, and any recoverable Capture input."
recovery_id = "RECOVERY-APP-DEEP-LINK-INTAKE-RECOVERABLE-002"
recovery_posture = "current"
recovery_owner = "app.deep-linking.command-contract"
privacy_egress = "Resolution uses only allowlisted source metadata and opaque identifiers; rejected or locked targets disclose no protected identity or content."
verification_ids = ["SCENARIO-APP-DEEP-LINK-COMMAND-CONTRACT-001"]
...
destination_id = "DEST-APP-DEEP-LINK-INTAKE-REJECTED-001"
destination_posture = "current"
...
success_focus_id = "FOCUS-APP-DEEP-LINK-INTAKE-REJECTED-001-SUCCESS"
success_focus_posture = "current"
failure_focus = "the Dismiss control and opaque recovery reason in Deep-link intake and resolution — Rejected"
failure_focus_id = "FOCUS-APP-DEEP-LINK-INTAKE-REJECTED-001-FAILURE"
failure_focus_posture = "current"
commit_boundary = "Non-mutating: route resolution, retry, fallback, or dismissal completes without a canonical commit."
rollback_undo = "No Undo is required; cancellation preserves the last stable route, local canonical state, and any recoverable Capture input."
recovery_id = "RECOVERY-APP-DEEP-LINK-INTAKE-REJECTED-001"
recovery_posture = "current"
recovery_owner = "app.deep-linking.command-contract"
privacy_egress = "Resolution uses only allowlisted source metadata and opaque identifiers; rejected or locked targets disclose no protected identity or content."
verification_ids = ["SCENARIO-APP-DEEP-LINK-COMMAND-CONTRACT-001"]
...
destination_id = "DEST-APP-DEEP-LINK-INTAKE-REJECTED-002"
destination_posture = "current"
...
success_focus_id = "FOCUS-APP-DEEP-LINK-INTAKE-REJECTED-002-SUCCESS"
success_focus_posture = "current"
failure_focus = "the Unlock control and opaque authentication reason"
failure_focus_id = "FOCUS-APP-DEEP-LINK-INTAKE-REJECTED-002-FAILURE"
failure_focus_posture = "current"
...
recovery_id = "RECOVERY-APP-DEEP-LINK-INTAKE-REJECTED-002"
recovery_posture = "current"
recovery_owner = "app.deep-linking.command-contract"
...
destination_id = "DEST-APP-DEEP-LINK-INTAKE-REJECTED-003"
destination_posture = "current"
...
success_focus_id = "FOCUS-APP-DEEP-LINK-INTAKE-REJECTED-003-SUCCESS"
success_focus_posture = "current"
failure_focus = "the Update Ambitions control and safe unsupported-version reason"
failure_focus_id = "FOCUS-APP-DEEP-LINK-INTAKE-REJECTED-003-FAILURE"
failure_focus_posture = "current"
commit_boundary = "External-result: the external or protected-system result is revalidated before any separately authorized local command."
rollback_undo = "No Undo is required; cancellation or external failure preserves the prior verified local state."
recovery_id = "RECOVERY-APP-DEEP-LINK-INTAKE-REJECTED-003"
recovery_posture = "current"
recovery_owner = "app.deep-linking.command-contract"
...
destination_id = "DEST-APP-DEEP-LINK-INTAKE-RESOLVING-001"
destination_posture = "current"
effect = "No durable mutation occurs and no Receipt is created; Dismiss closes only the route request. It cannot consume, replay, reveal, or mutate the requested target, and recoverable Capture input remains locally preserved. Visible evidence remains: Ambitions is checking this link before anything opens or changes."
success_focus = "the safe destination heading after Resolving"
success_focus_id = "FOCUS-APP-DEEP-LINK-INTAKE-RESOLVING-001-SUCCESS"
success_focus_posture = "current"
failure_focus = "the Dismiss control and opaque recovery reason in Deep-link intake and resolution — Resolving"
failure_focus_id = "FOCUS-APP-DEEP-LINK-INTAKE-RESOLVING-001-FAILURE"
failure_focus_posture = "current"
commit_boundary = "Non-mutating: route resolution, retry, fallback, or dismissal completes without a canonical commit."
rollback_undo = "No Undo is required; cancellation preserves the last stable route, local canonical state, and any recoverable Capture input."
recovery_id = "RECOVERY-APP-DEEP-LINK-INTAKE-RESOLVING-001"
recovery_posture = "current"
recovery_owner = "app.deep-linking.command-contract"
privacy_egress = "Resolution uses only allowlisted source metadata and opaque identifiers; rejected or locked targets disclose no protected identity or content."
verification_ids = ["SCENARIO-APP-DEEP-LINK-COMMAND-CONTRACT-001"]
