...
canon_revision = 1
profile = "system-v1"
owns_concepts = ["system.privacy.classification", "system.privacy.egress-firewall"]
...
This shadow specification defines intended privacy controls and exhaustive egress law. It is not privacy/legal approval, current network proof, or release evidence.
