...
[Ambitions_2_0_Object_Terminology.md](Ambitions_2_0_Object_Terminology.md) locks the shared object language for D02 and later batches. It is the active reference for Task/Step, Life Area, North Star, Ritual, Receipt, Review, Archive, Waiting, Decision, and Memory terminology.
...
| --- | --- | --- | --- |
| D01 | Shell IA / Tab Alignment Delta | Design Constitution, current shell evidence | Completed |
| D02 | Shared Object Terminology Cleanup | D01 | Completed |
| D03 | GroupedNavigationList Component | shared component primitives | Completed |
...
| D06 | Smart Attachment Foundation | D02, D05, Command Pipeline, Capture | Completed |
| D07 | Life Areas Overview / Atlas Object Model | D02, Life Graph | Completed |
| D08 | North Stars / Dormant Ambitions Object Model | D07 | Completed |
| D09 | One-Step Goals Object Model | D02, D05 | Completed |
| D10 | Screen Contract Matrix Implementation Pass | D03-D09 | Completed |
| D11 | Today 2.0 Design Constitution Alignment | D04, D09-D10, Now State, Plan believability | Completed |
| D12 | Capture + Quiet Command Sheet Alignment | D06, D09-D10 | Completed |
| D13 | Goals / Life Areas / North Stars Transformation and Semantic Zoom | D07-D10 | Completed |
| D14 | Goal Detail Mission Control Lanes Alignment | D09-D10, D13 | Completed |
| D15 | Plan Believability + Timeline Widget Alignment | D05, D10, Reality Model | Completed |
| D16 | Ritual Split Alignment | D11, D15, You foundation | Completed |
| D17 | You Personal System Center Alignment | D03-D05, D10 | Completed |
...
| D22 | External Surfaces Contract Alignment | D05, D20-D21, Now State, Command Pipeline | Completed |
| D23 | Widgets Alignment | D22 | Completed |
| D24 | Live Activities Alignment | D22 | Completed |
| D25 | App Intents / Shortcuts Alignment | D22 | Completed |
| D26 | Release Candidate Validation | D01-D25 | Completed |

Do not mark any delta complete until its implementation, validation evidence, docs/status truth, and handoff are aligned. After D26 Release Candidate Validation, M01-M12 maturity work through Cross-Surface Continuity, Mode Lens, Mature Invention Performance, R01 Final Accessibility Verification and Claims Lock, R02 Final Performance, Memory, and Responsiveness Pass, R03 Device QA, TestFlight Readiness, and Scenario Review, and R04 App Store, Privacy, Marketing, and Investor Demo Readiness, the D01-D26 Design Constitution delta/alignment layer, Layer 2 maturity proof layers, and first four R-gates are complete for planning purposes; R05 is the next dependency-safe implementation batch under [POST_D26_MATURITY_ROADMAP.md](POST_D26_MATURITY_ROADMAP.md).

Roadmap merge audit note: [Ambitions_2_0_Roadmap_Merge_Audit.md](Ambitions_2_0_Roadmap_Merge_Audit.md) now explicitly maps Batches 89-120 against D01-D26. It preserves useful Batch 89-120 intent, and post-D26 execution now follows the M01-M12/R01-R05 sequence in [POST_D26_MATURITY_ROADMAP.md](POST_D26_MATURITY_ROADMAP.md) rather than running old Batch 89 directly.
