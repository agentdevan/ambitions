...
- `proof_attachment_detail` — Proof Attachment Detail — planned_canon — high_specificity — [proof_attachment_detail.md](docs/canon/frontend/recipes/today/proof_attachment_detail.md)
...
- `today_vacation_away_state` — Today Vacation / Away State — planned_canon — high_specificity — [today_vacation_away_state.md](docs/canon/frontend/recipes/today/today_vacation_away_state.md)
...
- `capture_dictation_state` — Capture Dictation State — planned_canon — high_specificity — [capture_dictation_state.md](docs/canon/frontend/recipes/capture/capture_dictation_state.md)
- `capture_attachment_proof_picker` — Capture Attachment / Proof Picker — planned_canon — high_specificity — [capture_attachment_proof_picker.md](docs/canon/frontend/recipes/capture/capture_attachment_proof_picker.md)
...
- `capture_offline_local_only_state` — Capture Offline Local-Only State — planned_canon — high_specificity — [capture_offline_local_only_state.md](docs/canon/frontend/recipes/capture/capture_offline_local_only_state.md)
- `capture_error_failed_attachment_state` — Capture Error / Failed Attachment State — planned_canon — high_specificity — [capture_error_failed_attachment_state.md](docs/canon/frontend/recipes/capture/capture_error_failed_attachment_state.md)
...
- `month_lifeshape_surface` — Month LifeShape Surface — planned_canon — high_specificity — [month_lifeshape_surface.md](docs/canon/frontend/recipes/time/month_lifeshape_surface.md)
...
- `vacation_away_time_entry` — Vacation / Away Time Entry — planned_canon — high_specificity — [vacation_away_time_entry.md](docs/canon/frontend/recipes/time/vacation_away_time_entry.md)
...
- `time_vacation_away_state` — Time Vacation / Away State — planned_canon — high_specificity — [time_vacation_away_state.md](docs/canon/frontend/recipes/time/time_vacation_away_state.md)
...
- `vacation_away_time` — Vacation / Away Time — planned_canon — high_specificity — [vacation_away_time.md](docs/canon/frontend/recipes/you/vacation_away_time.md)
...
- `you_offline_local_only_state` — You Offline Local-Only State — planned_canon — high_specificity — [you_offline_local_only_state.md](docs/canon/frontend/recipes/you/you_offline_local_only_state.md)
- `commitment_staging_tray` — Commitment Staging Tray — planned_canon — high_specificity — [commitment_staging_tray.md](docs/canon/frontend/recipes/cross_surface/commitment_staging_tray.md)
- `reflow_preview_tray` — Reflow Preview Tray — planned_canon — high_specificity — [reflow_preview_tray.md](docs/canon/frontend/recipes/cross_surface/reflow_preview_tray.md)
- `receipt_system` — Receipt System — planned_canon — high_specificity — [receipt_system.md](docs/canon/frontend/recipes/cross_surface/receipt_system.md)
- `closure_system` — Closure System — planned_canon — high_specificity — [closure_system.md](docs/canon/frontend/recipes/cross_surface/closure_system.md)
- `proof_trail_system` — Proof Trail System — planned_canon — high_specificity — [proof_trail_system.md](docs/canon/frontend/recipes/cross_surface/proof_trail_system.md)
- `recommendation_source_system` — Recommendation Source System — planned_canon — high_specificity — [recommendation_source_system.md](docs/canon/frontend/recipes/cross_surface/recommendation_source_system.md)
- `why_this_sheet` — Why This Sheet — planned_canon — high_specificity — [why_this_sheet.md](docs/canon/frontend/recipes/cross_surface/why_this_sheet.md)
- `source_freshness_badge` — Source Freshness Badge — planned_canon — high_specificity — [source_freshness_badge.md](docs/canon/frontend/recipes/cross_surface/source_freshness_badge.md)
- `still_counts_state` — Still Counts State — planned_canon — high_specificity — [still_counts_state.md](docs/canon/frontend/recipes/cross_surface/still_counts_state.md)
- `moved_state` — Moved State — planned_canon — high_specificity — [moved_state.md](docs/canon/frontend/recipes/cross_surface/moved_state.md)
- `skipped_not_needed_state` — Skipped / Not Needed State — planned_canon — high_specificity — [skipped_not_needed_state.md](docs/canon/frontend/recipes/cross_surface/skipped_not_needed_state.md)
- `blocked_state` — Blocked State — planned_canon — high_specificity — [blocked_state.md](docs/canon/frontend/recipes/cross_surface/blocked_state.md)
- `waiting_state` — Waiting State — planned_canon — high_specificity — [waiting_state.md](docs/canon/frontend/recipes/cross_surface/waiting_state.md)
- `needs_recovery_state` — Needs Recovery State — planned_canon — high_specificity — [needs_recovery_state.md](docs/canon/frontend/recipes/cross_surface/needs_recovery_state.md)
- `needs_review_state` — Needs Review State — planned_canon — high_specificity — [needs_review_state.md](docs/canon/frontend/recipes/cross_surface/needs_review_state.md)
- `protected_marker` — Protected Marker — planned_canon — high_specificity — [protected_marker.md](docs/canon/frontend/recipes/cross_surface/protected_marker.md)
- `pressure_marker` — Pressure Marker — planned_canon — high_specificity — [pressure_marker.md](docs/canon/frontend/recipes/cross_surface/pressure_marker.md)
- `best_fit_marker` — Best Fit Marker — planned_canon — high_specificity — [best_fit_marker.md](docs/canon/frontend/recipes/cross_surface/best_fit_marker.md)
- `open_marker` — Open Marker — planned_canon — high_specificity — [open_marker.md](docs/canon/frontend/recipes/cross_surface/open_marker.md)
- `primary_cta` — Primary CTA — planned_canon — high_specificity — [primary_cta.md](docs/canon/frontend/recipes/cross_surface/primary_cta.md)
- `secondary_cta` — Secondary CTA — planned_canon — high_specificity — [secondary_cta.md](docs/canon/frontend/recipes/cross_surface/secondary_cta.md)
- `destructive_cta` — Destructive CTA — planned_canon — high_specificity — [destructive_cta.md](docs/canon/frontend/recipes/cross_surface/destructive_cta.md)
- `disabled_cta` — Disabled CTA — planned_canon — high_specificity — [disabled_cta.md](docs/canon/frontend/recipes/cross_surface/disabled_cta.md)
- `chevron_disclosure_row` — Chevron / Disclosure Row — planned_canon — high_specificity — [chevron_disclosure_row.md](docs/canon/frontend/recipes/cross_surface/chevron_disclosure_row.md)
- `quietglass_wrapper` — QuietGlass Wrapper — planned_canon — high_specificity — [quietglass_wrapper.md](docs/canon/frontend/recipes/cross_surface/quietglass_wrapper.md)
- `graphiterecess_base` — GraphiteRecess Base — planned_canon — high_specificity — [graphiterecess_base.md](docs/canon/frontend/recipes/cross_surface/graphiterecess_base.md)
- `luminoustrace_state_line` — LuminousTrace State Line — planned_canon — high_specificity — [luminoustrace_state_line.md](docs/canon/frontend/recipes/cross_surface/luminoustrace_state_line.md)
- `celestialfield_semantic_layer` — CelestialField Semantic Layer — planned_canon — high_specificity — [celestialfield_semantic_layer.md](docs/canon/frontend/recipes/cross_surface/celestialfield_semantic_layer.md)
- `first_run_root` — First Run Root — planned_canon — high_specificity — [first_run_root.md](docs/canon/frontend/recipes/onboarding/first_run_root.md)
- `schedule_setup_prompt` — Schedule Setup Prompt — planned_canon — high_specificity — [schedule_setup_prompt.md](docs/canon/frontend/recipes/onboarding/schedule_setup_prompt.md)
- `planning_defaults_prompt` — Planning Defaults Prompt — planned_canon — high_specificity — [planning_defaults_prompt.md](docs/canon/frontend/recipes/onboarding/planning_defaults_prompt.md)
- `privacy_local_runtime_explanation` — Privacy / Local Runtime Explanation — planned_canon — high_specificity — [privacy_local_runtime_explanation.md](docs/canon/frontend/recipes/onboarding/privacy_local_runtime_explanation.md)
- `capture_first_use_prompt` — Capture First-Use Prompt — planned_canon — high_specificity — [capture_first_use_prompt.md](docs/canon/frontend/recipes/onboarding/capture_first_use_prompt.md)
- `goals_first_use_prompt` — Goals First-Use Prompt — planned_canon — high_specificity — [goals_first_use_prompt.md](docs/canon/frontend/recipes/onboarding/goals_first_use_prompt.md)
- `time_first_use_prompt` — Time First-Use Prompt — planned_canon — high_specificity — [time_first_use_prompt.md](docs/canon/frontend/recipes/onboarding/time_first_use_prompt.md)
- `today_first_use_state` — Today First-Use State — planned_canon — high_specificity — [today_first_use_state.md](docs/canon/frontend/recipes/onboarding/today_first_use_state.md)
