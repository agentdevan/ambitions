...
This surface contains Start Here, Recommended Step, current time anchor, Now / Next / Later, closure prompt, receipt shelf, upcoming commitments, blocked/waiting, recovery, stale-source, local-only/offline, protected-time, away/vacation states. The top-level visual hierarchy is `Reality Meridian` first, one primary next action second, source/trust/proof affordances third, and secondary metadata last.
...
Step Detail; Step Session; Recommendation Source Sheet; Closure Sheet; Receipt Detail; Proof Attachment Detail; Adjust Time / Reflow Preview; Blocked / Waiting Detail; Goal Thread Context; Local Runtime Source Detail.
