...
This surface contains life area map, selected life area, Ambition Graph, goal thread, proof trail, active goals, milestone, recommended step, blockers, alternate paths, commitments, identity direction, reflection and recovery states. The top-level visual hierarchy is `Constellation Atlas` first, one primary next action second, source/trust/proof affordances third, and secondary metadata last.
...
Life Area Detail; Goal Detail; Goal Thread Detail; Ambition Graph Detail; Commitment Detail; Proof Trail Detail; Proof Detail; Blocker Detail; Alternate Path Detail; Reflection / Recovery Detail; Recommended Step Context.
