...
This surface contains Day / Week / Month scope, day/week/month shape, open time, protected time, pressure, best fit, recovery/flex, time-fit source line, Why this?, Shape Day, Reflow Week, Shape Month, Review Pressure, preview-before-confirm, receipts. The top-level visual hierarchy is `LifeShape Field` first, one primary next action second, source/trust/proof affordances third, and secondary metadata last.
...
Day Detail; Week Detail; Month Detail; Reflow Preview; Pressure Review; Protected Time Detail; Best Fit Explanation; Schedule & Availability; Planning Defaults; Vacation / Away Time; Time Receipt Detail.
