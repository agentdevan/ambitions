...
- [Planned Batch Frontend Direction Inventory](trace/PLANNED_BATCH_FRONTEND_DIRECTION_INVENTORY.md)
...
## MRI and HBI Source Families

See [MRI/HBI Source Family Integration Map](MRI_HBI_FRONTEND_INTEGRATION_MAP.md) and [Source Family Extraction Ledger](trace/VISUAL_DIRECTION_SOURCE_FAMILY_EXTRACTION_LEDGER.md). MRI and HBI are source families and overlay inputs, not frontend objects, and they do not override active truth or live source.
