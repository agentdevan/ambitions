# Surface Recipe: Destination Tab Item

## Canon Status
intended_canon

## Surface ID
destination_tab_item
...
## Final Intended Role
Navigation chrome for the five active destinations: Today, Goals, Capture, Time, You. It preserves orientation without badges, scores, or a sixth destination.
...
- Transient receipt/source indicators
- Safe-area and gesture alternatives

## Region-by-Region Recipe

### Region 1: Destination orientation

- Purpose: Orient the user to the current object, destination, and state before any action is offered.
- Contains: Destination orientation; current Global App Shell state; origin context when this is a drill-down or transient surface.
...
### Region 2: Active object context

- Purpose: Show how Active object context changes the visible hierarchy, source/proof meaning, and available action for Destination Tab Item.
...
### Region 3: Five-destination navigation

- Purpose: Show how Five-destination navigation changes the visible hierarchy, source/proof meaning, and available action for Destination Tab Item.
- Contains: Global App Shell; related commitments, proof, source, state markers, labels, and disclosure paths appropriate to shell.
- Primitives: GraphiteRecess ground, LuminousTrace attachment, CelestialField only for semantic orientation, SF Symbols, chevrons, label system.
- Typography: SF-first semantic type; region label stays compact, object/action text gets hierarchy only when it owns the current decision.
- Spacing: Attached to the object it explains; dense native rhythm with enough separation to avoid card-stack equivalence.
...
### Region 4: Transient receipt/source indicators
...
### Region 5: Safe-area and gesture alternatives

- Purpose: Show how Safe-area and gesture alternatives changes the visible hierarchy, source/proof meaning, and available action for Destination Tab Item.
- Contains: Global App Shell; related commitments, proof, source, state markers, labels, and disclosure paths appropriate to shell.
- Primitives: GraphiteRecess ground, LuminousTrace attachment, CelestialField only for semantic orientation, SF Symbols, chevrons, label system.
- Typography: SF-first semantic type; region label stays compact, object/action text gets hierarchy only when it owns the current decision.
- Spacing: Attached to the object it explains; dense native rhythm with enough separation to avoid card-stack equivalence.
