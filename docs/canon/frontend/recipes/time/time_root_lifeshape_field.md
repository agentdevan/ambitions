...
## Relationship to MRI
MRI influences this surface through local fit, pressure, protected-time, source freshness, and consentful reflow recommendations. This is source-family direction only, not MRI runtime proof.

## Relationship to HBI
HBI influences this surface through baseline capacity, recurring pressure, recovery patterns, and source freshness comparison. This is source-family direction only, not HBI runtime proof.
