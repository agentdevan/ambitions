# Surface Recipe: Proof Trail System
...
- Typography: Use native iPhone semantic text hierarchy: compact region label, Proof Trail System title or state label, source/proof caption, and readable action text. Emphasis stays on the active Proof Trail System decision or inspected state.
- Spacing: Keep source, proof, CTA, and state notes visually attached to Proof Trail System, with tight native grouping, thumb-zone reach for actions, and enough separation to prevent equal-weight card stacking.
...
- CTAs: Use a visible primary command only when this region changes Proof Trail System; otherwise prefer named disclosure rows such as Why this?, View source, View receipt, Add proof, Undo, or Close.
...
- Contains: Source freshness, proof basis, receipt expectation, unresolved-direction note, or Why this? affordance for Proof Trail System.
...
## Object Inventory
Proof Trail System, plus any visible Receipt System, Closure System, Recommendation Source System, Proof Trail System, Commitment Staging Tray, Reflow Preview Tray, Personal Runtime, or source/proof objects referenced by this surface.

## Typography Recipe
Native iPhone semantic typography. The Proof Trail System title or active decision owns the strongest weight; explanatory source/proof text remains compact but readable. Dynamic Type must preserve Proof Trail System, the source/proof line, the primary command, and the recovery or cancel path.
...
- HBI: historical comparison, proof continuity, and recovery context where relevant.
