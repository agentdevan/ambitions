...
## Relationship to MRI
MRI influences this surface through route reveal, parsing uncertainty, local correction, and placement suggestions. This is source-family direction only, not MRI runtime proof.
