...
## Relationship to MRI
MRI influences this surface through recommendation source, correction visibility, and return-path clarity. This is source-family direction only, not MRI runtime proof.
