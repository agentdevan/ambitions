# Surface Recipe: Today Root / Reality Meridian
...
## Final Intended Role
The flagship daily orientation canvas. It keeps Reality Meridian anchored to the present, with Start Here, commitments, source freshness, proof, and recovery attached to one current-day object instead of a task list.

## User Perception
The user should immediately know what today is asking of them, why it fits now, and how to inspect source, proof, or recovery without shame.

## Why This Surface Exists
It exists so the Today root can show the current-day object, source basis, proof path, receipt path, and recovery path as one calm surface. The recipe defines visible hierarchy, state meaning, accessibility, and anti-drift expectations without claiming implementation proof.
...
- current context and source strip
- Start Here or active Step object
- Now / Next / Later continuity
- protected-time and commitment edge
- closure, recovery, proof, and receipt shelf
...
## Object Inventory
Reality Meridian, Start Here, Recommendation Source System, Receipt System, Proof Trail, Closure System, and any source/proof objects referenced by this surface.
...
Use plain Ambitions language: Start here, Why this?, Recommended step, Source, Receipt, Needs recovery, Protected, Waiting, Blocked, and local trust terms where relevant. Avoid AI confidence, model language, productivity scores, overdue/failure copy, motivational filler, and retired top-level destination phrasing.
...
This recipe is final-state design canon for Today Root / Reality Meridian in Today. It does not prove implementation or release readiness.

### Good / Bad Example

- Good: Today Root / Reality Meridian stays attached to Reality Meridian, with trust, proof, receipt, and recovery visible.
- Bad: Today Root / Reality Meridian turns into a generic productivity pattern or hides its trust seam.
...
- recipe path: docs/canon/frontend/recipes/today/today_root_reality_meridian.md
...
Today Root / Reality Meridian keeps its trust seam attached to Reality Meridian and Today.
...
Today Root / Reality Meridian exposes local runtime behavior as inspectable state, not hidden automation.
...
Today Root / Reality Meridian previews local reset or forget consequences before the user commits to them.
...
## Purpose
Today Root / Reality Meridian exists to make Today understandable through the Reality Meridian, not through a generic productivity screen.
Minimum specificity: the recipe must name today_root_reality_meridian, the user job, and the reason this surface owns that job.

## Surface Hierarchy
Today Root / Reality Meridian sits inside Today and is subordinate to the Reality Meridian; supporting surfaces must not outrank it.
...
Minimum specificity: if Today Root / Reality Meridian cannot show what Reality Meridian owns, the surface is not final-proof eligible.

## Label-Off Signature
With labels blurred, Today Root / Reality Meridian must still read as Reality Meridian through orientation rail, current state seam, source/proof edge, primary action shelf, and recovery return path.
...
## Visible Regions
Visible regions for Today Root / Reality Meridian: orientation rail, current state seam, source/proof edge, primary action shelf, and recovery return path.
...
Disclosure opens deeper source, proof, consequence, or correction detail for Today Root / Reality Meridian; it is never decorative navigation noise.
Minimum specificity: every chevron must have a visible label or accessibility meaning tied to Reality Meridian.

## Source / Trust Behavior
Source Link Status: linked. Today Root / Reality Meridian must show whether source is linked, intended-only, stale, unavailable, or local-only.
...
Minimum specificity: proof cannot be a detached feed, generic toast, or release claim for Today Root / Reality Meridian.

## Transaction Behavior
Transactions on Today Root / Reality Meridian require visible intent, preview when consequence matters, explicit commit, receipt, and undo or recovery.
...
## VoiceOver Order
VoiceOver Order: Today, Today Root / Reality Meridian, Reality Meridian, state, source status, proof or receipt status, primary action, correction path.
...
## Reduce Motion Behavior
Reduce Motion replaces movement in Today Root / Reality Meridian with static before/after labels, source summaries, receipt state, and recovery labels.
...
## Native iPhone Believability Requirements
Today Root / Reality Meridian must feel like a restrained native iPhone surface with thumb-reachable actions, semantic rows, sheets, and stable safe areas.
...
Source-family influence for Today Root / Reality Meridian: visual canon, accessibility, source/proof receipts, local trust, transaction, and Today object depth.
Minimum specificity: train references must explain behavior, not imply shipped SwiftUI implementation.

## Source Linkage
Source Link Status: linked. Implementation Proof Boundary: Not In Scope. Required gates: ia, object_depth, label_off, source_truth, proof_source_receipt, transaction, anti_generic, accessibility, native_believability.
...
## Implementation Proof Boundary
Implementation Proof Boundary: this recipe is final-state design canon for Today Root / Reality Meridian; it does not prove SwiftUI, device, release, or accessibility implementation.
Minimum specificity: proof requires source inspection, local validation, and release evidence outside this recipe.

## Unresolved Direction
Unresolved direction for Today Root / Reality Meridian: any missing implementation source remains linked debt and must stay visible until a scoped implementation batch lands.
...
Validator hint: fail Today Root / Reality Meridian if Reality Meridian can be replaced by a generic list, calendar, chat, settings, score, or dashboard surface.
...
Minimum specificity: Today Root / Reality Meridian may define design canon only and must not claim production readiness.

## Acceptance Checklist
Good example: one current-day object with source, proof, action, and recovery visibly attached.
Acceptance requires source linkage, proof boundary, VoiceOver/Dynamic Type/Reduce Motion coverage, primary action, correction path, and anti-generic checks for Today Root / Reality Meridian.

## P0 Proof Appendix
- Source Link Status: linked; Today Root / Reality Meridian must keep source status inspectable, including local-only and stale source states, and must not hide intended-only debt.
...
The proof appendix exists to prevent a false Green for Today Root / Reality Meridian. It records what can be claimed as design canon and what remains outside implementation proof.
...
Evidence note: Today Root / Reality Meridian must keep generated reports, source-link status, and Not In Scope implementation proof aligned before any Green claim.
If any report upgrades Today Root / Reality Meridian without this boundary, the validator must fail rather than convert intended canon into shipped behavior.

## P0 Canon Appendix
VoiceOver must announce Today, Today Root / Reality Meridian, Reality Meridian, state, Source, Proof, Receipt, Primary Action, and recovery in that order.
...
This appendix is canon authority for Today Root / Reality Meridian, not implementation proof, release proof, or an approval to alter top-level IA.
