...
| Path Builder remains maturity work | M07 | Medium | M05 added the qualitative path intelligence contract with source/freshness, proof, fallback, scenario, and daily handoff boundaries; M06 added broad domain packs and explainable fork comparison; M07 still owns the accessible long-range roadmap UI. |
