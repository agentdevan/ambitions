# Ambitions 4.0 Product Maturity And Onboarding Kernel
...
Product Maturity And Onboarding makes Ambitions understandable and valuable to real users without requiring them to understand the full life OS on day one. It turns setup into immediate life value.

## User Problem

Users need fast value and trust-building setup without pressure to expose sensitive life context.

## User-Visible Outcome

First-week paths guide first capture, first goal, planning defaults, privacy choices, and review rituals with skip/later recovery.

## Owned Primitives

- LifeFrictionOnboarding
- FirstWeekSuccessPath
- UserMaturityLevel
- ProgressiveDisclosureRule
- ConciergeSetupStep
- SetupCompletenessSignal
- LifeSeasonTemplate
- OnboardingReceipt
- EducationMoment
- SetupLaterAction
...
- setup progress without pressure
- guided first capture
- guided first goal
- guided planning defaults
- privacy setup walkthrough
- first-week path
- maturity mode selector
- life season template picker
- explain this screen
...
- first review ritual
- setup completeness
- user education receipt
- life season template
- overwhelm-safe onboarding
- skip / later paths
...
Primary owner: Onboarding, You setup, Capture first value, Plan defaults.
...
onboarding canon, setup receipts, first-week fixtures, You setup surfaces, Capture/Goal/Plan guided setup named by EB19-EB24.

## Forbidden Implementation Scope

forced account setup, forced sensitive disclosure, pressure copy, release-readiness claims, or onboarding that blocks core value when skipped.
