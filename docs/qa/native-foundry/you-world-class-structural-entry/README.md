...
Selected closure: `VC11-YOU-D02 — Personal Control Passage`

Native substrate: `VC11-YOU-D01 — Native Grouped Control List`

Accessibility transformation: `VC11-YOU-D06 — Explicit Adaptive Control Passage`
...
2. [You authority map](you-authority-map.md)
3. [Current capability ceiling](current-capability-ceiling.md)
4. [Fixture contract](fixture-contract.md)
5. [Research corpus](research-corpus.md)
6. [Benchmark matrix](benchmark-matrix.md)
7. [Benchmark matrix CSV](benchmark-matrix.csv)
8. [Pattern atlas](pattern-atlas.md)
9. [Market anti-patterns](market-anti-patterns.md)
10. [World-class You bar](world-class-you-bar.md)
11. [You intervention synthesis](you-intervention-synthesis.md)
12. [Six structural directions](six-structural-directions.md)
13. [Direction comparison](direction-comparison.md)
14. [Source register](source-register.md)
15. [Architecture-sensitive assumptions](architecture-sensitive-assumptions.md)
