...
| `foundation_search_finds_goals_steps_proof_life_capital_and_settings` | Search finds goals, Steps, proof, Life Capital, and settings. | Partial | `Native/Ambitions/Core/LocalRuntimeOS/Search/MemoryLensService.swift`, `Native/Ambitions/Projection/SurfaceLenses/YouFeatureServiceEverythingSearchProjection.swift`, `Native/AmbitionsTests/Runtime/P1FLocalSearchFoundationTests.swift` | First-class Life Capital and Future Steps search proof, rendered route/accessibility proof |
