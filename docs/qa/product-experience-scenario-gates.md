...
| Gate ID | User-visible behavior | Current status | Evidence path if found | Required future proof |
|---|---|---|---|---|
| `foundation_reminder_can_be_created_completed_and_rescheduled` | User can create, complete, and reschedule a reminder-like Step. | Partial | `Native/Ambitions/Core/LocalRuntimeOS/PlanningEngine/`, `Native/Ambitions/Core/LocalRuntimeOS/CommandSpine/CommandRouter.swift`, `Native/AmbitionsTests/Today/TodayCommandHandlerTests.swift`, `Native/AmbitionsTests/LocalRuntimeOS/TimeEngine/ProtectedStepPlacementPolicyTests.swift` | Full rendered reminder UI proof, accessibility proof, broader persistence/relaunch matrix |
| `foundation_recurring_step_repeats_and_can_be_paused` | Recurring Steps repeat and can be paused. | Partial | `Native/Ambitions/Core/LocalRuntimeOS/PlanningEngine/PlanningDomainModels.swift`, `Native/Ambitions/Core/Runtime/SimpleStepLifecycleService.swift`, `Native/AmbitionsTests/Runtime/RecurringStepLifecycleServiceTests.swift` | Rendered recurring Step UI test, accessibility proof, device/release proof, notification delivery proof if claimed |
...
| `foundation_search_finds_goals_steps_proof_life_capital_and_settings` | Search finds goals, Steps, proof, Life Capital, and settings. | Partial | `Native/Ambitions/Core/LocalRuntimeOS/SearchRecall/MemoryLensService.swift`, `Native/Ambitions/Projection/SurfaceLenses/YouFeatureServiceEverythingSearchProjection.swift`, `Native/AmbitionsTests/Runtime/P1FLocalSearchFoundationTests.swift` | First-class Life Capital and Future Steps search proof, rendered route/accessibility proof |
...
| `foundation_offline_core_runs_without_account` | Core app runs without account or network. | Partial | `docs/truth/IMPLEMENTATION_TRUTH.md`, `Native/Ambitions/Core/Persistence/`, `Native/Ambitions/Core/LocalRuntimeOS/TimeEngine/ProtectedStepPlacementPolicy.swift`, `Native/AmbitionsTests/Runtime/P1FLocalSearchFoundationTests.swift`, `Native/AmbitionsTests/Time/P1DTimeFoundationTests.swift`, `Native/AmbitionsTests/LocalRuntimeOS/TimeEngine/ProtectedStepPlacementPolicyTests.swift` | Network-disabled device workflow, no-account launch matrix, release evidence |
...
| `goal_without_deadline_generates_flexible_path` | Goal without deadline gets flexible path. | Partial | `Native/Ambitions/Core/LocalRuntimeOS/PlanningEngine/DeterministicGoalPlanner.swift` | Flexible scheduled path proof |
...
| `near_term_step_edits_normally` | Near-term Step edits normally. | Partial | `Native/Ambitions/Core/LocalRuntimeOS/CommandSpine/CommandRouter.swift` | Edit UI/runtime/persistence proof |
...
| Gate ID | User-visible behavior | Current status | Evidence path if found | Required future proof |
|---|---|---|---|---|
| `automatic_future_adjustment_occurs_only_where_allowed` | Automatic adjustment follows automation permissions. | Partial | `Native/Ambitions/Core/LocalRuntimeOS/TimeEngine/ProtectedStepPlacementPolicy.swift`, `Native/AmbitionsTests/LocalRuntimeOS/TimeEngine/ProtectedStepPlacementPolicyTests.swift` | Full automation settings policy, rendered review UI, receipt/relaunch proof |
| `automatic_adjustment_does_not_move_next_seven_days_silently` | Next seven days are not silently moved. | Partial | `Native/Ambitions/Core/LocalRuntimeOS/TimeEngine/ProtectedStepPlacementPolicy.swift`, `Native/Ambitions/Core/LocalRuntimeOS/CommandSpine/PolicyGuardedCommandExecutor.swift`, `Native/AmbitionsTests/LocalRuntimeOS/TimeEngine/ProtectedStepPlacementPolicyTests.swift`, `Native/AmbitionsTests/LocalRuntimeOS/CommandSpine/PolicyGuardedCommandExecutorTests.swift` | Rendered approval/review UI, accessibility proof, device/no-network proof |
| `user_caused_adjustment_shows_impact_summary` | User-caused adjustment shows impact summary. | Partial | `Native/Ambitions/Projection/SurfaceLenses/TimeReflowDecisionProjector.swift`, `Native/Ambitions/Core/LocalRuntimeOS/TimeEngine/ProtectedStepPlacementPolicy.swift`, `Native/AmbitionsTests/LocalRuntimeOS/TimeEngine/ProtectedStepPlacementPolicyTests.swift` | User-caused change UI, receipt proof, accessibility proof |
...
| Gate ID | User-visible behavior | Current status | Evidence path if found | Required future proof |
|---|---|---|---|---|
| `priority_supports_low_normal_high` | Priority supports Low, Normal, High. | Partial | `Native/Ambitions/Core/LocalRuntimeOS/CommandSpine/AmbitionsCommandTaxonomy.swift`; `Native/Ambitions/Core/LocalRuntimeOS/TimeEngine/PriorityPlacementPolicy.swift`; `Native/AmbitionsTests/LocalRuntimeOS/TimeEngine/PriorityPlacementPolicyTests.swift` | Rendered priority UI and accessibility proof |
...
| `priority_can_be_overridden_by_user` | User can override priority. | Partial | `Native/Ambitions/Core/LocalRuntimeOS/TimeEngine/PriorityPlacementPolicy.swift`; `Native/AmbitionsTests/LocalRuntimeOS/TimeEngine/PriorityPlacementPolicyTests.swift` | Rendered edit control, persistence/relaunch proof, and accessibility proof |
| `priority_does_not_include_must_fit_as_goal_type` | `Must Fit` is not a goal type. | Partial | `Native/Ambitions/Core/LocalRuntimeOS/TimeEngine/PriorityPlacementPolicy.swift`; `Native/AmbitionsTests/LocalRuntimeOS/TimeEngine/PriorityPlacementPolicyTests.swift`; vocabulary drift scan | Broader goal-type audit and rendered priority proof |
...
| `automation_respects_protected_near_term_placement` | Automation respects protected near-term placement. | Partial | `Native/Ambitions/Core/LocalRuntimeOS/TimeEngine/ProtectedStepPlacementPolicy.swift`, `Native/Ambitions/Core/LocalRuntimeOS/CommandSpine/PolicyGuardedCommandExecutor.swift`, `Native/AmbitionsTests/LocalRuntimeOS/TimeEngine/ProtectedStepPlacementPolicyTests.swift`, `Native/AmbitionsTests/LocalRuntimeOS/CommandSpine/PolicyGuardedCommandExecutorTests.swift` | Rendered review UI, receipt persistence, accessibility proof, device/no-network proof |
