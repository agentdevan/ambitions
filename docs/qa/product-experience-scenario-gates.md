...
| Gate ID | User-visible behavior | Current status | Evidence path if found | Required future proof |
|---|---|---|---|---|
| `priority_supports_low_normal_high` | Priority supports Low, Normal, High. | Partial | `Native/Ambitions/Core/LocalRuntimeOS/Commands/AmbitionsCommandTaxonomy.swift`; `Native/Ambitions/Core/LocalRuntimeOS/TimeEngine/PriorityPlacementPolicy.swift`; `Native/AmbitionsTests/LocalRuntimeOS/TimeEngine/PriorityPlacementPolicyTests.swift` | Rendered priority UI and accessibility proof |
...
| `automation_respects_protected_near_term_placement` | Automation respects protected near-term placement. | Partial | `Native/Ambitions/Core/LocalRuntimeOS/TimeEngine/ProtectedStepPlacementPolicy.swift`, `Native/Ambitions/Core/LocalRuntimeOS/Commands/PolicyGuardedCommandExecutor.swift`, `Native/AmbitionsTests/LocalRuntimeOS/TimeEngine/ProtectedStepPlacementPolicyTests.swift`, `Native/AmbitionsTests/LocalRuntimeOS/Commands/PolicyGuardedCommandExecutorTests.swift` | Rendered review UI, receipt persistence, accessibility proof, device/no-network proof |
