...
| `foundation_recurring_step_repeats_and_can_be_paused` | Recurring Steps repeat and can be paused. | Unknown | `Native/Ambitions/Core/Domain/Planning/PlanningDomainModels.swift` | Recurrence model, pause behavior, UI test, persistence/relaunch proof |
