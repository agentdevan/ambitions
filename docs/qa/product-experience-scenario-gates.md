...
| `user_caused_adjustment_shows_impact_summary` | User-caused adjustment shows impact summary. | Partial | `Native/Ambitions/Projection/SurfaceLenses/TimeReflowDecisionProjector.swift`, `Native/Ambitions/Core/LocalRuntimeOS/Scheduling/ProtectedStepPlacementPolicy.swift`, `Native/AmbitionsTests/LocalRuntimeOS/Scheduling/ProtectedStepPlacementPolicyTests.swift` | User-caused change UI, receipt proof, accessibility proof |
