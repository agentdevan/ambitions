...
- first complete UI batch: `test-without-building -resultBundlePath /tmp/R14FinalCompleteUI.xcresult` (90 tests, 9 stale-contract failures used as repair history).
- focused assertion-repair batch and returned-Today rerun using `/tmp/R14RepairFocusedUI.xcresult` and `/tmp/R14RepairReturnedUI2.xcresult`.
- final complete UI batch: `test-without-building -resultBundlePath /tmp/R14FinalCompleteUI-Green.xcresult` (90 tests, 0 failures).
