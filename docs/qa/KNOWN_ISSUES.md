...
| `AMB-ISSUE-1302` | Goals | **Source-repaired candidate / runtime proof pending** | AMB-1193 replaces the diagnostic Goals root with Life Area Atlas, full-screen Area Detail, and path/journal-first Goal Detail source; visual/device acceptance remains pending. | `IMG_8479`, `IMG_8480`, `IMG_8491`, `IMG_8498`, `IMG_8499`; tester notes; AMB-1193 source/test proof. | Goals root, area detail, goal detail, and creation-entry screenshot proof. |
