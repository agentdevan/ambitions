...
| --- | --- | --- | --- | --- | --- |
| public_benefits_reference | blocked | define_coverage_frontier | frontier_governance_review | `source-atlas-foundry frontier-intake --domain public_benefits_reference --review-required` | coverage_frontier_missing |
