...
| `bounded_production_r2_write` | yes | specific production stable education_credentialing R2 upload/readback proof |  |
| `bounded_live_native_transport` | yes | bounded production stable education_credentialing, occupation_foundation, public_civic_requirements Worker gateway and native URLSession/lifecycle proof |  |
| `bounded_production_target` | yes | specific production stable education_credentialing pack target |  |
