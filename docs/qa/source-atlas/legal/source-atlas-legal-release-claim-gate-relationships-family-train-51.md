...
| `bounded_production_r2_write` | yes | specific production stable relationships_family R2 upload/readback proof |  |
| `bounded_live_native_transport` | yes | bounded production stable business_entrepreneurship, creative_project_reference, education_credentialing, finance_public_reference, health_wellness_reference, hobbies_recreation, home_life_admin, occupation_foundation, personal_growth, public_civic_requirements, relationships_family, travel_relocation Worker gateway and native URLSession/lifecycle proof |  |
| `bounded_production_target` | yes | specific production stable relationships_family pack target |  |
