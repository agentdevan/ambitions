...
| `bounded_production_r2_write` | yes | specific production stable home_life_admin R2 upload/readback proof |  |
| `bounded_live_native_transport` | yes | bounded production stable business_entrepreneurship, education_credentialing, finance_public_reference, health_wellness_reference, hobbies_recreation, home_life_admin, occupation_foundation, public_civic_requirements, travel_relocation Worker gateway and native URLSession/lifecycle proof |  |
| `bounded_production_target` | yes | specific production stable home_life_admin pack target |  |
