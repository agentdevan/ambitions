...
| --- | --- | --- | --- | --- | --- | --- |
| `state.travel.public_travel` | approved_internal_terms_review | allowed | redistributable_with_attribution | r2_pack_allowed | not_claimed | 2026-12-28 |
| `usa.gov.change_address` | approved_internal_terms_review | allowed | redistributable_with_attribution | r2_pack_allowed | not_claimed | 2026-12-28 |
