...
| `bounded_production_r2_write` | yes | specific production stable travel_relocation R2 upload/readback proof |  |
| `bounded_live_native_transport` | yes | bounded production stable business_entrepreneurship, education_credentialing, health_wellness_reference, hobbies_recreation, occupation_foundation, public_civic_requirements, travel_relocation Worker gateway and native URLSession/lifecycle proof |  |
| `bounded_production_target` | yes | specific production stable travel_relocation pack target |  |
