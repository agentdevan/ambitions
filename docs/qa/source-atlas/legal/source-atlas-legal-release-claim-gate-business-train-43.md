...
| `bounded_production_r2_write` | yes | specific production stable business_entrepreneurship R2 upload/readback proof |  |
| `bounded_live_native_transport` | yes | bounded production stable business_entrepreneurship, education_credentialing, occupation_foundation, public_civic_requirements Worker gateway and native URLSession/lifecycle proof |  |
| `bounded_production_target` | yes | specific production stable business_entrepreneurship pack target |  |
