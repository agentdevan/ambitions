# F15-F16-F16.5 Legacy UI Architecture Train
...
Path: docs/codex/batch-trains/F15_F16_F16_5_Legacy_UI_Architecture_Train.md
Status: Active batch train manifest

## Purpose
Do not auto-continue unless migration map is exact; F16.5 required before F17 if state-contract risk remains.

## Train Type
Quality/Product Train, conservative
...
## Batch List
- F15 Legacy identifier migration
- F16 UI test modernization
- F16.5 conditional SwiftUI architecture/state contract hardening
...
## Final Report Path
`docs/audits/ambitions-3-0-f15-f16-f16-5-legacy-ui-architecture-train-report.md`
