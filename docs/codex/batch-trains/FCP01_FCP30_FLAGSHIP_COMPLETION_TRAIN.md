...
- habit/proof thread/trophy drift
- AI chatbot wrapper
...
Acceptance: Completed / Now / Friction / Next / Horizon preserved; no surface grid.
...
Acceptance: no automated reroute; no PM surface.
