# F07-F09 Capture Placement Train
...
Path: docs/codex/batch-trains/F07_F09_Capture_Placement_Train.md
Status: Active batch train manifest

## Purpose
Auto-continue on Green; stop on routing or object ownership ambiguity.

## Train Type
Standard/Product Train
...
## Batch List
- F07 Capture Composer cleanup
- F08 Placement Resolver
- F09 Capture-to-Goal / Grow into Goal
...
## Final Report Path
`docs/audits/ambitions-3-0-f07-f09-capture-placement-train-report.md`
