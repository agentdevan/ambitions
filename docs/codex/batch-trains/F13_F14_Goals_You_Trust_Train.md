# F13-F14 Goals You Trust Train

Path: docs/codex/batch-trains/F13_F14_Goals_You_Trust_Train.md
Status: Active batch train manifest

## Purpose
Auto-continue F13 to F14 only if Green and F13.5 trigger does not fire; stop on privacy/memory ambiguity.

## Train Type
Standard/Product Train with privacy gates
...
## Batch List
- F13 Goals / Goal Mission Control
- F13.5 conditional Goals / You / Trust architecture checkpoint
- F14 You / Trust / What Ambitions Knows
...
## Final Report Path
`docs/audits/ambitions-3-0-f13-f14-goals-you-trust-train-report.md`
