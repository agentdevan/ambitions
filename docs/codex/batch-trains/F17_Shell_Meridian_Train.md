...
Path: docs/codex/batch-trains/F17_Shell_Meridian_Train.md
Status: Active batch train manifest

## Purpose
No auto-implementation without explicit approval.
...
## Batch List
- F17 Shell / Meridian planning and possible feature-flagged implementation after explicit approval
...
## Final Report Path
`docs/audits/ambitions-3-0-f17-shell-meridian-train-report.md`
