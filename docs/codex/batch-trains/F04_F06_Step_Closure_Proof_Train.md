# F04-F06 Step Closure Proof Train
...
Path: docs/codex/batch-trains/F04_F06_Step_Closure_Proof_Train.md
Status: Active batch train manifest

## Purpose
Auto-continue F04 to F05 and F05 to F06 only on Green. No Plan/Capture/Goals/Shell work.
...
## Batch List
- F04 Step Session rename/migration and routing
- F05 Action Closure / Still Counts
- F06 Proof & Receipt Ledger
...
## Final Report Path
`docs/audits/ambitions-3-0-f04-f06-step-closure-proof-train-report.md`
