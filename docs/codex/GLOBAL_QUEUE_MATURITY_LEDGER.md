...
- PK04 Atomic Goal Creation is the next implementation batch unless a fresh hard blocker appears.
...
| --- | --- | --- |
| executable_now | PK04 | Active Platform Kernel work after PK03; PK04 is the next implementation batch, later PK stays serial/dependency gated. |
| executable_later | PK05, PK06, PK07, PK08, PK09, PK10, PK11, PK12, PK13, PK14, PK15, PK16, PK17, PK18, PK19, PK20, PK21, PK22, PK23, PK24, PK25, PK26, PK27, PK28, PK29, PK30, PK31, PK32, PK33, PK34, PK35, PK36, PK37, PK38, PK39, PK40, PK41, SA07, SA08, SA09, SA10, SA10A, SA10B, SA10C, SA11, SA12, SA13, SA14, SA15, SA16, SA17, SA18, SA19, SA20, SA21, SA22, SA23, SA24, SA25, SA26, SA27, SA28, SA29, SA30, SA31, SA32, LDI17, LDI18, LDI19, FCP27, FCP28, FCP29, FCP30, PFC31, PFC32, PFC33, PFC34, PFC35, PFC36, PFC37, PFC38, PFC39, PFC40, RHC01, RHC02, RHC03, RHC04, RHC05, RHC06 | Active Platform Kernel work after PK03; PK04 is the next implementation batch, later PK stays serial/dependency gated. |
...
| historical_complete_do_not_run | PX01, PX02, PX03, PX04, PX05, PX06, PX07, PX08, PX09, PX10, PX11, PX12, PX13, PX14, PX15, PX16, PX17, PX18, PX19, PX20 | PXOS/PX batches are complete future-canon and roadmap evidence; do not rerun as implementation batches. |

## Batch Details

| Batch | Title | Classification | Blocking prerequisites | EFC |
| --- | --- | --- | --- | --- |
| PK04 | Atomic Goal Creation | executable_now | None | invoked |
| PK05 | Atomic Clarification / Materialization | executable_later | Complete prior PK batch PK04 and any data-safety proof named by the PK train. | invoked |
| PK06 | Atomic Capture Promotion | executable_later | Complete prior PK batch PK05 and any data-safety proof named by the PK train. | invoked |
| PK07 | Storage Schema Version Ledger | executable_later | Complete prior PK batch PK06 and any data-safety proof named by the PK train. | invoked |
| PK08 | Migration Plan Scaffold | executable_later | Complete prior PK batch PK07 and any data-safety proof named by the PK train. | invoked |
| PK09 | Unknown Persisted Value Degradation | executable_later | Complete prior PK batch PK08 and any data-safety proof named by the PK train. | invoked |
| PK10 | Storage Invariant Checker | executable_later | Complete prior PK batch PK09 and any data-safety proof named by the PK train. | invoked |
| PK11 | Pre-Migration Backup | executable_later | Complete prior PK batch PK10 and any data-safety proof named by the PK train. | invoked |
| PK12 | Staged Portable Import Dry Run | executable_later | Complete prior PK batch PK11 and any data-safety proof named by the PK train. | invoked |
| PK13 | Restore Rollback | executable_later | Complete prior PK batch PK12 and any data-safety proof named by the PK train. | invoked |
| PK14 | Durable Command/Event Ledger | executable_later | Complete prior PK batch PK13 and any data-safety proof named by the PK train. | invoked |
