...
- historical_complete_do_not_run: 36
- deleted_obsolete: 0
...
| --- | --- | --- |
| executable_now | PFC33 | PFC32 is complete / Green; PFC33 is the next implementation batch. |
| executable_later | PK19, PK20, PK21, PK22, PK23, PK24, PK25, PK26, PK27, PK28, PK29, PK30, PK31, PK32, PK33, PK34, PK35, PK36, PK37, PK38, PK39, PK40, PK41, SA07, SA08, SA09, SA10, SA10A, SA10B, SA11, SA12, SA13, SA14, SA15, SA16, SA24, SA25, SA26, SA27, SA28, SA29, SA30, SA31, SA32, LDI17, LDI18, LDI19, PFC34, PFC35, PFC36, PFC37, PFC38, PFC39, PFC40, RHC01, RHC02, RHC03, RHC04, RHC05, RHC06 | Later queued records remain dependency-gated and must not bypass the active executable_now record. |
...
| FCP28 | Final Visual Proof Packet | historical_complete_do_not_run | Complete / Accepted Yellow in `docs/audits/fcp28-batch-closeout-report.md`; do not rerun through normal fallback. | invoked |
| FCP29 | Accessibility And Dynamic Type Closeout | historical_complete_do_not_run | Complete / Accepted Yellow in `docs/audits/fcp29-batch-closeout-report.md`; do not rerun through normal fallback. | invoked |
| FCP30 | Flagship Completion Handoff | historical_complete_do_not_run | Complete / Green in `docs/audits/fcp30-batch-closeout-report.md`; do not rerun through normal fallback. | invoked |
| PFC31 | Architecture Extraction Closeout | historical_complete_do_not_run | Complete / Green in `docs/audits/pfc31-batch-closeout-report.md`; do not rerun through normal fallback. | invoked |
| PFC32 | Build And Test Determinism Closeout | historical_complete_do_not_run | Complete / Green in `docs/audits/pfc32-batch-closeout-report.md`; do not rerun through normal fallback. | invoked |
| PFC33 | External Surface Release Evidence | executable_now | Relevant PK/FCP/FVQ/EFC proof and human/legal/device gates where named. | invoked |
