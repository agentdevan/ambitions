...
- Complete / accepted Yellow: PD05-PD08 are complete as bounded Goals
  ...
  or top-level IA.
- Queued / Blocked: PD09-PD18 pending each batch's predecessor, PXOS/ME/CS/SI/AOS-if-needed gates, and Product Depth continuation checks.
