...
| MEG01 Metal / Advanced Rendering Eligibility Gate | Queued | MEG01 is the next eligible global batch under the FVQ visual excellence train before PFC15. It must keep advanced rendering eligibility bounded and prevent Metal from masking weak product composition. |
