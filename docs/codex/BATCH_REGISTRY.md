...
- Queued / Blocked: SI03-SI18 pending global-order selection or `Start Signature Interface Train` plus PXOS/ME/CS/SI quality gates.
...
| SI01-SI18 Signature Interface Implementation Train | Active | SI01-SI02 complete; SI03-SI18 require global-order selection or `Start Signature Interface Train`, PXOS completion, relevant ME/CS gates, and SI visual quality gates. |
