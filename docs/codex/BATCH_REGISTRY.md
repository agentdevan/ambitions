...
| 19 | Ambitions 2.0 Batch 00 / Canon reset | Active | Docs/canon/control-file integration only: establish Ambitions 2.0 as the active canon program while preserving Ambitions 1.0 completion history through Batch 18. |
| 20 | Ambitions 2.0 Batch 01 / Knowledge provider boundary | Queued | Define provider, provenance, freshness, trust, and uncertainty contracts before retrieval-backed recommendations. |
| 21 | Ambitions 2.0 Batch 02 / External knowledge ingestion core | Queued | Ingest external knowledge through the provider boundary into auditable claim/resource structures. |
| 22 | Ambitions 2.0 Batch 03 / Clarification and ambiguity engine | Queued | Detect ambiguity in life goals and produce structured clarification needs. |
