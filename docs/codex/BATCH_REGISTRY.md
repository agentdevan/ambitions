...
| 25 | Ambitions 2.0 Batch 06 / Domain pack framework | Active | Add modular domain intelligence packs for compiler requirements, resources, risks, and readiness criteria. |
