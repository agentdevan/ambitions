...
| 20 | Ambitions 2.0 Batch 01 / Knowledge provider boundary | Active | Define provider, provenance, freshness, trust, and uncertainty contracts before retrieval-backed recommendations. |
