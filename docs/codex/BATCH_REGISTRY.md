...
- Active: SI01-SI18 Signature Interface Implementation Train; SI01-SI09 complete and SI10-SI18 queued/blocked.
...
- Queued / Blocked: SI10-SI18 pending global-order selection or `Start Signature Interface Train` plus PXOS/ME/CS/SI quality gates. LDI hooks are queued-only and do not rewrite SI01-SI09 history.
...
| SI01-SI18 Signature Interface Implementation Train | Active | SI01-SI09 complete; SI10-SI18 require global-order selection or `Start Signature Interface Train`, PXOS completion, relevant ME/CS gates, and SI visual quality gates. |
