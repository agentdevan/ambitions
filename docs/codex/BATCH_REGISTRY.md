...
| 24 | Ambitions 2.0 Batch 05 / Path compiler foundation | Active | Compile understood goals into staged path candidates with dependencies, assumptions, risks, and fallback branches. |
