...
| 23 | Ambitions 2.0 Batch 04 / Generalized goal understanding contracts | Active | Stabilize interpreted goal outputs for domains, constraints, readiness, risk, and missing information. |
