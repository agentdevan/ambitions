...
| 26 | Ambitions 2.0 Batch 07 / Resource graph and source ranking | Active | Connect path stages to ranked resources and source entities with auditable trust/provenance signals. |
