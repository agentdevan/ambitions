...
| Visual Quality Gate | User-facing UI | Premium native object identity. | Screenshot/manual proof deferred with owner. | Generic/slop UI, dashboard drift, fake polish. |
