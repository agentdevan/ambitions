...
| MTX | Model Tier Execution | Splits Mini execution from Senior judgment, routes batch families, records Mini-to-Senior deferrals, and blocks lower-tier Green claims for proof-sensitive gates. | `docs/codex/MODEL_TIER_EXECUTION_POLICY.md`, `docs/codex/MODEL_TIER_BATCH_MATRIX.md`, `docs/codex/MODEL_TIER_DEFERRAL_LEDGER.md`, `docs/codex/RESUME_MINI_GLOBAL_BATCH_TRAIN.md`, `docs/codex/RESUME_SENIOR_GLOBAL_BATCH_TRAIN.md` |
...
12. `docs/codex/MODEL_TIER_BATCH_MATRIX.md` when classifying remaining batch families for Mini/Senior routing.
13. `docs/codex/MODEL_TIER_DEFERRAL_LEDGER.md` when the run is Mini-tier, Senior-tier, unknown-tier, closeout-oriented, or resolving deferred batches.
...
- When using Mini-tier or unknown-tier execution, follow MTX: Mini may execute bounded batches, must use the batch matrix, must defer non-blocking senior-only gates, and must stop on blocking senior-only prerequisites.
...
- Model tier batch matrix: `docs/codex/MODEL_TIER_BATCH_MATRIX.md`
