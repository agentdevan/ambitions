# F17 Shell Meridian Planning Prompt
...
Path: docs/codex/BATCH_F17_SHELL_MERIDIAN_PLANNING_PROMPT.md
...
Purpose: prepare F17 as planning/readiness only. Architecture Train. No implementation unless explicitly approved after planning. Include shell readiness audit, navigation/routing risk, accessibility fallback, feature flag, rollback, one-tap destination proof, deep-link safety, App Intent/widget implications, and route stability review. Forbidden by default: shell replacement, fallback removal, hidden navigation puzzle, breaking canonical destinations, workflow changes, runtime dependencies.
