# F13-F14 Goals You Trust Train Runner
...
Path: docs/codex/BATCH_TRAIN_F13_F14_PROMPT.md
...
Manifest: docs/codex/batch-trains/F13_F14_Goals_You_Trust_Train.md. Prerequisites: Goal Mission Control canon current, Evidence/Proof/Trust boundaries known, privacy/memory consent model current. F13 owns Goal Mission Control foundation; F13.5 owns checkpoint if triggered; F14 owns You/Trust/What Ambitions Knows. Stop on privacy/memory ambiguity.
