...
- PXOS/user-facing: Docs/protocol gates plus PXOS Product Experience, PXEQ Product Experience Equivalence, Top-Level Composition, Product Depth when relevant, Accessibility, Copy, Visual, Trust/Proof.
