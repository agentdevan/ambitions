...
- CS/compatibility: Source Truth, Scope, CS, Profile/You Compatibility when CS02 is active, Insights/Plan Compatibility when CS03 is active, Test Strength, Release Claim Safety if external, Rollback.
