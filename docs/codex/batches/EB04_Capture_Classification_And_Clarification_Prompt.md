# EB04 Capture Classification And Clarification Prompt
...
- Batch ID: EB04
- Name: Capture Classification And Clarification
- Global order after EB insertion: 050
...
Advance Capture Classification And Clarification inside the EB train with exact ownership, evidence, privacy, accessibility, and no-overwrite controls. Implementation allowed later for classification and one-question clarification only.
...
May claim only EB04 evidence after validation and commit.
...
`Run EB04 Capture Classification And Clarification`
