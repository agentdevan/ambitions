# AOS18 Evaluation Golden Scenarios Prompt
...
LDI hook: Evaluation should map the 45 LDI red-team fixture families and abuse-resistance gates.
...
Stop on Red, missing predecessor gate, dirty target files owned by someone else, unclear owner, untrusted validation, missing rollback path, release-claim ambiguity, privacy ambiguity, or a request to broaden beyond AOS18.
...
`Run AOS18 Evaluation Golden Scenarios`
