...
- advanced later core: Path Preview Drawer
## Start Gate
...
- Path Preview Drawer implementation after first-layer Goal Detail path systems are stable
...
- Path Preview Drawer must remain subordinate to Path Filmstrip and next-step truth; it is a shallow future reveal, not a replacement for full-path structure
## Exit Criteria
