# SI12 Interaction Motion Haptics System Prompt
...
- Batch ID: SI12
- Title: Interaction Motion Haptics System
- Train: SI01-SI18 Signature Interface Implementation Train
- Global order after SI insertion: 059
...
Build interaction behavior for SI primitives.
...
- New dependencies
- decorative animation-only work
- route/raw changes
- persistence
- .github/workflows/**
...
Motion tokens, transition helpers, haptic mapping notes, reduced-motion switches.
...
No decorative motion or gamified feedback loops.
...
rg -n "SI12|Interaction Motion Haptics System|Signature Interface|release ready|App Store ready|TestFlight ready" README.md docs .codex Native Sources AppUI || true
~~~

Strong build/tests, motion scan, Reduce Motion proof.

## Preview And Visual Evidence

Preview/report motion enabled and disabled state transitions.

Do not claim human visual approval unless a human actually approves. Do not claim physical-device proof unless performed.

## Green Criteria

- Scope completed exactly for SI12.
...
Rollback by reverting the SI12 commit. Repair Red by narrowing scope, restoring boundaries, adding missing evidence, splitting oversized files, or stopping with a Red repair report. Do not weaken product canon, tests, accessibility, compatibility, release truth, or SI gates.

## Claims

This batch may claim only the SI12 scope completed after validation, evidence, commit, and push.
...
Run SI12 Interaction Motion Haptics System
