...
Advance Visual Interaction System for PXOS without implementing app behavior
...
- Document forbidden visual patterns: repeated same-size card stacks, surface
