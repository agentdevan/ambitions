...
Objective: AmbitionsOS Canon And Runtime Contract.
Owning kernel: Governance / Runtime.
Affected surface: all.
Precondition: blocks all AOS work.
Boundary: no implementation; canon/runtime contract only.
