# EB01 External Brain Source Truth And Kernel Architecture Prompt
...
- Batch ID: EB01
- Name: External Brain Source Truth And Kernel Architecture
- Global order after EB insertion: 047
...
Advance External Brain Source Truth And Kernel Architecture inside the EB train with exact ownership, evidence, privacy, accessibility, and no-overwrite controls. Docs/canon; no production implementation is allowed because EB01 establishes source truth and gates.
...
- docs/canon docs/codex .codex only
...
May claim only EB01 evidence after validation and commit.
...
`Run EB01 External Brain Source Truth And Kernel Architecture`
