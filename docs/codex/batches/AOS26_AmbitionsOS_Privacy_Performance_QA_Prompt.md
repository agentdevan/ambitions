...
Objective: AmbitionsOS Privacy Performance QA.
Owning kernel: Evaluation.
Affected surface: all.
Precondition: depends on AOS16, AOS17, AOS18, and AOS25.
Boundary: privacy/performance proof.
