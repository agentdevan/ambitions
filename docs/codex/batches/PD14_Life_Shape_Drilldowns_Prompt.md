# PD14 Life Shape Drill-Downs Prompt
...
Make Month/Life Shape more than a calendar grid.

## Product Depth Ownership

Owns: Life areas; pressure weeks; milestones; protected time; free-time bands; recovery space; commitment load; long-range rhythm.
...
- PX05/PX10/PX12 Green
- ME Plan/PlanScreen gates Green
- Visual quality gate Green
...
- Life Shape communicates rhythm, pressure, recovery, and milestones rather than just events.
- Calendar-like views remain explanatory and Ambitions-owned.
- Heatmaps or dense visuals include text/non-visual explanation.
- Plan owner files pass ME gates before expansion.
...
It may claim only the completed, validated scope of `PD14` after evidence and commit.
...
`Run PD14 Life Shape Drill-Downs`
