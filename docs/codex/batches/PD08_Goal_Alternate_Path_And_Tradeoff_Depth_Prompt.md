# PD08 Goal Alternate Path and Tradeoff Depth Prompt
...
- Batch ID: `PD08`
- Name: Goal Alternate Path and Tradeoff Depth
- Train: Product Depth
- Type: Implementation
- Primary surface ownership: Goals
- Required approval phrase: `Start Product Depth Train`

## Purpose

Make goal pivots and alternate routes visible without creating overwhelm.

## Product Depth Ownership

Owns: Alternate path cards/lanes; tradeoff explanations; effort/time/energy comparison; blocked path recovery; user-owned route selection.
...
- PX03/PX15 Green
- AOS Alternate Path dependency if runtime logic touched
- No fake certainty
- No automated reroute without user review
...
- Automated reroute without review
- Confidence theater
- Overwhelming card wall
- .github/workflows/**
...
- Alternate path cards/lanes
- tradeoff explanations
- effort/time/energy comparison
- blocked path recovery
- user-owned route selection.

## Batch-Specific Acceptance Criteria

- Alternate routes explain tradeoffs without fake certainty.
- User review is required before route selection changes the plan.
- Blocked path recovery is visible and humane.
- AOS alternate-path runtime logic is blocked unless gates are Green.
...
It may claim only the completed, validated scope of `PD08` after evidence and commit.
...
`Run PD08 Goal Alternate Path and Tradeoff Depth`
