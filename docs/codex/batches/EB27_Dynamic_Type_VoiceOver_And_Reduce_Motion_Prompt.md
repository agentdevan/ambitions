# EB27 Dynamic Type VoiceOver And Reduce Motion Prompt
...
- Batch ID: EB27
- Name: Dynamic Type VoiceOver And Reduce Motion
...
Advance Dynamic Type VoiceOver And Reduce Motion inside the EB train with exact ownership, evidence, privacy, accessibility, and no-overwrite controls. Implementation allowed later for Dynamic Type, VoiceOver, and Reduce Motion evidence only.
...
- UI/accessibility/tests/previews when gate opens
...
May claim only EB27 evidence after validation and commit.
...
`Run EB27 Dynamic Type VoiceOver And Reduce Motion`
