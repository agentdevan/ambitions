# PD09 Capture Placement Review Prompt
...
Make captured thoughts easy to place without turning Capture into an inbox.

## Product Depth Ownership

Owns: Needs a Place; Ready to Place; captured item review; placement suggestions; user confirmation; discard/archive; privacy handling.
...
- PX04 Green
- PX13 edge states Green
- Privacy gate Green
- ME Capture owner check if implementation touches existing capture files
...
- Inbox/feed top level
- Silent placement
- New Capture tab variant
- .github/workflows/**
...
- Top-level Capture remains ultra-minimal.
- No feed or normal scrolling appears by default on Capture top level.
- Placement suggestions require user confirmation.
- Privacy handling is explicit for sensitive captures.
...
It may claim only the completed, validated scope of `PD09` after evidence and commit.
...
`Run PD09 Capture Placement Review`
