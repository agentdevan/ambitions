# PD06 Goal Lifecycle and Path Visualization Prompt
...
- Batch ID: `PD06`
- Name: Goal Lifecycle and Path Visualization
- Train: Product Depth
- Type: Implementation
...
Make a goal feel visually alive.

## Product Depth Ownership

Owns: Lifecycle rail; current position; progress shape; next milestone; proof markers; risk markers; alternate route indicators.
...
- PD05 Green
- PXOS top-level/drill-down composition gates Green
- Visual quality gate Green
- Accessibility non-visual equivalent
...
- proof markers
- risk markers
- alternate route indicators.

## Batch-Specific Acceptance Criteria

- Path, progress, proof, risk, and next step are understandable before dense text.
- Visual markers have non-visual equivalents.
- Lifecycle visualization does not become fake precision or productivity scoring.
- The top-level Goals surface remains orientation-first.
...
It may claim only the completed, validated scope of `PD06` after evidence and commit.
...
`Run PD06 Goal Lifecycle and Path Visualization`
