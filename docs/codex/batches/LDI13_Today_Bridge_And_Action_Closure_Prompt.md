# LDI13 Today Bridge And Action Closure Prompt
...
- Batch ID: LDI13
- Title: Today Bridge And Action Closure
...
Maps living plans into Today steps and closure states.
...
Boundary: 1-3 useful next steps, proof/source/review steps, closure states.
...
Implement only the smallest usable slice that advances Today Bridge And Action Closure. Any runtime behavior must be deterministic, local-first, evidence-producing, and compatible with Ambitions' five destination IA.
...
`Run LDI13 Today Bridge And Action Closure`

## Next Safe Prompt / Next Gate

After Green or accepted Yellow, ask global train for the next eligible batch. Expected next gate: LDI14.
