# SI08 LifeShape Time Capacity Map Prompt
...
- Batch ID: SI08
- Title: LifeShape Time Capacity Map
- Train: SI01-SI18 Signature Interface Implementation Train
- Global order after SI insertion: 055
...
Build Plan time/capacity/pressure primitive.
...
LifeShapeMap, time band, pressure marker, recovery marker, milestone overlay.

Likely owner families: Native/Ambitions/Features/Plan/**; Sources/Components/**; Sources/Previews/**; Native/AmbitionsTests/**; docs/audits/**. Any actual owner change must be named in the batch report before edits.

## Interaction Requirements

Scope changes, pressure reveal, band selection, reduced-motion equivalents.

Motion must orient, confirm, or reduce uncertainty. Haptics must be system-native and optional.

## Accessibility Requirements

Non-color pressure meaning, VoiceOver shape summary, Dynamic Type legends.

No icon-only meaning, no color-only meaning, no private content leak, and no Dynamic Type collapse.

## Visual Acceptance Criteria

Plan feels like a shaping surface.
...
No calendar-clone grid default and no silent reflow.
...
Strong Plan tests/build, SI scans, accessibility and visual proof.

## Preview And Visual Evidence

Preview low capacity, protected time, overloaded day, denied source, stale data.

Do not claim human visual approval unless a human actually approves. Do not claim physical-device proof unless performed.

## Green Criteria

- Scope completed exactly for SI08.
...
Rollback by reverting the SI08 commit. Repair Red by narrowing scope, restoring boundaries, adding missing evidence, splitting oversized files, or stopping with a Red repair report. Do not weaken product canon, tests, accessibility, compatibility, release truth, or SI gates.

## Claims

This batch may claim only the SI08 scope completed after validation, evidence, commit, and push.
...
Run SI08 LifeShape Time Capacity Map
