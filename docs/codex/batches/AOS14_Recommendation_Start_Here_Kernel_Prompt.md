...
Objective: Recommendation Start Here Kernel.
Owning kernel: Recommendation.
Affected surface: Today.
Precondition: depends on AOS04, AOS12, and AOS13.
Boundary: recommendation kernel.
