# ME06 ProfileScreen You Surface Extraction Prompt
...
- Batch ID: `ME06`
- Name: ProfileScreen You Surface Extraction
- Mode: extraction only
- Owner file or files: `Native/Ambitions/Features/Profile/ProfileScreen.swift`
- Extraction target: Extract You/Profile surface sections while preserving user-facing You naming.
...
- `git rev-parse HEAD`
- `git log -1 --oneline`
- `wc -l Native/Ambitions/Features/Profile/ProfileScreen.swift` when the owner path is concrete
- `rg -n "TODO|compat|route|accessibilityIdentifier|Start here|What Ambitions Knows|failed|Profile|You" Native/Ambitions/Features/Profile/ProfileScreen.swift || true` when the owner path is concrete
...
`Run ME06 ProfileScreen You Surface Extraction`
