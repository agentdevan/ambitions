...
Objective: Local Language Kernel Planning.
Owning kernel: Local Language.
Affected surface: Capture/You.
Precondition: depends on AOS04, AOS13, AOS14, and deterministic fallback.
Boundary: planning only until fallback.
