# EB03 Universal Capture Composer And Routing Prompt
...
- Batch ID: EB03
- Name: Universal Capture Composer And Routing
- Global order after EB insertion: 049
...
Advance Universal Capture Composer And Routing inside the EB train with exact ownership, evidence, privacy, accessibility, and no-overwrite controls. Implementation allowed later inside Capture composer/routing only after EB13 and EB25 gates.
...
- Native/Ambitions/Features/Captures Native/Ambitions/Domain tests docs when gate opens
- docs/audits/** for this batch report
- .codex/reports/** for run-state evidence

## Forbidden Files

- Files outside the named allowed families; .github/workflows/**; dependencies; lockfiles; signing; App Store/TestFlight files; unrelated production Swift; route/raw/persistence/accessibility identifier changes unless this prompt names the exact owner and validation lane.
...
May claim only EB03 evidence after validation and commit.
...
`Run EB03 Universal Capture Composer And Routing`
