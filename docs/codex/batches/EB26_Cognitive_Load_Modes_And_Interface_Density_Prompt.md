# EB26 Cognitive Load Modes And Interface Density Prompt
...
- Batch ID: EB26
- Name: Cognitive Load Modes And Interface Density
...
Advance Cognitive Load Modes And Interface Density inside the EB train with exact ownership, evidence, privacy, accessibility, and no-overwrite controls. Implementation allowed later for cognitive load modes and density only.
...
- UI/settings/domain/tests when gate opens
...
May claim only EB26 evidence after validation and commit.
...
`Run EB26 Cognitive Load Modes And Interface Density`
