...
Objective: Performance Energy Kernel.
Owning kernel: Performance Energy.
Affected surface: all.
Precondition: must be active before runtime-heavy implementation.
Boundary: budgets before runtime-heavy work.
