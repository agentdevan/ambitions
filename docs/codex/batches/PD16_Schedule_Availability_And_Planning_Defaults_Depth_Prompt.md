# PD16 Schedule, Availability, and Planning Defaults Depth Prompt
...
- Batch ID: `PD16`
- Name: Schedule, Availability, and Planning Defaults Depth
- Train: Product Depth
- Type: Implementation
- Primary surface ownership: You
- Required approval phrase: `Start Product Depth Train`

## Purpose

Make setup/preferences clearly useful to planning and recommendations.

## Product Depth Ownership

Owns: Schedule & Availability; Planning Defaults; Vacation / Away Time; Automation & Trust; setup completeness; why setup matters; per-vacation override; Guided automation default.
...
- PX06/PX11 Green
- REC release-claim guard Green
- Privacy/permission copy gate Green
- No unsupported calendar/reminder integration claims
...
- Unsupported calendar/reminder claim
- Onboarding permission grab
- Silent automation
- .github/workflows/**
...
- setup completeness
- why setup matters
- per-vacation override
- Guided automation default.

## Batch-Specific Acceptance Criteria

- Setup explains why each preference matters without pressuring completion.
- No unsupported calendar/reminder integration claim appears.
- Permission and privacy copy is explicit and Plan-owned where calendar access is relevant.
...
It may claim only the completed, validated scope of `PD16` after evidence and commit.
...
`Run PD16 Schedule, Availability, and Planning Defaults Depth`
...
LDI hook: You depth may prepare source packs, sync/archive, privacy controls, plan mutation permissions, data vault settings, and continuity controls after owned gates.
