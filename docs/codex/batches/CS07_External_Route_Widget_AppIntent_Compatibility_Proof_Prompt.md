# CS07 External Route Widget AppIntent Compatibility Proof Prompt
...
- Batch ID: `CS07`
- Name: External Route Widget AppIntent Compatibility Proof
- Compatibility action: proves
- Candidate seam: external routes, widget payloads, App Intent/Shortcut payloads
- Target: Prove external compatibility; no deletion.
...
`Run CS07 External Route Widget AppIntent Compatibility Proof`
