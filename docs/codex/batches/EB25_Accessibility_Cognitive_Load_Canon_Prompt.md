# EB25 Accessibility Cognitive Load Canon Prompt
...
- Batch ID: EB25
- Name: Accessibility Cognitive Load Canon
...
Advance Accessibility Cognitive Load Canon inside the EB train with exact ownership, evidence, privacy, accessibility, and no-overwrite controls. Docs/canon; no production implementation is allowed because EB25 establishes accessibility gates.
...
May claim only EB25 evidence after validation and commit.
...
`Run EB25 Accessibility Cognitive Load Canon`
