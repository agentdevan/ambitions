# PD12 Plan Reflow Decision Depth Prompt
...
- Batch ID: `PD12`
- Name: Plan Reflow Decision Depth
- Train: Product Depth
- Type: Implementation
...
Make plan changes understandable and user-owned.

## Product Depth Ownership

Owns: Reflow suggestion detail; what changed; why it changed; impacted steps; capacity impact; protected time impact; accept/edit/decline.
...
- PX05 Green
- PX07/PX08 recovery/trust gates Green
- AOS Reality Drift/Commitment Time if runtime logic touched
...
- Silent calendar clone behavior
- Forced automation
- Dense event card stack
- .github/workflows/**
...
- No silent rearrangement.
- Every reflow suggestion names what changed, why, and what is impacted.
- Accept/edit/decline are available where meaningful.
- AOS reality/commitment runtime logic is blocked unless gates are Green.
...
It may claim only the completed, validated scope of `PD12` after evidence and commit.
...
`Run PD12 Plan Reflow Decision Depth`
