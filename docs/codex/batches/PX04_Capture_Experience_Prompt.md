...
Advance Capture Experience for PXOS without implementing app behavior or inventing product
...
- Name empty, ambiguous, needs review-save, and offline capture states.
