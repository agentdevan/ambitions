...
- later core: Object-Persistent Navigation
## Start Gate
...
- Path Preview Drawer after Semantic Zoom for Goals, Path Filmstrip, and first-layer Goal Detail composition are stable
