# AOS07 Local Goal Packs Requirement Slots Prompt
...
LDI hook: Local Goal Packs should map Pack Registry, Pack Compiler, quality states, draft/generated/reviewed boundaries, and no executable logic.
...
- `git rev-parse HEAD`
- `git log -1 --oneline`
- `rg -n "AOS07|Goal Path Kernel|AmbitionsOS|release ready|App Store ready|TestFlight ready" docs .codex Native README.md AGENTS.md || true`
...
Stop on Red, missing predecessor gate, dirty target files owned by someone else, unclear owner, untrusted validation, missing rollback path, release-claim ambiguity, privacy ambiguity, or a request to broaden beyond AOS07.
...
`Run AOS07 Local Goal Packs Requirement Slots`
