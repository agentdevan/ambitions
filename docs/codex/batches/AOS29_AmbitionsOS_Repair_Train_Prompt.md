...
Objective: AmbitionsOS Repair Train.
Owning kernel: Governance.
Affected surface: repair.
Precondition: runs only after failed/Yellow AOS gates are classified.
Boundary: only after Yellow/failed gates.
