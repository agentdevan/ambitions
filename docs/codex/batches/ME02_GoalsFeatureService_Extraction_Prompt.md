...
- Batch ID: `ME02`
- Name: GoalsFeatureService Extraction
...
- `git rev-parse HEAD`
- `git log -1 --oneline`
- `wc -l Native/Ambitions/Features/Goals/GoalsFeatureService.swift` when the owner path is concrete
- `rg -n "TODO|compat|route|accessibilityIdentifier|Start here|What Ambitions Knows|failed|Profile|You" Native/Ambitions/Features/Goals/GoalsFeatureService.swift || true` when the owner path is concrete
...
`Run ME02 GoalsFeatureService Extraction`
