# PD11 Grow Into Goal Flow Prompt
...
- Batch ID: `PD11`
- Name: Grow Into Goal Flow
- Train: Product Depth
- Type: Implementation
- Primary surface ownership: Capture / Goals
- Required approval phrase: `Start Product Depth Train`

## Purpose

Turn meaningful captured ideas into goals through a calm, guided path.

## Product Depth Ownership

Owns: Grow into Goal flow; goal seed review; why this might be a goal; starting position; first milestone; first recommended step; proof/source seed; confirmation before promotion.
...
- PD09/PD10 Green
- PX03/PX04/PX15 Green
- AOS Goal Path/Starting Position if runtime logic touched
- No automatic goal creation without user confirmation
...
- Generic project template wizard
- Pressure copy
- .github/workflows/**
...
- Promotion from capture to goal requires explicit confirmation.
- The flow explains why the item might be a goal without pressure.
- Starting position, first milestone, and first step are bounded and editable.
- Capture and Goals route compatibility is checked before navigation changes.
...
It may claim only the completed, validated scope of `PD11` after evidence and commit.
...
LDI hook: Capture depth may prepare handling ladder review, placement review, grow-into-goal, unsafe redirect, one-question clarification, and North Star extraction surfaces after owned gates.
