...
Objective: Privacy Safety Kernel.
Owning kernel: Privacy Safety.
Affected surface: all/external.
Precondition: must be active before external/sensitive projection work.
Boundary: privacy projections.
