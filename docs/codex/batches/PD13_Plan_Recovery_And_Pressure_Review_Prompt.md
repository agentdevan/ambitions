# PD13 Plan Recovery and Pressure Review Prompt
...
- Batch ID: `PD13`
- Name: Plan Recovery and Pressure Review
- Train: Product Depth
- Type: Implementation
- Primary surface ownership: Plan
- Required approval phrase: `Start Product Depth Train`

## Purpose

Help the user understand overloaded days/weeks without shame.

## Product Depth Ownership

Owns: Pressure week detail; overloaded day explanation; recovery space; protected time conflict; late-start adjustment; missed-day review; capacity confidence.
...
- PD12 Green
- Accessibility/cognitive load gate Green
- Copy language gate Green
- No shame/needs closure loops
...
- Pressure week detail
- overloaded day explanation
- recovery space
...
- Pressure review is non-shaming and action-oriented.
- Overload explanations identify recovery space and protected-time conflicts.
- Capacity confidence avoids fake precision.
- No needs closure loop or punishment language appears.
...
It may claim only the completed, validated scope of `PD13` after evidence and commit.
...
`Run PD13 Plan Recovery and Pressure Review`
...
LDI hook: Plan depth may prepare living plan recompile, capacity fit, source-change impact, privacy-sensitive review, and no-silent-rearrangement review after owned gates.
