# EB38 External Brain Accessibility Evidence Closeout Prompt
...
- Batch ID: EB38
- Name: External Brain Accessibility Evidence Closeout
- Global order after EB insertion: 084
...
Advance External Brain Accessibility Evidence Closeout inside the EB train with exact ownership, evidence, privacy, accessibility, and no-overwrite controls. Evidence closeout; production implementation is not allowed unless a repair batch is generated.
...
- docs/audits .codex tests/previews if gate opens
...
May claim only EB38 evidence after validation and commit.
...
`Run EB38 External Brain Accessibility Evidence Closeout`
