...
- `git rev-parse HEAD`
- `git log -1 --oneline`
- `wc -l Native/Ambitions/Features/** and shared UI helpers selected by ME01` when the owner path is concrete
- `rg -n "TODO|compat|route|accessibilityIdentifier|Start here|What Ambitions Knows|failed|Profile|You" Native/Ambitions/Features/** and shared UI helpers selected by ME01 || true` when the owner path is concrete
...
`Run ME08 Shared Projector State Helper Standards`
