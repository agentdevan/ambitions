...
Objective: Interoperability Kernel App Intents EventKit Planning.
Owning kernel: Interoperability.
Affected surface: external.
Precondition: depends on AOS16, AOS17, and interoperability privacy gates.
Boundary: planning only; source verification before implementation.
