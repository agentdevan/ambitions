# PD04 Today Recovery and Closure Depth Prompt
...
- Batch ID: `PD04`
- Name: Today Recovery and Closure Depth
- Train: Product Depth
- Type: Implementation
- Primary surface ownership: Today / Recovery
- Required approval phrase: `Start Product Depth Train`

## Purpose

Make missed, moved, blocked, skipped, and still-valid steps recoverable without shame.

## Product Depth Ownership

Owns: Closure sheet; Still Counts; Moved; Skipped / Not Needed; Blocked; Waiting; Needs Recovery; Needs Review; soft prior-step prompts; recovery receipt.
...
- PX07 Green
- PX09 copy gates Green
- AOS Reality Drift/Proof Trust dependency if runtime logic touched
- No binary failure/needs closure regression
...
- Needs Recovery
- Needs Review
- soft prior-step prompts
- recovery receipt.

## Batch-Specific Acceptance Criteria

- Closure states are humane and never binary failure loops.
- Still Counts, Moved, Skipped, Blocked, Waiting, Needs Recovery, and Needs Review each have clear outcomes.
- Recovery receipt records what changed without hidden automation.
- AOS runtime logic is blocked unless its prerequisite gates are Green.
...
It may claim only the completed, validated scope of `PD04` after evidence and commit.
...
`Run PD04 Today Recovery and Closure Depth`
