...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 001 | REC02 | REC | Evidence | Human-only proof plan must precede release-adjacent claims. | REC01 accepted, `Continue Release Evidence Closure` or current global 4.0 preauthorization, Release Claim, Human Proof | Serial-only | Yes, needs approval | Adequate docs evidence | release evidence, claim boundary, human proof | Continue only if REC or global continuation is explicit and Green |
