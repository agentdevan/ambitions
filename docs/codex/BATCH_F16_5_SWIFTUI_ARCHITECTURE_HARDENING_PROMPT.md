# F16.5 SwiftUI Architecture Hardening Runner
...
Path: docs/codex/BATCH_F16_5_SWIFTUI_ARCHITECTURE_HARDENING_PROMPT.md
...
Use only if architecture scan, UI test modernization, shell readiness, or manifest requires it. Use docs/codex/batches/F16_5_SwiftUI_Architecture_State_Contract_Hardening_Prompt.md.
