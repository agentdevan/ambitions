...
Status: Ambitions 4.0 dependency graph; active through CS04A Habits/Ritual/Plan compatibility map evidence and SI formalization
Date: 2026-05-02
...
- CS04 is internally staged under global order `043`: CS04A Habits/Ritual/Plan compatibility map and retirement ledger repair precedes CS04B route/raw/default/external/accessibility proof; CS04C narrow internal retirement is blocked until CS04A and CS04B are Green or accepted Yellow. The formal batch count remains 113.
- CS05-CS06 depend on CS01 and the relevant CS07/CS08 compatibility proof where route/raw/external/import/export/persistence risk exists.
