...
Status: Ambitions 4.0 dependency graph; active through CS02A Profile/You compatibility seam repair evidence and SI formalization
Date: 2026-05-02
...
- CS03-CS06 depend on CS01 and the relevant CS07/CS08 compatibility proof where route/raw/external/import/export/persistence risk exists.
