...
| AOS24 UI Integration | Must use Source Atlas UI primitives without creating dashboard. |
...
Start Here may show source/freshness/source-needed line, SourceImpactReceipt, and Receipt Drawer source detail. It must not show Source Atlas dashboard or pack library.
