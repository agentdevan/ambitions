...
schema/zone/conflict contract and PFC11 test plan. PFC11 remains governed by
the PFC train and must either explicitly defer sync under current local-only
truth or prove a later-approved implementation.
