...
- HPS01-HPS12 are complete Accepted Yellow as docs-domain Human Progress
  Systems architecture evidence; AOS01 is next by full-stack order.
...
Yellow as Singular Experience and Acquisition Readiness Lock; AOS01 is the
next eligible remaining batch under the stricter HPS-before-AOS overlay.
