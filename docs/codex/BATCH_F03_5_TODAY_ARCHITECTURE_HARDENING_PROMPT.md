# F03.5 Today Architecture Hardening Single Batch Runner
...
> Candidate references: AMB28-same_surface_multiple_active_batches-13212827, AMB28-same_surface_multiple_active_batches-34058953
...
Path: docs/codex/BATCH_F03_5_TODAY_ARCHITECTURE_HARDENING_PROMPT.md
...
Manifest: docs/codex/batch-trains/F03_5_Today_Architecture_Hardening.md. Prerequisites: F01-F03 complete, Today focused tests and build passing, architecture scan available. Use docs/codex/batches/F03_5_Today_Execution_State_Contract_Hardening_Prompt.md.
