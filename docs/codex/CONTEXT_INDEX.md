...
- GQ01 Global Queue Maturity is complete / accepted Yellow. PK04 Atomic Goal Creation is complete / Green. Use `docs/codex/GLOBAL_QUEUE_MATURITY_LEDGER.md` and `docs/codex/GLOBAL_QUEUE_CANONICAL_ORDER.json` as the canonical fallback queue after live current-run state. PK05 Atomic Clarification / Materialization is the next implementation batch. SA07-SA32 are visible; EFC is overlay-first; CS02C-CS06C/CS09C are conditional triggers; PX01-PX20 are historical complete do-not-run.
