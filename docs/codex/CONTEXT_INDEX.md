...
These files define Ambitions 4.0 order, gates, repair loops, continuation, validation strength, and quality bars only. They do not start REC04, PXOS, ME, CS, AOS, Product Depth, app implementation, release readiness, or human-proof work.
