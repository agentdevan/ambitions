...
LDI is future source truth/governance only until its implementation batches run. PD01 is the next formal successor only after the Product Depth approval phrase is satisfied.
