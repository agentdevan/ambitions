...
- Found Life Layer source truth is active. FL01 is complete Green as
  ...
  Green as WidgetKit Strategy And Object Map evidence. FVQ01 was inserted
  remotely while local PFC13 was already active, so the next eligible global
  batch is FVQ01 before PFC15 Live Activities / ActivityKit Strategy.
...
order selects FVQ01 next because FVQ01 was inserted while PFC13 was active.
