# F13.5 Goals You Trust Architecture Checkpoint Runner
...
Path: docs/codex/BATCH_F13_5_GOALS_YOU_TRUST_ARCHITECTURE_CHECKPOINT_PROMPT.md
...
Use only if F13 triggers architecture risk before F14. Use docs/codex/batches/F13_5_Goals_You_Trust_Architecture_Checkpoint_Prompt.md.
