...
`docs/canon/` contains the product specifications and engineering standards.
Read the files relevant to the change together with the live source and tests.
They describe the product; they do not authorize edits or merge decisions.
