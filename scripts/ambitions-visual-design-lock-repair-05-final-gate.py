...
def main() -> int:
    ...
    required_paths = [
        ...
        "frontend/visual-encyclopedia/MATURE_APP_SURFACE_UNIVERSE.md",
        "frontend/visual-encyclopedia/VISUAL_SOURCE_PROVENANCE_AND_BATCH_LINKAGE.yaml",
        "frontend/visual-encyclopedia/VISUAL_SOURCE_PROVENANCE_AND_BATCH_LINKAGE.md",
        ...
        "frontend/visual-encyclopedia/trace/FINAL_FORM_LOCK_REPAIR_05_GAP_LEDGER.md",
