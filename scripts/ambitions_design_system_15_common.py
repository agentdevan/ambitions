...
def generate_design_tokens() -> None:
    ...
    adr_specs = [
        ...
        (4, "Product Object Architecture", "Ambitions organizes UI and logic around product objects rather than generic screens.", ["Reinforces Today / Goals / Time / Motion / You plus global Capture.", "Supports future object-first implementation work."]),
