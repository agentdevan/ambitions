...
FRONTEND_CONTENT_RE = re.compile(
    r"\b(SwiftUI|frontend|front-end|visual|UI|surface|screen|Today|Goals|Capture|Time|You|Reality Meridian|LifeShape|Constellation|Atmosphere Composer|User System Profile)\b",
    re.IGNORECASE,
)
