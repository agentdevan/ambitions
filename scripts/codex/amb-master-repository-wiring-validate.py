...
def validate() -> list[str]:
    ...
    check("Next runnable gate: AMB-1052 / M01.T04" in registry, failures, "program registry next runnable gate is stale")
    ...
    for issue in ("AMB-1126", "AMB-1046", "AMB-1047", "AMB-1048", "AMB-1049", "AMB-1050", "AMB-1051", "AMB-1052"):
    ...
    check(queue.get("next", {}).get("linear_id") == "AMB-1052", failures, "execution queue next issue must be AMB-1052 after AMB-1051 local closeout")
