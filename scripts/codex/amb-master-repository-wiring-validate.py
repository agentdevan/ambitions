...
def validate() -> list[str]:
    ...
    check("Next runnable gate: AMB-1062 / M04.T05" in registry, failures, "program registry next runnable gate is stale")
    ...
    check(queue.get("next", {}).get("linear_id") == "AMB-1062", failures, "execution queue next issue must be AMB-1062 after AMB-1061 closeout")
