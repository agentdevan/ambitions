...
def validate() -> list[str]:
    ...
    check("Next runnable gate: AMB-1059 / M04.T02" in registry, failures, "program registry next runnable gate is stale")
    ...
    check(queue.get("next", {}).get("linear_id") == "AMB-1059", failures, "execution queue next issue must be AMB-1059 after AMB-1058 closeout")
