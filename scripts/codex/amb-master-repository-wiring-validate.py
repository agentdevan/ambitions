...
def validate() -> list[str]:
    ...
    check("Next runnable gate: AMB-1128 / M01.T06B" in registry, failures, "program registry next runnable gate is stale")
    ...
    for issue in ("AMB-1126", "AMB-1046", "AMB-1047", "AMB-1048", "AMB-1049", "AMB-1050", "AMB-1051", "AMB-1052", "AMB-1053", "AMB-1127", "AMB-1128"):
    ...
    check(queue.get("next", {}).get("linear_id") == "AMB-1128", failures, "execution queue next issue must be AMB-1128 after AMB-1127 closeout")
