...
def validate() -> list[str]:
    ...
    check("Next runnable gate: AMB-1112 / M02.T02" in registry, failures, "program registry next runnable gate is stale")
    ...
    for issue in ("AMB-1126", "AMB-1046", "AMB-1047", "AMB-1048", "AMB-1049", "AMB-1050", "AMB-1051", "AMB-1052", "AMB-1053", "AMB-1127", "AMB-1128", "AMB-1113", "AMB-1111", "AMB-1112"):
    ...
    check(queue.get("next", {}).get("linear_id") == "AMB-1112", failures, "execution queue next issue must be AMB-1112 after AMB-1111 closeout")
