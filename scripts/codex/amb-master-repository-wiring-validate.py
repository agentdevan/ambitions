...
def validate() -> list[str]:
    ...
    check("Next runnable gate: AMB-1117 / M02.T08" in registry, failures, "program registry next runnable gate is stale")
    ...
    check(queue.get("next", {}).get("linear_id") == "AMB-1117", failures, "execution queue next issue must be AMB-1117 after AMB-1133 closeout")
