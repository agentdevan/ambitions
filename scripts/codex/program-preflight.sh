...
case "$program" in
 ...
 plos) check_file artifacts/plos-runtime/PLOS_GOAL.md; check_file artifacts/plos-runtime/PLOS-run-state.md; check_file artifacts/plos-runtime/PLOS_PHASE_GATES.md; check_file artifacts/plos-runtime/PLOS_GOLDEN_SLICE_PROOF.md; check_file artifacts/plos-runtime/PLOS_RISK_REGISTER.md; check_file artifacts/plos-runtime/PLOS_LINEAR_ISSUE_MAP.md; check_file artifacts/plos-runtime/PLOS_LINEAR_ISSUE_MAP.json; check_file artifacts/plos-runtime/PLOS_EXECUTION_QUEUE.md; check_file artifacts/plos-runtime/PLOS_EXECUTION_QUEUE.json; check_file artifacts/plos-runtime/PLOS_AUTONOMOUS_READINESS_AUDIT.md; check_file .agents/skills/plos-runtime-master-build/SKILL.md; check_file .agents/skills/plos-runtime-master-build/references/plos-reviewer-prompts.md; check_file .agents/skills/plos-runtime-master-build/references/plos-closeout-template.md; check_file scripts/codex/plos-readiness-validate.py; python3 scripts/codex/plos-readiness-validate.py || status=1;;
 source-atlas) check_file artifacts/source-atlas-factory/SAF_GOAL.md; check_file artifacts/source-atlas-factory/SAF-run-state.md; check_file artifacts/source-atlas-factory/SAF_PACK_RELEASE_LEDGER.md; check_file artifacts/source-atlas-factory/SAF_HARDENING_PLAN.md; check_file .agents/skills/source-atlas-factory/SKILL.md; check_file scripts/codex/source-atlas-readiness-validate.py; check_dir tools/source-atlas; python3 scripts/codex/source-atlas-readiness-validate.py || status=1;;
