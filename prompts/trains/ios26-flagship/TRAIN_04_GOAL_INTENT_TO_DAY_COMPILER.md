...
## Objective
Install and run the `Goal intent-to-day compiler` train only through the Ambitions runner when dependencies are satisfied.
...
## Batch summaries
- IOS26-T04-B01: `prompts/batches/IOS26-T04-B01-compiler-input-output-model.md`
- IOS26-T04-B02: `prompts/batches/IOS26-T04-B02-capacity-aware-compilation.md`
- IOS26-T04-B03: `prompts/batches/IOS26-T04-B03-compiler-persistence-receipts.md`
