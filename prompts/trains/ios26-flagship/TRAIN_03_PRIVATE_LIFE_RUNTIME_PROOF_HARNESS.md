...
## Objective
Install and run the `Private Life Runtime centralization and proof harness` train only through the Ambitions runner when dependencies are satisfied.
...
## Batch summaries
- IOS26-T03-B01: `prompts/batches/IOS26-T03-B01-runtime-kernel-contracts.md`
- IOS26-T03-B02: `prompts/batches/IOS26-T03-B02-local-only-proof-harness.md`
- IOS26-T03-B03: `prompts/batches/IOS26-T03-B03-replayable-decision-traces.md`
