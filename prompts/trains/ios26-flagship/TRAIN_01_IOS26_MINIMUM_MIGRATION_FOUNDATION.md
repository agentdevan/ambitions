...
## Objective
Install and run the `iOS 26 minimum migration foundation` train only through the Ambitions runner when dependencies are satisfied.
...
## Batch summaries
- IOS26-T01-B01: `prompts/batches/IOS26-T01-B01-toolchain-confirmation.md`
- IOS26-T01-B02: `prompts/batches/IOS26-T01-B02-deployment-target-bump.md`
- IOS26-T01-B03: `prompts/batches/IOS26-T01-B03-availability-compatibility-cleanup.md`
