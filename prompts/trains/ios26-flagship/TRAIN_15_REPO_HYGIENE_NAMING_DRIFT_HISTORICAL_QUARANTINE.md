...
## Objective
Install and run the `Repo hygiene, naming drift, historical quarantine` train only through the Ambitions runner when dependencies are satisfied.
...
## Batch summaries
- IOS26-T15-B01: `prompts/batches/IOS26-T15-B01-active-docs-front-door.md`
- IOS26-T15-B02: `prompts/batches/IOS26-T15-B02-historical-quarantine-plan.md`
- IOS26-T15-B03: `prompts/batches/IOS26-T15-B03-source-naming-final-sweep.md`
