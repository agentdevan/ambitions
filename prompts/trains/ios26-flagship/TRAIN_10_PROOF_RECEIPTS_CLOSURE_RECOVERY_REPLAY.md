...
## Objective
Install and run the `Proof, receipts, closure, recovery, replay` train only through the Ambitions runner when dependencies are satisfied.
...
- Receipts must cover schedule, reminder, commitment, project, knowledge, source, recommendation, closure, and reflow changes.
