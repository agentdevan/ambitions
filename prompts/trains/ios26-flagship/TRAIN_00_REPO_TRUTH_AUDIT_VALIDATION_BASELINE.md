...
## Objective
Install and run the `Repo truth, audit, validation baseline` train only through the Ambitions runner when dependencies are satisfied.
...
## Batch summaries
- IOS26-T00-B01: `prompts/batches/IOS26-T00-B01-repo-source-inventory.md`
- IOS26-T00-B02: `prompts/batches/IOS26-T00-B02-validation-baseline.md`
- IOS26-T00-B03: `prompts/batches/IOS26-T00-B03-naming-api-drift-inventory.md`
