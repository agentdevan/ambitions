...
MRI04-PROOF-CAPITAL-MODEL

# Runner Command

```bash
make batch BATCH=MRI04-PROOF-CAPITAL-MODEL PROMPT=prompts/batches/MRI04-PROOF-CAPITAL-MODEL.md
```

# Objective

Define proof creation, transfer, weakening, staleness, contradiction, and preservation through pivots.
...
Proof expectation: Focused proof transfer tests when implemented.
