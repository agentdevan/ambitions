...
# IOS26-T07-B02 - Sealed IOS26 Work Order
...
## Objective
Remove user-facing generic Task/Mission Control/board/dashboard drift from Goals.
...
User-facing copy, accessibility labels/IDs, tests.

## Forbidden files/directories
No broad source rename without tests. Do not rewrite historical docs.

## Exact implementation steps
Grep Goals source/tests; replace user-facing Task with Step/approved phrase; replace Mission Control where user-facing; keep internal compatibility names only if not user-facing.
...
build/reports/constellation-atlas/language-drift.md
...
# IOS26-T07-B02 — Goals language drift
...
## Why this exists
Goals must not regress to task-manager/dashboard semantics.
...
Goals feature; unit/UI tests; docs/truth.
...
Internal names require owner if retained.
