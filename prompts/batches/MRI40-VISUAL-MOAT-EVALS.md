...
MRI40-VISUAL-MOAT-EVALS

# Runner Command

```bash
make batch BATCH=MRI40-VISUAL-MOAT-EVALS PROMPT=prompts/batches/MRI40-VISUAL-MOAT-EVALS.md
```

# Objective

Evaluate anti-generic UI, native iPhone believability, quiet luxury, object-first surfaces, and chatbot/dashboard/calendar drift.
...
No visual approval without evidence.
...
```text
docs/audits/mri40-visual-moat-evals-report.md
```
