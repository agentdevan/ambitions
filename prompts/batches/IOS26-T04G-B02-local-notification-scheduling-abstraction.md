...
Reminders notification delivery job.

## Replacement P0 contract
Reminders P0 notification contract: local scheduler abstraction, permission/denied states, pending/delivered/cancelled states where supported, object backing.
