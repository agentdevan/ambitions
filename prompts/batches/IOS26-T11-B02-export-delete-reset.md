...
# IOS26-T11-B02 - Sealed IOS26 Work Order
...
## Batch role in train
Batch 2 of 3 in TRAIN_11

## Upstream dependencies
- `TRAIN_01`
- `schema_decisions_from_TRAIN_03_TRAIN_04_TRAIN_04D_TRAIN_10`
- `TRAIN_04K_where_persistence_models_are_involved`
...
## Objective
Implement or verify local export/delete/reset behavior.
...
Export/delete/reset services, You hooks, tests.

## Forbidden files/directories
No cloud export. No destructive delete without explicit confirmation.

## Exact implementation steps
Add local export snapshot service; add delete/reset service using safe existing reset; add confirmation/failure recovery; test export/delete/reset/relaunch.
...
build/reports/data-safety/export-delete-reset.md
...
# IOS26-T11-B02 — Export/delete/reset

## Batch type
Data rights/local persistence

## Objective
Implement or verify local export/delete/reset behavior.

## Why this exists
Users must control local data.
...
Persistence; You feature; Services; tests.
...
Destructive behavior without confirmation is Red.
