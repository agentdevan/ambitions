...
# IOS26-T11-B01 - Sealed IOS26 Work Order
...
## Objective
Add versioned migration foundation and fixtures.
...
SwiftData schema/migration code, fixtures, tests.

## Forbidden files/directories
No destructive migration without fixture proof.

## Exact implementation steps
Inspect schema; define versioning strategy; add old-to-current migration fixtures; add unknown/corrupt degradation; record limitations.
...
build/reports/data-safety/versioned-migration.md
...
# IOS26-T11-B01 — Versioned migration foundation
...
## Why this exists
Local-first trust requires safe schema evolution.

## Dependencies
Train 1 and stable schema decisions.
...
Persistence; Persistence tests; Release truth.
