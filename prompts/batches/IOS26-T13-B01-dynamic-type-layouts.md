...
# IOS26-T13-B01 - Sealed IOS26 Work Order
...
## Objective
Ensure core surfaces preserve primary objects and actions at large accessibility sizes.
...
Layout fixes, adaptive density, tests/previews/screenshots.

## Forbidden files/directories
No hiding primary action at accessibility sizes.

## Exact implementation steps
Add/verify large type states; fix clipping/overlap; ensure primary object/action visible; add screenshot proof if possible.
...
build/reports/accessibility-nutrition/dynamic-type.md
...
# IOS26-T13-B01 — Dynamic Type layouts
...
## Why this exists
Dynamic Type support cannot be inferred from source tokens alone.

## Dependencies
Train 5 through Train 12.
...
Today; Goals; Capture; Time; You; Sources; UI tests.
...
## Tests to add/update
Dynamic Type UI tests/screenshots.
