...
MRI23-REALITY-FIT-IN-START-HERE

# Runner Command

```bash
make batch BATCH=MRI23-REALITY-FIT-IN-START-HERE PROMPT=prompts/batches/MRI23-REALITY-FIT-IN-START-HERE.md
```

# Objective

Show why Start Here fits now: time, context, ambition, proof opportunity, risk if delayed.
...
Proof expectation: Today fit scenario proof.
...
```text
docs/audits/mri23-reality-fit-in-start-here-report.md
```
