...
# IOS26-T09-B02 - Sealed IOS26 Work Order
...
## Objective
Make trust and memory controls inspectable and correction-capable.
...
Memory/trust services, You UI, tests.

## Forbidden files/directories
No opaque AI memory claims. No server-side profile.
...
# IOS26-T09-B02 — Trust and memory controls

## Batch type
You trust/runtime memory

## Objective
Make trust and memory controls inspectable and correction-capable.

## Why this exists
Local memory must be user-owned and reviewable.
...
You feature; Runtime; Persistence; tests.
