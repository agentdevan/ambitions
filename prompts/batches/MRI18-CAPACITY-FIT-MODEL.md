...
MRI18-CAPACITY-FIT-MODEL

# Runner Command

```bash
make batch BATCH=MRI18-CAPACITY-FIT-MODEL PROMPT=prompts/batches/MRI18-CAPACITY-FIT-MODEL.md
```

# Objective

Define time/context/energy/pressure/proof/recovery fit calculations for recommendations.
...
Proof expectation: Fit model tests.
...
```text
docs/audits/mri18-capacity-fit-model-report.md
```
