...
# IOS26-T04E-B05 - Sealed IOS26 Work Order
...
The contract harness must require `SourceRecord`, local `Receipt`, and `ReplayTrace` evidence before any broad Notion replacement claim can pass.
