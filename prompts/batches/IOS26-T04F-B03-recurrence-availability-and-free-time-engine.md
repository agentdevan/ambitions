...
# IOS26-T04F-B03 - Sealed IOS26 Work Order
...
Know when life has room. Implement only the scoped local-first behavior after inspecting current source, then prove it with focused tests and proof artifacts.
...
Green: Recurrence and free-time scenarios pass.
Yellow: bounded gap with owner, reason, no-claim boundary, validation posture, and post-batch gate.
Red: No recurrence or free-time computation.

## Rollback behavior
Revert only files touched by `IOS26-T04F-B03`. Preserve unrelated dirty work and generated artifacts outside this batch.
...
Calendar availability job.

## Replacement P0 contract
Calendar P0 recurrence/availability contract: recurrence expansion, availability/free-time windows, all-day, timezone/DST, day/week/month/year horizon.
