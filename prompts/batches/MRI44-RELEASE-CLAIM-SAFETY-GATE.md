...
MRI44-RELEASE-CLAIM-SAFETY-GATE

# Runner Command

```bash
make batch BATCH=MRI44-RELEASE-CLAIM-SAFETY-GATE PROMPT=prompts/batches/MRI44-RELEASE-CLAIM-SAFETY-GATE.md
```

# Objective

Block unsupported release/device/accessibility/performance/privacy/global completion claims.
...
No readiness claims unless proof exists.
...
Proof expectation: Claim safety gate proof.
...
```text
docs/audits/mri44-release-claim-safety-gate-report.md
```
