...
# IOS26-T04H-B07 - Sealed IOS26 Work Order
...
## Objective
Prove Todoist and Things 3 P0 replacement.
...
Prove Todoist and Things 3 P0 replacement. Implement only the scoped local-first behavior after inspecting current source, then prove it with focused tests and proof artifacts.

## Validation commands
```bash
python3 scripts/ios26-flagship-preflight.py --batch IOS26-T04H-B07
python3 scripts/ios26-core-replacement-proof-shape-check.py --batch IOS26-T04H-B07
```
...
Green: 500+ scenarios pass or Yellow is bounded.
Yellow: bounded gap with owner, reason, no-claim boundary, validation posture, and post-batch gate.
Red: Todoist/Things P0 is not Green or accepted Yellow with no replacement claim.

## Rollback behavior
Revert only files touched by `IOS26-T04H-B07`. Preserve unrelated dirty work and generated artifacts outside this batch.
...
# IOS26-T04H-B07 - Todoist Things replacement gauntlet
...
Todoist and Things 3 P0 proof job.

## Replacement P0 contract
Todoist/Things gauntlet: at least 500 deterministic scenarios for projects/tasks/areas, due/deadline/dependency/labels/filters, Today/Upcoming/Open/Held, closure/recovery/proof, bulk, receipts/replay.
