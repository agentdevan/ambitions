...
# IOS26-T04F-B06 - Sealed IOS26 Work Order
...
Prove Calendar P0 replacement. Implement only the scoped local-first behavior after inspecting current source, then prove it with focused tests and proof artifacts.
...
Green: 300+ deterministic Calendar scenarios pass or Yellow is bounded.
Yellow: bounded gap with owner, reason, no-claim boundary, validation posture, and post-batch gate.
Red: Calendar P0 is not Green or accepted Yellow with no replacement claim.

## Rollback behavior
Revert only files touched by `IOS26-T04F-B06`. Preserve unrelated dirty work and generated artifacts outside this batch.
...
# IOS26-T04F-B06 - Calendar replacement gauntlet
