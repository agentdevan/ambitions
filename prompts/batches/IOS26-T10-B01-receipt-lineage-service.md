...
# IOS26-T10-B01 - Sealed IOS26 Work Order
...
## Objective
Create a central receipt lineage service.
...
Receipt/proof service, repository usage, tests.

## Forbidden files/directories
No schema change without migration proof.

## Exact implementation steps
Centralize receipt creation; include domain/result/privacy/proof/undo/local-only fields; use existing storage if safe; add replay/load tests.
...
- Run `python3 scripts/ios26-anti-card-check.py --surface proof --batch IOS26-T10-B03` as the shared proof object-purity gate.
...
build/reports/proof-receipts-replay/receipt-lineage.md
...
# IOS26-T10-B01 — Receipt lineage service

## Batch type
Proof/runtime persistence

## Objective
Create a central receipt lineage service.

## Why this exists
Receipts need consistent privacy, freshness, proof relevance, undo/correction metadata.

## Dependencies
Train 3 through Train 9.
...
Receipt domain; Persistence; Runtime; Services; tests.
...
Receipt lacks privacy/local-only boundary is Red.
