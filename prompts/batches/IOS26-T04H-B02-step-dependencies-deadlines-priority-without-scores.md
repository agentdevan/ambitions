...
# IOS26-T04H-B02 - Sealed IOS26 Work Order
...
## Objective
Represent priority and dependencies without gimmicks.
...
Represent priority and dependencies without gimmicks. Implement only the scoped local-first behavior after inspecting current source, then prove it with focused tests and proof artifacts.
