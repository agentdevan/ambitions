...
# IOS26-T09-B01 - Sealed IOS26 Work Order
...
## Objective
Make User System Profile settings affect runtime behavior.
...
Profile/preference models, app state repository, runtime input wiring, tests.

## Forbidden files/directories
No social profile/admin settings wall.
...
# IOS26-T09-B01 — Runtime-affecting profile

## Batch type
You/runtime integration

## Objective
Make User System Profile settings affect runtime behavior.

## Why this exists
You should not be decorative settings; it should control the Private Life Runtime.
...
You feature; Persistence; Runtime; Services; tests.
...
## Tests to add/update
Runtime effect and persistence tests.
