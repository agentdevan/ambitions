...
MRI22-CALENDAR-EVENT-BOUNDARY-HARDENING

# Runner Command

```bash
make batch BATCH=MRI22-CALENDAR-EVENT-BOUNDARY-HARDENING PROMPT=prompts/batches/MRI22-CALENDAR-EVENT-BOUNDARY-HARDENING.md
```

# Objective

Keep calendar/EventKit as source/side-effect boundaries, not product model replacement.
...
No calendar clone, no silent writes.
...
Proof expectation: Boundary tests.
...
```text
docs/audits/mri22-calendar-event-boundary-hardening-report.md
```
