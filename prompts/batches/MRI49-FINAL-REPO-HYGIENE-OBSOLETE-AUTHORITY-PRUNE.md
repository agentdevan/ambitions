...
MRI49-FINAL-REPO-HYGIENE-OBSOLETE-AUTHORITY-PRUNE

# Runner Command

```bash
make batch BATCH=MRI49-FINAL-REPO-HYGIENE-OBSOLETE-AUTHORITY-PRUNE PROMPT=prompts/batches/MRI49-FINAL-REPO-HYGIENE-OBSOLETE-AUTHORITY-PRUNE.md
```

# Objective

Prune/quarantine obsolete authority paths, stale prompts, and conflicting docs under historical policy.
...
Proof expectation: Repo hygiene proof.
...
```text
docs/audits/mri49-final-repo-hygiene-obsolete-authority-prune-report.md
```
