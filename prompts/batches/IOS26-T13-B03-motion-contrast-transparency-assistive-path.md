...
# IOS26-T13-B03 - Sealed IOS26 Work Order
...
## Batch role in train
Batch 3 of 3 in TRAIN_13

## Upstream dependencies
- `TRAIN_05_through_TRAIN_12`
- `TRAIN_04K_for_accessibility_equivalence_across_replacement_flows`

## Downstream dependencies
- none recorded

## Objective
Prove Reduce Motion, Increase Contrast, Reduce Transparency, and simplified Assistive Access path.
...
Reduced motion/material fallbacks, contrast fixes, simplified path docs/tests.

## Forbidden files/directories
No visual-only meaning.

## Exact implementation steps
Audit animated/transparent state cues; add text/icon/shape alternatives; add Reduce Transparency fallback; define simplified Assistive path; add proof docs/screenshots if available.
...
build/reports/accessibility-nutrition/motion-contrast-transparency-assistive.md
...
# IOS26-T13-B03 — Motion, contrast, transparency, Assistive path

## Batch type
Accessibility environment equivalence

## Objective
Prove Reduce Motion, Increase Contrast, Reduce Transparency, and simplified Assistive Access path.

## Why this exists
Motion/material meaning cannot be required for comprehension.

## Dependencies
IOS26-T13-B01 and IOS26-T13-B02.
...
## Tests to add/update
Fallback tests/previews if feasible.
...
Motion/glass required for meaning is Red.
