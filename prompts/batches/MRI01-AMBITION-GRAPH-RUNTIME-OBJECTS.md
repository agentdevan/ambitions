...
```bash
make batch BATCH=MRI01-AMBITION-GRAPH-RUNTIME-OBJECTS PROMPT=prompts/batches/MRI01-AMBITION-GRAPH-RUNTIME-OBJECTS.md
```

# Objective

Create runtime object contracts for Identity Direction, Life Area, Ambition, Outcome, Goal Thread, Commitment, Step, Closure Event, Proof, Reflection, Adaptation, and RecoveryThread.

Operating system: **Ambition Lifecycle Engine**  
Product loop: **Goal-to-life-direction**
...
Docs/domain-scoping only unless later batch explicitly touches runtime source.
...
Proof expectation: Model/projection prompt and focused model tests when runtime source is later touched.
