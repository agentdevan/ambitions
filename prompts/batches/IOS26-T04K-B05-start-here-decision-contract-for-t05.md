...
# IOS26-T04K-B05 - Sealed IOS26 Work Order
...
## Objective
Make Today / Start Here genuinely intelligent.
...
## Validation commands
```bash
python3 scripts/ios26-flagship-preflight.py --batch IOS26-T04K-B05
python3 scripts/ios26-core-replacement-proof-shape-check.py --batch IOS26-T04K-B05
```
...
- `build/reports/private-life-runtime-integration/start-here-decision-contract.md`
...
Green: Start Here decision contract is proven.
Yellow: bounded gap with owner, reason, no-claim boundary, validation posture, and post-batch gate.
Red: Start Here is a generic task card or static/sample task.

## Rollback behavior
Revert only files touched by `IOS26-T04K-B05`. Preserve unrelated dirty work and generated artifacts outside this batch.
...
# IOS26-T04K-B05 - Start Here decision contract for T05
...
Today Start Here intelligence job.

## Replacement P0 contract
Start Here contract: schedule reality, free time, protected time, commitments, pressure, GoalThread relevance, proof/closure/recovery, capture future context, source freshness, path ranking, Why this? sources/reason/control/receipt.
