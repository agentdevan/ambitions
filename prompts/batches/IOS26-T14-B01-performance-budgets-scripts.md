...
# IOS26-T14-B01 - Sealed IOS26 Work Order
...
## Objective
Install performance budgets and measurement commands.
...
Performance docs/scripts/proof templates.

## Forbidden files/directories
No performance claims without current logs.

## Exact implementation steps
Define budgets; add measurement script or manual commands; save proof template; do not claim measured performance until logs exist.
...
build/reports/performance/budgets-and-scripts.md
...
# IOS26-T14-B01 — Performance budgets and scripts

## Batch type
Performance proof foundation

## Objective
Install performance budgets and measurement commands.

## Why this exists
Performance cannot be claimed without measurements.

## Dependencies
Train 2 and Train 5 through Train 13.
...
scripts; Release truth; Native/Ambitions; Widget extension.
...
## Tests to add/update
None unless script has self-check.
...
Measurements absent means no performance claim.
