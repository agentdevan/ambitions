...
# IOS26-T16-B03 - Sealed IOS26 Work Order
...
## Batch role in train
Batch 3 of 3 in TRAIN_16

## Upstream dependencies
- `TRAIN_00_through_TRAIN_15`
- `TRAIN_04A`
- `TRAIN_04B_through_full_train_chain`
- `TRAIN_04C_through_full_train_chain`
- `TRAIN_04D_through_full_train_chain`
- `TRAIN_04K_through_full_train_chain`

## Downstream dependencies
- none recorded

## Objective
Prepare or run signed archive/TestFlight gate only with explicit approval.
...
Release proof docs/log index only. Signing changes only with explicit current approval.

## Forbidden files/directories
No signing/upload without explicit approval. No App Store/TestFlight ready claim without proof.

## Exact implementation steps
Check explicit approval; if absent, create gate packet and stop Yellow; if approved, run archive/export commands from repo docs; record exact allowed/forbidden claims.
...
build/reports/release-candidate/signed-archive-testflight-gate.md
...
# IOS26-T16-B03 — Signed archive / TestFlight gate
...
## Why this exists
Signed archive and App Store/TestFlight actions are release-sensitive.

## Dependencies
IOS26-T16-B01 Green, IOS26-T16-B02 Green/accepted Yellow, explicit owner approval.
...
project.yml; Release truth; docs/native-build-and-release.md; release-candidate reports.
...
## Tests to add/update
No tests unless archive approved.
...
Signing/upload without approval is Red.
