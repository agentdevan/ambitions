...
# IOS26-T04E-B04 - Sealed IOS26 Work Order
...
## Objective
Install Things 3 replacement contract tests/fixtures/proof requirements.
...
## Validation commands
```bash
python3 scripts/ios26-flagship-preflight.py --batch IOS26-T04E-B04
python3 scripts/ios26-core-replacement-proof-shape-check.py --batch IOS26-T04E-B04
```
...
Green: Things 3 P0 harness exists and blocks unsupported claims.
Yellow: bounded gap with owner, reason, no-claim boundary, validation posture, and post-batch gate.
Red: No explicit Things 3 P0 contract harness exists.

## Rollback behavior
Revert only files touched by `IOS26-T04E-B04`. Preserve unrelated dirty work and generated artifacts outside this batch.
...
# IOS26-T04E-B04 - Things 3 replacement contract harness
...
Things 3 Today/Upcoming/Open/Held planning job.

## Replacement P0 contract
Things 3 P0 quick capture, Today, Upcoming, Scheduled, Open, Held, Life Areas, Goal Threads, low-friction closure, Start Here.
