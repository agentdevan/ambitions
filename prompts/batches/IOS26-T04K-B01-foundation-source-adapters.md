...
# IOS26-T04K-B01 - Sealed IOS26 Work Order
...
## Objective
Let the runtime use the full replacement foundation safely.
...
Green: Adapter tests pass.
Yellow: bounded gap with owner, reason, no-claim boundary, validation posture, and post-batch gate.
Red: Runtime consumes foundation objects without source boundaries.

## Rollback behavior
Revert only files touched by `IOS26-T04K-B01`. Preserve unrelated dirty work and generated artifacts outside this batch.
...
# IOS26-T04K-B01 - Foundation source adapters
...
Runtime foundation adapter job.

## Replacement P0 contract
Runtime adapter contract: adapters from Time, Reminder, Project/Step, Life Knowledge, Capture Runtime, Proof/Receipts with freshness/sensitivity/reset.
