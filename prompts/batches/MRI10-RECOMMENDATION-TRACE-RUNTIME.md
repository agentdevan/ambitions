...
MRI10-RECOMMENDATION-TRACE-RUNTIME

# Runner Command

```bash
make batch BATCH=MRI10-RECOMMENDATION-TRACE-RUNTIME PROMPT=prompts/batches/MRI10-RECOMMENDATION-TRACE-RUNTIME.md
```

# Objective

Ensure every recommendation carries source, reason, fit, uncertainty, control, and receipt behavior.
...
No confidence percentages or opaque ranking.
...
Proof expectation: Recommendation trace tests.
