...
# IOS26-T04H-B04 - Sealed IOS26 Work Order
...
## Objective
Replace Things 3 execution states with Ambitions-native state.
...
Replace Things 3 execution states with Ambitions-native state. Implement only the scoped local-first behavior after inspecting current source, then prove it with focused tests and proof artifacts.
...
Green: View providers and Start Here consumption pass.
Yellow: bounded gap with owner, reason, no-claim boundary, validation posture, and post-batch gate.
Red: Today is a generic task list or Held/Future is missing.

## Rollback behavior
Revert only files touched by `IOS26-T04H-B04`. Preserve unrelated dirty work and generated artifacts outside this batch.
...
# IOS26-T04H-B04 - Today Upcoming Open Held view engine
...
Things 3 execution state job.

## Replacement P0 contract
Things P0 views: Today, Upcoming, Scheduled, Open, Held/Future providers; no generic task-list root; Start Here consumes ranked state.
