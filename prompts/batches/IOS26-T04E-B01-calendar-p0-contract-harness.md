...
# IOS26-T04E-B01 - Sealed IOS26 Work Order
...
## Objective
Install Calendar replacement contract tests/fixtures/proof requirements.
...
Install Calendar replacement contract tests/fixtures/proof requirements. Install explicit fixtures/proof expectations and make later broad claims fail unless current evidence exists.

## Validation commands
```bash
python3 scripts/ios26-flagship-preflight.py --batch IOS26-T04E-B01
python3 scripts/ios26-core-replacement-proof-shape-check.py --batch IOS26-T04E-B01
```
...
Green: Calendar P0 harness exists and blocks unsupported claims.
Yellow: bounded gap with owner, reason, no-claim boundary, validation posture, and post-batch gate.
Red: No explicit Calendar P0 contract harness exists.

## Rollback behavior
Revert only files touched by `IOS26-T04E-B01`. Preserve unrelated dirty work and generated artifacts outside this batch.
...
# IOS26-T04E-B01 - Calendar replacement contract harness
...
Calendar P0 scheduled blocks, recurrence, EventKit permission, denied fallback, conflicts, protected/free time, schedule receipts, Today consumption.
