...
MRI48-PRODUCT-NARRATIVE-APP-STORE-PROOF-DRAFT

# Runner Command

```bash
make batch BATCH=MRI48-PRODUCT-NARRATIVE-APP-STORE-PROOF-DRAFT PROMPT=prompts/batches/MRI48-PRODUCT-NARRATIVE-APP-STORE-PROOF-DRAFT.md
```

# Objective

Draft product narrative, App Store proof packet, metadata inputs from evidence only.
...
Proof expectation: Draft packet with no-claims.
...
```text
docs/audits/mri48-product-narrative-app-store-proof-draft-report.md
```
