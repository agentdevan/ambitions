...
```bash
make batch BATCH=MRI35-MOAT-GOLDEN-SCENARIO-SUITE PROMPT=prompts/batches/MRI35-MOAT-GOLDEN-SCENARIO-SUITE.md
```

# Objective

Install canonical end-to-end golden scenarios for the Ambitions product loops.
...
No runtime claims without tests.
...
Proof expectation: Scenario definitions and runner.
...
```text
docs/audits/mri35-moat-golden-scenario-suite-report.md
```
