...
# IOS26-T06-B03 - Sealed IOS26 Work Order
...
## Objective
Create a permission-aware local time reality provider.
...
Calendar reality service abstraction, denied/stale states, tests.

## Forbidden files/directories
No silent calendar dependency. No upload/sync.

## Exact implementation steps
Add available/denied/not requested/stale/unavailable states; feed state into capacity; show degraded copy; add permission matrix tests.
...
build/reports/lifeshape-field/calendar-reality-provider.md
...
# IOS26-T06-B03 — Calendar reality provider

## Batch type
EventKit/time reality

## Objective
Create a permission-aware local time reality provider.

## Why this exists
Time reality must be safe when calendar access is denied, stale, unavailable, or partial.
...
Services; Runtime; Time feature; tests.
...
Calendar access cannot be required for core runtime.
