...
# IOS26-T12-B01 - Sealed IOS26 Work Order
...
## Objective
Modernize widgets and Live Activity for iOS 26 minimum and privacy-safe snapshots.
...
Widget/Live Activity source, snapshot projection, tests, privacy redaction.

## Forbidden files/directories
No sensitive default content. No silent mutation.

## Exact implementation steps
Remove obsolete availability after SDK confirmation; ensure freshness/expiry; redact sensitive details; add stale/no-data state; add tests.
...
build/reports/external-surfaces/widget-live-activity.md
...
# IOS26-T12-B01 — Widget / Live Activity modernization
...
## Why this exists
External surfaces must be current, local, and redacted.
...
Widget extension; AppUI; ExternalSnapshots; tests.
...
Device/widget gallery proof can remain Yellow.
