...
MRI05-RECOVERY-THREAD-RUNTIME

# Runner Command

```bash
make batch BATCH=MRI05-RECOVERY-THREAD-RUNTIME PROMPT=prompts/batches/MRI05-RECOVERY-THREAD-RUNTIME.md
```

# Objective

Make RecoveryThread a first-class runtime object with last honest point, preserved proof, re-entry step, and receipt behavior.
...
No productivity shame or generic recovery dashboard.
...
Proof expectation: Recovery scenario tests when implemented.
