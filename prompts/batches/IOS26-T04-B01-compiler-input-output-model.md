...
# IOS26-T04-B01 - Sealed IOS26 Work Order
...
## Objective
Create formal goal intent-to-day compiler models.
...
Domain models/contracts/tests.

## Forbidden files/directories
No UI changes. No persistence schema change unless migration-safe.

## Exact implementation steps
Add GoalIntent, assumptions, CompiledStep, receipt, clarification, blocked reason; map existing drafts/plans/steps; add clear/ambiguous/blocked fixtures.
...
build/reports/goal-intent-compiler/input-output-model.md
...
# IOS26-T04-B01 — Compiler input/output model

## Batch type
Domain/runtime compiler foundation

## Objective
Create formal goal intent-to-day compiler models.

## Why this exists
Goal creation must produce deterministic, inspectable daily Step candidates.
...
Native/Ambitions/Domain/; GoalEngine; Planning; Runtime; Domain/Runtime tests.
...
Models must stay deterministic/local.
