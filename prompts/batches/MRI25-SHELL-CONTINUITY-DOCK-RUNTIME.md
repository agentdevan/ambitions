...
```bash
make batch BATCH=MRI25-SHELL-CONTINUITY-DOCK-RUNTIME PROMPT=prompts/batches/MRI25-SHELL-CONTINUITY-DOCK-RUNTIME.md
```

# Objective

Define/implement shell continuity, dock, context crown, trust/receipt affordances, and object-origin transitions.
...
No sixth tab, no Plan top-level.
...
Proof expectation: UI/preview proof when implemented.
...
```text
docs/audits/mri25-shell-continuity-dock-runtime-report.md
```
