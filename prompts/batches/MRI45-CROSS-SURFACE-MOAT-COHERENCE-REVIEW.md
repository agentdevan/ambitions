...
MRI45-CROSS-SURFACE-MOAT-COHERENCE-REVIEW

# Runner Command

```bash
make batch BATCH=MRI45-CROSS-SURFACE-MOAT-COHERENCE-REVIEW PROMPT=prompts/batches/MRI45-CROSS-SURFACE-MOAT-COHERENCE-REVIEW.md
```

# Objective

Review Today/Goals/Capture/Time/You for Ambition Graph, proof, recovery, source, trust, local learning, receipts.

Operating system: **Assurance Lab**  
Product loop: **Visual runtime acceptance**
...
Proof expectation: Coherence review packet.
...
```text
docs/audits/mri45-cross-surface-moat-coherence-review-report.md
```
