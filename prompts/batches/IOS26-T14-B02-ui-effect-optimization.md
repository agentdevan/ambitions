...
# IOS26-T14-B02 - Sealed IOS26 Work Order

## Batch ID
`IOS26-T14-B02`

## Train ID and title
`TRAIN_14` - Performance, Instruments, power, launch, scroll, memory

## Batch role in train
Batch 2 of 3 in TRAIN_14

## Upstream dependencies
- `TRAIN_02`
- `TRAIN_05_through_TRAIN_13`
- `TRAIN_04K_for_performance_budgets_across_replacement_flows`

## Downstream dependencies
- none recorded

## Objective
Optimize expensive UI effects while preserving flagship feel.
...
Lazy loading, effect throttling, reduced material intensity, animation simplification.

## Forbidden files/directories
No broad visual downgrade without screenshot comparison.

## Exact implementation steps
Identify high-cost gradients/glows/material stacks; throttle/simplify where measurable; add Reduce Motion/Transparency performance fallbacks; compare proof if possible.
...
build/reports/performance/ui-effect-optimization.md
...
# IOS26-T14-B02 — UI effect optimization
...
## Why this exists
Graphite/glass/celestial effects must not harm launch/scroll/battery.
...
## Tests to add/update
Build plus screenshot/perf comparison where possible.
...
Reasoned-only optimization is Yellow without measurements.
