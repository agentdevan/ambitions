...
# IOS26-T04F-B05 - Sealed IOS26 Work Order
...
- No Assistant, generic status board, Calendar, Plan, Inbox, Review, or Profile top-level IA.
- No chat-first UI.
...
Green: Schedule mutation receipts and replay pass.
Yellow: bounded gap with owner, reason, no-claim boundary, validation posture, and post-batch gate.
Red: Schedule mutation has no receipt.

## Rollback behavior
Revert only files touched by `IOS26-T04F-B05`. Preserve unrelated dirty work and generated artifacts outside this batch.
...
# IOS26-T04F-B05 - Schedule mutation receipts and replay
...
Calendar schedule trust job.

## Replacement P0 contract
Calendar P0 receipt contract: candidate preview, user approval, receipt on create/move/delete, replay trace, rollback.
