...
```bash
make batch BATCH=MRI28-CAPTURE-ATMOSPHERE-COMPOSER-RUNTIME PROMPT=prompts/batches/MRI28-CAPTURE-ATMOSPHERE-COMPOSER-RUNTIME.md
```

# Objective

Implement Capture as quiet composer with route reveal and proof/source/constraint/commitment/reflection routing.
...
Proof expectation: Capture visual/runtime proof.
...
```text
docs/audits/mri28-capture-atmosphere-composer-runtime-report.md
```
