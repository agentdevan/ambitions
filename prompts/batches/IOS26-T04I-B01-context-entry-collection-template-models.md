...
# IOS26-T04I-B01 - Sealed IOS26 Work Order
...
## Objective
Store structured life knowledge.
...
## Validation commands
```bash
python3 scripts/ios26-flagship-preflight.py --batch IOS26-T04I-B01
python3 scripts/ios26-core-replacement-proof-shape-check.py --batch IOS26-T04I-B01
```
...
Green: Knowledge models pass.
Yellow: bounded gap with owner, reason, no-claim boundary, validation posture, and post-batch gate.
Red: Structured life knowledge objects are missing.

## Rollback behavior
Revert only files touched by `IOS26-T04I-B01`. Preserve unrelated dirty work and generated artifacts outside this batch.
...
Notion structured knowledge job.

## Replacement P0 contract
Notion P0 model contract: ContextEntry, Collection, Template, Reflection, Decision, Resource, Person/Place context, migration/export/delete.
