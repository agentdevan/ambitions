...
# IOS26-T04-B02 - Sealed IOS26 Work Order
...
## Objective
Make compiler output sensitive to local capacity/time reality.
...
Compiler behavior, capacity models, tests.

## Forbidden files/directories
No external calendar dependency without fallback. No UI redesign.

## Exact implementation steps
Add capacity envelope input; include protected time, available windows, energy/recovery where existing models support them; test normal/low capacity/conflict/recovery outputs; include reasons.
...
## Why this exists
Same intent should produce different daily Steps for different local contexts.
...
Native/Ambitions/Runtime/; Domain/Planning; Services; Features/Time; tests.
