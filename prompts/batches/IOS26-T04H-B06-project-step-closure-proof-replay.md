...
# IOS26-T04H-B06 - Sealed IOS26 Work Order
...
## Validation commands
```bash
python3 scripts/ios26-flagship-preflight.py --batch IOS26-T04H-B06
python3 scripts/ios26-core-replacement-proof-shape-check.py --batch IOS26-T04H-B06
```
...
Green: Closure/proof/replay scenarios pass.
Yellow: bounded gap with owner, reason, no-claim boundary, validation posture, and post-batch gate.
Red: Completion is cosmetic or proof/replay is missing.

## Rollback behavior
Revert only files touched by `IOS26-T04H-B06`. Preserve unrelated dirty work and generated artifacts outside this batch.
...
Todoist/Things completion trust job.

## Replacement P0 contract
Todoist/Things closure: closure states, proof attachment, partial progress, recovery, replay, proof-preserving pivot.
