...
MRI09-SOURCE-TO-RECOMMENDATION-BRIDGE

# Runner Command

```bash
make batch BATCH=MRI09-SOURCE-TO-RECOMMENDATION-BRIDGE PROMPT=prompts/batches/MRI09-SOURCE-TO-RECOMMENDATION-BRIDGE.md
```

# Objective

Bridge Source Atlas claim/proof/freshness/risk states into recommendation evidence.
...
No fake certainty or AI-branded recommendations.
...
Proof expectation: Focused source/recommendation tests when implemented.
