...
MRI20-REFLOW-DECISION-FOLD

# Runner Command

```bash
make batch BATCH=MRI20-REFLOW-DECISION-FOLD PROMPT=prompts/batches/MRI20-REFLOW-DECISION-FOLD.md
```

# Objective

Define consent-based reflow: what moved, why, what proof survives, what changed, receipt path.
...
Proof expectation: Reflow tests.
...
```text
docs/audits/mri20-reflow-decision-fold-report.md
```
