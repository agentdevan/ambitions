...
# IOS26-T04I-B04 - Sealed IOS26 Work Order
...
Find life knowledge fast. Implement only the scoped local-first behavior after inspecting current source, then prove it with focused tests and proof artifacts.
...
Green: Local search tests and budget pass.
Yellow: bounded gap with owner, reason, no-claim boundary, validation posture, and post-batch gate.
Red: No local search or external search service is required.

## Rollback behavior
Revert only files touched by `IOS26-T04I-B04`. Preserve unrelated dirty work and generated artifacts outside this batch.
...
# IOS26-T04I-B04 - Local knowledge search and filters
...
Notion local search job.

## Replacement P0 contract
Notion P0 search: local search index and filters by type, life area, goal thread, source, date, proof, sensitivity, review state, performance budget, no external service.
