...
# IOS26-T04F-B01 - Sealed IOS26 Work Order
...
## Objective
Create/manage local schedule blocks.
...
Green: Local schedule objects are durable and tested.
Yellow: bounded gap with owner, reason, no-claim boundary, validation posture, and post-batch gate.
Red: No durable local schedule object exists.

## Rollback behavior
Revert only files touched by `IOS26-T04F-B01`. Preserve unrelated dirty work and generated artifacts outside this batch.
...
Calendar local schedule block job.
