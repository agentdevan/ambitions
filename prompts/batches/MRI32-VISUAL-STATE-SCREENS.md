...
```bash
make batch BATCH=MRI32-VISUAL-STATE-SCREENS PROMPT=prompts/batches/MRI32-VISUAL-STATE-SCREENS.md
```

# Objective

Implement/render non-happy states: empty, loading, source needed, stale, blocked, waiting, recovery, low confidence, offline, permission denied.
...
Proof expectation: State fixture proof.
...
```text
docs/audits/mri32-visual-state-screens-report.md
```
