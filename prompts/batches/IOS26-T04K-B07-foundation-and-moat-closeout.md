...
# IOS26-T04K-B07 - Sealed IOS26 Work Order
...
## Objective
Close the replacement foundation and runtime integration before T05.
...
- Keep proof artifacts under `build/reports/private-life-runtime-integration/`.
...
Close the replacement foundation and runtime integration before T05. Implement only the scoped local-first behavior after inspecting current source, then prove it with focused tests and proof artifacts.

## Validation commands
```bash
python3 scripts/ios26-flagship-preflight.py --batch IOS26-T04K-B07
python3 scripts/ios26-core-replacement-proof-shape-check.py --batch IOS26-T04K-B07
```
...
Green: T04E-T04K status and claims are explicit before T05 resumes.
Yellow: bounded gap with owner, reason, no-claim boundary, validation posture, and post-batch gate.
Red: Downstream T05 proceeds as final flagship surface without gate.

## Rollback behavior
Revert only files touched by `IOS26-T04K-B07`. Preserve unrelated dirty work and generated artifacts outside this batch.
...
# IOS26-T04K-B07 - Foundation and moat closeout
...
Foundation and runtime closeout job.

## Replacement P0 contract
Closeout contract: summarize T04E-T04K, P0 contracts Green/Yellow/Red, allowed/forbidden claims, downstream gates, next eligible train.
...
Private Life Runtime; Recommendation domain; Today Start Here; Time/Reminder/Project/Life Knowledge adapters; Proof/Receipts/Replay; Native/AmbitionsTests; Native/AmbitionsUITests; build/reports/private-life-runtime-integration/.
