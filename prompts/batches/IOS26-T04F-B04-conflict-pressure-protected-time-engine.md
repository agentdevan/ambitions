...
# IOS26-T04F-B04 - Sealed IOS26 Work Order
...
## Objective
Avoid overbooking and preserve what matters.
...
Avoid overbooking and preserve what matters. Implement only the scoped local-first behavior after inspecting current source, then prove it with focused tests and proof artifacts.
...
Green: Conflict and protected-time tests pass.
Yellow: bounded gap with owner, reason, no-claim boundary, validation posture, and post-batch gate.
Red: Protected time can be violated silently.

## Rollback behavior
Revert only files touched by `IOS26-T04F-B04`. Preserve unrelated dirty work and generated artifacts outside this batch.
...
# IOS26-T04F-B04 - Conflict pressure and protected-time engine
...
Calendar conflict and protected-time job.

## Replacement P0 contract
Calendar P0 conflict contract: conflict detection, overload/pressure without quantified productivity-ranking language, protected-time violation detection, source explanation.
