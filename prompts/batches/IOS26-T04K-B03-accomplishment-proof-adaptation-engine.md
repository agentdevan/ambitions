...
# IOS26-T04K-B03 - Sealed IOS26 Work Order
...
Green: Adaptation tests pass.
Yellow: bounded gap with owner, reason, no-claim boundary, validation posture, and post-batch gate.
Red: Closure/proof does not affect later recommendations.

## Rollback behavior
Revert only files touched by `IOS26-T04K-B03`. Preserve unrelated dirty work and generated artifacts outside this batch.
...
# IOS26-T04K-B03 - Accomplishment proof adaptation engine
...
Accomplishment adaptation job.

## Replacement P0 contract
Runtime adaptation contract: Completed, Still counts, Waiting, Blocked, Needs recovery, proof-preserving pivot, user-approved reflow affect later recommendations.
