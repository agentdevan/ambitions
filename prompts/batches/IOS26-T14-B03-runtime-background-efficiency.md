...
# IOS26-T14-B03 - Sealed IOS26 Work Order
...
## Objective
Reduce unnecessary background/runtime refresh and external snapshot churn.
...
Refresh cadence, snapshot invalidation, background maintenance scheduling, tests.

## Forbidden files/directories
No background upload. No cloud dependency.

## Exact implementation steps
Audit refresh calls; add coalescing/debounce; add stale/fresh thresholds; add tests for no unnecessary refresh.
...
build/reports/performance/runtime-background-efficiency.md
...
# IOS26-T14-B03 — Runtime/background efficiency
...
## Why this exists
Local-first intelligence should not drain battery.

## Dependencies
Train 11, Train 12, Train 14-B01.
...
Runtime; Services; ExternalSnapshots; App; tests.
...
Background user-data network activity is Red.
