...
# IOS26-T04H-B01 - Sealed IOS26 Work Order
...
Organize projects and tasks. Implement only the scoped local-first behavior after inspecting current source, then prove it with focused tests and proof artifacts.

## Validation commands
```bash
python3 scripts/ios26-flagship-preflight.py --batch IOS26-T04H-B01
python3 scripts/ios26-core-replacement-proof-shape-check.py --batch IOS26-T04H-B01
```
...
- `build/reports/project-step-operations/goal-thread-project-commitment-hierarchy.md`
...
Green: Hierarchy objects and tests pass.
Yellow: bounded gap with owner, reason, no-claim boundary, validation posture, and post-batch gate.
Red: Projects are cosmetic and not durable object hierarchy.

## Rollback behavior
Revert only files touched by `IOS26-T04H-B01`. Preserve unrelated dirty work and generated artifacts outside this batch.
...
# IOS26-T04H-B01 - GoalThread project commitment hierarchy
...
Todoist project organization job.

## Replacement P0 contract
Todoist/Things P0 hierarchy: GoalThread, Commitment group, Step hierarchy, checklist items, LifeArea ownership, repository integration.
