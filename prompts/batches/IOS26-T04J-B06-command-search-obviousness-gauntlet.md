...
# IOS26-T04J-B06 - Sealed IOS26 Work Order
...
## Objective
Prove the app is obvious and fast enough.
...
Prove the app is obvious and fast enough. Implement only the scoped local-first behavior after inspecting current source, then prove it with focused tests and proof artifacts.
...
Green: 300+ scenarios pass or Yellow is bounded.
Yellow: bounded gap with owner, reason, no-claim boundary, validation posture, and post-batch gate.
Red: Command/search/obviousness P0 is not Green or accepted Yellow with no broad claim.

## Rollback behavior
Revert only files touched by `IOS26-T04J-B06`. Preserve unrelated dirty work and generated artifacts outside this batch.
...
# IOS26-T04J-B06 - Command search obviousness gauntlet
...
Command/search gauntlet: at least 300 deterministic scenarios for quick capture, search, command, actions, empty states, onboarding, continuity, accessibility states, performance.
