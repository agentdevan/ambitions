...
# IOS26-T04G-B06 - Sealed IOS26 Work Order
...
## Objective
Prove Reminders P0 replacement.
...
Prove Reminders P0 replacement. Implement only the scoped local-first behavior after inspecting current source, then prove it with focused tests and proof artifacts.

## Validation commands
```bash
python3 scripts/ios26-flagship-preflight.py --batch IOS26-T04G-B06
python3 scripts/ios26-core-replacement-proof-shape-check.py --batch IOS26-T04G-B06
```
...
- `build/reports/reminder-operations/reminders-replacement-gauntlet.md`
...
Green: 300+ Reminders scenarios pass or Yellow is bounded.
Yellow: bounded gap with owner, reason, no-claim boundary, validation posture, and post-batch gate.
Red: Reminders P0 is not Green or accepted Yellow with no replacement claim.

## Rollback behavior
Revert only files touched by `IOS26-T04G-B06`. Preserve unrelated dirty work and generated artifacts outside this batch.
...
# IOS26-T04G-B06 - Reminders replacement gauntlet
...
Reminders P0 proof job.

## Replacement P0 contract
Reminders P0 gauntlet: at least 300 deterministic scenarios covering triggers, notification abstraction, recurrence, closure/recovery, receipts/replay.
...
Native/Ambitions/Domain; notification runtime/services; Capture service; Today/Time/Goals features; Persistence; Native/AmbitionsTests; build/reports/reminder-operations/.
