...
MRI21-PRESSURE-RECOVERY-BRIDGE

# Runner Command

```bash
make batch BATCH=MRI21-PRESSURE-RECOVERY-BRIDGE PROMPT=prompts/batches/MRI21-PRESSURE-RECOVERY-BRIDGE.md
```

# Objective

Connect high pressure or lost capacity to recovery-aware Start Here suggestions.
...
Proof expectation: Pressure/recovery scenario proof.
...
```text
docs/audits/mri21-pressure-recovery-bridge-report.md
```
