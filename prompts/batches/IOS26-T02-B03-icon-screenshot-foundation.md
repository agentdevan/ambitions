...
# IOS26-T02-B03 - Sealed IOS26 Work Order
...
## Objective
Create screenshot/icon proof infrastructure for iOS 26 visual QA.
...
Scripts/docs/tests for screenshot proof. Asset planning only unless existing asset workflow is clear.

## Forbidden files/directories
Do not fake screenshots. Do not claim visual approval.

## Exact implementation steps
Add screenshot matrix doc/script/test helper if feasible; define required surfaces/states; record icon variant requirements and current asset status; add no-claim boundaries.
...
build/reports/ios26-shell/screenshot-foundation.md
...
# IOS26-T02-B03 — Icon and screenshot foundation

## Batch type
Visual proof foundation
...
Native/Ambitions/Resources/; Native/Ambitions/PreviewSupport/; Native/AmbitionsUITests/; scripts/; docs/truth/RELEASE_TRUTH.md.
...
## Tests to add/update
Screenshot helper/UI tests if feasible.
...
Visual proof unavailable remains Yellow.
