...
MRI24-REALITY-FIT-GOLDEN-TESTS

# Runner Command

```bash
make batch BATCH=MRI24-REALITY-FIT-GOLDEN-TESTS PROMPT=prompts/batches/MRI24-REALITY-FIT-GOLDEN-TESTS.md
```

# Objective

Install golden scenarios for protected time, blocked commitment, short window, high pressure, and recovery fit.
...
Proof expectation: Scenario/eval proof.
...
```text
docs/audits/mri24-reality-fit-golden-tests-report.md
```
