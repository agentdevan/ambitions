...
MRI39-SOURCE-TRUST-EVALS

# Runner Command

```bash
make batch BATCH=MRI39-SOURCE-TRUST-EVALS PROMPT=prompts/batches/MRI39-SOURCE-TRUST-EVALS.md
```

# Objective

Evaluate claim state, freshness, proof, source-needed state, uncertainty, and Trust Seam output.
...
```text
docs/audits/mri39-source-trust-evals-report.md
```
