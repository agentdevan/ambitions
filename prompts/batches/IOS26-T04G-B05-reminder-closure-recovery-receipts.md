...
# IOS26-T04G-B05 - Sealed IOS26 Work Order
...
Close reminders without shame. Implement only the scoped local-first behavior after inspecting current source, then prove it with focused tests and proof artifacts.

## Validation commands
```bash
python3 scripts/ios26-flagship-preflight.py --batch IOS26-T04G-B05
python3 scripts/ios26-core-replacement-proof-shape-check.py --batch IOS26-T04G-B05
```
...
- `build/reports/reminder-operations/reminder-closure-recovery-receipts.md`
...
Green: Closure/recovery receipt tests pass.
Yellow: bounded gap with owner, reason, no-claim boundary, validation posture, and post-batch gate.
Red: Closure uses delayed-delivery framing or lacks receipt.

## Rollback behavior
Revert only files touched by `IOS26-T04G-B05`. Preserve unrelated dirty work and generated artifacts outside this batch.
...
# IOS26-T04G-B05 - Reminder closure recovery receipts
...
Reminders closure and recovery job.

## Replacement P0 contract
Reminders P0 closure contract: Completed, Still counts, Moved, Waiting, Blocked, Not needed, Needs recovery, Needs review, closure receipt, recovery, replay.
