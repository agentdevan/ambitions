...
MRI41-ACCESSIBILITY-SCENARIO-PROOF

# Runner Command

```bash
make batch BATCH=MRI41-ACCESSIBILITY-SCENARIO-PROOF PROMPT=prompts/batches/MRI41-ACCESSIBILITY-SCENARIO-PROOF.md
```

# Objective

Prove scenario-level VoiceOver, Dynamic Type, Reduce Motion, Increase Contrast, tap targets, and cognitive load.
...
No public conformance claim until complete.
...
Proof expectation: Accessibility proof packet.
...
```text
docs/audits/mri41-accessibility-scenario-proof-report.md
```
