...
# IOS26-T04K-B06 - Sealed IOS26 Work Order
...
## Validation commands
```bash
python3 scripts/ios26-flagship-preflight.py --batch IOS26-T04K-B06
python3 scripts/ios26-core-replacement-proof-shape-check.py --batch IOS26-T04K-B06
```
...
Green: 1,200+ scenarios pass or Yellow is bounded.
Yellow: bounded gap with owner, reason, no-claim boundary, validation posture, and post-batch gate.
Red: Private Life Runtime moat is claimed without replayable local proof.

## Rollback behavior
Revert only files touched by `IOS26-T04K-B06`. Preserve unrelated dirty work and generated artifacts outside this batch.
...
# IOS26-T04K-B06 - Cross-surface Private Life Runtime gauntlet
...
Foundation plus moat proof job.

## Replacement P0 contract
Runtime gauntlet: at least 1,200 deterministic scenarios covering replacement foundations, same-goal/different-context, adaptation, capture-to-runtime, sensitive review, replay/export/delete, no cloud LLM.
