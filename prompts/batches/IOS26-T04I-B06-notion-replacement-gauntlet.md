...
# IOS26-T04I-B06 - Sealed IOS26 Work Order
...
Prove Notion P0 replacement. Implement only the scoped local-first behavior after inspecting current source, then prove it with focused tests and proof artifacts.
...
Green: 400+ scenarios pass or Yellow is bounded.
Yellow: bounded gap with owner, reason, no-claim boundary, validation posture, and post-batch gate.
Red: Notion P0 is not Green or accepted Yellow with no replacement claim.

## Rollback behavior
Revert only files touched by `IOS26-T04I-B06`. Preserve unrelated dirty work and generated artifacts outside this batch.
...
Notion P0 gauntlet: at least 400 deterministic scenarios for notes/references/resources/decisions/proof, collections/templates/relations/search, conversion, source usage, export/delete/reset, replay.
