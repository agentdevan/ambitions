...
# IOS26-T04E-B02 - Sealed IOS26 Work Order
...
## Objective
Install Reminders replacement contract tests/fixtures/proof requirements.
...
## Validation commands
```bash
python3 scripts/ios26-flagship-preflight.py --batch IOS26-T04E-B02
python3 scripts/ios26-core-replacement-proof-shape-check.py --batch IOS26-T04E-B02
```
...
Green: Reminders P0 harness exists and blocks unsupported claims.
Yellow: bounded gap with owner, reason, no-claim boundary, validation posture, and post-batch gate.
Red: No explicit Reminders P0 contract harness exists.

## Rollback behavior
Revert only files touched by `IOS26-T04E-B02`. Preserve unrelated dirty work and generated artifacts outside this batch.
...
# IOS26-T04E-B02 - Reminders replacement contract harness
...
Reminders P0 parse, trigger, recurrence, notification abstraction, snooze/reschedule, closure, visibility, receipt/replay.
