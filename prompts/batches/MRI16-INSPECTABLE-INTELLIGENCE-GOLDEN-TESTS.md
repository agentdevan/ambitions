...
MRI16-INSPECTABLE-INTELLIGENCE-GOLDEN-TESTS

# Runner Command

```bash
make batch BATCH=MRI16-INSPECTABLE-INTELLIGENCE-GOLDEN-TESTS PROMPT=prompts/batches/MRI16-INSPECTABLE-INTELLIGENCE-GOLDEN-TESTS.md
```

# Objective

Install golden scenarios for source-backed recommendation, correction, reset/delete learning, and Why This? behavior.
