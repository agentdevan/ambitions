...
Generic surface, static profile clone, source/proof loss, review bypass, or release/readiness claims.
...
Stop on generic surface drift, review bypass, provenance loss, or missing visual proof for UI changes.
