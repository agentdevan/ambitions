...
# IOS26-T04H-B05 - Sealed IOS26 Work Order
...
Green: Planning operations are receipt-backed.
Yellow: bounded gap with owner, reason, no-claim boundary, validation posture, and post-batch gate.
Red: Material changes have no receipt or operation contract is absent.

## Rollback behavior
Revert only files touched by `IOS26-T04H-B05`. Preserve unrelated dirty work and generated artifacts outside this batch.
...
Todoist/Things planning operation job.

## Replacement P0 contract
Todoist/Things operations: move, hold, schedule, unschedule, mark waiting, mark blocked, attach proof, bulk/downstream contract, receipts.
