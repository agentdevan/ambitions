...
# IOS26-T15-B02 - Sealed IOS26 Work Order
...
## Objective
Create a concrete extract/archive/delete plan for historical material.
...
No delete/archive/move without explicit user approval.

## Exact implementation steps
Classify historical/supporting/active files; identify conflicts; choose keep/supporting/extract-archive/extract-delete/delete-candidate; add rollback notes.
...
build/reports/repo-hygiene/historical-quarantine-plan.md
...
# IOS26-T15-B02 — Historical quarantine plan

## Batch type
Repo hygiene/historical policy

## Objective
Create a concrete extract/archive/delete plan for historical material.

## Why this exists
Historical docs can confuse Codex but deletion requires approval.
...
docs/canon; docs/AmbitionsCanon; docs/audits; docs/handoff; docs/codex/batches; prompts; .codex; .agents.
