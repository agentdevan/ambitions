...
MRI47-APPLE-NATIVE-SURFACE-COHERENCE

# Runner Command

```bash
make batch BATCH=MRI47-APPLE-NATIVE-SURFACE-COHERENCE PROMPT=prompts/batches/MRI47-APPLE-NATIVE-SURFACE-COHERENCE.md
```

# Objective

Review widgets/App Intents/share/notifications/Live Activity for receipts/trust/policy boundaries.
...
No device validation claim without device proof.
...
Proof expectation: External surface proof packet.
...
```text
docs/audits/mri47-apple-native-surface-coherence-report.md
```
