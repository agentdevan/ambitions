...
# IOS26-T12-B03 - Sealed IOS26 Work Order
...
## Objective
Harden share extension input, receipt, accessibility, and failure behavior.
...
Share extension UI/intake service/tests.

## Forbidden files/directories
No sensitive debug logs. No unconfirmed goal creation.

## Exact implementation steps
Handle empty/large/URL/text/unknown type; add local receipt/provenance; add accessible labels/failure copy; test request creation and landing route.
...
build/reports/external-surfaces/share-extension.md
...
# IOS26-T12-B03 — Share extension hardening
...
## Why this exists
Share intake must not lose or leak user input.
...
Share extension; ExternalSnapshots; Capture feature; tests.
...
Manual share sheet proof can remain Yellow.
