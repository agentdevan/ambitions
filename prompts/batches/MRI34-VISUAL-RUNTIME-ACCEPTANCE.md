...
```bash
make batch BATCH=MRI34-VISUAL-RUNTIME-ACCEPTANCE PROMPT=prompts/batches/MRI34-VISUAL-RUNTIME-ACCEPTANCE.md
```

# Objective

Run anti-generic/native iPhone/object-first/Trust Seam/receipt/recovery visual acceptance review.
...
Proof expectation: Visual acceptance packet.
...
```text
docs/audits/mri34-visual-runtime-acceptance-report.md
```
