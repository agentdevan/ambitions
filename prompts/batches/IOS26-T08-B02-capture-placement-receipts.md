...
# IOS26-T08-B02 - Sealed IOS26 Work Order

## Batch ID
`IOS26-T08-B02`

## Train ID and title
`TRAIN_08` - Capture / Atmosphere Composer final object

## Batch role in train
Batch 2 of 3 in TRAIN_08
...
## Objective
Add editable placement decisions and receipts for captured material.
...
Capture placement models/services/UI receipts/tests.

## Forbidden files/directories
No silent goal creation. No irreversible promotion without confirmation.

## Exact implementation steps
Add placement decisions; write/display receipt; add correction/undo where feasible; test capture to placement to receipt.
...
build/reports/atmosphere-composer/placement-receipts.md
...
# IOS26-T08-B02 — Capture placement receipts
...
## Why this exists
Capture must show where something went and why.
...
Capture domain; Services; Persistence; Capture feature; tests.
