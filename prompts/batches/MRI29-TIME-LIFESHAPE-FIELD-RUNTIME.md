...
```bash
make batch BATCH=MRI29-TIME-LIFESHAPE-FIELD-RUNTIME PROMPT=prompts/batches/MRI29-TIME-LIFESHAPE-FIELD-RUNTIME.md
```

# Objective

Implement Time as LifeShape Field with capacity, pressure, protected/open time, reflow, and horizons.
...
Proof expectation: Time visual/runtime proof.
...
```text
docs/audits/mri29-time-lifeshape-field-runtime-report.md
```
