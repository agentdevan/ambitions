...
MRI07-AMBITION-GRAPH-CROSS-SURFACE-WIRING

# Runner Command

```bash
make batch BATCH=MRI07-AMBITION-GRAPH-CROSS-SURFACE-WIRING PROMPT=prompts/batches/MRI07-AMBITION-GRAPH-CROSS-SURFACE-WIRING.md
```

# Objective

Wire Ambition Graph context into Today, Goals, Capture, Time, and You as a cross-surface product loop.
...
No broad UI rewrite unless later scoped.
...
Proof expectation: Cross-surface golden scenario proof.
