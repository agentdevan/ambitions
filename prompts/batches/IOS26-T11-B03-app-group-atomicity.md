...
# IOS26-T11-B03 - Sealed IOS26 Work Order
...
## Objective
Make App Group reads/writes atomic and failure-aware.
...
Shared store atomic writes, error handling, tests.

## Forbidden files/directories
No sensitive logs. No external network.

## Exact implementation steps
Inspect shared stores; add temp-write/rename if absent; add stale/corrupt read behavior; add concurrent-like tests; add degraded state.
...
build/reports/data-safety/app-group-atomicity.md
...
# IOS26-T11-B03 — App Group atomicity

## Batch type
External local durability

## Objective
Make App Group reads/writes atomic and failure-aware.

## Why this exists
Widgets, App Intents, and share extension rely on shared local files/snapshots.
...
ExternalSnapshots; Share extension; Widget extension; AppIntents; tests.
...
Sensitive content leaks are Red.
