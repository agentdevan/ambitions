...
# IOS26-T15-B01 - Sealed IOS26 Work Order
...
## Objective
Clarify active docs front door and proof boundaries.
...
Active docs front-door clarification only.

## Forbidden files/directories
No source changes. No historical deletion.

## Exact implementation steps
Ensure docs route to truth files; remove/soften overclaims; add no-claim boundaries; keep concise.
...
build/reports/repo-hygiene/active-docs-front-door.md
...
# IOS26-T15-B01 — Active docs front door

## Batch type
Repo hygiene/docs governance

## Objective
Clarify active docs front door and proof boundaries.

## Why this exists
Fresh Codex sessions must start from truth files and not old canon/prompts.
...
README.md; AGENTS.md; docs/README.md; docs/truth/; docs/codex/.
...
Docs-only; no app behavior claim.
