...
```bash
make batch BATCH=MRI31-NATIVE-APPLE-SURFACES-WITH-RECEIPTS PROMPT=prompts/batches/MRI31-NATIVE-APPLE-SURFACES-WITH-RECEIPTS.md
```

# Objective

Ensure Widget/App Intent/Shortcut/Share/Notification/Live Activity actions route through policy guard, command/event, side-effect ledger, and receipts.

Operating system: **Native Signature Interface**  
Product loop: **Native Apple surfaces with receipts**
...
No external surface bypass of trust policy.
...
Proof expectation: External surface focused tests.
...
```text
docs/audits/mri31-native-apple-surfaces-with-receipts-report.md
```
