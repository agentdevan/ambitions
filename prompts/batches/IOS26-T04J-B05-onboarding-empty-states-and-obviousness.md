...
# IOS26-T04J-B05 - Sealed IOS26 Work Order
...
Understand how to operate life from Ambitions immediately. Implement only the scoped local-first behavior after inspecting current source, then prove it with focused tests and proof artifacts.
...
# IOS26-T04J-B05 - Onboarding empty states and obviousness
...
Obvious first-run operation job.

## Replacement P0 contract
Obviousness contract: surfaces explain jobs under 3 seconds; empty states; first-run route Capture anything, Shape time, Create goal, Start here, Close with proof, Inspect what Ambitions knows.
