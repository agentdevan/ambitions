...
MRI02-AMBITION-GRAPH-PROJECTION-STORE

# Runner Command

```bash
make batch BATCH=MRI02-AMBITION-GRAPH-PROJECTION-STORE PROMPT=prompts/batches/MRI02-AMBITION-GRAPH-PROJECTION-STORE.md
```

# Objective

Define projection stores for Today, Goals, Capture, Time, and You Ambition Graph context.
...
No storage migration or Package.swift/project.yml changes in prompt planning phase.
...
Proof expectation: Projection contract and focused tests when implementation runs.
