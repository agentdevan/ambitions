...
# IOS26-T04G-B01 - Sealed IOS26 Work Order
...
## Objective
Create reminders as durable local life objects.
...
Create reminders as durable local life objects. Implement only the scoped local-first behavior after inspecting current source, then prove it with focused tests and proof artifacts.
...
Green: Reminder trigger models and repository pass.
Yellow: bounded gap with owner, reason, no-claim boundary, validation posture, and post-batch gate.
Red: No durable reminder trigger object exists.

## Rollback behavior
Revert only files touched by `IOS26-T04G-B01`. Preserve unrelated dirty work and generated artifacts outside this batch.
...
# IOS26-T04G-B01 - Reminder trigger models and repositories
...
Reminders P0 object contract: ReminderTrigger, ReminderDeliveryPolicy, ReminderSource, ReminderState, Commitment/Step attachment, repository, migration/export/delete.
