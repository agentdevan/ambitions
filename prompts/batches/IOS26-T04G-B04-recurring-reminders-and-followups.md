...
# IOS26-T04G-B04 - Sealed IOS26 Work Order
...
## Objective
Use recurring obligations and waiting follow-ups.
...
Use recurring obligations and waiting follow-ups. Implement only the scoped local-first behavior after inspecting current source, then prove it with focused tests and proof artifacts.
...
Green: Recurring/follow-up tests pass.
Yellow: bounded gap with owner, reason, no-claim boundary, validation posture, and post-batch gate.
Red: Recurring reminders or follow-ups are missing.

## Rollback behavior
Revert only files touched by `IOS26-T04G-B04`. Preserve unrelated dirty work and generated artifacts outside this batch.
...
Reminders recurring obligation job.

## Replacement P0 contract
Reminders P0 recurrence contract: recurrence generation, missed trigger handling, waiting follow-up, blocked follow-up, reschedule/snooze.
