...
MRI46-USER-JOURNEY-END-TO-END-PROOF

# Runner Command

```bash
make batch BATCH=MRI46-USER-JOURNEY-END-TO-END-PROOF PROMPT=prompts/batches/MRI46-USER-JOURNEY-END-TO-END-PROOF.md
```

# Objective

Prove new user, daily use, capture-heavy, pivot, recovery, source-heavy, privacy-control journeys.
...
Proof expectation: Journey proof packet.
...
```text
docs/audits/mri46-user-journey-end-to-end-proof-report.md
```
