...
# IOS26-T08-B01 - Sealed IOS26 Work Order
...
## Objective
Make Atmosphere Composer the dominant Capture object.
...
Capture UI/view model, tests/previews.

## Forbidden files/directories
No generic notes inbox or task feed.
...
# IOS26-T08-B01 — Atmosphere Composer dominance

## Batch type
Capture UI final object

## Objective
Make Atmosphere Composer the dominant Capture object.

## Why this exists
Capture should be composer-led, not feed/inbox-first.
...
Capture feature; Capture domain; tests.
...
Composer-first top level required.
