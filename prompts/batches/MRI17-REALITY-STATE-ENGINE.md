...
MRI17-REALITY-STATE-ENGINE

# Runner Command

```bash
make batch BATCH=MRI17-REALITY-STATE-ENGINE PROMPT=prompts/batches/MRI17-REALITY-STATE-ENGINE.md
```

# Objective

Unify day state, open time, protected time, pressure, blocked/waiting items, source freshness, and recovery context.
...
Proof expectation: Reality model tests.
...
```text
docs/audits/mri17-reality-state-engine-report.md
```
