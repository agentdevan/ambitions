...
# IOS26-T03-B03 - Sealed IOS26 Work Order
...
## Objective
Emit replayable decision traces from existing runtime service paths.
...
Trace models, service adapters, tests. Minimal non-visual Today model wiring only if needed.

## Forbidden files/directories
No visual redesign.

## Exact implementation steps
Capture inputs, capacity facts, alternatives, selected Step, rejection reasons, freshness/privacy facts; add deterministic fixture tests; defer persistence unless safe.
...
build/reports/private-life-runtime/decision-traces.md
...
# IOS26-T03-B03 — Replayable decision traces
...
## Why this exists
Users and tests need to inspect why a Step/recommendation was selected.

## Dependencies
IOS26-T03-B01 and IOS26-T03-B02.
...
Native/Ambitions/Runtime/; Native/Ambitions/Domain/Recommendation*; Native/Ambitions/Domain/Planning/; Native/Ambitions/Features/Today/; tests.
...
Trace must not leak private data.
