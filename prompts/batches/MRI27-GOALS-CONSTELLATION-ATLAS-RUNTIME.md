...
```bash
make batch BATCH=MRI27-GOALS-CONSTELLATION-ATLAS-RUNTIME PROMPT=prompts/batches/MRI27-GOALS-CONSTELLATION-ATLAS-RUNTIME.md
```

# Objective

Implement Goals as Constellation Atlas with Ambition Graph, goal threads, proof trail, alternate paths, Orbital Lens.
...
No KPI dashboard/ranked life scores.
...
Proof expectation: Goals visual/runtime proof.
...
```text
docs/audits/mri27-goals-constellation-atlas-runtime-report.md
```
