...
```bash
make batch BATCH=MRI26-TODAY-REALITY-MERIDIAN-RUNTIME PROMPT=prompts/batches/MRI26-TODAY-REALITY-MERIDIAN-RUNTIME.md
```

# Objective

Implement Today as Reality Meridian with Start Here, Now/Next/Later, closure, recovery, receipt, trust.

Operating system: **Native Signature Interface**  
Product loop: **Start Here daily execution**
...
No task-list or detached card UI.
...
Proof expectation: Today visual/runtime proof.
...
```text
docs/audits/mri26-today-reality-meridian-runtime-report.md
```
