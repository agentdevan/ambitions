...
MRI38-RECOVERY-QUALITY-EVALS

# Runner Command

```bash
make batch BATCH=MRI38-RECOVERY-QUALITY-EVALS PROMPT=prompts/batches/MRI38-RECOVERY-QUALITY-EVALS.md
```

# Objective

Evaluate recovery language, last honest point, proof preservation, lightest next action, and non-shame behavior.
...
```text
docs/audits/mri38-recovery-quality-evals-report.md
```
