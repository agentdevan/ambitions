...
```bash
make batch BATCH=MRI33-VISUAL-QA-PREVIEW-FIXTURES PROMPT=prompts/batches/MRI33-VISUAL-QA-PREVIEW-FIXTURES.md
```

# Objective

Create visual QA previews/fixtures for all primary surfaces and key states.
...
No visual completion claim without rendered evidence.
...
Proof expectation: Preview/screenshot proof.
...
```text
docs/audits/mri33-visual-qa-preview-fixtures-report.md
```
