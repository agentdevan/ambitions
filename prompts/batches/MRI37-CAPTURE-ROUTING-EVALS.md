...
MRI37-CAPTURE-ROUTING-EVALS

# Runner Command

```bash
make batch BATCH=MRI37-CAPTURE-ROUTING-EVALS PROMPT=prompts/batches/MRI37-CAPTURE-ROUTING-EVALS.md
```

# Objective

Evaluate capture classification/routing into proof, source, constraint, commitment, reflection, held item, goal seed.
...
```text
docs/audits/mri37-capture-routing-evals-report.md
```
