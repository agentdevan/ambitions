...
MRI06-REFLECTION-ADAPTATION-RUNTIME

# Runner Command

```bash
make batch BATCH=MRI06-REFLECTION-ADAPTATION-RUNTIME PROMPT=prompts/batches/MRI06-REFLECTION-ADAPTATION-RUNTIME.md
```

# Objective

Define reflection/adaptation records that inform local deterministic future recommendations without diary/chatbot behavior.

Operating system: **Ambition Lifecycle Engine**  
Product loop: **Recovery and re-entry**
...
No external/cloud LLM, no hidden inference.
...
Proof expectation: Focused adaptation tests when implemented.
