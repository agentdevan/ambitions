...
# IOS26-T04K-B04 - Sealed IOS26 Work Order
...
Green: Personal operating model tests pass.
Yellow: bounded gap with owner, reason, no-claim boundary, validation posture, and post-batch gate.
Red: Hidden inference or missing reset/delete controls.

## Rollback behavior
Revert only files touched by `IOS26-T04K-B04`. Preserve unrelated dirty work and generated artifacts outside this batch.
...
# IOS26-T04K-B04 - Personal operating model and What Ambitions knows
