...
MRI15-RECOMMENDATION-REJECTION-LEARNING

# Runner Command

```bash
make batch BATCH=MRI15-RECOMMENDATION-REJECTION-LEARNING PROMPT=prompts/batches/MRI15-RECOMMENDATION-REJECTION-LEARNING.md
```

# Objective

Let users reject recommendations with structured local reasons that affect future recommendations inspectably.
...
No shame language or hidden tracking.
...
Proof expectation: Rejection learning tests.
