...
# IOS26-T10-B02 - Sealed IOS26 Work Order
...
## Objective
Add a cross-surface proof drawer/detail pattern.
...
Proof drawer UI, per-surface entry points, tests.

## Forbidden files/directories
No audit overload in root surfaces. No sensitive external exposure.

## Exact implementation steps
Build reusable proof drawer/detail; add surface entry points where receipt exists; add VoiceOver grouping; keep proof behind disclosure.
...
build/reports/proof-receipts-replay/cross-surface-proof-drawer.md
...
# IOS26-T10-B02 — Cross-surface proof drawer
...
## Why this exists
Users need inspectability without top-level clutter.
...
Today; Goals; Capture; Time; You; UI; UI tests.
...
Sensitive proof leakage is Red.
