...
MRI03-COMMITMENT-LIFECYCLE

# Runner Command

```bash
make batch BATCH=MRI03-COMMITMENT-LIFECYCLE PROMPT=prompts/batches/MRI03-COMMITMENT-LIFECYCLE.md
```

# Objective

Define commitment states and transitions through closure, waiting, blocked, moved, shortened, still counts, not needed, proof, recovery.
...
No shame language, no overdue/failure framing.
...
Proof expectation: Focused lifecycle transition tests when implemented.
