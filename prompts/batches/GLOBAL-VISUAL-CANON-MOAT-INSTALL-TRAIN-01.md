...
Today must not become a task list, agenda, dashboard, or focus widget.
```
...
Goals must not become a dashboard, score screen, habit tracker, astrology map, or generic goal list.
```
