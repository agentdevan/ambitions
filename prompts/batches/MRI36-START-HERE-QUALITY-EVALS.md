...
MRI36-START-HERE-QUALITY-EVALS

# Runner Command

```bash
make batch BATCH=MRI36-START-HERE-QUALITY-EVALS PROMPT=prompts/batches/MRI36-START-HERE-QUALITY-EVALS.md
```

# Objective

Evaluate Start Here actionability, fit, why-this, control, non-shaming language, and receipt behavior.
...
```text
docs/audits/mri36-start-here-quality-evals-report.md
```
