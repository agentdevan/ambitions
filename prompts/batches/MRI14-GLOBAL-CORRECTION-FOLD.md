...
MRI14-GLOBAL-CORRECTION-FOLD

# Runner Command

```bash
make batch BATCH=MRI14-GLOBAL-CORRECTION-FOLD PROMPT=prompts/batches/MRI14-GLOBAL-CORRECTION-FOLD.md
```

# Objective

Create one correction pattern for wrong capture routes, source claims, recommendations, time-fit decisions, and learning inputs.
...
No broad rewrite, no destructive automatic mutation.
...
Proof expectation: Correction scenario tests.
