...
# IOS26-T13-B02 - Sealed IOS26 Work Order
...
## Objective
Make VoiceOver traversal equivalent for top-level and core detail flows.
...
Accessibility labels, grouping, hints, values, tests.

## Forbidden files/directories
No unlabeled primary actions.

## Exact implementation steps
Add object-level summaries; group state/reason/source/action/receipt; add UI tests where feasible; create manual traversal checklist.
...
build/reports/accessibility-nutrition/voiceover.md
...
# IOS26-T13-B02 — VoiceOver traversal
...
## Why this exists
Labels exist, but traversal proof is required.
...
Features; UI; Sources/Accessibility; UI tests.
...
Manual traversal pending is Yellow.
