...
# IOS26-T04I-B02 - Sealed IOS26 Work Order
...
Store reference material. Implement only the scoped local-first behavior after inspecting current source, then prove it with focused tests and proof artifacts.

## Validation commands
```bash
python3 scripts/ios26-flagship-preflight.py --batch IOS26-T04I-B02
python3 scripts/ios26-core-replacement-proof-shape-check.py --batch IOS26-T04I-B02
```
...
- `build/reports/life-knowledge-operations/attachments-links-source-records.md`
...
Green: Reference/source tests pass.
Yellow: bounded gap with owner, reason, no-claim boundary, validation posture, and post-batch gate.
Red: Attachments or source records are unsupported.

## Rollback behavior
Revert only files touched by `IOS26-T04I-B02`. Preserve unrelated dirty work and generated artifacts outside this batch.
...
# IOS26-T04I-B02 - Attachments links and source records
...
Notion reference material job.

## Replacement P0 contract
Notion P0 reference contract: AttachmentReference, link reference, source record, redaction/export policy, delete/reset behavior.
