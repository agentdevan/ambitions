...
MRI42-PERFORMANCE-SCENARIO-PROOF

# Runner Command

```bash
make batch BATCH=MRI42-PERFORMANCE-SCENARIO-PROOF PROMPT=prompts/batches/MRI42-PERFORMANCE-SCENARIO-PROOF.md
```

# Objective

Prove launch/scroll/cache/large-store/read-model performance against budgets.
...
No performance readiness claim until measured.
...
Proof expectation: Performance proof packet.
...
```text
docs/audits/mri42-performance-scenario-proof-report.md
```
