...
MRI12-PERSONAL-RUNTIME-INSPECTION

# Runner Command

```bash
make batch BATCH=MRI12-PERSONAL-RUNTIME-INSPECTION PROMPT=prompts/batches/MRI12-PERSONAL-RUNTIME-INSPECTION.md
```

# Objective

Expose what Ambitions learned, used, ignored, and changed through local inspection UI/contracts.
...
Proof expectation: Focused controls/inspection tests.
