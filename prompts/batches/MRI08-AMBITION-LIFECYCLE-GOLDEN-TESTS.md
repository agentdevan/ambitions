...
MRI08-AMBITION-LIFECYCLE-GOLDEN-TESTS

# Runner Command

```bash
make batch BATCH=MRI08-AMBITION-LIFECYCLE-GOLDEN-TESTS PROMPT=prompts/batches/MRI08-AMBITION-LIFECYCLE-GOLDEN-TESTS.md
```

# Objective

Install golden tests/scenarios for Ambition Graph, commitment, proof, pivot, recovery, and reflection loops.
...
Proof expectation: Scenario/eval proof only.
