...
```bash
make batch BATCH=MRI30-YOU-USER-SYSTEM-PROFILE-RUNTIME PROMPT=prompts/batches/MRI30-YOU-USER-SYSTEM-PROFILE-RUNTIME.md
```

# Objective

Implement You as User System Profile with Personal Runtime, trust, automation, local learning, data controls, receipts.
...
No social/admin/profile framing.
...
Proof expectation: You visual/runtime proof.
...
```text
docs/audits/mri30-you-user-system-profile-runtime-report.md
```
