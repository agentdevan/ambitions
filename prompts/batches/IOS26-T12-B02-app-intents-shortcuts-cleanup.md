...
# IOS26-T12-B02 - Sealed IOS26 Work Order
...
## Batch role in train
Batch 2 of 3 in TRAIN_12

## Upstream dependencies
- `TRAIN_02`
- `TRAIN_10`
- `TRAIN_11`
- `TRAIN_04K_where_widgets_App_Intents_share_extension_expose_life_objects`

## Downstream dependencies
- none recorded

## Objective
Modernize App Intents/Shortcuts and remove Plan-facing destination drift.
...
AppIntent destination names, route adapters, tests.

## Forbidden files/directories
No silent completion of sensitive actions. No private Spotlight indexing without privacy gate.

## Exact implementation steps
Rename plan shortcut destination to Time while keeping legacy adapter; require app confirmation for closure/recovery; add route/dialog tests; gate Spotlight if not approved.
...
build/reports/external-surfaces/app-intents-shortcuts.md
...
# IOS26-T12-B02 — App Intents / Shortcuts cleanup
...
## Why this exists
Shortcuts should open local surfaces or queue safe local capture with receipts.

## Dependencies
Train 2, Train 10, Train 11.
...
AppIntents; AppExternalRouting; App tests; UI tests.
...
Silent mutation or Plan product drift is Red.
