...
# IOS26-T02-B02 - Sealed IOS26 Work Order
...
## Objective
Add restrained iOS 26 Liquid Glass-era token support with legibility fallbacks.
...
Design-system tokens/components and usage where shell/control-specific.

## Forbidden files/directories
No glass-on-glass content stacks. No broad surface redesign.

## Exact implementation steps
Add tokens after API verification; add Reduce Transparency fallback; preserve dark graphite/OLED content surfaces; ensure semantic colors remain legible; update design-system tests.
...
build/reports/ios26-shell/liquid-glass-token-layer.md
...
# IOS26-T02-B02 — Liquid Glass token layer
...
## Why this exists
Ambitions should use glass for controls/shell, not content clutter.
...
Sources/Theme/; Sources/Components/; Native/Ambitions/UI/; Native/Ambitions/App/; Native/Ambitions/Features/*/.
...
Do not adopt unverified Liquid Glass APIs.
