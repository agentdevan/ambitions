...
.PHONY: repo-doctor repo-doctor-strict canon-install codex-os-context codex-os-next codex-os-sync codex-os-performance codex-os-repair-route codex-os-batch-select authorized-batch autonomy-loop afri-authority-validate afri-stale-doc-scan
...
private-runtime-wiring-check:
	python3 scripts/ambitions-private-runtime-wiring-check.py

linear-sync-dry-run:
	python3 scripts/ambitions-linear-sync-dry-run.py

linear-sync-apply: linear-sync-dry-run
	python3 .linear-sync/linear_sync_apply.py

batch-ledger-inventory:
	python3 scripts/ambitions-batch-ledger-inventory.py

batch-ledger-detect-touchpoints: batch-ledger-inventory
	python3 scripts/ambitions-batch-ledger-touchpoint-detect.py

batch-ledger-classify-status: batch-ledger-detect-touchpoints
	python3 scripts/ambitions-batch-ledger-status-classify.py

batch-ledger-conflict-report: batch-ledger-classify-status
	python3 scripts/ambitions-batch-ledger-conflict-report.py
...
change-impact-check:
	python3 scripts/ambitions-change-impact-check.py

implementation-prompt-template-validate:
	python3 scripts/ambitions-implementation-prompt-template-validate.py

post-implementation-reconciliation-validate:
	python3 scripts/ambitions-post-implementation-reconciliation-validate.py

canon-collapse-candidates:
	python3 scripts/ambitions-active-canon-collapse-candidates.py

canon-collapse-red-rewrite:
	python3 scripts/ambitions-canon-collapse-red-rewrite.py

canon-collapse-proof-bundles:
	python3 scripts/ambitions-source-only-proof-bundles.py

canon-collapse-proof-resolution:
	python3 scripts/ambitions-source-only-proof-resolution.py
	python3 scripts/ambitions-active-canon-collapse-candidates.py

canon-collapse-remaining-resolution:
	python3 scripts/ambitions-remaining-canon-collapse-resolution.py
	python3 scripts/ambitions-active-canon-collapse-candidates.py
	python3 scripts/ambitions-repo-cleanliness-gate.py

canon-collapse-actual-hygiene:
	python3 scripts/ambitions-actual-canon-content-hygiene-rewrite.py

canon-collapse-actual-hygiene-repair:
	python3 scripts/ambitions-canon-hygiene-second-pass-repair.py
