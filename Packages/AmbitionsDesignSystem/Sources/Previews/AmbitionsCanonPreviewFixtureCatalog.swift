...
public enum AmbitionsCanonPreviewFixtureCatalog {
    ...
    public static let requiredFixtures: [AmbitionsCanonPreviewFixtureRequirement] = [
        ...
        requirement("TimeWeekDefault", "Time", "Life Calendar", coveredBy: "time.normal"),
        requirement("TimeDayPressure", "Time", "Life Calendar", coveredBy: "time.partialSource"),
        requirement("TimeMonthShaping", "Time", "Life Calendar", coveredBy: nil),
        requirement("TimeOpenCapacity", "Time", "Life Calendar", coveredBy: nil),
        requirement("TimeLowCapacity", "Time", "Life Calendar", coveredBy: nil),
        requirement("TimeProtectedBlocks", "Time", "Life Calendar", coveredBy: nil),
        requirement("TimePressureFriday", "Time", "Life Calendar", coveredBy: nil),
        requirement("TimeCalendarDeniedManual", "Time", "Life Calendar", coveredBy: "time.deniedSource"),
        ...
        requirement("TimeLargeText", "Time", "Life Calendar", coveredBy: nil),
        requirement("TimeReduceMotion", "Time", "Life Calendar", coveredBy: "time.reducedMotion"),
