# Recommendation Ledger Builder

## Purpose

Use this skill for recommendation ledger builder work in Ambitions 3.0.

## Use When

- The task explicitly matches `recommendation-ledger-builder`.
