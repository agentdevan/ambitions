# View State Projector Builder

## Purpose

Use this skill for view state projector builder work in Ambitions 3.0.

## Use When

- The task explicitly matches `view-state-projector-builder`.
