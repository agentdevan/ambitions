...
Depth-not-width owner. Reject new tabs, generic productivity expansion, chatbot direction, analytics dashboard drift, and product depth without primitive ownership.
