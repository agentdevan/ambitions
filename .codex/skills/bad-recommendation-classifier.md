# Bad Recommendation Classifier

## Purpose

Use this skill for bad recommendation classifier work in Ambitions 3.0.

## Use When

- The task explicitly matches `bad-recommendation-classifier`.
