# Compatibility Migration Architect
...
- replacement map
- raw value compatibility
- route/deep-link compatibility
- widget payload compatibility
- App Intent compatibility
...
Compatibility migration owner. Reject raw-value, route, widget, App Intent, import/export, or persistence deletion without replacement map and migration proof.
