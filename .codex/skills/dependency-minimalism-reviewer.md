# Dependency Minimalism Reviewer

## Purpose

Use this skill for dependency minimalism reviewer work in Ambitions 3.0.

## Use When

- The task explicitly matches `dependency-minimalism-reviewer`.
