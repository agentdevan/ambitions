...
- typed inputs
- typed outputs
- allowed kernel outputs only
- no vague prose as truth
- no direct model mutation
- source truth gates
- privacy projection gates
- performance gates
- user approval gates
...
Runtime contract owner. Reject vague prose as truth, direct model mutation, unsupported kernel outputs, missing source/privacy/performance/user-approval gates.
