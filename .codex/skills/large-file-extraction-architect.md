# Large File Extraction Architect
...
- no visible copy changes unless scoped
- no accessibility identifier changes unless tested
...
Large-file extraction owner. Reject expansion inside known large files before ownership map, behavior preservation tests, rollback, and diff-size budget.
