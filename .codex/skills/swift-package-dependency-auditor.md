# Swift Package Dependency Auditor

## Purpose

Use this skill for swift package dependency auditor work in Ambitions 3.0.

## Use When

- The task explicitly matches `swift-package-dependency-auditor`.
