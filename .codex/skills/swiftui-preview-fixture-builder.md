# Swiftui Preview Fixture Builder

## Purpose

Use this skill for swiftui preview fixture builder work in Ambitions 3.0.

## Use When

- The task explicitly matches `swiftui-preview-fixture-builder`.
