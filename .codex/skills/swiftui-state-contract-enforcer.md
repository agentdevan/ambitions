# Swiftui State Contract Enforcer
...
- views render state
- projectors transform domain into view state
- services assemble deterministic data
- no hidden mutation from UI
- stable accessibility identifiers
- preview fixtures for user-facing states
- focused tests for every state projection
...
State/projector/view separation owner. Reject views that compute domain truth, projectors with hidden mutation, unstable accessibility identifiers, and missing preview fixtures.
