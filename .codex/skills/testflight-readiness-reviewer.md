# Testflight Readiness Reviewer

## Purpose

Use this skill for testflight readiness reviewer work in Ambitions 3.0.

## Use When

- The task explicitly matches `testflight-readiness-reviewer`.
