# First 7 Days Retention Reviewer

## Purpose

Use this skill for first 7 days retention reviewer work in Ambitions 3.0.

## Use When

- The task explicitly matches `first-7-days-retention-reviewer`.
