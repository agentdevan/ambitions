# Receipt Proof Data Model Reviewer

## Purpose

Use this skill for receipt proof data model reviewer work in Ambitions 3.0.

## Use When

- The task explicitly matches `receipt-proof-data-model-reviewer`.
