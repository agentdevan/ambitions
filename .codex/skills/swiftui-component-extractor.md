# Swiftui Component Extractor

## Purpose

Use this skill for swiftui component extractor work in Ambitions 3.0.

## Use When

- The task explicitly matches `swiftui-component-extractor`.
