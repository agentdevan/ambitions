...
Model boundary owner. Reject model-as-truth, model writes to graph, launch model calls, deterministic work routed to model, and unsupported device fallback gaps.
