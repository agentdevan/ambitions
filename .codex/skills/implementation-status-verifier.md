# Implementation Status Verifier

## Purpose

Use this skill for implementation status verifier work in Ambitions 3.0.

## Use When

- The task explicitly matches `implementation-status-verifier`.
