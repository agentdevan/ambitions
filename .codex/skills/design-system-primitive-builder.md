# Design System Primitive Builder

## Purpose

Use this skill for design system primitive builder work in Ambitions 3.0.

## Use When

- The task explicitly matches `design-system-primitive-builder`.
