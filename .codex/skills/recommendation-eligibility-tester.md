# Recommendation Eligibility Tester

## Purpose

Use this skill for recommendation eligibility tester work in Ambitions 3.0.

## Use When

- The task explicitly matches `recommendation-eligibility-tester`.
