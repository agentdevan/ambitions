...
Prompt executability owner. Reject prompts without owner files, allowed/forbidden paths, validation commands, stop conditions, evidence outputs, and claim boundaries.
