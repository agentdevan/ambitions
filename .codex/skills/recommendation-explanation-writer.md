# Recommendation Explanation Writer

## Purpose

Use this skill for recommendation explanation writer work in Ambitions 3.0.

## Use When

- The task explicitly matches `recommendation-explanation-writer`.
