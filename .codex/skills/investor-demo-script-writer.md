# Investor Demo Script Writer

## Purpose

Use this skill for investor demo script writer work in Ambitions 3.0.

## Use When

- The task explicitly matches `investor-demo-script-writer`.
