# Share Extension Integration Skill

## Purpose

Use this skill for share extension integration skill work in Ambitions 3.0.

## Use When

- The task explicitly matches `share-extension-integration-skill`.
