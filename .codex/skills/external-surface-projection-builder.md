# External Surface Projection Builder

## Purpose

Use this skill for external surface projection builder work in Ambitions 3.0.

## Use When

- The task explicitly matches `external-surface-projection-builder`.
