...
Schema/migration owner. Reject schema or persistence behavior without migration snapshots, compatibility views, rollback, and old payload survival tests.
