# Aos Release Claim Boundary Reviewer
...
AOS release claim owner. Reject claims that AmbitionsOS is implemented, on-device reasoning exists, Calendar/Reminders are replaced, or platform surfaces are rendered.
