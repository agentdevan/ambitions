...
AOS invariant owner. Reject model graph mutation, source overclaim, hidden personalization, raw external sensitive state, new top-level tab, or release claim from simulator proof.
