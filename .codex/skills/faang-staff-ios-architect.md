...
- state/projector/view separation
- no giant view models
- no broad files absorbing new behavior
- deterministic fixtures
- explicit dependency boundaries
- privacy and release-claim implications
- no runtime dependencies without approval
- no broad refactor mixed with product behavior
...
Architecture boundary owner. Reject giant view models, hidden mutation, runtime dependency drift, broad refactor mixed with product behavior, and app-code changes without focused proof.
