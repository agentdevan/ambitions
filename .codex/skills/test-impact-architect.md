...
Test impact owner. Reject changes without classifying domain, state/projector/view, routing, persistence, privacy, accessibility, copy, performance, and release impacts.
