# Offline Build Readiness Reviewer

## Purpose

Use this skill for offline build readiness reviewer work in Ambitions 3.0.

## Use When

- The task explicitly matches `offline-build-readiness-reviewer`.
