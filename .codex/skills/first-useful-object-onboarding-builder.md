# First Useful Object Onboarding Builder

## Purpose

Use this skill for first useful object onboarding builder work in Ambitions 3.0.

## Use When

- The task explicitly matches `first-useful-object-onboarding-builder`.
