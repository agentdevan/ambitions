# Paid Tool Avoidance Reviewer

## Purpose

Use this skill for paid tool avoidance reviewer work in Ambitions 3.0.

## Use When

- The task explicitly matches `paid-tool-avoidance-reviewer`.
