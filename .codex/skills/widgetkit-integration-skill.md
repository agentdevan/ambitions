# Widgetkit Integration Skill

## Purpose

Use this skill for widgetkit integration skill work in Ambitions 3.0.

## Use When

- The task explicitly matches `widgetkit-integration-skill`.
