# App Intent Integration Skill

## Purpose

Use this skill for app intent integration skill work in Ambitions 3.0.

## Use When

- The task explicitly matches `app-intent-integration-skill`.
