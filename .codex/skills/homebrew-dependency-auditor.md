# Homebrew Dependency Auditor

## Purpose

Use this skill for homebrew dependency auditor work in Ambitions 3.0.

## Use When

- The task explicitly matches `homebrew-dependency-auditor`.
