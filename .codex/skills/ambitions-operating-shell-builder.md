# Ambitions Operating Shell Builder

## Purpose

Use this skill for ambitions operating shell builder work in Ambitions 3.0.

## Use When

- The task explicitly matches `ambitions-operating-shell-builder`.
