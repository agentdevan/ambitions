# Personalization Source Label Auditor

## Purpose

Use this skill for personalization source label auditor work in Ambitions 3.0.

## Use When

- The task explicitly matches `personalization-source-label-auditor`.
