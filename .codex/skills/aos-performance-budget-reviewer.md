# Aos Performance Budget Reviewer
...
AOS performance budget owner. Reject runtime-heavy implementation before budgets, fixtures, measurement method, warning/failure thresholds, and fallback behavior.
