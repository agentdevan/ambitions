...
AOS fixture owner. Reject implementation without named fixtures for starting position, regulated goals, stale source, privacy, low power, old device, and long history when relevant.
