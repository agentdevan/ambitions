# Xcresult Evidence Extractor

## Purpose

Use this skill for xcresult evidence extractor work in Ambitions 3.0.

## Use When

- The task explicitly matches `xcresult-evidence-extractor`.
