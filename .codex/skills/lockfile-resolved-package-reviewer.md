# Lockfile Resolved Package Reviewer

## Purpose

Use this skill for lockfile resolved package reviewer work in Ambitions 3.0.

## Use When

- The task explicitly matches `lockfile-resolved-package-reviewer`.
