# Navigationstack Safety Reviewer

## Purpose

Use this skill for navigationstack safety reviewer work in Ambitions 3.0.

## Use When

- The task explicitly matches `navigationstack-safety-reviewer`.
