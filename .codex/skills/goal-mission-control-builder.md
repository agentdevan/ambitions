# Goal Mission Control Builder

## Purpose

Use this skill for goal mission control builder work in Ambitions 3.0.

## Use When

- The task explicitly matches `goal-mission-control-builder`.
