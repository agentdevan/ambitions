# Dependency Removal Reviewer

## Purpose

Use this skill for dependency removal reviewer work in Ambitions 3.0.

## Use When

- The task explicitly matches `dependency-removal-reviewer`.
