# Domain Model Extension Builder

## Purpose

Use this skill for domain model extension builder work in Ambitions 3.0.

## Use When

- The task explicitly matches `domain-model-extension-builder`.
