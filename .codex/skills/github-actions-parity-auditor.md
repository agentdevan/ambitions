# Github Actions Parity Auditor

## Purpose

Use this skill for github actions parity auditor work in Ambitions 3.0.

## Use When

- The task explicitly matches `github-actions-parity-auditor`.
