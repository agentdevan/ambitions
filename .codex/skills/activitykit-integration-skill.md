# Activitykit Integration Skill

## Purpose

Use this skill for activitykit integration skill work in Ambitions 3.0.

## Use When

- The task explicitly matches `activitykit-integration-skill`.
