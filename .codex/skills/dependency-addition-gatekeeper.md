# Dependency Addition Gatekeeper

## Purpose

Use this skill for dependency addition gatekeeper work in Ambitions 3.0.

## Use When

- The task explicitly matches `dependency-addition-gatekeeper`.
