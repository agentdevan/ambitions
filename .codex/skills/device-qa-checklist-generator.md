# Device Qa Checklist Generator

## Purpose

Use this skill for device qa checklist generator work in Ambitions 3.0.

## Use When

- The task explicitly matches `device-qa-checklist-generator`.
