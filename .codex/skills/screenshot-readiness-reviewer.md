# Screenshot Readiness Reviewer

## Purpose

Use this skill for screenshot readiness reviewer work in Ambitions 3.0.

## Use When

- The task explicitly matches `screenshot-readiness-reviewer`.
