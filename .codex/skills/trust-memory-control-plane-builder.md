# Trust Memory Control Plane Builder

## Purpose

Use this skill for trust memory control plane builder work in Ambitions 3.0.

## Use When

- The task explicitly matches `trust-memory-control-plane-builder`.
