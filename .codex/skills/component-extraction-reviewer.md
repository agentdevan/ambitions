# Component Extraction Reviewer

## Purpose

Use this skill for component extraction reviewer work in Ambitions 3.0.

## Use When

- The task explicitly matches `component-extraction-reviewer`.
