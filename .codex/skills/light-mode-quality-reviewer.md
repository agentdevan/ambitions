# Light Mode Quality Reviewer

## Purpose

Use this skill for light mode quality reviewer work in Ambitions 3.0.

## Use When

- The task explicitly matches `light-mode-quality-reviewer`.
