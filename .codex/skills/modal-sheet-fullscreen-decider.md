# Modal Sheet Fullscreen Decider

## Purpose

Use this skill for modal sheet fullscreen decider work in Ambitions 3.0.

## Use When

- The task explicitly matches `modal-sheet-fullscreen-decider`.
