# Focused Regression Pack Selector

## Purpose

Use this skill for focused regression pack selector work in Ambitions 3.0.

## Use When

- The task explicitly matches `focused-regression-pack-selector`.
