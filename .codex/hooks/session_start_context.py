    ...
    output = {
        "hookSpecificOutput": {
            ...
            "developerContext": {
                ...
                "git_root": git_root,
                "top_level_ia": "Today / Goals / Time / Motion / You",
                "global_action": "Capture",
                "capture_model": "Capture is the global Atmosphere Composer/action layer, not a tab",
                "motion_model": "Motion replaces Pulse; Pulse is prior working-name / historical context only",
