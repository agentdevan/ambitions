...
Keep AmbitionsOS operating assets useful without creating one-file-per-idea sprawl. This catalog owns proposed validation packs until a future train proves an item is required for execution, evidence, repair, or repeated review.
...
Every cataloged or split-out validation pack must include: checks, allowed/forbidden files, Green/Yellow/Red gates, commands, report requirements, stop conditions.
