# Swiftui State Contract Hardening Protocol

Path: .codex/operations/swiftui-state-contract-hardening-protocol.md
Status: Active operation protocol

## When To Use
Use when feature state/projector/view responsibilities are at risk.
