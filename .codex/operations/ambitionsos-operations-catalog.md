# AmbitionsOS Operations Catalog
...
Keep AmbitionsOS operating assets useful without creating one-file-per-idea sprawl. This catalog owns proposed operations until a future train proves an item is required for execution, evidence, repair, or repeated review.
...
Every cataloged or split-out operation must include: when to invoke, allowed/forbidden files, validation commands, Green/Yellow/Red gates, report required.
