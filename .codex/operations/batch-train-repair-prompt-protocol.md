# Batch Train Repair Prompt Protocol

Path: .codex/operations/batch-train-repair-prompt-protocol.md
Status: Active operation protocol

## When To Use
Use to generate copy/paste repair prompts after Yellow or Red.
