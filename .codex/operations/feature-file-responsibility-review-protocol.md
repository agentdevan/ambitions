# Feature File Responsibility Review Protocol

Path: .codex/operations/feature-file-responsibility-review-protocol.md
Status: Active operation protocol

## When To Use
Use when file size or responsibility thresholds trigger.
