# Batch Train Yellow Stop Protocol

Path: .codex/operations/batch-train-yellow-stop-protocol.md
Status: Active operation protocol

## When To Use
Use when advisory or ambiguous issues require a decision/repair stop.
