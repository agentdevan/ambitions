# Batch Train Green Gate Protocol

Path: .codex/operations/batch-train-green-gate-protocol.md
Status: Active operation protocol

## When To Use
Use after validation suggests automatic continuation may be safe.
