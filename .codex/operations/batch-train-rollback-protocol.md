# Batch Train Rollback Protocol

Path: .codex/operations/batch-train-rollback-protocol.md
Status: Active operation protocol

## When To Use
Use only for Codex-owned current-batch changes that cannot be repaired forward.
