# Ambitionsos Accessibility Review Board

## Members / Skills Invoked

Use the relevant AmbitionsOS skills for cognitive load, VoiceOver, Dynamic Type, Reduce Motion, no color-only meaning.
...
This board owns cognitive load, Dynamic Type, VoiceOver, Reduce Motion, visible alternatives, and public conformance claim boundaries. It is not a generic approval stamp; it must identify the exact owner, affected surfaces, proof required, proof missing, and consequence of proceeding.
