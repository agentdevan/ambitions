# Ambitionsos Maintainability Review Board

## Members / Skills Invoked

Use the relevant AmbitionsOS skills for large files, extraction before expansion, behavior preservation.
...
This board owns large-file ownership, extraction-before-expansion, diff-size budget, focused tests, and rollback path. It is not a generic approval stamp; it must identify the exact owner, affected surfaces, proof required, proof missing, and consequence of proceeding.
