# Ambitionsos Privacy Safety Review Board

## Members / Skills Invoked

Use the relevant AmbitionsOS skills for sensitive goals, privacy projections, medical/legal/source boundaries.
...
This board owns sensitive goal handling, privacy projections, source-truth boundaries, external-surface redaction, and local-first posture. It is not a generic approval stamp; it must identify the exact owner, affected surfaces, proof required, proof missing, and consequence of proceeding.
