# Ambitionsos Release Claim Review Board

## Members / Skills Invoked

Use the relevant AmbitionsOS skills for release, App Store, TestFlight, device, accessibility, platform proof boundaries.
...
This board owns evidence hierarchy, App Store/TestFlight/device/accessibility/platform claim boundaries, and simulator-proof limits. It is not a generic approval stamp; it must identify the exact owner, affected surfaces, proof required, proof missing, and consequence of proceeding.
