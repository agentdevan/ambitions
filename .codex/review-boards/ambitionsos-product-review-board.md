# Ambitionsos Product Review Board

## Members / Skills Invoked

Use the relevant AmbitionsOS skills for product identity, deep-not-wide, surfaces, no generic productivity drift.
...
This board owns deep-not-wide product shape, Today/Goals/Capture/Plan/You ownership, non-chatbot direction, and humane path language. It is not a generic approval stamp; it must identify the exact owner, affected surfaces, proof required, proof missing, and consequence of proceeding.
