...
Keep AmbitionsOS operating assets useful without creating one-file-per-idea sprawl. This catalog owns proposed checklists until a future train proves an item is required for execution, evidence, repair, or repeated review.
...
Every cataloged or split-out checklist must include: owner, source docs, decision questions, evidence expected, pass/fail criteria.
