...
| CS | `docs/codex/batch-trains/CS01_CS10_COMPATIBILITY_SEAM_RETIREMENT_TRAIN.md` | Completed with conditional triggers | CS01-CS10 completed/supporting per registry context | CS02C-CS06C and CS09C conditional trigger only | Global train + implementation truth | Global queue maturity ledger | Keep supporting until compatibility seams retire |
