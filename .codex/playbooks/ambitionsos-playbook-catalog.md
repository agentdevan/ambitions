...
Keep AmbitionsOS operating assets useful without creating one-file-per-idea sprawl. This catalog owns proposed playbooks until a future train proves an item is required for execution, evidence, repair, or repeated review.
...
Every cataloged or split-out playbook must include: trigger, triage steps, stop conditions, repair path, closeout evidence.
