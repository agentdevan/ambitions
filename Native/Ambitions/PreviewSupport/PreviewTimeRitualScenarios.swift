...
enum PreviewTimeRitualScenarios {
    static let active = TimeRitualsDashboard(
        mode: .active,
        ...
        stats: [
            ...
            MetricSummary(id: "active-rhythm", title: "Best rhythm", value: "14", detail: "Across current set", icon: "flame.fill")
        ],
        rituals: [
            makeTimeRitual(id: "ritual-planning", title: "Morning planning reset", subtitle: "A 10 minute alignment pass before the workday hardens.", cadence: "Daily rhythm", rhythm: "6 steady days", consistency: "86% consistency - best 9", progress: 0.86, progressLabel: "86% consistency", status: .completed, note: "Today's full version is already in the log.", minimumVersion: "Open the daily plan and define one deliberate win.", supportLabel: nil),
            makeTimeRitual(id: "ritual-review", title: "Evening review", subtitle: "Capture what moved and what still feels heavier than it should.", cadence: "Daily rhythm", rhythm: "Restart gently today", consistency: "57% consistency - best 5", progress: 0.57, progressLabel: "57% consistency", status: .minimumDone, note: "The minimum version counted today. That still protects the rhythm.", minimumVersion: "Write one sentence about the day and one sentence about tomorrow.", supportLabel: nil)
        ],
        recoveryRituals: [
            makeTimeRitual(id: "ritual-stretch", title: "Weekly stretching reset", subtitle: "Keep mobility alive without turning it into a performative workout.", cadence: "Every 3 days", rhythm: "Restart gently today", consistency: "43% consistency - best 4", progress: 0.43, progressLabel: "43% consistency", status: .recovery, note: "This loop wants a gentler restart or a smaller ask.", minimumVersion: "Do two minutes of the easiest stretch sequence and log it.", supportLabel: nil)
        ],
        momentum: TimeRitualMomentumSummary(
            ...
            stats: [
                MetricSummary(id: "rhythm-a", title: "Current rhythm", value: "6", detail: "Best live rhythm", icon: "flame"),
                MetricSummary(id: "rhythm-b", title: "Consistency", value: "62%", detail: "Last 14 days", icon: "checkmark.seal"),
                MetricSummary(id: "rhythm-c", title: "Recovered slips", value: "3", detail: "Recent rebounds", icon: "waveform.path.ecg")
            ],
    ...
    static let recovery = TimeRitualsDashboard(
        mode: .recovery,
        ...
        stats: [
            ...
            MetricSummary(id: "recovery-rhythm", title: "Best rhythm", value: "8", detail: "Still recoverable", icon: "flame.fill")
        ],
        rituals: [],
        recoveryRituals: [
            makeTimeRitual(id: "ritual-support", title: "Reading support check-in", subtitle: "Create a calm support window instead of pressuring Maya to perform.", cadence: "Support rhythm every 2 days", rhythm: "Restart gently today", consistency: "36% consistency - best 3", progress: 0.36, progressLabel: "36% consistency", status: .needsEasierVersion, note: "The plan is asking for a smaller version before it asks for more consistency.", minimumVersion: "Ask Maya what kind of reading support would feel easiest tonight.", supportLabel: "Support Maya without making them the task."),
            makeTimeRitual(id: "ritual-walk", title: "Recovery walk", subtitle: "Keep the loop gentle enough that it can survive lower-energy days.", cadence: "Daily rhythm", rhythm: "Restart gently today", consistency: "29% consistency - best 5", progress: 0.29, progressLabel: "29% consistency", status: .recovery, note: "This loop wants a gentler restart or a smaller ask.", minimumVersion: "Walk for five minutes or step outside and breathe once before logging it.", supportLabel: nil)
        ],
        momentum: TimeRitualMomentumSummary(
            title: "Recovery stays visible",
            subtitle: "The goal is to restart the loop cleanly, not to preserve a perfect score.",
            stats: [
                MetricSummary(id: "recovery-rhythm-a", title: "Current rhythm", value: "0", detail: "Fresh restart", icon: "flame"),
                MetricSummary(id: "recovery-rhythm-b", title: "Consistency", value: "33%", detail: "Last 14 days", icon: "checkmark.seal"),
                MetricSummary(id: "recovery-rhythm-c", title: "Recovered slips", value: "2", detail: "Past month", icon: "waveform.path.ecg")
            ],
    ...
    static let seeded = TimeRitualsDashboard(
        mode: .seeded,
        ...
        stats: active.stats,
        rituals: active.rituals,
        recoveryRituals: active.recoveryRituals,
    ...
    static let empty = TimeRitualsDashboard(
        mode: .empty,
        ...
        momentum: TimeRitualMomentumSummary(
            ...
            stats: [
                MetricSummary(id: "empty-rhythm-a", title: "Current rhythm", value: "0", detail: "Waiting on first ritual", icon: "flame"),
                MetricSummary(id: "empty-rhythm-b", title: "Consistency", value: "0%", detail: "No tracked windows yet", icon: "checkmark.seal")
            ],
    ...
    private static func makeTimeRitual(
        id: String,
        title: String,
        subtitle: String,
        cadence: String,
        ...
        status: TimeRitualState,
        note: String,
        minimumVersion: String,
        supportLabel: String?
    ) -> TimeRitualSummary {
        let target = TimeRitualActionTarget(goalID: id, stepID: "step-\(id)", draftID: nil)
