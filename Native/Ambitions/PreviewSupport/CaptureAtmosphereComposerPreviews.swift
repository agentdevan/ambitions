...
#Preview("SI09 Capture Field") {
    ...
    let preview = CaptureDraftRoutePreview(
        ...
        routeProofTitle: "Placement check",
        routeProofDetail: "Local text only; no calendar, network, account, or cloud placement.",
        ...
        correctionLabel: "Correction: change placement before saving",
        receiptSeamLabel: "Review history: save creates a local capture receipt",
        resolverFoldTitle: "Placement review",
        resolverWhyLabel: "Local review: Step based on local text only.",
        ...
        accessibilityLabel: "Suggested capture placement",
        accessibilityValue: "Step, Today, private item",
        accessibilityHint: "Choose a placement or save the suggested placement.",
