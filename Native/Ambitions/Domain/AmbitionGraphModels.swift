...
struct AmbitionGraphGoalThreadHierarchy: Codable, Sendable, Equatable, Hashable, Identifiable {
    ...
    private static func commitmentOrdering(_ lhs: Commitment, _ rhs: Commitment) -> Bool {
    ...
    private static func stepOrdering(_ lhs: AmbitionGraphStep, _ rhs: AmbitionGraphStep) -> Bool {
    ...
    private static func proofOrdering(_ lhs: Proof, _ rhs: Proof) -> Bool {
    ...
    private static func receiptOrdering(_ lhs: RecoveryThread, _ rhs: RecoveryThread) -> Bool {
        if lhs.updatedAt != rhs.updatedAt {
            return lhs.updatedAt > rhs.updatedAt
        }
        return lhs.id < rhs.id
