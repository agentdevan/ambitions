...
enum ScreenContractRegistry {
    ...
    private static let today = ScreenContract(
        ...
        requiredFirstScreenContent: ["Hero Decision Panel", "Now Layer", "Today Plan Layer", "Compact timeline", "Relevant One-Step Goals", "Open-window awareness", "Recovery"],
    ...
    private static let goals = ScreenContract(
        ...
        requiredFirstScreenContent: ["Direction hero", "Goal Lifecycle Rail", "Active goals", "Life Areas preview", "North Stars rail", "Controlled One-Step Goals"],
    ...
    private static let goalDetail = ScreenContract(
        ...
        requiredFirstScreenContent: ["Object identity header", "Mission Control lanes"],
    ...
    private static let capture = ScreenContract(
        ...
        requiredFirstScreenContent: ["Fast input", "Needs a Place", "Suggested routes", "Recent captures", "Smart Attachment receipt"],
    ...
    private static let plan = ScreenContract(
        ...
        requiredFirstScreenContent: ["Believability hero", "Weekly Plan Strip", "Rich Timeline Widget", "Rituals", "Scheduling", "Open windows"],
        ...
        accessibilityRequirements: ["Calendar controls have permission rationale.", "Timeline has non-gesture controls."],
        trustPrivacyRequirements: ["Calendar remains Plan-owned.", "External writes require confirmation."],
        ...
        evidenceAnchors: [
            screenMatrixAnchor,
            accessibilityMatrixAnchor,
            .init(kind: .sourceSurface, path: "Native/Ambitions/Features/Plan/PlanScreen.swift", note: "Current Plan surface"),
    ...
    private static let oneStepGoalDetail = ScreenContract(
        ...
        forbiddenFirstScreenContent: ["Goal-only Mission Control overload", "Top-level Tasks tab"],
