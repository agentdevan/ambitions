...
struct GoalPlanner: GoalPlanning {
    ...
    private func lightweightTrackingSections(draft: GoalDraft, now: String) -> [PlannerSectionDraft] {
        ...
        return [
            ...
            PlannerSectionDraft(title: "Smallest Next Move", summary: "Starter plans should only ask for the smallest move that can create real signal.", kind: .activeSteps, steps: [
