...
extension PreviewGoalsScenarios {
    static let detailScenarios: [String: GoalDetailPresentation] = [
        ...
        starterTarget.id: GoalDetailPresentation(
            ...
            progress: GoalDetailProgress(label: "Starter path in motion", detail: "Starter-plan assumptions are being treated as provisional scaffolding.", value: 0.22, evidenceLabel: "No evidence logged yet"),
