...
struct MissionControlTimeSpine: View {
    ...
    @State var selectedItemID: MissionControlLaneItem.ID?
    ...
    var selectedID: MissionControlLaneItem.ID? {
...
struct MissionControlSpineLane: View {
    @Environment(\.ambitionTheme) var theme
    ...
    @ViewBuilder
    func spineRail(style: AmbitionStateStyle) -> some View {
        VStack(spacing: 0) {
            Rectangle()
...
struct MissionControlLaneInspector: View {
    @Environment(\.ambitionTheme) var theme
...
struct MissionControlLaneGrid: View {
    ...
    @State var focusedItemID: MissionControlLaneItem.ID?
...
struct MissionControlLaneSparkLine: View {
    @Environment(\.accessibilityReduceMotion) var reduceMotion
    ...
    func barHeight(index: Int) -> CGFloat {
