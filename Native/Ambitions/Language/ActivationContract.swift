...
enum ActivationContract {
    ...
    static let orientationSubtitle = "It works through four primary objects: Today, Goals, Time, and You, with Capture available as the global place to start. You only need one real thing to begin, and setup stays manual-first."
    ...
    static let onboardingKnownNowRows: [ActivationCopyRow] = [
        ...
        ActivationCopyRow(title: "The objects do the work", detail: "Today, Goals, Time, and You organize life while global Capture catches the first loose thing.", icon: "square.grid.2x2"),
