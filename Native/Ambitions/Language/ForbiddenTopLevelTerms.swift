...
enum ForbiddenTopLevelTerms {
    ...
    static let rules: [Rule] = [
        ...
        Rule(term: "analytics dashboard", minimumAllowedExposure: .internal),
        Rule(term: "task dashboard", minimumAllowedExposure: .internal),
        Rule(term: "task board", minimumAllowedExposure: .internal),
        Rule(term: "task manager", minimumAllowedExposure: .internal),
        Rule(term: "habit tracker", minimumAllowedExposure: .internal),
        Rule(term: "habit ring", minimumAllowedExposure: .internal),
        Rule(term: "Habits tab", minimumAllowedExposure: .internal),
        Rule(term: "AI assistant", minimumAllowedExposure: .internal),
        Rule(term: "AI wrapper", minimumAllowedExposure: .internal),
        Rule(term: "AI recommends", minimumAllowedExposure: .internal),
        Rule(term: "activity feed", minimumAllowedExposure: .internal),
        Rule(term: "AI confidence", minimumAllowedExposure: .internal),
        Rule(term: "productivity score", minimumAllowedExposure: .internal),
        Rule(term: "life score", minimumAllowedExposure: .internal),
        Rule(term: "KPI", minimumAllowedExposure: .internal),
        Rule(term: "streak", minimumAllowedExposure: .internal),
        Rule(term: "chatbot", minimumAllowedExposure: .internal),
        Rule(term: "dashboard", minimumAllowedExposure: .internal),
