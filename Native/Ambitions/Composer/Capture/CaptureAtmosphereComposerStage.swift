...
struct CaptureAtmosphereComposerStage<Content: View>: View {
    ...
    var body: some View {
        ...
        .accessibilityIdentifier("capture.flagship.atmosphere-composer.stage")
    }
...
extension View {
    func flagshipCaptureComposerStage(state: LivingVisualState, summary: String) -> some View {
        CaptureAtmosphereComposerStage(state: state, summary: summary) {
            self
        }
    }
}
