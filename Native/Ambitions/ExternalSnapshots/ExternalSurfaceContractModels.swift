...
enum ExternalSurfaceContractRegistry {
    static let contracts: [ExternalSurfaceContract] = [
        ExternalSurfaceContract(
            ...
            allowedActions: ["Start", "Move", "Park", "Mark Done", "Open Plan"],
            fallbackRoute: .tab,
            fallbackTab: "today",
        ...
        ExternalSurfaceContract(
            ...
            hidesSensitiveDetailsByDefault: true,
            allowedActions: ["Open Plan", "Mark Done where safe", "Park where safe"],
            fallbackRoute: .tab,
            fallbackTab: "plan",
        ...
        ExternalSurfaceContract(
            kind: .appIntents,
            allowedContent: ["Capture", "Start Next Step", "Mark Done", "Save the Day", "Open Plan"],
            ...
            hidesSensitiveDetailsByDefault: true,
            allowedActions: ["Capture", "Start Next Step", "Mark Done", "Save the Day", "Open Plan"],
            fallbackRoute: .tab,
            fallbackTab: "today",
        ...
        ExternalSurfaceContract(
            kind: .shortcuts,
            allowedContent: ["Capture", "Open Plan", "Save the Day", "safe status"],
            forbiddenContent: ["silent destructive automations"],
            privacyDefault: .conservative,
            hidesSensitiveDetailsByDefault: true,
            allowedActions: ["Capture", "Open Plan", "Save the Day", "safe status"],
            fallbackRoute: .tab,
            fallbackTab: "today",
