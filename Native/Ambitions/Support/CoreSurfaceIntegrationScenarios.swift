...
enum CoreSurfaceIntegrationScenarioCatalog {
    ...
    static let blockers: [CoreSurfaceMaturityBlocker] = [
        ...
        CoreSurfaceMaturityBlocker(id: "m12-continuity-performance", title: "Cross-surface continuity and mature performance remain unmeasured", ownerBatch: "M12/R02", severity: .high, evidenceNeeded: "Continuity handoff proof and realistic performance measurements."),
