...
extension ExternalSurfaceControlContract {
    static let systemControlSet: [ExternalSurfaceControlContract] = [
        ExternalSurfaceControlContract(
            ...
            privacySummary: "Opens Ambitions to the recommended step without exposing private step text in the system surface.",
        ...
        ExternalSurfaceControlContract(
            ...
            privacySummary: "Opens the proof target in Ambitions; proof content stays user-confirmed in app before it becomes durable.",
            actionName: .open,
            payloadSurface: .goalDetail,
