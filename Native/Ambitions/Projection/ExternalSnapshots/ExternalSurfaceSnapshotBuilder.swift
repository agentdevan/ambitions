    ...
    private func projectionAmbientState(
        ...
        return ExternalSurfaceAmbientState(
            today: ExternalSurfaceVariantState(
                ...
                detail: hasRedactions ? "Open Ambitions to review private context safely." : "Open Ambitions to continue from the latest local projection.",
            ...
            timeShape: ExternalSurfaceVariantState(
                ...
                detail: "Open Time to inspect the latest local projection.",
