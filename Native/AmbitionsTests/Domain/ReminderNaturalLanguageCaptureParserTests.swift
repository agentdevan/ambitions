...
final class ReminderNaturalLanguageCaptureParserTests: XCTestCase {
    func testParserCoversTheReminderP0PhraseMatrixAndLocalInspectionBoundary() throws {
        ...
        XCTAssertEqual(parsedTomorrow.source.localReminderYouInspectionSummary, "You / Search Ambitions can inspect this source, receipt, and reason.")
        XCTAssertEqual(parsedTomorrow.inspectionBoundary.surfaceTitle, "Search Ambitions")
