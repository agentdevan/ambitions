...
final class GoalDetailStrategicPresentationTests: XCTestCase {
    ...
    func testM07PathBuilderConnectsRoadmapForkProofAndTodayWithoutNewTab() async throws {
        ...
        XCTAssertEqual(pathBuilder.title, "Goal path")
    ...
    func testFCP11LifePathThreadPreservesOrderPrimitivesAndPrivateRedaction() async throws {
        ...
        XCTAssertEqual(thread.title, "Goal path")
        ...
        XCTAssertEqual(thread.sourceFold.title, "Path source")
        XCTAssertTrue(thread.accessibilityValue.contains("Order 1"))
        XCTAssertTrue(thread.accessibilityHint.contains("proof points"))
        XCTAssertTrue(thread.accessibilityHint.contains("friction"))
        XCTAssertTrue(thread.accessibilityHint.contains("future routes"))
        XCTAssertTrue(thread.accessibilityHint.contains("source"))
