...
final class FeatureEnginePackageBoundaryModelsTests: XCTestCase {
    func testCurrentManifestDefinesFeatureEngineBoundaryWithoutProjectWiringClaim() {
        ...
        XCTAssertEqual(manifest.activeDestinationSourceRoots, ["Captures", "Goals", "Plan", "Profile", "Today"])
    ...
    func testValidatorAcceptsKnownFeatureRootsWhenWiringDeclared() {
        ...
        let files = [
            ...
            FeatureEngineSourceFileBoundary(path: "Native/Ambitions/Features/Plan/TimeFeatureService.swift", imports: ["AmbitionsDesignSystem", "Foundation"]),
            FeatureEngineSourceFileBoundary(path: "Native/Ambitions/Features/Profile/ProfileScreen.swift", imports: ["AmbitionsDesignSystem", "SwiftUI", "UIKit"]),
    ...
    func testValidatorBlocksOutOfRootUnknownFeatureForbiddenImportsAndMissingImports() {
        let files = [
            ...
            FeatureEngineSourceFileBoundary(path: "Native/Ambitions/Features/Captures/CapturesScreen.swift", imports: ["AmbitionsDesignSystem", "SwiftUI"]),
            FeatureEngineSourceFileBoundary(path: "Native/Ambitions/Features/Plan/TimeFeatureService.swift", imports: ["Foundation"]),
            FeatureEngineSourceFileBoundary(path: "Native/Ambitions/Features/Profile/ProfileScreen.swift", imports: ["SwiftUI", "UIKit"]),
