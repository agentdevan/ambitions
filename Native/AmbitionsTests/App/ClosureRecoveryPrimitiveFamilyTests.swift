...
final class ClosureRecoveryPrimitiveFamilyTests: XCTestCase {
    ...
    func testAMB578ActiveClosureRecoverySurfacesUsePrimitiveFamily() throws {
        ...
        let richPanelSource = try source("Packages/AmbitionsDesignSystem/Sources/Components/RichPanelPrimitives+02-AmbitionRichPanel.swift", root: root)
        let canonicalSource = try source("Packages/AmbitionsDesignSystem/Sources/Components/AmbitionsV2CanonicalComponents.swift", root: root)
        let tactileSource = try source("Packages/AmbitionsDesignSystem/Sources/Components/AmbitionsExtendedTactileKit.swift", root: root)
        let shellSource = try source("Packages/AmbitionsDesignSystem/Sources/Components/ShellChromePrimitives.swift", root: root)
