...
final class ScenarioMatrixTests: XCTestCase {
    ...
    func testForbiddenLanguageTermsRejectOldRootCanon() {
        ...
        XCTAssertEqual(ForbiddenLanguageAudit.violation(in: "Open the dashboard"), "dashboard")
        XCTAssertEqual(ForbiddenLanguageAudit.violation(in: "Start a chatbot"), "chatbot")
        XCTAssertEqual(ForbiddenLanguageAudit.violation(in: "Show the task dashboard"), "task dashboard")
        XCTAssertEqual(ForbiddenLanguageAudit.violation(in: "Track a habit ring"), "habit ring")
        XCTAssertEqual(ForbiddenLanguageAudit.violation(in: "Your productivity score improved"), "productivity score")
