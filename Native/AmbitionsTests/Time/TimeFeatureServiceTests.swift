...
final class TimeFeatureServiceTests: XCTestCase {
    func testAMB573TimeObjectStagePrimitiveContractReplacesFirstViewportGenericGeometry() throws {
        ...
        XCTAssertTrue(contract.replacesFirstViewportStructures.contains("preview changes panel"))
    ...
    func testFCP15ReflowDecisionFoldShowsBeforeAfterReceiptAndUserChoice() async throws {
        ...
        XCTAssertTrue(preview.receiptPreviewLabel.hasPrefix("Review preview:"))
