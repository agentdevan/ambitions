...
final class ReplayableDecisionTraceTests: XCTestCase {
    ...
    func testReplayableDecisionTraceProjectsPersonalRuntimeLearningSignalsFromRejectionLearningInfluence() throws {
        ...
        XCTAssertEqual(trace.personalRuntimeLearningSignals.first?.personalRuntimeInspectableSummary.contains("Reset, disable, or delete") ?? false, true)
        ...
        XCTAssertEqual(trace.personalRuntimeLearningSignals.first?.personalRuntimeDisableRoute, "you://personal-runtime/recommendation.runtime.rejection/disable")
