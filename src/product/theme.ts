  ...
  return {
    ...
    colors: {
      ...
      tabBar: {
        ...
        border: mode === "dark" ? "#2F343C" : "#DFD4C5",
        pill: mode === "dark" ? withAlpha(accentPrimary, "3E") : withAlpha(accentPrimary, "1D"),
        active: base.textPrimary,
        inactive: mode === "dark" ? "#B7AEA2" : base.textTertiary,
      },
      shadow: {
        color: base.shadow,
