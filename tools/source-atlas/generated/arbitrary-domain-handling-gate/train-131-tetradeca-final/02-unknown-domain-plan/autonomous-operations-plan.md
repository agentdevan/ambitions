...
- `define_coverage_frontier`: 3
- `monitor_current_production_runtime`: 14

## Domain Plan

| Domain | Readiness | Next Action | Gate | Command | Blockers |
| --- | --- | --- | --- | --- | --- |
| community_volunteering_opportunities | blocked | define_coverage_frontier | frontier_governance_review | `source-atlas-foundry frontier-intake --domain community_volunteering_opportunities --review-required` | coverage_frontier_missing |
| eldercare_local_services | blocked | define_coverage_frontier | frontier_governance_review | `source-atlas-foundry frontier-intake --domain eldercare_local_services --review-required` | coverage_frontier_missing |
| public_safety_training_reference | blocked | define_coverage_frontier | frontier_governance_review | `source-atlas-foundry frontier-intake --domain public_safety_training_reference --review-required` | coverage_frontier_missing |
...
| volunteering_public_reference | current_production_runtime_recertified | monitor_current_production_runtime | next_due_review_or_freshness_window | `none` |  |
