...
| --- | --- | --- | --- | --- | --- |
| local_permit_reference | blocked | define_coverage_frontier | frontier_governance_review | `source-atlas-foundry frontier-intake --domain local_permit_reference --review-required` | coverage_frontier_missing |
| public_childcare_benefit_reference | blocked | define_coverage_frontier | frontier_governance_review | `source-atlas-foundry frontier-intake --domain public_childcare_benefit_reference --review-required` | coverage_frontier_missing |
| unrepresented_public_reference_domain | blocked | define_coverage_frontier | frontier_governance_review | `source-atlas-foundry frontier-intake --domain unrepresented_public_reference_domain --review-required` | coverage_frontier_missing |
