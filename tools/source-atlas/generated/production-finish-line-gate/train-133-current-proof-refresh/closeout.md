...
Counts:
- Production domains: 14
- Production source IDs: 28
- R2 reports valid: 14 / 14
- R2 reports blocked: 0
- Recertified domains: 14
- Recertification blocked domains: 0
- Legal allowed claims: 3
- Legal blocked claims: 5
...
| `bounded_live_transport` | yes | configured production gateway/native transport proof |  |
| `bounded_configured_runtime_green` | yes | bounded configured Source Atlas public-pack runtime proof |  |
...
Proof artifacts:
- tools/source-atlas/generated/production-finish-line-gate/train-133-current-proof-refresh/production-finish-line-gate-report.json
- tools/source-atlas/generated/production-finish-line-gate/train-133-current-proof-refresh/production-finish-line-gate-report.md
- tools/source-atlas/generated/production-finish-line-gate/train-133-current-proof-refresh/closeout.md
- tools/source-atlas/generated/production-finish-line-gate/train-133-current-proof-refresh/00-production-recertification/production-recertification-report.json
- tools/source-atlas/generated/production-finish-line-gate/train-133-current-proof-refresh/01-internal-terms-approval/legal-terms-approval-packet.json
