# Source Atlas Autonomous Production Supervisor Train 123
...
| --- | --- | --- | --- | --- | --- |
| volunteering_public_reference | define_coverage_frontier | executed_safe_local_or_candidate_action | frontier_governance_review | yes | tools/source-atlas/generated/autonomous-production-supervisor/train-123-current/03-operations-executor/frontier-intake/volunteering_public_reference/candidate-sources.json<br>tools/source-atlas/generated/autonomous-production-supervisor/train-123-current/03-operations-executor/frontier-intake/volunteering_public_reference/frontier-intake-input.json<br>tools/source-atlas/generated/autonomous-production-supervisor/train-123-current/03-operations-executor/frontier-intake/volunteering_public_reference/frontier-intake.json<br>tools/source-atlas/generated/autonomous-production-supervisor/train-123-current/03-operations-executor/frontier-intake/volunteering_public_reference/manifest.json<br>tools/source-atlas/generated/autonomous-production-supervisor/train-123-current/03-operations-executor/frontier-intake/volunteering_public_reference/proposed-frontiers.json |
...
Rollback plan:
- Revert Train 123 autonomous production supervisor module, CLI wiring, focused tests, generated artifacts, and QA evidence.
- Continue using the individual production orchestrator, operations plan, and operations executor reports directly if supervision regresses.
