...
- Monitor-only decisions: 14
- Candidate/review-only decisions: 2
...
| --- | --- | --- | --- | --- |
| community_volunteering_opportunities | candidate_frontier_review | candidate_or_source_review_only | not_r2_write_action | review-only action cannot emit claims, packs, or R2 writes |
| eldercare_local_services | candidate_frontier_review | candidate_or_source_review_only | not_r2_write_action | review-only action cannot emit claims, packs, or R2 writes |
...
| volunteering_public_reference | monitor_current_production | monitor_only_current | existing_remote_upload_readback_reconciled | none |
