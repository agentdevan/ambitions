...
| --- | --- | --- | --- | --- | --- |
| community_volunteering_opportunities | candidate_frontier_review | review | candidate_only_review_required | frontier_governance_review | coverage_frontier_missing |
| eldercare_local_services | candidate_frontier_review | review | candidate_only_review_required | frontier_governance_review | coverage_frontier_missing |
...
| volunteering_public_reference | monitor_current_production | monitor | current | next_due_review_or_freshness_window | current within review and terms windows |
