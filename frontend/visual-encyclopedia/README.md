...
Status: Active frontend visual canon portal
Authority: subordinate to `docs/truth/*`

Use this portal for the detailed visual encyclopedia, recipe system, trace ledgers, object/primitive canon, and signature visual instrument doctrine.
...
- Today -> Reality Meridian Instrument
- Goals -> Constellation Atlas Instrument
- Capture -> Atmosphere Composer Instrument
- Time -> LifeShape Field Instrument
- You -> User System Profile Instrument
