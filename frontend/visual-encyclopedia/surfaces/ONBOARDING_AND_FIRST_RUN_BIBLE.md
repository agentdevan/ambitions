...
This surface contains local-first promise, no calendar permission request, calm setup choices, first useful route, local runtime explanation, privacy defaults. The top-level visual hierarchy is `Progressive Intelligence Onboarding` first, one primary next action second, source/trust/proof affordances third, and secondary metadata last.

## Primary Object

- Destination: Onboarding
- Primary object: Progressive Intelligence Onboarding
- User job: First run setup
...
Setup choice detail; Privacy explanation; later You-owned schedule setup.
