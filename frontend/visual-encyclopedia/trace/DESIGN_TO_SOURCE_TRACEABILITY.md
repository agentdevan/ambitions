...
| Capture / Atmosphere Composer | frontend/visual-encyclopedia/surfaces/CAPTURE_ATMOSPHERE_COMPOSER_BIBLE.md | captureSignal | PRIMARY_CTA_CONTRACT.md | Native/Ambitions/Features/Capture/* | source-present | debt | component-contract-check | none |
| Time / LifeShape Field | frontend/visual-encyclopedia/surfaces/TIME_LIFESHAPE_FIELD_BIBLE.md | timeCapacity | SOURCE_FRESHNESS_BADGE_CONTRACT.md | Native/Ambitions/Features/Time/* | source-present | debt | component-contract-check | none |
| You / User System Profile | frontend/visual-encyclopedia/surfaces/YOU_USER_SYSTEM_PROFILE_BIBLE.md | youTrust | TRUST_SEAM_CONTRACT.md | Native/Ambitions/Features/You/* | source-present | debt | component-contract-check | none |
