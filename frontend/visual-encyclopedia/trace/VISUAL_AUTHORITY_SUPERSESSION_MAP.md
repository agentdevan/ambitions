...
| --- | --- | --- | --- | --- |
| docs/truth/CODEX_PROCESS_TRUTH.md | active_authority | current repo truth | — | — |
| docs/truth/HISTORICAL_POLICY.md | active_authority | current repo truth | — | — |
...
| frontend/visual-encyclopedia/SURFACE_RECIPE_TEMPLATE.md | report_only | supporting control-plane file | — | — |
| frontend/visual-encyclopedia/TERM_ALIAS_AND_DEPRECATION_REGISTRY.md | report_only | supporting control-plane file | — | — |
| frontend/visual-encyclopedia/VISUAL_ACCESSIBILITY_ADHD_REQUIREMENTS.md | report_only | supporting control-plane file | — | — |
| frontend/visual-encyclopedia/VISUAL_ANTI_SLOP_RULES.md | report_only | supporting control-plane file | — | — |
| frontend/visual-encyclopedia/VISUAL_DECISION_RECORDS.md | report_only | supporting control-plane file | — | — |
| frontend/visual-encyclopedia/VISUAL_DESIGN_AUTHORITY_LOCK_PREP_03.md | report_only | supporting control-plane file | — | — |
| frontend/visual-encyclopedia/VISUAL_DESIGN_FINAL_FORM_LOCK_REPAIR_05.md | report_only | supporting control-plane file | — | — |
| frontend/visual-encyclopedia/VISUAL_DESIGN_LOCK_REVIEW_PACKET.md | report_only | supporting control-plane file | — | — |
| frontend/visual-encyclopedia/VISUAL_DIRECTION_CHANGE_PROTOCOL.md | report_only | supporting control-plane file | — | — |
| frontend/visual-encyclopedia/VISUAL_ENCYCLOPEDIA_PERFECTION_PLAN.md | report_only | supporting control-plane file | — | — |
| frontend/visual-encyclopedia/VISUAL_ENCYCLOPEDIA_RUTHLESS_AUDIT.md | report_only | supporting control-plane file | — | — |
| frontend/visual-encyclopedia/VISUAL_ITEM_REGISTRY.md | report_only | supporting control-plane file | — | — |
| frontend/visual-encyclopedia/VISUAL_ITEM_REGISTRY.yaml | report_only | supporting control-plane file | — | — |
| frontend/visual-encyclopedia/VISUAL_OBJECT_FIRST_REVIEW_RUBRIC.md | report_only | supporting control-plane file | — | — |
| frontend/visual-encyclopedia/VISUAL_RECIPE_SCHEMA_CONTRACT.md | report_only | supporting control-plane file | — | — |
| frontend/visual-encyclopedia/VISUAL_RECIPE_SCHEMA_CONTRACT.yaml | report_only | supporting control-plane file | — | — |
| frontend/visual-encyclopedia/VISUAL_RECIPE_SHORT_FORM_TEMPLATE.md | report_only | supporting control-plane file | — | — |
| frontend/visual-encyclopedia/VISUAL_REFERENCE_LEDGER.md | report_only | supporting control-plane file | — | — |
| frontend/visual-encyclopedia/VISUAL_SOURCE_LINKS.yaml | report_only | supporting control-plane file | — | — |
| frontend/visual-encyclopedia/VISUAL_SOURCE_PROVENANCE_AND_BATCH_LINKAGE.md | report_only | supporting control-plane file | — | — |
| frontend/visual-encyclopedia/VISUAL_SOURCE_PROVENANCE_AND_BATCH_LINKAGE.yaml | report_only | supporting control-plane file | — | — |
| frontend/visual-encyclopedia/VISUAL_VOCABULARY_BOUNDARY.md | report_only | supporting control-plane file | — | — |
| frontend/visual-encyclopedia/behavior/ACCESSIBILITY_AND_ADHD_LAWS.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/behavior/ADHD_USABILITY_RULES.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/behavior/AMBITIONS_TRANSACTION_MODEL.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/behavior/ANTI_GENERIC_KILL_SWITCHES.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/behavior/CROSS_SURFACE_STATE_GRAMMAR.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/behavior/DYNAMIC_TYPE.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/behavior/LOCAL_FIRST_TRUST_BEHAVIOR.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/behavior/MOTION_AND_HAPTICS.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/behavior/NO_FALSE_MOMENTUM.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/behavior/PREVIEW_CONFIRM_UNDO_BEHAVIOR.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/behavior/RECOMMENDATION_INSPECTION_BEHAVIOR.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/behavior/RECOVERY_MODE.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/behavior/REDUCE_MOTION.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/behavior/STATE_TRANSITIONS.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/behavior/VOICEOVER_GROUPING.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/contracts/ACCESSIBILITY_CONTRACT_INDEX.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/contracts/COMPONENT_CONTRACT_INDEX.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/contracts/DIFFERENTIATE_WITHOUT_COLOR_CONTRACT.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/contracts/DISCLOSURE_ROW_CONTRACT.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/contracts/DYNAMIC_TYPE_CONTRACT.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/contracts/PRIMARY_CTA_CONTRACT.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/contracts/PROOF_CHIP_CONTRACT.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/contracts/RECEIPT_CONTRACT.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/contracts/REDUCE_MOTION_CONTRACT.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/contracts/REDUCE_TRANSPARENCY_CONTRACT.md | active_authority | active frontend canon | — | — |
...
| frontend/visual-encyclopedia/gates/NORTH_STAR_100_GATE_RESULTS.md | report_only | supporting control-plane file | — | — |
| frontend/visual-encyclopedia/gates/NORTH_STAR_100_MEASURABLE_GATE_MATRIX.yaml | report_only | supporting control-plane file | — | — |
| frontend/visual-encyclopedia/gates/SOURCE_PROOF_RECEIPT_COVERAGE_GATE.md | report_only | supporting control-plane file | — | — |
| frontend/visual-encyclopedia/gates/VISUAL_REGRESSION_READINESS.md | report_only | supporting control-plane file | — | — |
| frontend/visual-encyclopedia/objects/AMBITION_GRAPH.md | report_only | supporting control-plane file | — | — |
| frontend/visual-encyclopedia/objects/ATMOSPHERE_COMPOSER.md | report_only | supporting control-plane file | — | — |
| frontend/visual-encyclopedia/objects/ATMOSPHERE_COMPOSER_ANATOMY.md | report_only | supporting control-plane file | — | — |
| frontend/visual-encyclopedia/objects/CLOSURE_SYSTEM.md | report_only | supporting control-plane file | — | — |
| frontend/visual-encyclopedia/objects/COMMITMENT_STAGING_TRAY.md | report_only | supporting control-plane file | — | — |
| frontend/visual-encyclopedia/objects/CONSTELLATION_ATLAS.md | report_only | supporting control-plane file | — | — |
| frontend/visual-encyclopedia/objects/CONSTELLATION_ATLAS_ANATOMY.md | report_only | supporting control-plane file | — | — |
| frontend/visual-encyclopedia/objects/LABEL_OFF_SIGNATURE_TESTS.md | report_only | supporting control-plane file | — | — |
| frontend/visual-encyclopedia/objects/LIFESHAPE_FIELD.md | report_only | supporting control-plane file | — | — |
| frontend/visual-encyclopedia/objects/LIFESHAPE_FIELD_ANATOMY.md | report_only | supporting control-plane file | — | — |
| frontend/visual-encyclopedia/objects/LOCAL_RUNTIME_TRUST_PANEL.md | report_only | supporting control-plane file | — | — |
| frontend/visual-encyclopedia/objects/PLANNED_TRAIN_FRONTEND_INFLUENCE_OBJECTS.md | report_only | supporting control-plane file | — | — |
| frontend/visual-encyclopedia/objects/PRIMARY_OBJECT_ANATOMY_CANON.md | report_only | supporting control-plane file | — | — |
| frontend/visual-encyclopedia/objects/PROOF_TRAIL.md | report_only | supporting control-plane file | — | — |
| frontend/visual-encyclopedia/objects/REALITY_MERIDIAN.md | report_only | supporting control-plane file | — | — |
| frontend/visual-encyclopedia/objects/REALITY_MERIDIAN_ANATOMY.md | report_only | supporting control-plane file | — | — |
| frontend/visual-encyclopedia/objects/RECEIPT_SYSTEM.md | report_only | supporting control-plane file | — | — |
| frontend/visual-encyclopedia/objects/RECOMMENDATION_SOURCE_SYSTEM.md | report_only | supporting control-plane file | — | — |
| frontend/visual-encyclopedia/objects/REFLOW_PREVIEW_TRAY.md | report_only | supporting control-plane file | — | — |
| frontend/visual-encyclopedia/objects/USER_SYSTEM_PROFILE.md | report_only | supporting control-plane file | — | — |
| frontend/visual-encyclopedia/objects/USER_SYSTEM_PROFILE_ANATOMY.md | report_only | supporting control-plane file | — | — |
| frontend/visual-encyclopedia/primitives/ADHD_DENSITY_PRIMITIVES.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/primitives/BADGES_MARKERS_AND_STATE_GLYPHS.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/primitives/CHEVRONS_AND_DISCLOSURE.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/primitives/CHROME_AND_NAVIGATION.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/primitives/COLOR_AND_STATE_TOKENS.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/primitives/CTA_SYSTEM.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/primitives/DIVIDERS_SEPARATORS_AND_BOUNDARIES.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/primitives/DYNAMIC_TYPE_COLLAPSE_PRIMITIVES.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/primitives/EMPTY_STATE_COPY_AND_AFFORDANCES.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/primitives/ICONOGRAPHY.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/primitives/LABEL_SYSTEM.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/primitives/LOCAL_RUNTIME_PRIMITIVES.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/primitives/MATERIALS.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/primitives/MATERIAL_PRIMITIVE_ROLES.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/primitives/PRESSURE_AND_CAPACITY_PRIMITIVES.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/primitives/PROOF_PRIMITIVES.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/primitives/PROTECTED_TIME_PRIMITIVES.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/primitives/RECEIPT_PRIMITIVES.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/primitives/RECEIPT_ROWS_AND_EVENT_ROWS.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/primitives/SOURCE_FRESHNESS_PRIMITIVES.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/primitives/SPACING_AND_LAYOUT_RHYTHM.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/primitives/TRANSACTION_PRIMITIVES.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/primitives/TRUST_SEAM.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/primitives/TYPOGRAPHY.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/primitives/VOICEOVER_ORDER_PRIMITIVES.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/primitives/WRAPPERS_AND_CONTAINERS.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/capture/capture_active_text_entry.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/capture/capture_attachment_proof_picker.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/capture/capture_dictation_state.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/capture/capture_empty_first_use_state.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/capture/capture_error_failed_attachment_state.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/capture/capture_grow_into_goal_route.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/capture/capture_hold_needs_a_place_route.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/capture/capture_idle_composer.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/capture/capture_make_commitment_route.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/capture/capture_mark_constraint_route.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/capture/capture_offline_local_only_state.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/capture/capture_parse_uncertain_state.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/capture/capture_post_input_route_reveal.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/capture/capture_receipt.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/capture/capture_reflect_route.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/capture/capture_root_atmosphere_composer.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/capture/capture_save_as_proof_route.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/cross_surface/best_fit_marker.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/cross_surface/blocked_state.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/cross_surface/celestialfield_semantic_layer.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/cross_surface/chevron_disclosure_row.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/cross_surface/closure_system.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/cross_surface/commitment_staging_tray.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/cross_surface/destructive_cta.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/cross_surface/disabled_cta.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/cross_surface/graphiterecess_base.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/cross_surface/luminoustrace_state_line.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/cross_surface/moved_state.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/cross_surface/needs_recovery_state.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/cross_surface/needs_review_state.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/cross_surface/open_marker.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/cross_surface/pressure_marker.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/cross_surface/primary_cta.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/cross_surface/proof_trail_system.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/cross_surface/protected_marker.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/cross_surface/quietglass_wrapper.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/cross_surface/receipt_system.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/cross_surface/recommendation_source_system.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/cross_surface/reflow_preview_tray.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/cross_surface/secondary_cta.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/cross_surface/skipped_not_needed_state.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/cross_surface/source_freshness_badge.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/cross_surface/still_counts_state.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/cross_surface/waiting_state.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/cross_surface/why_this_sheet.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/goals/alternate_path_detail.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/goals/ambition_graph.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/goals/blocker_detail.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/goals/commitment_detail.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/goals/goal_detail.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/goals/goal_thread_detail.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/goals/goals_archive_historical_goal_state.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/goals/goals_blocked_state.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/goals/goals_empty_state.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/goals/goals_life_area_map.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/goals/goals_review_state.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/goals/goals_root_constellation_atlas.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/goals/milestone_detail.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/goals/proof_detail.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/goals/proof_gap_state.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/goals/proof_trail.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/goals/recommended_step_context_from_goals.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/goals/reflection_recovery_detail.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/goals/selected_life_area_surface.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/onboarding/capture_first_use_prompt.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/onboarding/first_run_root.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/onboarding/goals_first_use_prompt.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/onboarding/planning_defaults_prompt.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/onboarding/privacy_local_runtime_explanation.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/onboarding/schedule_setup_prompt.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/onboarding/time_first_use_prompt.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/onboarding/today_first_use_state.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/shell/back_navigation.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/shell/compact_surface_header.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/shell/context_crown.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/shell/destination_dock.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/shell/destination_tab_item.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/shell/global_app_shell.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/shell/global_empty_state_shell.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/shell/global_error_fallback_shell.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/shell/receipt_toast_inline_confirmation.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/shell/sheet_chrome.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/shell/tray_chrome.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/time/best_fit_explanation_sheet.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/time/best_fit_region.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/time/day_detail.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/time/day_lifeshape_surface.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/time/month_detail.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/time/month_lifeshape_surface.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/time/open_time_region.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/time/planning_defaults_entry.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/time/pressure_region.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/time/protected_time_detail.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/time/protected_time_region.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/time/recovery_flex_region.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/time/reflow_preview_tray.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/time/reflow_week_flow.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/time/review_pressure_surface.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/time/schedule_and_availability_entry.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/time/shape_day_flow.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/time/shape_month_flow.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/time/time_no_calendar_data_state.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/time/time_overloaded_state.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/time/time_protected_block_state.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/time/time_receipt_detail.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/time/time_root_lifeshape_field.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/time/time_scope_control.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/time/time_stale_source_state.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/time/time_vacation_away_state.md | active_authority | active frontend canon | — | — |
...
| frontend/visual-encyclopedia/recipes/today/goal_thread_context_from_today.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/today/local_runtime_source_detail_from_today.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/today/proof_attachment_detail.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/today/receipt_detail.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/today/recommendation_source_sheet.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/today/step_detail.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/today/step_session.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/today/today_closure_prompt_region.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/today/today_current_context_header.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/today/today_empty_state.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/today/today_no_schedule_data_state.md | active_authority | active frontend canon | — | — |
...
| frontend/visual-encyclopedia/recipes/today/today_recovery_state.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/today/today_root_reality_meridian.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/today/today_source_freshness_indicator.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/today/today_stale_recommendation_state.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/today/today_start_here_region.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/today/today_upcoming_commitments_region.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/today/today_vacation_away_state.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/today/waiting_detail.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/you/about_ambitions.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/you/automation_and_trust.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/you/capture_preferences.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/you/focus_session_defaults.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/you/help.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/you/local_data_reset_forget.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/you/local_runtime_trust_panel.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/you/notifications.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/you/personal_runtime.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/you/planning_defaults.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/you/planning_setup_section.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/you/privacy.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/you/schedule_and_availability.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/you/user_profile_header.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/you/vacation_away_time.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/you/you_empty_first_run_state.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/you/you_offline_local_only_state.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/you/you_root_user_system_profile.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/recipes/you/you_trust_warning_state.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/reviews/VISUAL_100_DESTINATION_SCORECARD.md | report_only | supporting control-plane file | — | — |
| frontend/visual-encyclopedia/reviews/VISUAL_100_OBJECT_SCORECARD.md | report_only | supporting control-plane file | — | — |
| frontend/visual-encyclopedia/reviews/VISUAL_100_PRIMITIVE_SCORECARD.md | report_only | supporting control-plane file | — | — |
| frontend/visual-encyclopedia/reviews/VISUAL_100_RECIPE_SCORECARD.md | report_only | supporting control-plane file | — | — |
| frontend/visual-encyclopedia/source-families/HBI_FRONTEND_SOURCE_FAMILY.md | report_only | supporting control-plane file | — | — |
| frontend/visual-encyclopedia/source-families/MRI_FRONTEND_SOURCE_FAMILY.md | report_only | supporting control-plane file | — | — |
| frontend/visual-encyclopedia/surfaces/CAPTURE_ATMOSPHERE_COMPOSER_BIBLE.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/surfaces/EMPTY_STATES_AND_RECOVERY_STATES_BIBLE.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/surfaces/EXTERNAL_SURFACES_BIBLE.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/surfaces/GLOBAL_SHELL_AND_CHROME_BIBLE.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/surfaces/GOALS_CONSTELLATION_ATLAS_BIBLE.md | active_authority | active frontend canon | — | — |
| frontend/visual-encyclopedia/surfaces/ONBOARDING_AND_FIRST_RUN_BIBLE.md | active_authority | active frontend canon | — | — |
...
| frontend/visual-encyclopedia/trace/DESIGN_TOKEN_COMPLETENESS_MATRIX.yaml | report_only | trace output or supporting ledger | — | — |
| frontend/visual-encyclopedia/trace/DESIGN_TO_SOURCE_TRACEABILITY.md | report_only | trace output or supporting ledger | — | — |
| frontend/visual-encyclopedia/trace/DESIGN_TO_SOURCE_TRACEABILITY.yaml | supporting_authority | current visual control plane | — | — |
...
| frontend/visual-encyclopedia/trace/MRI_HBI_TO_FRONTEND_SURFACE_MATRIX.md | report_only | trace output or supporting ledger | — | — |
| frontend/visual-encyclopedia/trace/NATIVE_IPHONE_INTERACTION_GRAMMAR_MATRIX.yaml | report_only | trace output or supporting ledger | — | — |
| frontend/visual-encyclopedia/trace/OBJECT_TO_PRIMITIVE_MATRIX.md | report_only | trace output or supporting ledger | — | — |
| frontend/visual-encyclopedia/trace/PLANNED_BATCH_FRONTEND_DIRECTION_INVENTORY.md | report_only | trace output or supporting ledger | — | — |
| frontend/visual-encyclopedia/trace/PLANNED_TRAIN_FRONTEND_DIRECTION_INVENTORY.md | report_only | trace output or supporting ledger | — | — |
| frontend/visual-encyclopedia/trace/PLANNED_TRAIN_FRONTEND_DIRECTION_INVENTORY.yaml | report_only | trace output or supporting ledger | — | — |
| frontend/visual-encyclopedia/trace/PREVIEW_MATRIX.md | report_only | trace output or supporting ledger | — | — |
| frontend/visual-encyclopedia/trace/PREVIEW_MATRIX.yaml | supporting_authority | current visual control plane | — | — |
...
| frontend/visual-encyclopedia/trace/STATE_TO_VISUAL_ENCODING_MATRIX.md | report_only | trace output or supporting ledger | — | — |
| frontend/visual-encyclopedia/trace/SURFACE_RECIPE_SPECIFICITY_REVIEW_LEDGER.md | supporting_authority | current visual control plane | — | — |
| frontend/visual-encyclopedia/trace/SURFACE_SCENARIO_COVERAGE_MATRIX.yaml | report_only | trace output or supporting ledger | — | — |
| frontend/visual-encyclopedia/trace/SURFACE_TO_OBJECT_MATRIX.md | report_only | trace output or supporting ledger | — | — |
| frontend/visual-encyclopedia/trace/TOKEN_SOURCE_AUTHORITY_LEDGER.md | report_only | trace output or supporting ledger | — | — |
| frontend/visual-encyclopedia/trace/TRAIN_FAMILY_PRECEDENCE_LEDGER.md | report_only | trace output or supporting ledger | — | — |
| frontend/visual-encyclopedia/trace/TRAIN_FAMILY_TO_OBJECT_MATRIX.md | report_only | trace output or supporting ledger | — | — |
...
| frontend/visual-encyclopedia/trace/VISUAL_100_PRIORITY_RECIPE_REGISTRY.md | report_only | trace output or supporting ledger | — | — |
| frontend/visual-encyclopedia/trace/VISUAL_100_PRIORITY_RECIPE_REGISTRY.yaml | supporting_authority | current visual control plane | — | — |
| frontend/visual-encyclopedia/trace/VISUAL_100_PROMPT_SUPERSESSION_LEDGER.md | supporting_authority | current visual control plane | — | — |
| frontend/visual-encyclopedia/trace/VISUAL_100_RED_YELLOW_FLAG_LEDGER.md | report_only | trace output or supporting ledger | — | — |
| frontend/visual-encyclopedia/trace/VISUAL_100_SOURCE_DEBT_LEDGER.md | supporting_authority | current visual control plane | — | — |
| frontend/visual-encyclopedia/trace/VISUAL_100_SOURCE_LINK_DISTRIBUTION.md | report_only | trace output or supporting ledger | — | — |
| frontend/visual-encyclopedia/trace/VISUAL_100_VOCABULARY_SCAN_SCOPE.md | report_only | trace output or supporting ledger | — | — |
| frontend/visual-encyclopedia/trace/VISUAL_AUTHORITY_SUPERSESSION_MAP.md | report_only | trace output or supporting ledger | — | — |
| frontend/visual-encyclopedia/trace/VISUAL_CONFLICT_LEDGER.md | report_only | trace output or supporting ledger | — | — |
| frontend/visual-encyclopedia/trace/VISUAL_DIRECTION_SOURCE_FAMILY_EXTRACTION_LEDGER.md | report_only | trace output or supporting ledger | — | — |
| frontend/visual-encyclopedia/trace/VISUAL_NO_ORPHAN_GRAPH.yaml | report_only | trace output or supporting ledger | — | — |
| frontend/visual-encyclopedia/trace/VISUAL_SOURCE_LINKAGE_LEDGER.md | supporting_authority | current visual control plane | — | — |
| frontend/visual-encyclopedia/trace/VISUAL_SURFACE_GRAPH_LEDGER.md | supporting_authority | current visual control plane | — | — |
| DesignTokens/README.md | active_authority | token source tree | — | — |
| DesignTokens/accessibility.tokens.json | active_authority | token source tree | — | — |
| DesignTokens/component.tokens.json | active_authority | token source tree | — | — |
| DesignTokens/foundations.tokens.json | active_authority | token source tree | — | — |
| DesignTokens/haptics.tokens.json | active_authority | token source tree | — | — |
| DesignTokens/motion.tokens.json | active_authority | token source tree | — | — |
| DesignTokens/objects/atmosphere-composer.tokens.json | active_authority | token source tree | — | — |
| DesignTokens/objects/constellation-atlas.tokens.json | active_authority | token source tree | — | — |
| DesignTokens/objects/lifeshape-field.tokens.json | active_authority | token source tree | — | — |
| DesignTokens/objects/reality-meridian.tokens.json | active_authority | token source tree | — | — |
| DesignTokens/objects/user-system-profile.tokens.json | active_authority | token source tree | — | — |
| DesignTokens/semantic.tokens.json | active_authority | token source tree | — | — |
| DesignTokens/states/closure.tokens.json | active_authority | token source tree | — | — |
| DesignTokens/states/proof.tokens.json | active_authority | token source tree | — | — |
| DesignTokens/states/protected-time.tokens.json | active_authority | token source tree | — | — |
| DesignTokens/states/recovery.tokens.json | active_authority | token source tree | — | — |
| DesignTokens/states/source-freshness.tokens.json | active_authority | token source tree | — | — |
| Sources/Theme/AmbitionObjectTokens.generated.swift | generated_output | generated from DesignTokens | — | — |
...
| build/reports/ambitions-codex-os-dry-run-004.json | report_only | validation output only | — | — |
...
| build/reports/design-system-15-systems-install-01.md | report_only | validation output only | — | — |
| build/reports/design-to-source-trace.json | report_only | validation output only | — | — |
| build/reports/design-token-completeness.json | report_only | validation output only | — | — |
...
| build/reports/frontend-surface-recipe-encyclopedia-001.md | report_only | validation output only | — | — |
| build/reports/frontend-surface-recipe-specificity-and-train-extraction-001.json | report_only | validation output only | — | — |
| build/reports/frontend-surface-recipe-specificity-and-train-extraction-001.md | report_only | validation output only | — | — |
...
| build/reports/visual-100-false-green.json | report_only | validation output only | — | — |
| build/reports/visual-100-gate.json | report_only | validation output only | — | — |
| build/reports/visual-100-gate.md | report_only | validation output only | — | — |
| build/reports/visual-100-hidden-automation.json | report_only | validation output only | — | — |
| build/reports/visual-100-local-first-trust.json | report_only | validation output only | — | — |
| build/reports/visual-100-native-believability.json | report_only | validation output only | — | — |
| build/reports/visual-100-no-false-momentum.json | report_only | validation output only | — | — |
| build/reports/visual-100-object-depth.json | report_only | validation output only | — | — |
| build/reports/visual-100-p0-recipe-upgrade.json | report_only | validation output only | — | — |
| build/reports/visual-100-primitive-operationality.json | report_only | validation output only | — | — |
| build/reports/visual-100-priority-registry.json | report_only | validation output only | — | — |
| build/reports/visual-100-prompt-authority.json | report_only | validation output only | — | — |
| build/reports/visual-100-proof-dashboard.json | report_only | validation output only | — | — |
| build/reports/visual-100-proof-dashboard.md | report_only | validation output only | — | — |
| build/reports/visual-100-proof-source-receipt.json | report_only | validation output only | — | — |
| build/reports/visual-100-recipe-contract.json | report_only | validation output only | — | — |
| build/reports/visual-100-scorecard.json | report_only | validation output only | — | — |
| build/reports/visual-100-source-debt.json | report_only | validation output only | — | — |
| build/reports/visual-100-transaction.json | report_only | validation output only | — | — |
...
| build/reports/visual-encyclopedia-dashboard.md | report_only | validation output only | — | — |
| build/reports/visual-no-orphan-graph.json | report_only | validation output only | — | — |
| build/reports/visual-regression-readiness.json | report_only | validation output only | — | — |
| build/reports/visual-source-linkage.json | report_only | validation output only | — | — |
| build/reports/visual-surface-graph.json | report_only | validation output only | — | — |
...
| docs/archive/superseded-design-canon/design/design-system-spec.md | archive_candidate | explicitly archived history | — | — |
| docs/archive/superseded-design-canon/design/external-surface-spec.md | archive_candidate | explicitly archived history | — | — |
| docs/archive/superseded-design-canon/design/motion-microinteraction-spec.md | archive_candidate | explicitly archived history | — | — |
| docs/archive/superseded-design-canon/design/novel-interaction-systems-spec.md | archive_candidate | explicitly archived history | — | — |
| docs/archive/superseded-design-canon/design/screen-architecture-spec.md | archive_candidate | explicitly archived history | — | — |
| docs/archive/superseded-design-canon/design/shell-ia-spec.md | archive_candidate | explicitly archived history | — | — |
| docs/archive/superseded-design-canon/design/transformation-terminology-spec.md | archive_candidate | explicitly archived history | — | — |
| docs/archive/superseded-design-canon/design/transformation-validation-standard.md | archive_candidate | explicitly archived history | — | — |
| docs/archive/superseded-design-canon/design/trust-explainability-correction-spec.md | archive_candidate | explicitly archived history | — | — |
| docs/archive/superseded-design-canon/presentations/frontend-transformation-investor-deck/narrative_plan.md | archive_candidate | explicitly archived history | — | — |
| docs/archive/superseded-design-canon/rc1-native-finish-pass.md | archive_candidate | explicitly archived history | — | — |
| prompts/batches/VISUAL-DESIGN-AUTHORITY-FINAL-FORM-04.md | report_only | current execution prompt, not authority | — | — |
| prompts/batches/VISUAL-DESIGN-AUTHORITY-LOCK-PREP-03.md | historical | superseded by final-form prompt | VISUAL-DESIGN-AUTHORITY-FINAL-FORM-04 | — |

## Supersession Notes

- `prompts/batches/VISUAL-DESIGN-AUTHORITY-LOCK-PREP-03.md` is superseded by `prompts/batches/VISUAL-DESIGN-AUTHORITY-FINAL-FORM-04.md`.
