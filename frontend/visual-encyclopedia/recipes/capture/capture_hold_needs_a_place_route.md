# Surface Recipe: Capture Hold / Needs a Place Route

## Canon Status
intended_canon

## Surface ID
capture_hold_needs_a_place_route
...
- Purpose: Show how Composer atmosphere field changes the visible hierarchy, source/proof meaning, and available action for Capture Hold / Needs a Place Route.
...
- Purpose: Show how Input affordance changes the visible hierarchy, source/proof meaning, and available action for Capture Hold / Needs a Place Route.
- Contains: Atmosphere Composer; visible ingredients include captured text or attachment, routing destination, needs-place state, source/proof attachment, local-only note, receipt expectation, and correction or undo path. Supporting objects: Receipt System, Source Freshness Badge, Why This Sheet, Closure System. Region context: orientation, primary object, source/proof line.
- Primitives: GraphiteRecess ground, LuminousTrace attachment, CelestialField only for semantic orientation, SF Symbols, chevrons, label system.
- Typography: Use native iPhone semantic text hierarchy: compact region label, Atmosphere Composer title or state label, source/proof caption, and readable action text. Emphasis stays on the active Atmosphere Composer decision or inspected state.
- Spacing: Keep source, proof, CTA, and state notes visually attached to Atmosphere Composer, with tight native grouping, thumb-zone reach for actions, and enough separation to prevent equal-weight card stacking.
...
- Purpose: Show how Route reveal or placement options changes the visible hierarchy, source/proof meaning, and available action for Capture Hold / Needs a Place Route.
- Contains: Atmosphere Composer; visible ingredients include captured text or attachment, routing destination, needs-place state, source/proof attachment, local-only note, receipt expectation, and correction or undo path. Supporting objects: Receipt System, Source Freshness Badge, Why This Sheet, Closure System. Region context: orientation, primary object, source/proof line.
- Primitives: GraphiteRecess ground, LuminousTrace attachment, CelestialField only for semantic orientation, SF Symbols, chevrons, label system.
- Typography: Use native iPhone semantic text hierarchy: compact region label, Atmosphere Composer title or state label, source/proof caption, and readable action text. Emphasis stays on the active Atmosphere Composer decision or inspected state.
- Spacing: Keep source, proof, CTA, and state notes visually attached to Atmosphere Composer, with tight native grouping, thumb-zone reach for actions, and enough separation to prevent equal-weight card stacking.
...
- Purpose: Show how Local-only/error state changes the visible hierarchy, source/proof meaning, and available action for Capture Hold / Needs a Place Route.
- Contains: Atmosphere Composer; visible ingredients include captured text or attachment, routing destination, needs-place state, source/proof attachment, local-only note, receipt expectation, and correction or undo path. Supporting objects: Receipt System, Source Freshness Badge, Why This Sheet, Closure System. Region context: orientation, primary object, source/proof line.
- Primitives: GraphiteRecess ground, LuminousTrace attachment, CelestialField only for semantic orientation, SF Symbols, chevrons, label system.
- Typography: Use native iPhone semantic text hierarchy: compact region label, Atmosphere Composer title or state label, source/proof caption, and readable action text. Emphasis stays on the active Atmosphere Composer decision or inspected state.
- Spacing: Keep source, proof, CTA, and state notes visually attached to Atmosphere Composer, with tight native grouping, thumb-zone reach for actions, and enough separation to prevent equal-weight card stacking.
...
This recipe is final-state design canon for Capture Hold / Needs a Place Route in Capture. It does not prove implementation or release readiness.

### Good / Bad Example

- Good: Capture Hold / Needs a Place Route stays attached to Atmosphere Composer, with trust, proof, receipt, and recovery visible.
- Bad: Capture Hold / Needs a Place Route turns into a generic productivity pattern or hides its trust seam.
...
Capture Hold / Needs a Place Route keeps its trust seam attached to Atmosphere Composer and Capture.
...
Capture Hold / Needs a Place Route exposes local runtime behavior as inspectable state, not hidden automation.
...
Capture Hold / Needs a Place Route previews local reset or forget consequences before the user commits to them.
