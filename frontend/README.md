...
Status: Active frontend portal
Authority: subordinate to `docs/truth/*`

The active frontend visual canon lives under [`visual-encyclopedia/`](visual-encyclopedia/README.md).
...
- [`visual-encyclopedia/UI_STUDIO_OPERATING_SYSTEM.md`](visual-encyclopedia/UI_STUDIO_OPERATING_SYSTEM.md) for the installed UI Studio control-plane
- [`visual-encyclopedia/trace/UI_STUDIO_SCREEN_STATE_MATRIX.md`](visual-encyclopedia/trace/UI_STUDIO_SCREEN_STATE_MATRIX.md) for the state coverage matrix
