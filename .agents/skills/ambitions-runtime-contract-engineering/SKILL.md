...
3. Map the contract to canonical owners: `Core/LocalRuntimeOS/Commands`, `Core/LocalRuntimeOS/Transactions`, `Core/LocalRuntimeOS/EventJournal`, `Core/LocalRuntimeOS/Projections`, `Core/LocalRuntimeOS/PrivateLifeRuntimeKernel`, `Core/LocalRuntimeOS/Planning`, `Core/LocalRuntimeOS/TimeEngine`, `Core/LocalRuntimeOS/CaptureRouteGraph`, `Core/LocalRuntimeOS/Inspection`, `Core/LocalRuntimeOS/Search`, `Core/LocalRuntimeOS/ExternalWrites`, `Core/LocalRuntimeOS/SourceAtlas`, `Core/LocalRuntimeOS/PrivacySecurity`, `Core/LocalRuntimeOS/Storage`, `Core/LocalRuntimeOS/Repair`, `Core/LocalRuntimeOS/Diagnostics`, `Projection/Mutations`, `Trust`, `Scenarios`, `Surfaces`, `Composer/Capture`, `Stage/Motion`, or another exact Final Architecture Tree owner.
