...
Review Research conversationally with Devan. Confirm that it clearly states the
idea and user problem, accurately reflects current repository and canon truth,
grounds its recommendation in available evidence, considers meaningful
...
Confirm that the frontend investigation names the current surfaces examined,
classifies potential impact as none, possible, or certain, and does not treat
omission as evidence of no impact.
