...
class ParserTests(unittest.TestCase):
    ...
    STATE_COMMAND_CONTRACT = (
        ...
        'destination_id = "DEST-TODAY-DETAIL-OPEN-STEP"\n'
        'destination_posture = "current"\n'
        'success_focus_id = "FOCUS-TODAY-DETAIL-OPEN-STEP-SUCCESS"\n'
        'success_focus_posture = "current"\n'
        'failure_focus_id = "FOCUS-TODAY-DETAIL-OPEN-STEP-FAILURE"\n'
        'failure_focus_posture = "current"\n'
        'recovery_id = "RECOVERY-TODAY-DETAIL-OPEN-STEP"\n'
        'recovery_posture = "current"\n'
        'recovery_owner = "surface.today.primary-identity"\n'
