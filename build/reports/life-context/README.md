# Life Context Proof Root

Status: installed_not_run

This directory is the proof artifact root for `TRAIN_04A - Life Context & Historical Catch-Up Runtime Inputs`.

Expected future artifacts:
- `domain.md`
- `historical-catchup-intake.md`
