# Frontend Authority Packet: Proof Detail

Batch: `ENCYCLOPEDIA-TO-FRONTEND-OPERATING-SYSTEM-06`
Surface ID: `proof_detail`
Destination: `Goals`
Primary object: `Constellation Atlas`
Maturity tier: `P2`
Recipe path: `frontend/visual-encyclopedia/recipes/goals/proof_detail.md`
...
- python3 scripts/ambitions-frontend-authority-preflight.py --surface proof_detail
- python3 scripts/ambitions-frontend-implementation-prompt.py --surface proof_detail --batch FRONTEND-SURFACE-RECIPE-ENCYCLOPEDIA-001
