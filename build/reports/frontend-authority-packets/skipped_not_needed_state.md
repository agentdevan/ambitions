# Frontend Authority Packet: Skipped / Not Needed State

Batch: `ENCYCLOPEDIA-TO-FRONTEND-OPERATING-SYSTEM-06`
Surface ID: `skipped_not_needed_state`
Destination: `Cross-surface`
Primary object: `Skipped / Not Needed State`
Maturity tier: `candidate`
Recipe path: `frontend/visual-encyclopedia/recipes/cross_surface/skipped_not_needed_state.md`
...
- python3 scripts/ambitions-frontend-authority-preflight.py --surface skipped_not_needed_state
- python3 scripts/ambitions-frontend-implementation-prompt.py --surface skipped_not_needed_state --batch FRONTEND-SURFACE-RECIPE-ENCYCLOPEDIA-001
