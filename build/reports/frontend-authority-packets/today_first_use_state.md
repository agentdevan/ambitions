# Frontend Authority Packet: Today First-Use State

Batch: `ENCYCLOPEDIA-TO-FRONTEND-OPERATING-SYSTEM-06`
Surface ID: `today_first_use_state`
Destination: `Onboarding`
Primary object: `First Run Root`
Maturity tier: `candidate`
Recipe path: `frontend/visual-encyclopedia/recipes/onboarding/today_first_use_state.md`
...
- python3 scripts/ambitions-frontend-authority-preflight.py --surface today_first_use_state
- python3 scripts/ambitions-frontend-implementation-prompt.py --surface today_first_use_state --batch FRONTEND-SURFACE-RECIPE-ENCYCLOPEDIA-001
