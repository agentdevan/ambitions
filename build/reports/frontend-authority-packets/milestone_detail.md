# Frontend Authority Packet: Milestone Detail

Batch: `ENCYCLOPEDIA-TO-FRONTEND-OPERATING-SYSTEM-06`
Surface ID: `milestone_detail`
Destination: `Goals`
Primary object: `Constellation Atlas`
Maturity tier: `P2`
Recipe path: `frontend/visual-encyclopedia/recipes/goals/milestone_detail.md`
...
- python3 scripts/ambitions-frontend-authority-preflight.py --surface milestone_detail
- python3 scripts/ambitions-frontend-implementation-prompt.py --surface milestone_detail --batch FRONTEND-SURFACE-RECIPE-ENCYCLOPEDIA-001
