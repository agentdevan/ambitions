# Frontend Authority Packet: Goals Empty State

Batch: `ENCYCLOPEDIA-TO-FRONTEND-OPERATING-SYSTEM-06`
Surface ID: `goals_empty_state`
Destination: `Goals`
Primary object: `Constellation Atlas`
Maturity tier: `P2`
Recipe path: `frontend/visual-encyclopedia/recipes/goals/goals_empty_state.md`
...
- python3 scripts/ambitions-frontend-authority-preflight.py --surface goals_empty_state
- python3 scripts/ambitions-frontend-implementation-prompt.py --surface goals_empty_state --batch FRONTEND-SURFACE-RECIPE-ENCYCLOPEDIA-001
