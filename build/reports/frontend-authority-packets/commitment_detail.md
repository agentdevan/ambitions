# Frontend Authority Packet: Commitment Detail

Batch: `ENCYCLOPEDIA-TO-FRONTEND-OPERATING-SYSTEM-06`
Surface ID: `commitment_detail`
Destination: `Goals`
Primary object: `Constellation Atlas`
Maturity tier: `P2`
Recipe path: `frontend/visual-encyclopedia/recipes/goals/commitment_detail.md`
...
- python3 scripts/ambitions-frontend-authority-preflight.py --surface commitment_detail
- python3 scripts/ambitions-frontend-implementation-prompt.py --surface commitment_detail --batch FRONTEND-SURFACE-RECIPE-ENCYCLOPEDIA-001
