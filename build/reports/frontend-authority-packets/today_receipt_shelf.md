# Frontend Authority Packet: Today Receipt Shelf

Batch: `ENCYCLOPEDIA-TO-FRONTEND-OPERATING-SYSTEM-06`
Surface ID: `today_receipt_shelf`
Destination: `Today`
Primary object: `Reality Meridian`
Maturity tier: `P2`
Recipe path: `frontend/visual-encyclopedia/recipes/today/today_receipt_shelf.md`
...
- python3 scripts/ambitions-frontend-authority-preflight.py --surface today_receipt_shelf
- python3 scripts/ambitions-frontend-implementation-prompt.py --surface today_receipt_shelf --batch FRONTEND-SURFACE-RECIPE-ENCYCLOPEDIA-001
