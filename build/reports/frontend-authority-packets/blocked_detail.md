# Frontend Authority Packet: Blocked Detail

Batch: `ENCYCLOPEDIA-TO-FRONTEND-OPERATING-SYSTEM-06`
Surface ID: `blocked_detail`
Destination: `Today`
Primary object: `Reality Meridian`
Maturity tier: `P2`
Recipe path: `frontend/visual-encyclopedia/recipes/today/blocked_detail.md`
...
- python3 scripts/ambitions-frontend-authority-preflight.py --surface blocked_detail
- python3 scripts/ambitions-frontend-implementation-prompt.py --surface blocked_detail --batch FRONTEND-SURFACE-RECIPE-ENCYCLOPEDIA-001
