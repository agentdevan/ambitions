# Frontend Authority Packet: Notifications
...
Maturity tier: `P2`
Recipe path: `frontend/visual-encyclopedia/recipes/you/notifications.md`
...
- python3 scripts/ambitions-frontend-authority-preflight.py --surface notifications
- python3 scripts/ambitions-frontend-implementation-prompt.py --surface notifications --batch FRONTEND-SURFACE-RECIPE-ENCYCLOPEDIA-001
