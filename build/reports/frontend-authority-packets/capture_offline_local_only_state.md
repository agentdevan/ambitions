# Frontend Authority Packet: Capture Offline Local-Only State

Batch: `ENCYCLOPEDIA-TO-FRONTEND-OPERATING-SYSTEM-06`
Surface ID: `capture_offline_local_only_state`
Destination: `Capture`
Primary object: `Atmosphere Composer`
Maturity tier: `candidate`
Recipe path: `frontend/visual-encyclopedia/recipes/capture/capture_offline_local_only_state.md`
...
- python3 scripts/ambitions-frontend-authority-preflight.py --surface capture_offline_local_only_state
- python3 scripts/ambitions-frontend-implementation-prompt.py --surface capture_offline_local_only_state --batch FRONTEND-SURFACE-RECIPE-ENCYCLOPEDIA-001
