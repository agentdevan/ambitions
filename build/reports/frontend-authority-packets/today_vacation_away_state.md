# Frontend Authority Packet: Today Vacation / Away State

Batch: `ENCYCLOPEDIA-TO-FRONTEND-OPERATING-SYSTEM-06`
Surface ID: `today_vacation_away_state`
Destination: `Today`
Primary object: `Reality Meridian`
Maturity tier: `candidate`
Recipe path: `frontend/visual-encyclopedia/recipes/today/today_vacation_away_state.md`
...
- python3 scripts/ambitions-frontend-authority-preflight.py --surface today_vacation_away_state
- python3 scripts/ambitions-frontend-implementation-prompt.py --surface today_vacation_away_state --batch FRONTEND-SURFACE-RECIPE-ENCYCLOPEDIA-001
