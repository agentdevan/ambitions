# Frontend Authority Packet: GraphiteRecess Base

Batch: `ENCYCLOPEDIA-TO-FRONTEND-OPERATING-SYSTEM-06`
Surface ID: `graphiterecess_base`
Destination: `Cross-surface`
Primary object: `GraphiteRecess Base`
Maturity tier: `candidate`
Recipe path: `frontend/visual-encyclopedia/recipes/cross_surface/graphiterecess_base.md`
...
- python3 scripts/ambitions-frontend-authority-preflight.py --surface graphiterecess_base
- python3 scripts/ambitions-frontend-implementation-prompt.py --surface graphiterecess_base --batch FRONTEND-SURFACE-RECIPE-ENCYCLOPEDIA-001
