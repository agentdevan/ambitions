# Frontend Authority Packet: Review Pressure Surface

Batch: `ENCYCLOPEDIA-TO-FRONTEND-OPERATING-SYSTEM-06`
Surface ID: `review_pressure_surface`
Destination: `Time`
Primary object: `LifeShape Field`
Maturity tier: `P2`
Recipe path: `frontend/visual-encyclopedia/recipes/time/review_pressure_surface.md`
...
- visible_regions:
  ...
  - protected-time integrity readout
  - capacity compression field
  - one relief option
...
- python3 scripts/ambitions-frontend-authority-preflight.py --surface review_pressure_surface
- python3 scripts/ambitions-frontend-implementation-prompt.py --surface review_pressure_surface --batch FRONTEND-SURFACE-RECIPE-ENCYCLOPEDIA-001
