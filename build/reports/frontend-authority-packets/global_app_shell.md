# Frontend Authority Packet: Global App Shell

Batch: `ENCYCLOPEDIA-TO-FRONTEND-OPERATING-SYSTEM-06`
Surface ID: `global_app_shell`
Destination: `Cross-surface`
Primary object: `Global App Shell`
Maturity tier: `P1`
Recipe path: `frontend/visual-encyclopedia/recipes/shell/global_app_shell.md`
...
- python3 scripts/ambitions-frontend-authority-preflight.py --surface global_app_shell
- python3 scripts/ambitions-frontend-implementation-prompt.py --surface global_app_shell --batch FRONTEND-SURFACE-RECIPE-ENCYCLOPEDIA-001
