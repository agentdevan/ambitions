# Frontend Authority Packet: Back Navigation

Batch: `ENCYCLOPEDIA-TO-FRONTEND-OPERATING-SYSTEM-06`
Surface ID: `back_navigation`
Destination: `Cross-surface`
Primary object: `Global App Shell`
Maturity tier: `P1`
Recipe path: `frontend/visual-encyclopedia/recipes/shell/back_navigation.md`
...
- python3 scripts/ambitions-frontend-authority-preflight.py --surface back_navigation
- python3 scripts/ambitions-frontend-implementation-prompt.py --surface back_navigation --batch FRONTEND-SURFACE-RECIPE-ENCYCLOPEDIA-001
