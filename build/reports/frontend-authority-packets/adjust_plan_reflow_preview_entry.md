# Frontend Authority Packet: Adjust Plan / Reflow Preview Entry

Batch: `ENCYCLOPEDIA-TO-FRONTEND-OPERATING-SYSTEM-06`
Surface ID: `adjust_plan_reflow_preview_entry`
Destination: `Today`
Primary object: `Reality Meridian`
Maturity tier: `P2`
Recipe path: `frontend/visual-encyclopedia/recipes/today/adjust_plan_reflow_preview_entry.md`
...
- python3 scripts/ambitions-frontend-authority-preflight.py --surface adjust_plan_reflow_preview_entry
- python3 scripts/ambitions-frontend-implementation-prompt.py --surface adjust_plan_reflow_preview_entry --batch FRONTEND-SURFACE-RECIPE-ENCYCLOPEDIA-001
