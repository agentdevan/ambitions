# Frontend Authority Packet: Capture Preferences

Batch: `ENCYCLOPEDIA-TO-FRONTEND-OPERATING-SYSTEM-06`
Surface ID: `capture_preferences`
Destination: `You`
Primary object: `User System Profile`
Maturity tier: `P2`
Recipe path: `frontend/visual-encyclopedia/recipes/you/capture_preferences.md`
...
- python3 scripts/ambitions-frontend-authority-preflight.py --surface capture_preferences
- python3 scripts/ambitions-frontend-implementation-prompt.py --surface capture_preferences --batch FRONTEND-SURFACE-RECIPE-ENCYCLOPEDIA-001
