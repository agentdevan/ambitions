# Frontend Authority Packet: Today Closure Prompt Region

Batch: `ENCYCLOPEDIA-TO-FRONTEND-OPERATING-SYSTEM-06`
Surface ID: `today_closure_prompt_region`
Destination: `Today`
Primary object: `Reality Meridian`
Maturity tier: `P2`
Recipe path: `frontend/visual-encyclopedia/recipes/today/today_closure_prompt_region.md`
...
- python3 scripts/ambitions-frontend-authority-preflight.py --surface today_closure_prompt_region
- python3 scripts/ambitions-frontend-implementation-prompt.py --surface today_closure_prompt_region --batch FRONTEND-SURFACE-RECIPE-ENCYCLOPEDIA-001
