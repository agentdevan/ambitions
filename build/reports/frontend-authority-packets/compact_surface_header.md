# Frontend Authority Packet: Compact Surface Header

Batch: `ENCYCLOPEDIA-TO-FRONTEND-OPERATING-SYSTEM-06`
Surface ID: `compact_surface_header`
Destination: `Cross-surface`
Primary object: `Global App Shell`
Maturity tier: `P1`
Recipe path: `frontend/visual-encyclopedia/recipes/shell/compact_surface_header.md`
...
- surface_kind: navigation_chrome
- supporting_objects:
  - Receipt System
...
- python3 scripts/ambitions-frontend-authority-preflight.py --surface compact_surface_header
- python3 scripts/ambitions-frontend-implementation-prompt.py --surface compact_surface_header --batch FRONTEND-SURFACE-RECIPE-ENCYCLOPEDIA-001
