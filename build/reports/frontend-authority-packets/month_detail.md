# Frontend Authority Packet: Month Detail

Batch: `ENCYCLOPEDIA-TO-FRONTEND-OPERATING-SYSTEM-06`
Surface ID: `month_detail`
Destination: `Time`
Primary object: `LifeShape Field`
Maturity tier: `P2`
Recipe path: `frontend/visual-encyclopedia/recipes/time/month_detail.md`
...
- visible_regions:
  - month LifeShape horizon
  - protected span map
  - pressure cluster summary
  - open-capacity basin
...
- python3 scripts/ambitions-frontend-authority-preflight.py --surface month_detail
- python3 scripts/ambitions-frontend-implementation-prompt.py --surface month_detail --batch FRONTEND-SURFACE-RECIPE-ENCYCLOPEDIA-001
