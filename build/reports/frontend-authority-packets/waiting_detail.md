# Frontend Authority Packet: Waiting Detail

Batch: `ENCYCLOPEDIA-TO-FRONTEND-OPERATING-SYSTEM-06`
Surface ID: `waiting_detail`
Destination: `Today`
Primary object: `Reality Meridian`
Maturity tier: `P2`
Recipe path: `frontend/visual-encyclopedia/recipes/today/waiting_detail.md`
...
- python3 scripts/ambitions-frontend-authority-preflight.py --surface waiting_detail
- python3 scripts/ambitions-frontend-implementation-prompt.py --surface waiting_detail --batch FRONTEND-SURFACE-RECIPE-ENCYCLOPEDIA-001
