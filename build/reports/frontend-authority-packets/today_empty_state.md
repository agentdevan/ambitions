# Frontend Authority Packet: Today Empty State

Batch: `ENCYCLOPEDIA-TO-FRONTEND-OPERATING-SYSTEM-06`
Surface ID: `today_empty_state`
Destination: `Today`
Primary object: `Reality Meridian`
Maturity tier: `P2`
Recipe path: `frontend/visual-encyclopedia/recipes/today/today_empty_state.md`
...
- python3 scripts/ambitions-frontend-authority-preflight.py --surface today_empty_state
- python3 scripts/ambitions-frontend-implementation-prompt.py --surface today_empty_state --batch FRONTEND-SURFACE-RECIPE-ENCYCLOPEDIA-001
