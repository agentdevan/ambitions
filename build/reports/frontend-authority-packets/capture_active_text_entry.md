# Frontend Authority Packet: Capture Active Text Entry

Batch: `ENCYCLOPEDIA-TO-FRONTEND-OPERATING-SYSTEM-06`
Surface ID: `capture_active_text_entry`
Destination: `Capture`
Primary object: `Atmosphere Composer`
Maturity tier: `P2`
Recipe path: `frontend/visual-encyclopedia/recipes/capture/capture_active_text_entry.md`
...
- python3 scripts/ambitions-frontend-authority-preflight.py --surface capture_active_text_entry
- python3 scripts/ambitions-frontend-implementation-prompt.py --surface capture_active_text_entry --batch FRONTEND-SURFACE-RECIPE-ENCYCLOPEDIA-001
