# Frontend Authority Packet: Sheet Chrome

Batch: `ENCYCLOPEDIA-TO-FRONTEND-OPERATING-SYSTEM-06`
Surface ID: `sheet_chrome`
Destination: `Cross-surface`
Primary object: `Global App Shell`
Maturity tier: `P1`
Recipe path: `frontend/visual-encyclopedia/recipes/shell/sheet_chrome.md`
...
- python3 scripts/ambitions-frontend-authority-preflight.py --surface sheet_chrome
- python3 scripts/ambitions-frontend-implementation-prompt.py --surface sheet_chrome --batch FRONTEND-SURFACE-RECIPE-ENCYCLOPEDIA-001
