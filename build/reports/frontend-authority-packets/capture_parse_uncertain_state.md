# Frontend Authority Packet: Capture Parse Uncertain State

Batch: `ENCYCLOPEDIA-TO-FRONTEND-OPERATING-SYSTEM-06`
Surface ID: `capture_parse_uncertain_state`
Destination: `Capture`
Primary object: `Atmosphere Composer`
Maturity tier: `P2`
Recipe path: `frontend/visual-encyclopedia/recipes/capture/capture_parse_uncertain_state.md`
...
- python3 scripts/ambitions-frontend-authority-preflight.py --surface capture_parse_uncertain_state
- python3 scripts/ambitions-frontend-implementation-prompt.py --surface capture_parse_uncertain_state --batch FRONTEND-SURFACE-RECIPE-ENCYCLOPEDIA-001
