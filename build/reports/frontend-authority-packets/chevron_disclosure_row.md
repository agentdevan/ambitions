# Frontend Authority Packet: Chevron / Disclosure Row

Batch: `ENCYCLOPEDIA-TO-FRONTEND-OPERATING-SYSTEM-06`
Surface ID: `chevron_disclosure_row`
Destination: `Cross-surface`
Primary object: `Chevron / Disclosure Row`
Maturity tier: `candidate`
Recipe path: `frontend/visual-encyclopedia/recipes/cross_surface/chevron_disclosure_row.md`
...
- python3 scripts/ambitions-frontend-authority-preflight.py --surface chevron_disclosure_row
- python3 scripts/ambitions-frontend-implementation-prompt.py --surface chevron_disclosure_row --batch FRONTEND-SURFACE-RECIPE-ENCYCLOPEDIA-001
