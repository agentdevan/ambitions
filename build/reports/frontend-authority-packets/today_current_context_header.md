# Frontend Authority Packet: Today Current Context Header

Batch: `ENCYCLOPEDIA-TO-FRONTEND-OPERATING-SYSTEM-06`
Surface ID: `today_current_context_header`
Destination: `Today`
Primary object: `Reality Meridian`
Maturity tier: `P2`
Recipe path: `frontend/visual-encyclopedia/recipes/today/today_current_context_header.md`
...
- python3 scripts/ambitions-frontend-authority-preflight.py --surface today_current_context_header
- python3 scripts/ambitions-frontend-implementation-prompt.py --surface today_current_context_header --batch FRONTEND-SURFACE-RECIPE-ENCYCLOPEDIA-001
