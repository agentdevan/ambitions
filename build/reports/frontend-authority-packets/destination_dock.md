# Frontend Authority Packet: Destination Dock

Batch: `ENCYCLOPEDIA-TO-FRONTEND-OPERATING-SYSTEM-06`
Surface ID: `destination_dock`
Destination: `Cross-surface`
Primary object: `Global App Shell`
Maturity tier: `P1`
Recipe path: `frontend/visual-encyclopedia/recipes/shell/destination_dock.md`
...
- python3 scripts/ambitions-frontend-authority-preflight.py --surface destination_dock
- python3 scripts/ambitions-frontend-implementation-prompt.py --surface destination_dock --batch FRONTEND-SURFACE-RECIPE-ENCYCLOPEDIA-001
