# Frontend Authority Packet: Today Source Freshness Indicator

Batch: `ENCYCLOPEDIA-TO-FRONTEND-OPERATING-SYSTEM-06`
Surface ID: `today_source_freshness_indicator`
Destination: `Today`
Primary object: `Reality Meridian`
Maturity tier: `P2`
Recipe path: `frontend/visual-encyclopedia/recipes/today/today_source_freshness_indicator.md`
...
- python3 scripts/ambitions-frontend-authority-preflight.py --surface today_source_freshness_indicator
- python3 scripts/ambitions-frontend-implementation-prompt.py --surface today_source_freshness_indicator --batch FRONTEND-SURFACE-RECIPE-ENCYCLOPEDIA-001
