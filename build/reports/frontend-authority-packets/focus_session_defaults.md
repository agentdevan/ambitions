# Frontend Authority Packet: Focus / Session Defaults

Batch: `ENCYCLOPEDIA-TO-FRONTEND-OPERATING-SYSTEM-06`
Surface ID: `focus_session_defaults`
Destination: `You`
Primary object: `User System Profile`
Maturity tier: `P2`
Recipe path: `frontend/visual-encyclopedia/recipes/you/focus_session_defaults.md`
...
- python3 scripts/ambitions-frontend-authority-preflight.py --surface focus_session_defaults
- python3 scripts/ambitions-frontend-implementation-prompt.py --surface focus_session_defaults --batch FRONTEND-SURFACE-RECIPE-ENCYCLOPEDIA-001
