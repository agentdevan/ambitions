# Frontend Authority Packet: Goals Life Area Map

Batch: `ENCYCLOPEDIA-TO-FRONTEND-OPERATING-SYSTEM-06`
Surface ID: `goals_life_area_map`
Destination: `Goals`
Primary object: `Constellation Atlas`
Maturity tier: `P2`
Recipe path: `frontend/visual-encyclopedia/recipes/goals/goals_life_area_map.md`
...
- python3 scripts/ambitions-frontend-authority-preflight.py --surface goals_life_area_map
- python3 scripts/ambitions-frontend-implementation-prompt.py --surface goals_life_area_map --batch FRONTEND-SURFACE-RECIPE-ENCYCLOPEDIA-001
