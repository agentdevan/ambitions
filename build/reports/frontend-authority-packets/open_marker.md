# Frontend Authority Packet: Open Marker

Batch: `ENCYCLOPEDIA-TO-FRONTEND-OPERATING-SYSTEM-06`
Surface ID: `open_marker`
Destination: `Cross-surface`
Primary object: `Open Marker`
Maturity tier: `candidate`
Recipe path: `frontend/visual-encyclopedia/recipes/cross_surface/open_marker.md`
...
- python3 scripts/ambitions-frontend-authority-preflight.py --surface open_marker
- python3 scripts/ambitions-frontend-implementation-prompt.py --surface open_marker --batch FRONTEND-SURFACE-RECIPE-ENCYCLOPEDIA-001
