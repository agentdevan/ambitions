# Frontend Authority Packet: Reflow Week Flow

Batch: `ENCYCLOPEDIA-TO-FRONTEND-OPERATING-SYSTEM-06`
Surface ID: `reflow_week_flow`
Destination: `Time`
Primary object: `LifeShape Field`
Maturity tier: `P2`
Recipe path: `frontend/visual-encyclopedia/recipes/time/reflow_week_flow.md`
...
- python3 scripts/ambitions-frontend-authority-preflight.py --surface reflow_week_flow
- python3 scripts/ambitions-frontend-implementation-prompt.py --surface reflow_week_flow --batch FRONTEND-SURFACE-RECIPE-ENCYCLOPEDIA-001
