# Frontend Authority Packet: Best Fit Region

Batch: `ENCYCLOPEDIA-TO-FRONTEND-OPERATING-SYSTEM-06`
Surface ID: `best_fit_region`
Destination: `Time`
Primary object: `LifeShape Field`
Maturity tier: `P2`
Recipe path: `frontend/visual-encyclopedia/recipes/time/best_fit_region.md`
...
- python3 scripts/ambitions-frontend-authority-preflight.py --surface best_fit_region
- python3 scripts/ambitions-frontend-implementation-prompt.py --surface best_fit_region --batch FRONTEND-SURFACE-RECIPE-ENCYCLOPEDIA-001
