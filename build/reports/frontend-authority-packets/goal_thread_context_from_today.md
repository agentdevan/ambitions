# Frontend Authority Packet: Goal Thread Context from Today

Batch: `ENCYCLOPEDIA-TO-FRONTEND-OPERATING-SYSTEM-06`
Surface ID: `goal_thread_context_from_today`
Destination: `Today`
Primary object: `Reality Meridian`
Maturity tier: `P2`
Recipe path: `frontend/visual-encyclopedia/recipes/today/goal_thread_context_from_today.md`
...
- python3 scripts/ambitions-frontend-authority-preflight.py --surface goal_thread_context_from_today
- python3 scripts/ambitions-frontend-implementation-prompt.py --surface goal_thread_context_from_today --batch FRONTEND-SURFACE-RECIPE-ENCYCLOPEDIA-001
