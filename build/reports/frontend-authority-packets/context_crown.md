# Frontend Authority Packet: Context Crown

Batch: `ENCYCLOPEDIA-TO-FRONTEND-OPERATING-SYSTEM-06`
Surface ID: `context_crown`
Destination: `Cross-surface`
Primary object: `Global App Shell`
Maturity tier: `P1`
Recipe path: `frontend/visual-encyclopedia/recipes/shell/context_crown.md`
...
- python3 scripts/ambitions-frontend-authority-preflight.py --surface context_crown
- python3 scripts/ambitions-frontend-implementation-prompt.py --surface context_crown --batch FRONTEND-SURFACE-RECIPE-ENCYCLOPEDIA-001
