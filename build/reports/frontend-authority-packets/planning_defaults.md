# Frontend Authority Packet: Planning Defaults

Batch: `ENCYCLOPEDIA-TO-FRONTEND-OPERATING-SYSTEM-06`
Surface ID: `planning_defaults`
Destination: `You`
Primary object: `User System Profile`
Maturity tier: `P2`
Recipe path: `frontend/visual-encyclopedia/recipes/you/planning_defaults.md`
...
- python3 scripts/ambitions-frontend-authority-preflight.py --surface planning_defaults
- python3 scripts/ambitions-frontend-implementation-prompt.py --surface planning_defaults --batch FRONTEND-SURFACE-RECIPE-ENCYCLOPEDIA-001
