# Frontend Authority Packet: Capture Grow into Goal Route

Batch: `ENCYCLOPEDIA-TO-FRONTEND-OPERATING-SYSTEM-06`
Surface ID: `capture_grow_into_goal_route`
Destination: `Capture`
Primary object: `Atmosphere Composer`
Maturity tier: `P2`
Recipe path: `frontend/visual-encyclopedia/recipes/capture/capture_grow_into_goal_route.md`
...
- python3 scripts/ambitions-frontend-authority-preflight.py --surface capture_grow_into_goal_route
- python3 scripts/ambitions-frontend-implementation-prompt.py --surface capture_grow_into_goal_route --batch FRONTEND-SURFACE-RECIPE-ENCYCLOPEDIA-001
