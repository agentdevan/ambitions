# Frontend Authority Packet: Recommended Step Context from Goals

Batch: `ENCYCLOPEDIA-TO-FRONTEND-OPERATING-SYSTEM-06`
Surface ID: `recommended_step_context_from_goals`
Destination: `Goals`
Primary object: `Constellation Atlas`
Maturity tier: `P2`
Recipe path: `frontend/visual-encyclopedia/recipes/goals/recommended_step_context_from_goals.md`
...
- python3 scripts/ambitions-frontend-authority-preflight.py --surface recommended_step_context_from_goals
- python3 scripts/ambitions-frontend-implementation-prompt.py --surface recommended_step_context_from_goals --batch FRONTEND-SURFACE-RECIPE-ENCYCLOPEDIA-001
