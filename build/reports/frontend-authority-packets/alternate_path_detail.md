# Frontend Authority Packet: Alternate Path Detail

Batch: `ENCYCLOPEDIA-TO-FRONTEND-OPERATING-SYSTEM-06`
Surface ID: `alternate_path_detail`
Destination: `Goals`
Primary object: `Constellation Atlas`
Maturity tier: `P2`
Recipe path: `frontend/visual-encyclopedia/recipes/goals/alternate_path_detail.md`
...
- python3 scripts/ambitions-frontend-authority-preflight.py --surface alternate_path_detail
- python3 scripts/ambitions-frontend-implementation-prompt.py --surface alternate_path_detail --batch FRONTEND-SURFACE-RECIPE-ENCYCLOPEDIA-001
