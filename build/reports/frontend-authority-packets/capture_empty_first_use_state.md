# Frontend Authority Packet: Capture Empty First-Use State

Batch: `ENCYCLOPEDIA-TO-FRONTEND-OPERATING-SYSTEM-06`
Surface ID: `capture_empty_first_use_state`
Destination: `Capture`
Primary object: `Atmosphere Composer`
Maturity tier: `P2`
Recipe path: `frontend/visual-encyclopedia/recipes/capture/capture_empty_first_use_state.md`
...
- python3 scripts/ambitions-frontend-authority-preflight.py --surface capture_empty_first_use_state
- python3 scripts/ambitions-frontend-implementation-prompt.py --surface capture_empty_first_use_state --batch FRONTEND-SURFACE-RECIPE-ENCYCLOPEDIA-001
