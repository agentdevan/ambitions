# Frontend Authority Packet: Pressure Marker

Batch: `ENCYCLOPEDIA-TO-FRONTEND-OPERATING-SYSTEM-06`
Surface ID: `pressure_marker`
Destination: `Cross-surface`
Primary object: `Pressure Marker`
Maturity tier: `candidate`
Recipe path: `frontend/visual-encyclopedia/recipes/cross_surface/pressure_marker.md`
...
- python3 scripts/ambitions-frontend-authority-preflight.py --surface pressure_marker
- python3 scripts/ambitions-frontend-implementation-prompt.py --surface pressure_marker --batch FRONTEND-SURFACE-RECIPE-ENCYCLOPEDIA-001
