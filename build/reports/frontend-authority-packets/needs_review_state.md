# Frontend Authority Packet: Needs Review State

Batch: `ENCYCLOPEDIA-TO-FRONTEND-OPERATING-SYSTEM-06`
Surface ID: `needs_review_state`
Destination: `Cross-surface`
Primary object: `Needs Review State`
Maturity tier: `candidate`
Recipe path: `frontend/visual-encyclopedia/recipes/cross_surface/needs_review_state.md`
...
- python3 scripts/ambitions-frontend-authority-preflight.py --surface needs_review_state
- python3 scripts/ambitions-frontend-implementation-prompt.py --surface needs_review_state --batch FRONTEND-SURFACE-RECIPE-ENCYCLOPEDIA-001
