# Frontend Authority Packet: Waiting State

Batch: `ENCYCLOPEDIA-TO-FRONTEND-OPERATING-SYSTEM-06`
Surface ID: `waiting_state`
Destination: `Cross-surface`
Primary object: `Waiting State`
Maturity tier: `candidate`
Recipe path: `frontend/visual-encyclopedia/recipes/cross_surface/waiting_state.md`
...
- python3 scripts/ambitions-frontend-authority-preflight.py --surface waiting_state
- python3 scripts/ambitions-frontend-implementation-prompt.py --surface waiting_state --batch FRONTEND-SURFACE-RECIPE-ENCYCLOPEDIA-001
