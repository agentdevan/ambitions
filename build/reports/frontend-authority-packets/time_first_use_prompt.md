# Frontend Authority Packet: Time First-Use Prompt

Batch: `ENCYCLOPEDIA-TO-FRONTEND-OPERATING-SYSTEM-06`
Surface ID: `time_first_use_prompt`
Destination: `Onboarding`
Primary object: `First Run Root`
Maturity tier: `candidate`
Recipe path: `frontend/visual-encyclopedia/recipes/onboarding/time_first_use_prompt.md`
...
- python3 scripts/ambitions-frontend-authority-preflight.py --surface time_first_use_prompt
- python3 scripts/ambitions-frontend-implementation-prompt.py --surface time_first_use_prompt --batch FRONTEND-SURFACE-RECIPE-ENCYCLOPEDIA-001
