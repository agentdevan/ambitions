# Frontend Authority Packet: Capture Idle Composer

Batch: `ENCYCLOPEDIA-TO-FRONTEND-OPERATING-SYSTEM-06`
Surface ID: `capture_idle_composer`
Destination: `Capture`
Primary object: `Atmosphere Composer`
Maturity tier: `P2`
Recipe path: `frontend/visual-encyclopedia/recipes/capture/capture_idle_composer.md`
...
- python3 scripts/ambitions-frontend-authority-preflight.py --surface capture_idle_composer
- python3 scripts/ambitions-frontend-implementation-prompt.py --surface capture_idle_composer --batch FRONTEND-SURFACE-RECIPE-ENCYCLOPEDIA-001
