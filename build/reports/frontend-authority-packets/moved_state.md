# Frontend Authority Packet: Moved State

Batch: `ENCYCLOPEDIA-TO-FRONTEND-OPERATING-SYSTEM-06`
Surface ID: `moved_state`
Destination: `Cross-surface`
Primary object: `Moved State`
Maturity tier: `candidate`
Recipe path: `frontend/visual-encyclopedia/recipes/cross_surface/moved_state.md`
...
- python3 scripts/ambitions-frontend-authority-preflight.py --surface moved_state
- python3 scripts/ambitions-frontend-implementation-prompt.py --surface moved_state --batch FRONTEND-SURFACE-RECIPE-ENCYCLOPEDIA-001
