# Frontend Authority Packet: Today Recovery State

Batch: `ENCYCLOPEDIA-TO-FRONTEND-OPERATING-SYSTEM-06`
Surface ID: `today_recovery_state`
Destination: `Today`
Primary object: `Reality Meridian`
Maturity tier: `P2`
Recipe path: `frontend/visual-encyclopedia/recipes/today/today_recovery_state.md`
...
- python3 scripts/ambitions-frontend-authority-preflight.py --surface today_recovery_state
- python3 scripts/ambitions-frontend-implementation-prompt.py --surface today_recovery_state --batch FRONTEND-SURFACE-RECIPE-ENCYCLOPEDIA-001
