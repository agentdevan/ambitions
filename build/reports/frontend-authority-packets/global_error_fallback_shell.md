# Frontend Authority Packet: Global Error / Fallback Shell

Batch: `ENCYCLOPEDIA-TO-FRONTEND-OPERATING-SYSTEM-06`
Surface ID: `global_error_fallback_shell`
Destination: `Cross-surface`
Primary object: `Global App Shell`
Maturity tier: `P2`
Recipe path: `frontend/visual-encyclopedia/recipes/shell/global_error_fallback_shell.md`
...
- python3 scripts/ambitions-frontend-authority-preflight.py --surface global_error_fallback_shell
- python3 scripts/ambitions-frontend-implementation-prompt.py --surface global_error_fallback_shell --batch FRONTEND-SURFACE-RECIPE-ENCYCLOPEDIA-001
