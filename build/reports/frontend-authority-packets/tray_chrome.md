# Frontend Authority Packet: Tray Chrome

Batch: `ENCYCLOPEDIA-TO-FRONTEND-OPERATING-SYSTEM-06`
Surface ID: `tray_chrome`
Destination: `Cross-surface`
Primary object: `Global App Shell`
Maturity tier: `P1`
Recipe path: `frontend/visual-encyclopedia/recipes/shell/tray_chrome.md`
...
- python3 scripts/ambitions-frontend-authority-preflight.py --surface tray_chrome
- python3 scripts/ambitions-frontend-implementation-prompt.py --surface tray_chrome --batch FRONTEND-SURFACE-RECIPE-ENCYCLOPEDIA-001
