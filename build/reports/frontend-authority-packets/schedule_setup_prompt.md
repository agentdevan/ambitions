# Frontend Authority Packet: Schedule Setup Prompt

Batch: `ENCYCLOPEDIA-TO-FRONTEND-OPERATING-SYSTEM-06`
Surface ID: `schedule_setup_prompt`
Destination: `Onboarding`
Primary object: `First Run Root`
Maturity tier: `candidate`
Recipe path: `frontend/visual-encyclopedia/recipes/onboarding/schedule_setup_prompt.md`
...
- python3 scripts/ambitions-frontend-authority-preflight.py --surface schedule_setup_prompt
- python3 scripts/ambitions-frontend-implementation-prompt.py --surface schedule_setup_prompt --batch FRONTEND-SURFACE-RECIPE-ENCYCLOPEDIA-001
