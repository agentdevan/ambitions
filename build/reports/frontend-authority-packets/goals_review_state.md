# Frontend Authority Packet: Goals Review State

Batch: `ENCYCLOPEDIA-TO-FRONTEND-OPERATING-SYSTEM-06`
Surface ID: `goals_review_state`
Destination: `Goals`
Primary object: `Constellation Atlas`
Maturity tier: `P2`
Recipe path: `frontend/visual-encyclopedia/recipes/goals/goals_review_state.md`
...
- python3 scripts/ambitions-frontend-authority-preflight.py --surface goals_review_state
- python3 scripts/ambitions-frontend-implementation-prompt.py --surface goals_review_state --batch FRONTEND-SURFACE-RECIPE-ENCYCLOPEDIA-001
