# Frontend Authority Packet: Recommendation Source System

Batch: `ENCYCLOPEDIA-TO-FRONTEND-OPERATING-SYSTEM-06`
Surface ID: `recommendation_source_system`
Destination: `Cross-surface`
Primary object: `Recommendation Source System`
Maturity tier: `candidate`
Recipe path: `frontend/visual-encyclopedia/recipes/cross_surface/recommendation_source_system.md`
...
- python3 scripts/ambitions-frontend-authority-preflight.py --surface recommendation_source_system
- python3 scripts/ambitions-frontend-implementation-prompt.py --surface recommendation_source_system --batch FRONTEND-SURFACE-RECIPE-ENCYCLOPEDIA-001
