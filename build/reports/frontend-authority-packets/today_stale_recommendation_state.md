# Frontend Authority Packet: Today Stale Recommendation State

Batch: `ENCYCLOPEDIA-TO-FRONTEND-OPERATING-SYSTEM-06`
Surface ID: `today_stale_recommendation_state`
Destination: `Today`
Primary object: `Reality Meridian`
Maturity tier: `P2`
Recipe path: `frontend/visual-encyclopedia/recipes/today/today_stale_recommendation_state.md`
...
- python3 scripts/ambitions-frontend-authority-preflight.py --surface today_stale_recommendation_state
- python3 scripts/ambitions-frontend-implementation-prompt.py --surface today_stale_recommendation_state --batch FRONTEND-SURFACE-RECIPE-ENCYCLOPEDIA-001
