# Frontend Authority Packet: Capture First-Use Prompt

Batch: `ENCYCLOPEDIA-TO-FRONTEND-OPERATING-SYSTEM-06`
Surface ID: `capture_first_use_prompt`
Destination: `Onboarding`
Primary object: `First Run Root`
Maturity tier: `candidate`
Recipe path: `frontend/visual-encyclopedia/recipes/onboarding/capture_first_use_prompt.md`
...
- python3 scripts/ambitions-frontend-authority-preflight.py --surface capture_first_use_prompt
- python3 scripts/ambitions-frontend-implementation-prompt.py --surface capture_first_use_prompt --batch FRONTEND-SURFACE-RECIPE-ENCYCLOPEDIA-001
