# Frontend Authority Packet: Planning Defaults Prompt

Batch: `ENCYCLOPEDIA-TO-FRONTEND-OPERATING-SYSTEM-06`
Surface ID: `planning_defaults_prompt`
Destination: `Onboarding`
Primary object: `First Run Root`
Maturity tier: `candidate`
Recipe path: `frontend/visual-encyclopedia/recipes/onboarding/planning_defaults_prompt.md`
...
- python3 scripts/ambitions-frontend-authority-preflight.py --surface planning_defaults_prompt
- python3 scripts/ambitions-frontend-implementation-prompt.py --surface planning_defaults_prompt --batch FRONTEND-SURFACE-RECIPE-ENCYCLOPEDIA-001
