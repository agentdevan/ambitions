# Frontend Authority Packet: Source Freshness Badge

Batch: `ENCYCLOPEDIA-TO-FRONTEND-OPERATING-SYSTEM-06`
Surface ID: `source_freshness_badge`
Destination: `Cross-surface`
Primary object: `Source Freshness Badge`
Maturity tier: `candidate`
Recipe path: `frontend/visual-encyclopedia/recipes/cross_surface/source_freshness_badge.md`
...
- python3 scripts/ambitions-frontend-authority-preflight.py --surface source_freshness_badge
- python3 scripts/ambitions-frontend-implementation-prompt.py --surface source_freshness_badge --batch FRONTEND-SURFACE-RECIPE-ENCYCLOPEDIA-001
