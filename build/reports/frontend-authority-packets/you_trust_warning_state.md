# Frontend Authority Packet: You Trust Warning State

Batch: `ENCYCLOPEDIA-TO-FRONTEND-OPERATING-SYSTEM-06`
Surface ID: `you_trust_warning_state`
Destination: `You`
Primary object: `User System Profile`
Maturity tier: `P2`
Recipe path: `frontend/visual-encyclopedia/recipes/you/you_trust_warning_state.md`
...
- python3 scripts/ambitions-frontend-authority-preflight.py --surface you_trust_warning_state
- python3 scripts/ambitions-frontend-implementation-prompt.py --surface you_trust_warning_state --batch FRONTEND-SURFACE-RECIPE-ENCYCLOPEDIA-001
