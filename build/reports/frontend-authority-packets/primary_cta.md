# Frontend Authority Packet: Primary CTA

Batch: `ENCYCLOPEDIA-TO-FRONTEND-OPERATING-SYSTEM-06`
Surface ID: `primary_cta`
Destination: `Cross-surface`
Primary object: `Primary CTA`
Maturity tier: `candidate`
Recipe path: `frontend/visual-encyclopedia/recipes/cross_surface/primary_cta.md`
...
- python3 scripts/ambitions-frontend-authority-preflight.py --surface primary_cta
- python3 scripts/ambitions-frontend-implementation-prompt.py --surface primary_cta --batch FRONTEND-SURFACE-RECIPE-ENCYCLOPEDIA-001
