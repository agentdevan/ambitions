# Frontend Authority Packet: User Profile Header

Batch: `ENCYCLOPEDIA-TO-FRONTEND-OPERATING-SYSTEM-06`
Surface ID: `user_profile_header`
Destination: `You`
Primary object: `User System Profile`
Maturity tier: `P2`
Recipe path: `frontend/visual-encyclopedia/recipes/you/user_profile_header.md`
...
- python3 scripts/ambitions-frontend-authority-preflight.py --surface user_profile_header
- python3 scripts/ambitions-frontend-implementation-prompt.py --surface user_profile_header --batch FRONTEND-SURFACE-RECIPE-ENCYCLOPEDIA-001
