# Frontend Authority Packet: Capture Dictation State

Batch: `ENCYCLOPEDIA-TO-FRONTEND-OPERATING-SYSTEM-06`
Surface ID: `capture_dictation_state`
Destination: `Capture`
Primary object: `Atmosphere Composer`
Maturity tier: `candidate`
Recipe path: `frontend/visual-encyclopedia/recipes/capture/capture_dictation_state.md`
...
- python3 scripts/ambitions-frontend-authority-preflight.py --surface capture_dictation_state
- python3 scripts/ambitions-frontend-implementation-prompt.py --surface capture_dictation_state --batch FRONTEND-SURFACE-RECIPE-ENCYCLOPEDIA-001
