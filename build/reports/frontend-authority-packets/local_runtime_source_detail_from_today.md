# Frontend Authority Packet: Local Runtime Source Detail from Today

Batch: `ENCYCLOPEDIA-TO-FRONTEND-OPERATING-SYSTEM-06`
Surface ID: `local_runtime_source_detail_from_today`
Destination: `Today`
Primary object: `Reality Meridian`
Maturity tier: `P2`
Recipe path: `frontend/visual-encyclopedia/recipes/today/local_runtime_source_detail_from_today.md`
...
- visible_regions:
  - runtime basis summary
  - source authority row
  - freshness and local-only mark
  - correction path
...
- python3 scripts/ambitions-frontend-authority-preflight.py --surface local_runtime_source_detail_from_today
- python3 scripts/ambitions-frontend-implementation-prompt.py --surface local_runtime_source_detail_from_today --batch FRONTEND-SURFACE-RECIPE-ENCYCLOPEDIA-001
