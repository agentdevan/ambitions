# Frontend Authority Packet: Help
...
Maturity tier: `P2`
Recipe path: `frontend/visual-encyclopedia/recipes/you/help.md`
...
- python3 scripts/ambitions-frontend-authority-preflight.py --surface help
- python3 scripts/ambitions-frontend-implementation-prompt.py --surface help --batch FRONTEND-SURFACE-RECIPE-ENCYCLOPEDIA-001
