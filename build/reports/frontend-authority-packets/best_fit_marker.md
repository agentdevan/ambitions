# Frontend Authority Packet: Best Fit Marker

Batch: `ENCYCLOPEDIA-TO-FRONTEND-OPERATING-SYSTEM-06`
Surface ID: `best_fit_marker`
Destination: `Cross-surface`
Primary object: `Best Fit Marker`
Maturity tier: `candidate`
Recipe path: `frontend/visual-encyclopedia/recipes/cross_surface/best_fit_marker.md`
...
- python3 scripts/ambitions-frontend-authority-preflight.py --surface best_fit_marker
- python3 scripts/ambitions-frontend-implementation-prompt.py --surface best_fit_marker --batch FRONTEND-SURFACE-RECIPE-ENCYCLOPEDIA-001
