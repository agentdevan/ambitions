# Frontend Authority Packet: First Run Root

Batch: `ENCYCLOPEDIA-TO-FRONTEND-OPERATING-SYSTEM-06`
Surface ID: `first_run_root`
Destination: `Onboarding`
Primary object: `First Run Root`
Maturity tier: `candidate`
Recipe path: `frontend/visual-encyclopedia/recipes/onboarding/first_run_root.md`
...
- python3 scripts/ambitions-frontend-authority-preflight.py --surface first_run_root
- python3 scripts/ambitions-frontend-implementation-prompt.py --surface first_run_root --batch FRONTEND-SURFACE-RECIPE-ENCYCLOPEDIA-001
