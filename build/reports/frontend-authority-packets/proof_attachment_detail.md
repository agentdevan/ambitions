# Frontend Authority Packet: Proof Attachment Detail

Batch: `ENCYCLOPEDIA-TO-FRONTEND-OPERATING-SYSTEM-06`
Surface ID: `proof_attachment_detail`
Destination: `Today`
Primary object: `Reality Meridian`
Maturity tier: `candidate`
Recipe path: `frontend/visual-encyclopedia/recipes/today/proof_attachment_detail.md`
...
- python3 scripts/ambitions-frontend-authority-preflight.py --surface proof_attachment_detail
- python3 scripts/ambitions-frontend-implementation-prompt.py --surface proof_attachment_detail --batch FRONTEND-SURFACE-RECIPE-ENCYCLOPEDIA-001
