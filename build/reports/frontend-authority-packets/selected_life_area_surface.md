# Frontend Authority Packet: Selected Life Area Surface

Batch: `ENCYCLOPEDIA-TO-FRONTEND-OPERATING-SYSTEM-06`
Surface ID: `selected_life_area_surface`
Destination: `Goals`
Primary object: `Constellation Atlas`
Maturity tier: `P2`
Recipe path: `frontend/visual-encyclopedia/recipes/goals/selected_life_area_surface.md`
...
- python3 scripts/ambitions-frontend-authority-preflight.py --surface selected_life_area_surface
- python3 scripts/ambitions-frontend-implementation-prompt.py --surface selected_life_area_surface --batch FRONTEND-SURFACE-RECIPE-ENCYCLOPEDIA-001
