# Frontend Authority Packet: Goal Detail

Batch: `ENCYCLOPEDIA-TO-FRONTEND-OPERATING-SYSTEM-06`
Surface ID: `goal_detail`
Destination: `Goals`
Primary object: `Constellation Atlas`
Maturity tier: `P2`
Recipe path: `frontend/visual-encyclopedia/recipes/goals/goal_detail.md`
...
- python3 scripts/ambitions-frontend-authority-preflight.py --surface goal_detail
- python3 scripts/ambitions-frontend-implementation-prompt.py --surface goal_detail --batch FRONTEND-SURFACE-RECIPE-ENCYCLOPEDIA-001
